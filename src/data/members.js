// 30 membres réseau + 2 membres adhérent
// source:'réseau' = employés Breiz'Agri Conseil ; source:'adherent' = équipe propre d'une org adhérente
// Les membres réseau ont orgIds[] (admins/proprio) ou orgIds[N] (agents affectés à une org)
// Les membres adhérent ont orgIds[N] correspondant à leur organisation
...
export const members = [
  // ── Propriétaire (1M) ─────────────────────────────────────────────────────
  {
    ...
    role: 'propriétaire', statut: 'actif', source: 'réseau',
    orgIds: [],
    parcelIds: [2, 13, 37]
  },
  ...
  // ── Admins (3M, 1F) ───────────────────────────────────────────────────────
  {
    ...
    role: 'admin', statut: 'actif', source: 'réseau',
    orgIds: [],
  ...
  },
  {
    ...
    role: 'agent', statut: 'invité', source: 'réseau',
  ...
  // ── Lecteurs (3M, 2F) ─────────────────────────────────────────────────────
  {
    ...
    role: 'lecteur', statut: 'actif', source: 'réseau',
    orgIds: [], parcelIds: [1]
  },
  {
  ...
  },
  {
    ...
    role: 'lecteur', statut: 'invité', source: 'réseau',
    orgIds: [], parcelIds: [15]
  },
  {
  ...
  },
  {
    ...
    role: 'lecteur', statut: 'inactif', source: 'réseau',
    orgIds: [], parcelIds: [40]
  },

  // ── Membres adhérent — Ferme du Bocage (orgId:1) ──────────────────────────
  {

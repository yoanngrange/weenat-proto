import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css             */import{p as se}from"./plots-DhtWL7s_.js";import{s as P}from"./sensors-CRadjF8G.js";import{o as We}from"./orgs-DnFmvGlp.js";import{m as ie}from"./members-Cr98hVG_.js";import{u as ht}from"./breadcrumb-CzFWtd6d.js";import{d as ne,c as $e}from"./store-c0FlIf2T.js";import{I as N,g as Dt,s as ft}from"./irrigations-C22Dtsoo.js";import{S as Nt,a as Pe,E as Ot,I as bt}from"./constants-D_Yu58_o.js";const gt=new URLSearchParams(window.location.search),B=parseInt(gt.get("id")),S=se.find(e=>e.id===B);function $(e,t){return Math.floor(Math.random()*(t-e+1))+e}function D(e,t){return parseFloat((Math.random()*(t-e)+e).toFixed(2))}const Ve=[{id:"etp",name:"Évapotranspiration (ETP)",unit:"mm/j",color:"#7DBDD7",base:()=>D(.5,5),cumul:{label:"Cumul d'ETP",unit:"mm"},isCumul:!1,chartType:"bar"},{id:"rayonnement",name:"Rayonnement",unit:"W/m²",color:"#CBCB0B",base:()=>$(0,900),cumul:{label:"Énergie",unit:"Wh/m²"},isCumul:!1},{id:"temp_rosee",name:"Température de rosée",unit:"°C",color:"#72B0D8",base:()=>$(2,16),isCumul:!1}],zt={id:"irrigation",name:"Irrigation",unit:"mm",color:"#FF8C00",base:()=>0,isCumul:!0,chartType:"bar",isIrrigation:!0},R={"P+":[{id:"pluie",name:"Pluie",unit:"mm",color:"#2E75B6",base:()=>$(0,8),cumul:{label:"Cumul de pluie",unit:"mm"},isCumul:!0,chartType:"bar"},{id:"temp",name:"Température",unit:"°C",color:"#FBAF05",base:()=>$(10,28),cumul:{label:"Cumul de degrés jour",unit:"°j"}},{id:"humidite",name:"Humidité",unit:"%",color:"#5B12A4",base:()=>$(40,90)}],PT:[{id:"pluie",name:"Pluie",unit:"mm",color:"#2E75B6",base:()=>$(0,8),cumul:{label:"Cumul de pluie",unit:"mm"},isCumul:!0,chartType:"bar"},{id:"temp",name:"Température",unit:"°C",color:"#FBAF05",base:()=>$(10,28),cumul:{label:"Cumul de degrés jour",unit:"°j"}},{id:"etp",name:"Évapotranspiration (ETP)",unit:"mm/j",color:"#7DBDD7",base:()=>D(.5,5),cumul:{label:"Cumul ETP",unit:"mm"},isCumul:!1,chartType:"bar"}],P:[{id:"pluie",name:"Pluie",unit:"mm",color:"#2E75B6",base:()=>$(0,8),cumul:{label:"Cumul de pluie",unit:"mm"},isCumul:!0,chartType:"bar"}],SMV:[{id:"pluie",name:"Pluie",unit:"mm",color:"#2E75B6",base:()=>$(0,8),cumul:{label:"Cumul de pluie",unit:"mm"},isCumul:!0,chartType:"bar"},{id:"temp",name:"Température",unit:"°C",color:"#FBAF05",base:()=>$(10,28),cumul:{label:"Cumul de degrés jour",unit:"°j"}},{id:"humidite",name:"Humidité",unit:"%",color:"#5B12A4",base:()=>$(40,90)},{id:"etp",name:"Évapotranspiration (ETP)",unit:"mm/j",color:"#7DBDD7",base:()=>D(.5,5),cumul:{label:"Cumul ETP",unit:"mm"},isCumul:!1,chartType:"bar"}],TH:[{id:"temp",name:"Température",unit:"°C",color:"#FBAF05",base:()=>$(10,28),cumul:{label:"Cumul de degrés jour",unit:"°j"}},{id:"humidite",name:"Humidité",unit:"%",color:"#5B12A4",base:()=>$(40,90)}],"CHP-15/30":[{id:"pothydr",name:"Potentiel hydrique",unit:"kPa",color:"#A6C157",base:()=>$(10,150)},{id:"tsol",name:"Température du sol",unit:"°C",color:"#795548",base:()=>$(8,22)}],"CHP-30/60":[{id:"pothydr",name:"Potentiel hydrique",unit:"kPa",color:"#A6C157",base:()=>$(10,150)},{id:"tsol",name:"Température du sol",unit:"°C",color:"#795548",base:()=>$(8,22)}],"CHP-60/90":[{id:"pothydr",name:"Potentiel hydrique",unit:"kPa",color:"#A6C157",base:()=>$(10,150)},{id:"tsol",name:"Température du sol",unit:"°C",color:"#795548",base:()=>$(8,22)}],"CAPA-30-3":[{id:"vwc10",name:"Teneur en eau du sol 10 cm",unit:"%vol",color:"#105200",base:()=>$(15,45)},{id:"vwc20",name:"Teneur en eau du sol 20 cm",unit:"%vol",color:"#8C5E82",base:()=>$(15,45)},{id:"vwc30",name:"Teneur en eau du sol 30 cm",unit:"%vol",color:"#46DA82",base:()=>$(15,45)},{id:"tsol",name:"Température du sol",unit:"°C",color:"#795548",base:()=>$(8,22)}],"CAPA-60-6":[{id:"vwc10",name:"Teneur en eau du sol 10 cm",unit:"%vol",color:"#105200",base:()=>$(15,45)},{id:"vwc20",name:"Teneur en eau du sol 20 cm",unit:"%vol",color:"#8C5E82",base:()=>$(15,45)},{id:"vwc30",name:"Teneur en eau du sol 30 cm",unit:"%vol",color:"#46DA82",base:()=>$(15,45)},{id:"vwc40",name:"Teneur en eau du sol 40 cm",unit:"%vol",color:"#949494",base:()=>$(17,43)},{id:"vwc50",name:"Teneur en eau du sol 50 cm",unit:"%vol",color:"#870021",base:()=>$(18,42)},{id:"vwc60",name:"Teneur en eau du sol 60 cm",unit:"%vol",color:"#F608C2",base:()=>$(18,42)},{id:"tsol",name:"Température du sol",unit:"°C",color:"#795548",base:()=>$(8,22)}],T_MINI:[{id:"tsol",name:"Température du sol",unit:"°C",color:"#795548",base:()=>$(8,22)}],LWS:[{id:"humec",name:"Humectation foliaire",unit:"h",color:"#00887E",base:()=>$(0,12)}],T_GEL:[{id:"tseche",name:"Temp. sèche",unit:"°C",color:"#23B19B",base:()=>$(-2,12)},{id:"thumide",name:"Temp. humide",unit:"°C",color:"#5E88EC",base:()=>$(-4,10)}],W:[{id:"_vent",name:"Vent",unit:"km/h · direction",color:"#7bc4b0",isWindComposite:!0,base:()=>$(0,40)}],EC:[{id:"ec",name:"Conductivité",unit:"mS/cm",color:"#f0a030",base:()=>D(.1,3)},{id:"tsol",name:"Température du sol",unit:"°C",color:"#bb8fce",base:()=>$(8,22)}],PYRANO:[{id:"rayonnement",name:"Rayonnement",unit:"W/m²",color:"#f5c842",base:()=>$(0,900),cumul:{label:"Énergie",unit:"Wh/m²"}}],PAR:[{id:"par",name:"Densité de flux de photons photosynthétiques",unit:"µmol/m²/s",color:"#c47a00",base:()=>$(0,2e3)}]},_=["CHP-15/30","CHP-30/60","CHP-60/90"],Re=[{name:"Tensiomètre (CHP)",models:new Set(["CHP-15/30","CHP-30/60","CHP-60/90"])},{name:"Sonde capacitive (CAPA)",models:new Set(["CAPA-30-3","CAPA-60-6"])},{name:"Sonde fertirrigation (EC)",models:new Set(["EC"])},{name:"Thermomètre de sol (T_MINI)",models:new Set(["T_MINI"])}];function De(e){return Re.find(t=>t.models.has(e))||null}const _t={"CAPA-30-3":[{depth:10,label:"10 cm",vwcColor:"#105200",tsolColor:"#FFA040"},{depth:20,label:"20 cm",vwcColor:"#8C5E82",tsolColor:"#E07050"},{depth:30,label:"30 cm",vwcColor:"#46DA82",tsolColor:"#A04030"}],"CAPA-60-6":[{depth:10,label:"10 cm",vwcColor:"#105200",tsolColor:"#FFA040"},{depth:20,label:"20 cm",vwcColor:"#8C5E82",tsolColor:"#E07050"},{depth:30,label:"30 cm",vwcColor:"#46DA82",tsolColor:"#A04030"},{depth:40,label:"40 cm",vwcColor:"#949494",tsolColor:"#804828"},{depth:50,label:"50 cm",vwcColor:"#870021",tsolColor:"#603818"},{depth:60,label:"60 cm",vwcColor:"#F608C2",tsolColor:"#402810"}]},Je=["CAPA-30-3","CAPA-60-6"],ee={"P+":"Station météo",PT:"Station météo",P:"Pluviomètre",SMV:"Station météo virtuelle",TH:"Thermomètre-hygromètre",T_MINI:"Thermomètre de sol",W:"Anémomètre",PYRANO:"Pyranomètre",PAR:"Capteur PAR",LWS:"Capteur d'humectation foliaire",T_GEL:"Capteur de gel","CHP-15/30":"Tensiomètre","CHP-30/60":"Tensiomètre","CHP-60/90":"Tensiomètre","CAPA-30-3":"Sonde capacitive","CAPA-60-6":"Sonde capacitive",EC:"Sonde de fertirrigation"};function Wt(e,t=null,i=null,n=null){const a=Math.max(2,Math.min(200,Math.floor(pe()/fe()))),o=Array.from({length:a},()=>$(5,35)),c=o.map(E=>Math.min(E+$(3,18),80)),l=Array.from({length:a},()=>$(0,359)),u=600,r=200,v=46,s=16,d=16,m=28,p=u-v-s,h=r-d-m,f=Math.ceil(Math.max(...c)/10)*10||50,y=E=>v+E/Math.max(a-1,1)*p,b=E=>d+h-E/f*h,w=c.map((E,A)=>`${y(A).toFixed(1)},${b(E).toFixed(1)}`).join("L"),g=[...o].reverse().map((E,A)=>`${y(a-1-A).toFixed(1)},${b(E).toFixed(1)}`).join("L"),C=`M${w}L${g}Z`,M=o.map((E,A)=>`${A?"L":"M"}${y(A).toFixed(1)},${b(E).toFixed(1)}`).join(""),k=[.25,.5,.75].map(E=>{const A=(d+h-E*h).toFixed(1);return`<line x1="${v}" y1="${A}" x2="${u-s}" y2="${A}" stroke="rgba(0,0,0,.06)" stroke-width="1" stroke-dasharray="3,3"/>`}).join(""),I=[0,.5,1].map(E=>{const A=d+h-E*h;return`<text x="${v-4}" y="${(A+4).toFixed(1)}" text-anchor="end" font-size="10" fill="var(--txt3)">${Math.round(E*f)}</text>`}).join(""),j=`<line x1="${v}" y1="${d+h}" x2="${u-s}" y2="${d+h}" stroke="var(--bdr2)" stroke-width="1"/>`,H=Math.max(1,Math.floor(a/6));let F="";for(let E=0;E<a;E+=H){const A=(a-1-E)/Math.max(a-1,1)*pe();F+=`<text x="${y(E).toFixed(1)}" y="${(d+h+14).toFixed(1)}" text-anchor="middle" font-size="10" font-family="var(--font)" fill="var(--txt3)">${Se(A)}</text>`}const W=Math.max(1,Math.round(a/25)),Z=[];for(let E=0;E<a;E+=W){const A=y(E).toFixed(1),O=(d+h*.35).toFixed(1);Z.push(`<g transform="translate(${A},${O}) rotate(${l[E]})">
  ...
  `;n.length===0?l+='<div class="journal-empty">Aucune entrée dans le journal.</div>':n.forEach(s=>{var h;const d=o[s.type]||o.note,m=s.type==="modification"||s._auto===!0,p=s.type==="traitement";l+=`
    ...
    <div class="add-modal-content" style="max-width:480px">
      ...
      </div>`,e.appendChild(n),(t=n.querySelector(".compare-close-btn"))==null||t.addEventListener("click",()=>{G=null,Te(),U()});const a=Ae(x.linkedSensorIds),o=$e(G),c=(o==null?void 0:o.linkedSensorIds)??P.filter(p=>p.parcelIds.includes(G)).map(p=>p.id),l=Ae(c),u=a.map(p=>p.id),r=l.map(p=>p.id),v=u.filter(p=>r.includes(p)),s=u.filter(p=>!r.includes(p)),d=r.filter(p=>!u.includes(p));[...v,...s,...d].forEach(p=>{const h=a.find(g=>g.id===p),f=l.find(g=>g.id===p),y=document.createElement("div");y.className="compare-row";const b=document.createElement("div");h?Oe(b,h):b.innerHTML='<div class="compare-chart-empty">—</div>';const w=document.createElement("div");f?Oe(w,f):w.innerHTML='<div class="compare-chart-empty">—</div>',y.appendChild(b),y.appendChild(w),e.appendChild(y)})}else e.className="charts-stack",di(e,x.linkedSensorIds);$i()}const ye=["#5b8dd9","#e07050","#4ecdc4","#f5c842","#c090e0","#78d8a0"];function ui(e){const t=e.depth||30;return[{depth:t,label:`${t} cm`,sensor:e}]}function mi(e){if(ke==="capteur")return e.map((i,n)=>({label:i.serial,color:ye[n%ye.length],depth:i.depth||30,sensor:i}));const t=new Map;return e.forEach(i=>ui(i).forEach(n=>{t.has(n.depth)||t.set(n.depth,n)})),[...t.values()].sort((i,n)=>i.depth-n.depth).map((i,n)=>({label:i.label,color:ye[n%ye.length],depth:i.depth,sensor:i.sensor}))}function pi(e,t,i,n=null,a=null,o=null){var p;const l={pothydr:{name:"Potentiel hydrique",unit:"kPa"},tsol:{name:"Température du sol",unit:"°C"}}[t],u=mi(i),r=document.createElement("div");r.className="chart-card tensio-multi-card",r.dataset.tensioMetric=t,r.dataset.tensioCurves=JSON.stringify(u.map(h=>({depth:h.depth,color:h.color}))),o&&(r.dataset.cardKey=o,r.draggable=!0);const v=u.map(h=>`<span style="display:inline-flex;align-items:center;gap:4px;font-size:11px;color:var(--txt2)">
  ...
  `,e.appendChild(u),u}function vi(e,t,i=null,n=null,a=null){$t(e,t,"vwcColor","Teneur en eau du sol","%vol","capa-svg","capa",a)}function hi(e,t,i=null,n=null,a=null){$t(e,t,"tsolColor","Température du sol par horizon","°C","capa-tsol-svg","capaT",a)}function Oe(e,t,i=null,n=null,a=null,o=!1,c=null){var p;const l=t.base(),u=document.createElement("div");u.className="chart-card",u.dataset.base=l,u.dataset.color=t.color,u.dataset.cumul=t.isCumul?"1":"",u.dataset.chartType=t.chartType||"line",u.dataset.metricId=t.id,u.dataset.metricName=t.name,u.dataset.metricUnit=t.unit,t.isIrrigation&&(u.dataset.isIrrigation="1"),a&&(u.dataset.cardKey=a,u.draggable=!0);const r=t.cumul?`<div class="chart-cumul"><span class="chart-cumul-label">${t.cumul.label} : <strong>${et(t)} ${t.cumul.unit}</strong></span><button class="chart-cumul-add-btn" data-cumul-label="${t.cumul.label}" data-cumul-val="${et(t)} ${t.cumul.unit}" title="Ajouter au tableau de bord"><i class="bi bi-house"></i></button></div>`:"",v=i?`<span class="chart-card-source">${i}</span>`:"",s=n!=null?`<span class="chart-card-emission">il y a ${n} min</span>`:"";let d="";if(c){const h=((p=document.getElementById("time-step"))==null?void 0:p.value)||"1h";d=`<a class="chart-card-expand" href="capteur-graphique.html?sensorId=${c}&metricId=${t.id}&parcelId=${B}&period=${J}&step=${h}" title="Graphique plein écran"><i class="bi bi-fullscreen"></i></a>`}const m=o?'<div class="chart-unavailable">Données indisponibles pour ce pas de temps</div>':'<svg class="chart-svg" width="100%" height="180" viewBox="0 0 600 180" preserveAspectRatio="none"></svg>';u.innerHTML=`
    <div class="chart-card-header">
    ...
    ${m}
    ${r}
  `,e.appendChild(u)}let ge=null;function fi(){return ge||(ge=document.createElement("div"),ge.className="chart-tooltip",document.body.appendChild(ge)),ge}function bi(e,t){return t==="temp"||t==="temperature"?["#6eb4d4","#e07050"]:t==="tseche"||t==="thumide"?["#6eb4d4","#e07050"]:t==="temp_rosee"?["#a0d0f0","#4090c0"]:[gi(e,.55),e]}function gi(e,t){const i=parseInt(e.slice(1,3),16),n=parseInt(e.slice(3,5),16),a=parseInt(e.slice(5,7),16),o=Math.round(i+(255-i)*t),c=Math.round(n+(255-n)*t),l=Math.round(a+(255-a)*t);return`#${o.toString(16).padStart(2,"0")}${c.toString(16).padStart(2,"0")}${l.toString(16).padStart(2,"0")}`}function Ie(e){if(e.length<2)return"";if(e.length===2)return`M${e[0].x},${e[0].y} L${e[1].x},${e[1].y}`;let t=`M${e[0].x.toFixed(1)},${e[0].y.toFixed(1)}`;for(let i=0;i<e.length-1;i++){const n=e[Math.max(i-1,0)],a=e[i],o=e[i+1],c=e[Math.min(i+2,e.length-1)],l=a.x+(o.x-n.x)/6,u=a.y+(o.y-n.y)/6,r=o.x-(c.x-a.x)/6,v=o.y-(c.y-a.y)/6;t+=` C${l.toFixed(1)},${u.toFixed(1)} ${r.toFixed(1)},${v.toFixed(1)} ${o.x.toFixed(1)},${o.y.toFixed(1)}`}return t}function Se(e){const t=new Date(Date.now()-e*6e4);return e<1440?`${String(t.getHours()).padStart(2,"0")}h`:e>=43200?["jan","fév","mar","avr","mai","juin","juil","aoû","sep","oct","nov","déc"][t.getMonth()]:`${String(t.getDate()).padStart(2,"0")}/${String(t.getMonth()+1).padStart(2,"0")}`}function Ke(e){const t=Date.now()-e*6e4;return new Date(t).getHours()+new Date(t).getMinutes()/60}function yi(e){return Math.max(0,Math.sin(Math.PI*(e-6)/12))}function Ze(e){return .5+.5*Math.sin(2*Math.PI*(e-4)/24-Math.PI/2)}function wi(e){const t=Math.floor((Date.now()-e*6e4)/864e5),i=Math.sin(t*12.9898+78.233)*43758.5453;return i-Math.floor(i)}function ce(e,t,i,n=.15){const a=Ke(i),o=Ze(a),c=yi(a),l=wi(i),u=()=>1+(Math.random()-.5)*2*n;switch(e){case"temp":{const r=.6+l*.8;return(t-6+o*12*r)*u()}case"tseche":case"thumide":{const r=.6+l*.8;return(t-4+o*8*r)*u()}case"temp_rosee":{const r=.6+l*.8,v=t-6+o*12*r;return Math.min(v-1,t-8+o*6*r)*u()}case"tsol":{const r=Ke(i+120),v=.7+l*.6;return(t-3+Ze(r)*6*v)*u()}case"humidite":{const r=1.4-l*.8;return Math.min(100,Math.max(20,(t+(1-o)*25*r-o*15)*u()))}case"rayonnement":{const r=.4+l*.9;return Math.max(0,c*t*1.3*r*u())}case"etp":{const r=.4+l*.9;return Math.max(0,c*t*1.5*r*u())}case"humec":{const r=1.4-l*.8;return Math.max(0,t*Math.max(0,.8-c*1.2)*r*u())}case"pluie":{const r=.06+(1-l)*.22;return Math.random()<r?t*Math.random()*2.5*(1.3-l):0}case"vent":case"rafales":{const r=.5+l;return Math.max(0,t*(.6+c*.8)*r*u())}default:return Math.max(0,t*u())}}function $i(){const e=Xt(),t=fe(),i=Kt();P.filter(a=>x.linkedSensorIds.includes(a.id)).filter(a=>_.includes(a.model)),document.querySelectorAll(".chart-card").forEach(a=>{if(a.classList.contains("tensio-multi-card")){const m=a.querySelector(".tensio-svg"),p=JSON.parse(a.dataset.tensioCurves||"[]");m&&p.length>0&&xi(m,p,e,t);return}if(a.classList.contains("capa-multi-card")){const m=a.querySelector(".capa-svg"),p=JSON.parse(a.dataset.capaCurves||"[]");m&&p.length>0&&Qe(m,p,e,t,"vwc");return}if(a.classList.contains("capaT-multi-card")){const m=a.querySelector(".capa-tsol-svg"),p=JSON.parse(a.dataset.capaTCurves||"[]");m&&p.length>0&&Qe(m,p,e,t,"tsol");return}const o=a.querySelector(".chart-svg");if(!o)return;const c=parseFloat(a.dataset.base),l=a.dataset.color,u=a.dataset.cumul==="1",r=a.dataset.chartType||"line",v=a.dataset.metricId||"",s=a.dataset.metricName||"",d=a.dataset.metricUnit||"";if(a.dataset.isIrrigation)Ei(o,l,e,t,i);else{const m=i>0&&Yt.has(v);Ci(o,c,l,e,t,u,r,v,s,d,i,m)}}),xt(),Ct()}function xi(e,t,i,n){const c={t:14,r:10,b:28,l:46},l=600-c.l-c.r,u=180-c.t-c.b,r=t.map(w=>{const g=20+w.depth*.8+Math.random()*20;return Array.from({length:i},(C,M)=>{const k=(i-1-M)*n;return Math.max(0,ce("pothydr",g,k))})}),v=r.flat(),s=Math.min(...v),d=Math.max(...v),m=d-s||1,p=w=>c.l+w/Math.max(i-1,1)*l,h=w=>c.t+u-(w-s)/m*u,f=`tc-${Math.random().toString(36).slice(2)}`;let y=`<defs><clipPath id="${f}"><rect x="${c.l}" y="${c.t}" width="${l}" height="${u}"/></clipPath></defs>`;for(let w=0;w<=4;w++){const g=c.t+w/4*u,C=d-w/4*m;y+=`<line x1="${c.l}" y1="${g.toFixed(1)}" x2="${600-c.r}" y2="${g.toFixed(1)}" stroke="var(--bdr2)" stroke-width="1"/>`,y+=`<text x="${c.l-5}" y="${(g+4).toFixed(1)}" text-anchor="end" font-size="10" font-family="var(--font)" fill="var(--txt3)">${C.toFixed(0)}</text>`}r.forEach((w,g)=>{const C=w.map((k,I)=>({x:p(I),y:h(k)})),M=Ie(C);y+=`<path d="${M}" fill="none" stroke="${t[g].color}" stroke-width="2" stroke-linecap="round" clip-path="url(#${f})"/>`}),y+=`<line x1="${c.l}" y1="${c.t+u}" x2="${600-c.r}" y2="${c.t+u}" stroke="var(--bdr2)" stroke-width="1"/>`;const b=Math.max(1,Math.floor(i/6));for(let w=0;w<i;w+=b){const g=(i-1-w)*n;y+=`<text x="${p(w).toFixed(1)}" y="${(c.t+u+14).toFixed(1)}" text-anchor="middle" font-size="10" font-family="var(--font)" fill="var(--txt3)">${Se(g)}</text>`}e.innerHTML=y}function Qe(e,t,i,n,a="vwc"){const l={t:14,r:10,b:28,l:46},u=600-l.l-l.r,r=180-l.t-l.b,v=t.map((g,C)=>{if(a==="tsol"){const k=16-g.depth*.06+C*.5+Math.random()*3;return Array.from({length:i},(I,j)=>{const H=(i-1-j)*n;return ce("tsol",k,H)})}const M=35-g.depth*.15+C*2+Math.random()*8;return Array.from({length:i},(k,I)=>{const j=(i-1-I)*n;return Math.max(10,Math.min(55,ce("teneur-eau",M,j)))})}),s=v.flat(),d=Math.floor(Math.min(...s)-2),m=Math.ceil(Math.max(...s)+2),p=m-d||1,h=g=>l.l+g/Math.max(i-1,1)*u,f=g=>l.t+r-(g-d)/p*r,y=`cc-${Math.random().toString(36).slice(2)}`;let b=`<defs><clipPath id="${y}"><rect x="${l.l}" y="${l.t}" width="${u}" height="${r}"/></clipPath></defs>`;for(let g=0;g<=4;g++){const C=l.t+g/4*r,M=m-g/4*p;b+=`<line x1="${l.l}" y1="${C.toFixed(1)}" x2="${600-l.r}" y2="${C.toFixed(1)}" stroke="var(--bdr2)" stroke-width="1"/>`,b+=`<text x="${l.l-5}" y="${(C+4).toFixed(1)}" text-anchor="end" font-size="10" font-family="var(--font)" fill="var(--txt3)">${M.toFixed(0)}</text>`}v.forEach((g,C)=>{const M=g.map((I,j)=>({x:h(j),y:f(I)})),k=Ie(M);b+=`<path d="${k}" fill="none" stroke="${t[C].color}" stroke-width="2" stroke-linecap="round" clip-path="url(#${y})"/>`}),b+=`<line x1="${l.l}" y1="${l.t+r}" x2="${600-l.r}" y2="${l.t+r}" stroke="var(--bdr2)" stroke-width="1"/>`;const w=Math.max(1,Math.floor(i/6));for(let g=0;g<i;g+=w){const C=(i-1-g)*n;b+=`<text x="${h(g).toFixed(1)}" y="${(l.t+r+14).toFixed(1)}" text-anchor="middle" font-size="10" font-family="var(--font)" fill="var(--txt3)">${Se(C)}</text>`}e.innerHTML=b}function Ci(e,t,i,n,a,o,c="line",l="",u="",r="",v=0,s=!1){const p={t:14,r:10,b:28,l:46},h=600-p.l-p.r,f=180-p.t-p.b,y=n+v,b=s?v:0,w=n+b,g=Math.max(1,Math.round(a/15)),C=Array.from({length:w},(T,E)=>{const A=(n-1-E)*a;if(o){let O=0;for(let V=0;V<g;V++)O+=ce(l,t/g,A+V*(a/g));return O}else if(g>1){let O=0;for(let V=0;V<g;V++)O+=ce(l,t,A+V*(a/g));return O/g}else return ce(l,t,A)}),M=c==="bar"?0:Math.min(...C),k=Math.max(...C),I=k-M||1,j=T=>p.l+T/Math.max(y-1,1)*h,H=T=>p.t+f-(T-M)/I*f,F=`grad_${Math.random().toString(36).slice(2)}`,[W,Z]=bi(i,l);let q=`<defs>
    ...
    <clipPath id="clip_${F}">
  ...
  </defs>`;if(v>0){const T=j(n-.5),E=`stripe_${F}`;q+=`<defs><pattern id="${E}" width="8" height="8" patternUnits="userSpaceOnUse" patternTransform="rotate(45)">
      ...
      <text x="${(600-p.r-4).toFixed(1)}" y="${(p.t+12).toFixed(1)}" text-anchor="end" font-size="10" font-family="var(--font)" fill="var(--txt3)" font-style="italic">Prévisions</text>`}for(let T=0;T<=4;T++){const E=p.t+T/4*f,A=k-T/4*I,O=Math.abs(A)>=100?A.toFixed(0):Math.abs(A)>=10?A.toFixed(1):A.toFixed(2);q+=`<line x1="${p.l}" y1="${E.toFixed(1)}" x2="${600-p.r}" y2="${E.toFixed(1)}" stroke="var(--bdr2)" stroke-width="1"/>`,q+=`<text x="${p.l-5}" y="${(E+4).toFixed(1)}" text-anchor="end" font-size="10" font-family="var(--font)" fill="var(--txt3)">${O}</text>`}q+=`<line x1="${p.l}" y1="${p.t+f}" x2="${600-p.r}" y2="${p.t+f}" stroke="var(--bdr2)" stroke-width="1"/>`;const be=Math.max(1,Math.floor(y/6));for(let T=0;T<y;T+=be){const E=j(T).toFixed(1),A=(n-T)*a;q+=`<line x1="${E}" y1="${p.t}" x2="${E}" y2="${p.t+f}" stroke="var(--bdr2)" stroke-width="1" stroke-dasharray="3,3"/>`,q+=`<text x="${E}" y="${p.t+f+14}" text-anchor="middle" font-size="10" font-family="var(--font)" fill="var(--txt3)">${Se(A)}</text>`}if(c==="bar"){const T=Math.max(2,h/y*.65);C.forEach((E,A)=>{if(E<=0)return;const O=A>=n,V=j(A),Me=H(E),Le=p.t+f-Me;q+=`<rect x="${(V-T/2).toFixed(1)}" y="${Me.toFixed(1)}" width="${T.toFixed(1)}" height="${Le.toFixed(1)}" fill="${O?"#C7C7CC":`url(#${F})`}" opacity="${O?"0.5":"0.9"}" rx="1"/>`})}else{const T=C.slice(0,n).map((O,V)=>({x:j(V),y:H(O)})),E=Ie(T),A=E+` L${j(n-1).toFixed(1)},${p.t+f} L${p.l.toFixed(1)},${p.t+f} Z`;if(q+=`<path d="${A}" fill="${Z}" opacity="0.07" clip-path="url(#clip_${F})"/>`,q+=`<path d="${E}" fill="none" stroke="url(#${F})" stroke-width="2" stroke-linejoin="round" stroke-linecap="round" clip-path="url(#clip_${F})"/>`,b>0){const O=C.slice(n-1).map((Me,Le)=>({x:j(n-1+Le),y:H(Me)})),V=Ie(O);q+=`<path d="${V}" fill="none" stroke="url(#${F})" stroke-width="2" stroke-dasharray="5,4" stroke-linejoin="round" stroke-linecap="round" opacity="0.5" clip-path="url(#clip_${F})"/>`}}q+=`<rect class="chart-hover-rect" x="${p.l}" y="${p.t}" width="${h}" height="${f}" fill="transparent" style="cursor:crosshair"/>`,e.innerHTML=q,Si(e,C,j,H,M,k,y,n,a,u,r,i,p,600)}function Si(e,t,i,n,a,o,c,l,u,r,v,s,d,m,p){const h=fi(),f=e.querySelector(".chart-hover-rect");if(!f)return;const b=document.createElementNS("http://www.w3.org/2000/svg","circle");b.setAttribute("r","4"),b.setAttribute("fill",s),b.setAttribute("stroke","#fff"),b.setAttribute("stroke-width","1.5"),b.style.display="none",b.style.pointerEvents="none",e.appendChild(b),f.addEventListener("mousemove",w=>{const g=e.getBoundingClientRect(),C=m/g.width,M=(w.clientX-g.left)*C,k=m-d.l-d.r,I=Math.max(0,Math.min(1,(M-d.l)/k)),j=Math.round(I*(c-1));if(j<0||j>=t.length)return;const H=t[j],F=i(j),W=n(H);b.setAttribute("cx",F),b.setAttribute("cy",W),b.style.display="";const Z=(l-j)*u,q=Se(Z),be=Math.abs(H)>=100?H.toFixed(1):H.toFixed(2);h.innerHTML=`
  ...
  `,t.appendChild(n);const a=n.querySelector(".compare-search-input");a.focus(),a.addEventListener("input",o=>{const c=o.target.value.toLowerCase();n.querySelectorAll(".compare-dropdown-item").forEach(l=>{l.style.display=l.textContent.toLowerCase().includes(c)?"":"none"})}),n.querySelectorAll(".compare-dropdown-item").forEach(o=>{o.addEventListener("click",()=>{G=parseInt(o.dataset.id),n.remove(),Te(),U()})}),setTimeout(()=>{document.addEventListener("click",function o(c){!n.contains(c.target)&&!t.contains(c.target)&&(n.remove(),document.removeEventListener("click",o))})},0)}function Hi(){const e=We.find(t=>t.id===S.orgId);St(e),qi(e),Be(),ze(),le(),Ye()}const st=["Abricotier","Ail","Amandier","Artichaut","Asperge","Aubergine","Avoine","Basilic","Betterave fourragère","Betterave sucrière","Blé dur","Blé tendre","Brocoli","Carotte","Cerisier","Chou-fleur","Chou pommé","Ciboulette","Citrouille","Clémentinier","Courgette","Echalote","Endive","Epinard","Fève","Figuier","Fraisier","Framboisier","Gesse","Giroflier","Haricot vert","Houblon","Kiwi","Lavande","Lentille","Luzerne","Maïs doux","Maïs grain","Maïs semence","Maïs silage","Melon","Menthe","Moutarde","Navet","Nectarinier","Noisetier","Noyer","Oignon","Olivier","Orge de brasserie","Orge de printemps","Orge d'hiver","Pêcher","Persil","Pissenlit","Poireau","Pois chiche","Pois de conserve","Pois fourrager","Pois protéagineux","Poivron","Pomme de terre","Pommier","Poirier","Prunier","Pruneau d'Agen","Radis","Raisin de cuve","Raisin de table","Riz","Romarin","Sarrasin","Seigle","Soja","Sorgho","Tabac","Thym","Tomate","Tournesol","Triticale","Vigne","Cardon","Céleri","Cerise","Châtaignier","Colza","Courge","Fénugrec","Groseillier","Lin fibre","Lin oléagineux","Mâche","Millet","Myrtille","Noix de cajou","Paprika","Patate douce","Pistachier","Poisson-Chat","Quinoa","Safran","Sainfoin","Scorsonère","Shallot","Topinambour","Trèfle","Vesce","Fétuque","Ray-grass","Prairie temporaire","Prairie permanente","Jachère","Autre"];function St(e){const t=document.getElementById("panel-ident"),i=x,n=i.texture||null,a=i.irrigation||null,o=i.crop||st[0],c=i.env||null,l=n===Pe,u=i.soilAnalysis||{};t.innerHTML=`
    ...
    ${l?`
      ${Ee("Argile (%)",String(u.argile??""),"soilArgile","number")}
      ${Ee("Limon (%)",String(u.limon??""),"soilLimon","number")}
      ${Ee("Sable (%)",String(u.sable??""),"soilSable","number")}
    `:""}
    ${He("Irrigation",a,"irrigation",bt,"Non renseigné")}
    ${ot("Exploitation",e?e.name:"—")}
  `,te(t,"name",i.name||"",r=>{z({name:r}),ht(r,{label:"Parcelles",href:"parcelles.html"})}),te(t,"crop",o,r=>z({crop:r})),te(t,"env",c||"",r=>z({env:r||null})),te(t,"texture",n||"",r=>{const v=r||null,s={texture:v};v!==Pe&&(s.soilAnalysis=null),z(s),St(e)}),l&&(te(t,"soilArgile",String(u.argile??""),r=>z({soilAnalysis:{...x.soilAnalysis,argile:+r}})),te(t,"soilLimon",String(u.limon??""),r=>z({soilAnalysis:{...x.soilAnalysis,limon:+r}})),te(t,"soilSable",String(u.sable??""),r=>z({soilAnalysis:{...x.soilAnalysis,sable:+r}}))),te(t,"irrigation",a||"",r=>z({irrigation:r||null}))}function Ee(e,t,i,n="text"){const a=(t||"").replace(/"/g,"&quot;");return`
    <div class="panel-row" data-field="${i}">
      <span class="panel-row-key">${e}</span>
      <input type="${n}" class="panel-field-input" data-val value="${a}">
    </div>`}function Fi(e,t,i,n){return`
    <div class="panel-row" data-field="${i}">
      <span class="panel-row-key">${e}</span>
  ...
  `}function Ri(){const e=new Set;return P.filter(i=>x.linkedSensorIds.includes(i.id)).forEach(i=>{const n=R[i.model]||[];_.includes(i.model)||n.forEach(a=>e.add(a.id))}),e}function rt(e){const t=R[e]||[];return t.length?`<div class="sensor-metric-badges">${t.map(i=>`<span class="sensor-metric-badge" style="--mc:${i.color}">${i.name}</span>`).join("")}</div>`:""}function Be(){const e=document.getElementById("panel-sensors"),t=P.filter(m=>x.linkedSensorIds.includes(m.id)),i=P.filter(m=>m.orgId===S.orgId&&!x.linkedSensorIds.includes(m.id)),n=t.filter(m=>!_.includes(m.model)),a={};n.forEach(m=>(R[m.model]||[]).forEach(p=>{a[p.id]=(a[p.id]||0)+1}));const o=Object.entries(a).filter(([,m])=>m>1).map(([m])=>{var p;return((p=Object.values(R).flat().find(h=>h.id===m))==null?void 0:p.name)||m});let c="";if(o.length>0&&(c+=`<div class="sensor-conflict-banner">
      ...
      </div>`);const v=document.getElementById("sensor-add-row"),s=document.getElementById("add-sensor-select");v&&s&&(i.length>0?(s.innerHTML='<option value="">Ajouter un capteur…</option>'+i.map(m=>`<option value="${m.id}">${ee[m.model]||m.model} — ${m.serial}</option>`).join(""),v.style.display=""):v.style.display="none"),e.querySelectorAll(".remove-sensor-btn").forEach(m=>{m.addEventListener("click",()=>{const p=parseInt(m.dataset.id),h=P.find(y=>y.id===p),f=h?`${ee[h.model]||h.model} — ${h.serial}`:`capteur #${p}`;xe({title:"Retirer le capteur",message:`Retirer <strong>${f}</strong> de cette parcelle ?<br><br>Les données historiques sont conservées.`,confirmLabel:"Retirer",onConfirm:()=>{const y=x.linkedSensorIds.filter(b=>b!==p);z({linkedSensorIds:y}),ct(y),Be(),U(),de()}})})});const d=document.getElementById("add-sensor-btn");d&&d.addEventListener("click",()=>{const m=document.getElementById("add-sensor-select"),p=parseInt(m.value);if(!p)return;const h=P.find(y=>y.id===p);if(!h)return;const f=De(h.model);if(f){const b=P.filter(w=>x.linkedSensorIds.includes(w.id)).filter(w=>{const g=De(w.model);return g&&g!==f});if(b.length>0){const w=b.map(g=>`${ee[g.model]||g.model} — ${g.serial}`).join(", ");xe({title:"Capteur incompatible",message:`Cette parcelle utilise déjà : <strong>${w}</strong>.<br><br>Les capteurs de sol (CHP, CAPA, EC, T_MINI) sont exclusifs — une seule technologie par parcelle.<br><br>Retirer ${b.length>1?"ces capteurs":"ce capteur"} et ajouter le nouveau ?`,confirmLabel:"Remplacer",onConfirm:()=>{const g=new Set(b.map(M=>M.id)),C=x.linkedSensorIds.filter(M=>!g.has(M));z({linkedSensorIds:[...C,p]}),ct(C),dt(h),Be(),U(),de()}});return}}if(!_.includes(h.model)){const y=Ri(),w=(R[h.model]||[]).map(g=>g.id).filter(g=>y.has(g));if(w.length>0){const g=w.map(M=>{const k=Object.values(R).flat().find(I=>I.id===M);return(k==null?void 0:k.name)||M});if(!confirm(`Attention : ce capteur (${h.model}) mesure des métriques déjà fournies par un autre capteur :
• ${g.join(`
• `)}

Voulez-vous l'ajouter quand même ?`))return}}z({linkedSensorIds:[...x.linkedSensorIds,p]}),dt(h),Be(),U(),de()})}function ze(){var c;const e=document.getElementById("panel-integrations"),t=x.integrations||[],i=Vt.filter(l=>!t.includes(l));let n="";t.length===0?n+='<div class="panel-empty" style="margin-bottom:8px">Aucune intégration active</div>':n+=t.map(l=>`
  ...
  </div>`}function le(){var s;Di();const e=((s=document.getElementById("sidebar"))==null?void 0:s.getAttribute("data-role"))==="adherent-reseau",t=document.getElementById("panel-membres"),i=document.getElementById("panel-membres-section"),n=ie.filter(d=>{var m;return d.source==="adherent"&&((m=d.orgIds)==null?void 0:m.includes(S.orgId))}),a=n.filter(d=>K.includes(d.id));i&&(i.style.display=!e&&n.length===0?"none":""),t&&(t.innerHTML=a.length?a.map(d=>lt(d,!0,!1)).join(""):'<p class="panel-empty">Aucun membre associé.</p>',t.querySelectorAll(".remove-membre-btn").forEach(d=>{d.addEventListener("click",()=>{const m=parseInt(d.dataset.id),p=ie.find(h=>h.id===m);xe({title:"Retirer le membre",message:`Retirer <strong>${p?`${p.prenom} ${p.nom}`:`membre #${m}`}</strong> de cette parcelle ?`,confirmLabel:"Retirer",onConfirm:()=>{K=K.filter(h=>h!==m),ne(B,{linkedOrgMemberIds:K}),le()}})})}));const o=document.getElementById("add-membre-org-row");o&&(o.style.display="");const c=document.getElementById("add-membre-org-select");c&&(c.innerHTML='<option value="">Associer un membre…</option>',n.filter(d=>!K.includes(d.id)).forEach(d=>{const m=document.createElement("option");m.value=d.id,m.textContent=`${d.prenom} ${d.nom}`,c.appendChild(m)})),document.getElementById("add-membre-org-btn").onclick=()=>{const d=parseInt(c==null?void 0:c.value);!d||K.includes(d)||(K.push(d),ne(B,{linkedOrgMemberIds:K}),le())};const l=document.getElementById("panel-conseillers"),u=document.getElementById("panel-conseillers-section"),r=ie.filter(d=>d.source==="réseau"&&Q.includes(d.id));u&&(u.style.display=e&&r.length===0?"none":""),l&&(l.innerHTML=r.length?r.map(d=>lt(d,!e,!0)).join(""):'<p class="panel-empty">Aucun conseiller associé.</p>',e||l.querySelectorAll(".remove-membre-btn").forEach(d=>{d.addEventListener("click",()=>{const m=parseInt(d.dataset.id),p=ie.find(h=>h.id===m);xe({title:"Retirer le conseiller",message:`Retirer <strong>${p?`${p.prenom} ${p.nom}`:`conseiller #${m}`}</strong> de cette parcelle ?`,confirmLabel:"Retirer",onConfirm:()=>{Q=Q.filter(h=>h!==m),ne(B,{linkedConseillerIds:Q}),le()}})})}));const v=document.getElementById("add-conseiller-row");if(v&&(v.style.display=e?"none":""),!e){const d=document.getElementById("add-membre-select");d&&(d.innerHTML='<option value="">Ajouter un conseiller…</option>',ie.filter(m=>m.source==="réseau"&&!Q.includes(m.id)).forEach(m=>{const p=document.createElement("option");p.value=m.id,p.textContent=`${m.prenom} ${m.nom} (${m.role})`,d.appendChild(p)})),document.getElementById("add-membre-btn").onclick=()=>{const m=parseInt(d==null?void 0:d.value);!m||Q.includes(m)||(Q.push(m),ne(B,{linkedConseillerIds:Q}),le())}}}function Ye(){const e=document.getElementById("panel-alertes"),t=x.alertes||[],i={seuil:"bi-graph-up-arrow",cumul:"bi-droplet",absence:"bi-wifi-off"};let n="";t.length===0?n+='<div class="panel-empty" style="margin-bottom:8px">Aucune alerte configurée</div>':n+=t.map((a,o)=>`
    ...
    `).join(""),n+='<button id="create-alert-btn" class="action-btn" style="margin-top:6px"><i class="bi bi-plus"></i> Créer une alerte</button>',e.innerHTML=n,e.querySelectorAll(".remove-alert-btn").forEach(a=>{a.addEventListener("click",()=>{const o=parseInt(a.dataset.idx),c=[...x.alertes];c.splice(o,1),z({alertes:c}),Ye()})}),document.getElementById("create-alert-btn").addEventListener("click",()=>{Oi(e)})}function Ni(){const e=[];return P.filter(i=>x.linkedSensorIds.includes(i.id)).forEach(i=>{(R[i.model]||[]).forEach(a=>{e.find(o=>o.id===a.id)||e.push({id:a.id,name:a.name,unit:a.unit})})}),Ve.forEach(i=>{e.find(n=>n.id===i.id)||e.push({id:i.id,name:i.name,unit:i.unit})}),e}function Oi(e){if(e.querySelector(".alert-create-form"))return;const i=Ni(),n=document.createElement("div");n.className="alert-create-form",n.innerHTML=`
  ...
  `,e.appendChild(n),n.querySelector("#alert-metric").addEventListener("change",a=>{const o=a.target.selectedOptions[0];n.querySelector("#alert-unit-label").textContent=(o==null?void 0:o.dataset.unit)||"—"}),n.querySelector("#alert-save-btn").addEventListener("click",()=>{const o=n.querySelector("#alert-metric").value,c=i.find(v=>v.id===o),l=n.querySelector("#alert-condition").value,u=n.querySelector("#alert-threshold").value;if(!o||!u)return;const r={type:"seuil",label:`Alerte ${(c==null?void 0:c.name)||o}`,metric:(c==null?void 0:c.name)||o,condition:l,threshold:u,unit:(c==null?void 0:c.unit)||""};z({alertes:[...x.alertes||[],r]}),Ye()}),n.querySelector("#alert-cancel-btn").addEventListener("click",()=>n.remove())}function zi(e,t){const i=new Blob(["\uFEFF"+e],{type:"text/csv;charset=utf-8;"}),n=Object.assign(document.createElement("a"),{href:URL.createObjectURL(i),download:t});document.body.appendChild(n),n.click(),document.body.removeChild(n),setTimeout(()=>URL.revokeObjectURL(n.href),100)}function _i(){const e=x.name||S.name||"Parcelle",t=Ae(x.linkedSensorIds);let i;if(G){const d=se.find(f=>f.id===G),m=P.filter(f=>f.parcelIds.includes(G)).map(f=>f.id),p=Ae(m),h=(d==null?void 0:d.name)||"Comparaison";i=[...t.map(f=>({h:`[${e}] ${f.name} (${f.unit})`,gen:f.base})),...p.map(f=>({h:`[${h}] ${f.name} (${f.unit})`,gen:f.base}))]}else i=t.map(d=>({h:`${d.name} (${d.unit})`,gen:d.base}));const n=pe()*6e4,a=fe()*6e4,o=J==="custom"&&me?me:new Date,c=J==="custom"&&ue?ue:new Date(o-n),l=Math.min(Math.ceil((o-c)/a)+1,500),u=(o-c)/Math.max(l-1,1),r=["Horodatage",...i.map(d=>d.h)].join(";"),v=Array.from({length:l},(d,m)=>[new Date(c.getTime()+m*u).toISOString().replace("T"," ").slice(0,19),...i.map(h=>h.gen())].join(";")),s=e.replace(/[^\w]/g,"_");zi([r,...v].join(`\r
`),`${s}_${J}_${new Date().toISOString().slice(0,10)}.csv`)}function xe({title:e,message:t,confirmLabel:i="Confirmer",onConfirm:n}){const a=document.createElement("div");a.className="modal add-modal",a.style.zIndex="9999",a.innerHTML=`
  ...
  </svg>`}function Xi(e){const t=["Dim","Lun","Mar","Mer","Jeu","Ven","Sam"],i=["jan","fév","mar","avr","mai","jun","jul","aoû","sep","oct","nov","déc"],n=["bi-sun","bi-cloud-sun","bi-cloud","bi-cloud-rain","bi-cloud-lightning-rain"],a=["Ensoleillé","Part. nuageux","Couvert","Pluvieux","Orageux"],o=new Date,c=se.find(d=>d.id===B),l=We.find(d=>d.id===(c==null?void 0:c.orgId)),u=(c==null?void 0:c.ville)||(l==null?void 0:l.ville)||"—",r=(d,m)=>{const p=new Date(o);p.setDate(p.getDate()+d);const h=Math.floor((B*7+d*3)%11/2.2);return{lbl:d===0?"Auj.":t[p.getDay()],date:`${p.getDate()} ${i[p.getMonth()]}`,tmax:$(17+m,34+m),tmin:$(4+m,15+m),pluie:h>=3?$(2,18):0,vent:$(10,35),rafales:$(25,70),wi:h}},v=[0,1,2].map(d=>r(d,0)).concat([3,4].map(d=>r(d,-1))),s=d=>`
    ...
    <div class="w-weephyt-src">Via <strong>Weephyt</strong> · ${i||"—"}</div>
      ...
      <div class="w-cumul-item">
        ...
        <button class="w-cumul-del" data-cid="${r.id}" title="Retirer">×</button>
          ...
          </label>`).join("")+'<button class="w-cumul-cfg-ok">OK</button>',r.closest(".w-cumul-item").after(m),m.querySelector(".w-cumul-cfg-ok").addEventListener("click",()=>{m.querySelectorAll(".w-cumul-cfg-inp").forEach(h=>{l[h.dataset.key]=parseFloat(h.value)||0}),qe({cfg:l}),m.remove(),_e(e)})})})}function Zi(e){if(!P.filter(s=>x.linkedSensorIds.includes(s.id)).some(s=>s.model==="T_GEL")){e.innerHTML='<div class="dash-empty">Capteur T_GEL non lié</div>';return}const i=25,n=D(0,5),a=Array.from({length:i},(s,d)=>+(n+d*.18+D(-.8,.8)).toFixed(1)),o=a.map(s=>+(s-D(1,2.5)).toFixed(1)),c=Et([{values:a,color:"#23B19B"},{values:o,color:"#5E88EC"}],380,100),l=a[i-1],u=o[i-1],r=$(5,8),v=String(Math.floor(Math.random()*60)).padStart(2,"0");e.innerHTML=`<div class="w-gel-wrap">
  ...
  </div>`}function en(e){if(!P.filter(d=>x.linkedSensorIds.includes(d.id)).some(d=>{const m=R[d.model]||[];return m.some(p=>p.id==="temp")&&m.some(p=>p.id==="humidite")})){e.innerHTML='<div class="dash-empty">Capteur T+HR requis</div>';return}const n=D(20,35),a=$(45,90),o=+(n-.55*(1-a/100)*(n-14.5)).toFixed(0),c=o<68?"#2d9e5f":o<72?"#f5c842":o<79?"#f5a030":"#e07050",l=o<68?"Confort":o<72?"Stress léger":o<79?"Stress modéré":"Stress sévère",u=["Dim","Lun","Mar","Mer","Jeu","Ven","Sam"],r=new Date,v=Array.from({length:3},(d,m)=>{const p=new Date(r);return p.setDate(p.getDate()+m+1),{day:u[p.getDay()],m:$(64,72),j:$(68,80),s:$(62,70)}}),s=d=>d<68?"#2d9e5f":d<72?"#f5c842":"#f5a030";e.innerHTML=`<div class="w-thi-wrap">
  ...
  </div>`}function nn(e){if(!P.filter(j=>x.linkedSensorIds.includes(j.id)).some(j=>(R[j.model]||[]).some(H=>H.id==="tsol"))){e.innerHTML='<div class="dash-empty">Capteur T. sol requis</div>';return}const n=48,a=D(14,20),o=Array.from({length:n},(j,H)=>+(a+3*Math.sin(H/24*2*Math.PI-Math.PI/2)+D(-.4,.4)).toFixed(1)),c=15,l=22,u=380,r=100,v=28,s=8,d=6,m=20,p=u-v-s,h=r-d-m,f=[...o,c,l],y=Math.min(...f)-1,b=Math.max(...f)+1,w=j=>(v+j/(n-1)*p).toFixed(1),g=j=>(d+h-(j-y)/(b-y)*h).toFixed(1),C=+g(c),M=+g(l),k=[.25,.5,.75].map(j=>{const H=(d+j*h).toFixed(1);return`<line x1="${v}" y1="${H}" x2="${u-s}" y2="${H}" stroke="rgba(0,0,0,.06)" stroke-width="1"/>`}).join(""),I=o.map((j,H)=>`${H?"L":"M"}${w(H)},${g(j)}`).join("");e.innerHTML=`<div class="w-tsol-wrap">
    <svg width="100%" height="${r}" viewBox="0 0 ${u} ${r}" preserveAspectRatio="none">
      ${k}
  ...
  </div>`}function an(e){const t=(x.crop||S.crop||"").toLowerCase();if(!t.includes("maïs")&&!t.includes("mais")){e.innerHTML='<div class="dash-empty">Culture Maïs requise</div>';return}const i=[{name:"Farmflex 253",target:1320},{name:"DKC 3230",target:1380},{name:"Ronaldinio",target:1290},{name:"Banguy",target:1350}],n=i[B%i.length],a=S.degresJour||$(600,1200),o=Math.min(a/n.target,1),c=Math.max(0,n.target-a),l=new Date,u=Math.round(c/10),r=new Date(l);r.setDate(r.getDate()+Math.max(0,u-5));const v=new Date(l);v.setDate(v.getDate()+u+5);const s=["jan","fév","mar","avr","mai","jun","jul","aoû","sep","oct","nov","déc"],d=m=>`${m.getDate()} ${s[m.getMonth()]}`;e.innerHTML=`<div class="w-maizy-wrap">
  ...
  </div>`}const Bt=[{id:"j7",label:"J-7"},{id:"j1",label:"J-1"},{id:"j0",label:"J0"},{id:"last",label:"Dernières données"}],on=Bt.filter(e=>e.id==="j7"||e.id==="j1"),ut=()=>`w-reservoir-agg-${B}`,mt=()=>`w-profil-reservoir-agg-${B}`;function At(e,t="j0"){return localStorage.getItem(e())||t}function It(e,t){localStorage.setItem(e(),t)}function Tt(e){const t=S.reserveHydrique||80,i=(S.id*17+13)%41,n={j7:-8,j1:-2,j0:0,last:1},a=Math.min(95,Math.max(15,55+i+(n[e]||0))),o=Math.round(t*a/100);return{rhu:t,pct:a,mm:o}}function Lt(e,t=Bt){return`<select class="w-reservoir-agg-sel">
    ...
    <div class="w-bilan-layout">
    ...
    </div>`}function Ft(e){const t=document.createElement("div");if(t.className="journal-form-overlay",e==="vol"){const i=$e(B).volumeMaxM3??"",n=$e(B).debitM3h??"";t.innerHTML=`
      ...
      </div>`,document.body.appendChild(t),t.querySelector("#iwa-cancel").onclick=()=>t.remove(),t.querySelector("#iwa-save").onclick=()=>{const a=t.querySelector("#iwa-vol-inp").value,o=t.querySelector("#iwa-debit-inp").value;ne(B,{volumeMaxM3:a!==""?parseInt(a):null,debitM3h:o!==""?parseFloat(o):null}),t.remove(),document.querySelector("#dblock-irrigations")&&Ce(document.querySelector("#dblock-irrigations"))}}else{const i=x.irrigation||"";t.innerHTML=`
      <div class="journal-form-modal">
    ...
    <div class="irr-save-confirm-box">
      ...
      <a href="irrigation.html?plot=${B}" class="irr-save-confirm-link">Gérer les irrigations de toutes mes parcelles &gt;</a>
    ...
    </div>`,document.body.appendChild(t),t.addEventListener("click",i=>{i.target===t&&t.remove()}),t.querySelector("#irr-m-s-cancel").onclick=()=>t.remove(),t.querySelector("#irr-m-s-save").onclick=()=>{const i=t.querySelector("#irr-m-s-date").value,n=parseInt(t.querySelector("#irr-m-s-qty").value)||0;if(!i||!n)return;const a=i>ae,o=()=>{N.push({iso:i,mm:n,real:!a,plotId:S.id,fromStrategy:!1}),ft(),t.remove(),Ce(e),Rt("Irrigation enregistrée",[`Date : ${Ne(i)}`,`Quantité : ${n} mm`])},c=N.filter(l=>l.plotId===S.id&&l.iso===i);if(c.length){qt(c.length,()=>{N.splice(0,N.length,...N.filter(l=>!(l.plotId===S.id&&l.iso===i))),o()});return}o()}}function vt(e){const t=document.createElement("div");t.className="journal-form-overlay",t.innerHTML=`
    <div class="journal-form-modal">

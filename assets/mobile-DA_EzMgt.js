const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/irrigation-CBjc6n12.js","assets/irrigations-cQAUTeq7.js","assets/plots-BEYIGwLd.js","assets/modulepreload-polyfill-B5Qt9EMX.js","assets/sensors-DDe0aa9W.js","assets/orgs-Cx4wNzLL.js","assets/network-YzWdS0n_.js","assets/members-DEd9yWse.js"])))=>i.map(i=>d[i]);
import"./modulepreload-polyfill-B5Qt9EMX.js";import{p as F}from"./plots-BEYIGwLd.js";import{s as z}from"./sensors-DDe0aa9W.js";import{o as J}from"./orgs-Cx4wNzLL.js";import{n as ue}from"./network-YzWdS0n_.js";import{b as At,I as Tt}from"./irrigations-cQAUTeq7.js";import{m as Ie}from"./members-DEd9yWse.js";const ve=[];function xe(t){const i=document.getElementById("phone-screen"),e=document.createElement("div");return e.className="m-detail-layer",e.innerHTML=t,i.appendChild(e),requestAnimationFrame(()=>e.classList.add("m-detail-layer--in")),ve.push(e),e}function re(){const t=ve.pop();t&&(t.classList.remove("m-detail-layer--in"),setTimeout(()=>t.remove(),300))}function Ke(){return ve.length}function kt(){return ve.some(t=>t.dataset.dirty==="true")}function bs(){ve.forEach(t=>delete t.dataset.dirty)}window.addEventListener("m-tab-change",()=>{ve.forEach(t=>t.remove()),ve.length=0});const Qe={admin:{initials:"JD",prenom:"Jean",nom:"Dupont",email:"jean.dupont@ferme-du-bocage.fr",phones:[{label:"Principal",numero:"+33 6 12 34 56 78"},{label:"Sophie Dupont",numero:"+33 6 98 76 54 32"}],apiKeys:[{id:1,name:"Application mobile",created:"10/01/2026",value:"sk-wnt-mbl4X9pQr2Lz7vNcKwJ1eYtU6sSoD8aF"},{id:2,name:"Intégration Agreo",created:"28/02/2026",value:"sk-wnt-agr8B3mTxP5nVcLqR1uZoK7wJ9dE2sY"},{id:3,name:"Script export nuit",created:"01/04/2026",value:"sk-wnt-xpt2H7kNpQ4rVmLcJ9sT1oY6uB3wF8dE"}]},adherent:{initials:"MM",prenom:"Marie",nom:"Martin",email:"marie.martin@ferme-du-bocage.fr",phones:[{label:"Principal",numero:"+33 7 52 18 93 46"}],apiKeys:[{id:1,name:"Application mobile",created:"14/02/2026",value:"sk-wnt-mbl9Z2xQr5Lp7vNcKwA1eYtU3sRoD4bG"}]}},Pt=["Français","English","Español","Deutsch","Italiano","Português","Polski","Nederlands"],et=["Métrique (mm, °C, km/h…)","Impérial (in, °F, mph…)"];let le={};function Z(t){var n;const i=document.getElementById("phone-screen");(n=document.querySelector(".m-toast"))==null||n.remove();const e=document.createElement("div");e.className="m-toast",e.textContent=t,i.appendChild(e),requestAnimationFrame(()=>e.classList.add("m-toast--show")),setTimeout(()=>{e.classList.remove("m-toast--show"),setTimeout(()=>e.remove(),300)},2200)}function he({title:t,body:i,onDone:e,doneLabel:n="OK"}){var l;const r=document.getElementById("phone-screen");(l=document.querySelector(".m-sheet-overlay"))==null||l.remove();const s=document.createElement("div");s.className="m-sheet-overlay",s.innerHTML=`
    <div class="m-sheet">
  ...
  `,s.querySelector(".m-sheet-body").appendChild(typeof i=="string"?Object.assign(document.createElement("div"),{innerHTML:i}):i),r.appendChild(s),requestAnimationFrame(()=>s.classList.add("m-sheet-overlay--show"));const a=()=>{s.classList.remove("m-sheet-overlay--show"),setTimeout(()=>s.remove(),280)};return s.querySelector(".m-sheet-cancel").addEventListener("click",a),s.querySelector(".m-sheet-done").addEventListener("click",()=>{e==null||e(),a()}),s.addEventListener("click",d=>{d.target===s&&a()}),s}function tt(t,i,e){const n=document.createElement("div");n.innerHTML=`<input class="m-sheet-input" type="text" value="${i}" placeholder="${t}">`;const r=n.querySelector("input");he({title:t,body:n,doneLabel:"Enregistrer",onDone:()=>{e(r.value.trim()),Z("Enregistré")}}),setTimeout(()=>r.focus(),300)}function it(t,i,e,n){const r=document.createElement("div");r.innerHTML=i.map((a,l)=>`
    <div class="m-sheet-option${a===e?" m-sheet-option--active":""}" data-i="${l}">
      <span>${a}</span>
      ${a===e?'<i class="bi bi-check" style="color:#007aff;font-size:18px"></i>':""}
    </div>
  `).join("");const s=he({title:t,body:r,doneLabel:"Fermer",onDone:()=>{}});r.querySelectorAll(".m-sheet-option").forEach(a=>{a.addEventListener("click",()=>{n(i[+a.dataset.i]),s.classList.remove("m-sheet-overlay--show"),setTimeout(()=>s.remove(),280),Z("Enregistré")})})}function It(t,i){const e=document.createElement("div"),n=()=>{var r;e.innerHTML=t.map((s,a)=>`
    ...
    `).join("")+'<button class="m-sheet-add-phone"><i class="bi bi-plus-circle"></i> Ajouter un numéro</button>',e.querySelectorAll("input").forEach(s=>{s.addEventListener("input",()=>{t[+s.dataset.i][s.dataset.f]=s.value})}),e.querySelectorAll(".m-sheet-remove").forEach(s=>{s.addEventListener("click",()=>{t.splice(+s.dataset.i,1),n()})}),(r=e.querySelector(".m-sheet-add-phone"))==null||r.addEventListener("click",()=>{t.push({label:"",numero:""}),n()})};n(),he({title:"Téléphone(s)",body:e,doneLabel:"Enregistrer",onDone:()=>{i(t),Z("Enregistré")}})}function qt(t,i,e){const n=document.createElement("div");n.innerHTML=`
  ...
  `,n.querySelector(".m-sheet-key-copy").addEventListener("click",()=>{var s;(s=navigator.clipboard)==null||s.writeText(t.value).catch(()=>{}),Z("Clé copiée !")});const r=he({title:"Clé API",body:n,doneLabel:"Fermer",onDone:()=>{}});n.querySelector(".m-sheet-key-delete").addEventListener("click",()=>{const s=i.findIndex(a=>a.id===t.id);s!==-1&&i.splice(s,1),r.classList.remove("m-sheet-overlay--show"),setTimeout(()=>{r.remove(),e()},280),Z("Clé supprimée")})}function jt(){const t="ABCDEFGHJKLMNPQRSTUVWXYZabcdefghjkmnpqrstuvwxyz23456789";return"sk-wnt-"+Array.from({length:32},()=>t[Math.floor(Math.random()*t.length)]).join("")}function Ht(t){const i=document.createElement("div");i.innerHTML='<input class="m-sheet-input" type="text" placeholder="Nom de la clé (ex: Application mobile)">';const e=i.querySelector("input");he({title:"Nouvelle clé API",body:i,doneLabel:"Générer",onDone:()=>{const n=e.value.trim();if(!n){Z("Entrez un nom");return}const r={id:Date.now(),name:n,created:new Date().toLocaleDateString("fr-FR"),value:jt()};t(r),Z("Clé générée")}}),setTimeout(()=>e.focus(),300)}function _t(t,i){le={profile:JSON.parse(JSON.stringify(Qe[i]||Qe.admin)),langue:"Français",unites:et[0]};const n=localStorage.getItem("mobile_avatarUrl")||null;function r(){const a=le.profile,l=n?`<img src="${n}" alt="avatar" style="width:100%;height:100%;object-fit:cover">`:`<span>${a.initials}</span>`,d=a.apiKeys.map(o=>`
    ...
    `).join(""),c=a.phones.map((o,v)=>`
      <div class="m-list-row${v===a.phones.length-1&&a.phones.length>1?" m-list-row--last":""}" data-action="phones">
        <span class="m-list-row-label">${o.label||"Numéro "+(v+1)}</span>
    ...
    `).join("");t.innerHTML=`
      ...
      <div class="m-list">
        <div class="m-list-row" data-action="langue">
          ...
          <span class="m-list-row-value" id="val-langue">${le.langue}</span>
          <i class="bi bi-chevron-right m-list-chevron"></i>
        </div>
    ...
    `,s()}function s(){var l;const a=le.profile;(l=t.querySelector("#m-avatar-upload"))==null||l.addEventListener("change",d=>{const c=d.target.files[0];if(!c)return;const o=new FileReader;o.onload=v=>{localStorage.setItem("mobile_avatarUrl",v.target.result),t.querySelector("#m-avatar").innerHTML=`<img src="${v.target.result}" alt="avatar" style="width:100%;height:100%;object-fit:cover">`},o.readAsDataURL(c)}),t.querySelectorAll(".m-list-row[data-action]").forEach(d=>{d.addEventListener("click",()=>{switch(d.dataset.action){case"prenom":tt("Prénom",a.prenom,c=>{a.prenom=c,r()});break;case"nom":tt("Nom",a.nom,c=>{a.nom=c,r()});break;case"email":he({title:"Adresse email",body:Object.assign(document.createElement("div"),{innerHTML:`<div class="m-sheet-info"><i class="bi bi-envelope-check" style="font-size:32px;color:#007aff"></i><p>${a.email}</p><p class="m-sheet-info-sub">Pour modifier votre email, un lien de vérification sera envoyé à la nouvelle adresse.</p></div>`}),doneLabel:"Modifier",onDone:()=>Z("Fonctionnalité à venir")});break;case"phones":It(a.phones,c=>{a.phones=c,r()});break;case"mdp":he({title:"Mot de passe",body:Object.assign(document.createElement("div"),{innerHTML:`
                ...
                `}),doneLabel:"Modifier",onDone:()=>Z("Fonctionnalité à venir")});break;case"langue":it("Langue",Pt,le.langue,c=>{le.langue=c,t.querySelector("#val-langue").textContent=c});break;case"unites":it("Unités",et,le.unites,c=>{le.unites=c,t.querySelector("#val-unites").textContent=c.split(" ")[0]});break;case"gen-key":Ht(c=>{a.apiKeys.push(c),r()});break;case"delete":Z("Contactez le support pour supprimer votre compte");break}})}),t.querySelectorAll(".m-list-row[data-key-id]").forEach(d=>{d.addEventListener("click",()=>{const c=a.apiKeys.find(o=>o.id===+d.dataset.keyId);c&&qt(c,a.apiKeys,r)})}),t.querySelectorAll(".m-toggle input[data-notif]").forEach(d=>{d.addEventListener("change",()=>Z("Préférence enregistrée"))})}r()}function B(t){var n;const i=document.getElementById("phone-screen");(n=document.querySelector(".m-toast"))==null||n.remove();const e=document.createElement("div");e.className="m-toast",e.textContent=t,i.appendChild(e),requestAnimationFrame(()=>e.classList.add("m-toast--show")),setTimeout(()=>{e.classList.remove("m-toast--show"),setTimeout(()=>e.remove(),300)},2200)}function U({title:t,body:i,doneLabel:e="Fermer",onDone:n}={}){var l;const r=document.getElementById("phone-screen");(l=document.querySelector(".m-sheet-overlay"))==null||l.remove();const s=document.createElement("div");s.className="m-sheet-overlay",s.innerHTML=`
    <div class="m-sheet">
      <div class="m-sheet-handle"></div>
      <div class="m-sheet-hd">
        <button class="m-sheet-cancel">Annuler</button>
      ...
      <div class="m-sheet-body"></div>
        ...
        <div class="m-alert-card" data-id="${l.id}">
          ...
          <div class="m-alert-body">
            <div class="m-alert-row">
              ...
              <span class="m-alert-row-val">${st[l.metric]||l.metric}</span>
            </div>
            <div class="m-alert-row">
        ...
        </div>`}).join(""),s()}function s(){e.querySelectorAll(".m-alert-toggle input").forEach(l=>{l.addEventListener("change",d=>{d.stopPropagation();const c=+l.dataset.id,o=n.find(v=>v.id===c);o&&(o.statut=l.checked?"actif":"inactif",r(),B(`Alerte ${l.checked?"activée":"désactivée"}`))})}),e.querySelectorAll(".m-alert-more-btn").forEach(l=>{l.addEventListener("click",d=>{d.stopPropagation();const c=+l.dataset.id,o=n.find(C=>C.id===c);if(!o)return;at(o);const v=document.createElement("div"),y=Dt(c);function m(){const C=o.sensorIds.map((A,T)=>{const k=z.find(f=>f.id===A);return k?{label:`${k.model} ${k.serial}`,type:"sensor",idx:T}:null}).filter(Boolean),M=o.parcelIds.map((A,T)=>{const k=F.find(f=>f.id===A);return k?{label:k.name,type:"parcel",idx:T}:null}).filter(Boolean),E=[...C,...M];return E.length?E.map(A=>`<div class="m-perimetre-item" data-type="${A.type}" data-idx="${A.idx}">
                <span>${A.label}</span>
                <button class="m-perimetre-del" data-type="${A.type}" data-idx="${A.idx}"><i class="bi bi-x-lg"></i></button>
              </div>`).join(""):'<span style="color:#8e8e93;font-size:13px">—</span>'}const b=document.createElement("div");b.className="m-sheet-info-rows";function $(){var A;v.innerHTML="";const C=document.createElement("div");C.className="m-sheet-info-rows",C.innerHTML=`
            <div class="m-sheet-info-row"><span>Métrique</span><span>${st[o.metric]||o.metric}</span></div>
            ...
            <div class="m-sheet-info-row"><span>Statut</span><span>${o.statut}</span></div>`;const M=document.createElement("div");M.style.cssText="padding:8px 0;border-bottom:.5px solid rgba(0,0,0,.08)",M.innerHTML=`<div style="font-size:13px;color:#8e8e93;margin-bottom:6px">Périmètre</div><div class="m-perimetre-list">${m()}</div>`,C.appendChild(M),v.appendChild(C);const E=document.createElement("div");E.innerHTML=`<div class="m-history-title">Déclenchements</div>
            ${y.map(T=>`<div class="m-history-row">
              ...
              </div></div>`).join("")}`,v.appendChild(E),v.querySelectorAll(".m-perimetre-del").forEach(T=>{T.addEventListener("click",k=>{k.stopPropagation();const f=T.dataset.type,u=+T.dataset.idx;f==="sensor"?o.sensorIds.splice(u,1):o.parcelIds.splice(u,1),$(),r(),B("Retiré du périmètre")})})}$(),U({title:o.name,body:v,doneLabel:"Fermer",onDone:()=>{}})})}),e.querySelectorAll(".m-alert-card").forEach(l=>{l.addEventListener("click",d=>{if(d.target.closest(".m-alert-toggle")||d.target.closest(".m-alert-more-btn"))return;const c=+l.dataset.id,o=n.find(m=>m.id===c);if(!o)return;const v=document.createElement("div");v.innerHTML=`
          ...
          </div>`;const y=U({title:o.name,body:v,doneLabel:"Fermer",onDone:()=>{}});v.querySelector("#al-edit").addEventListener("click",()=>{y.classList.remove("m-sheet-overlay--show"),setTimeout(()=>{y.remove(),B("Modification à venir")},280)}),v.querySelector("#al-delete").addEventListener("click",()=>{const m=n.findIndex(b=>b.id===c);m!==-1&&n.splice(m,1),y.classList.remove("m-sheet-overlay--show"),setTimeout(()=>{y.remove(),r()},280),B("Alerte supprimée")})})})}(a=t.querySelector(".m-navbar-action"))==null||a.addEventListener("click",()=>{B("Création d'alerte — à venir")}),r()}const zt="modulepreload",Nt=function(t){return"/weenat-proto/"+t},nt={},se=function(i,e,n){let r=Promise.resolve();if(e&&e.length>0){document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),l=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));r=Promise.allSettled(e.map(d=>{if(d=Nt(d),d in nt)return;nt[d]=!0;const c=d.endsWith(".css"),o=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${o}`))return;const v=document.createElement("link");if(v.rel=c?"stylesheet":zt,c||(v.as="script"),v.crossOrigin="",v.href=d,l&&v.setAttribute("nonce",l),document.head.appendChild(v),c)return new Promise((y,m)=>{v.addEventListener("load",y),v.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${d}`)))})}))}function s(a){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=a,window.dispatchEvent(l),!l.defaultPrevented)throw a}return r.then(a=>{for(const l of a||[])l.status==="rejected"&&s(l.reason);return i().catch(s)})},Vt={admin:100,adherent:1},yt="weenat-m-dash";function ze(){try{return JSON.parse(localStorage.getItem(yt))||{}}catch{return{}}}function Wt(t){try{localStorage.setItem(yt,JSON.stringify({...ze(),...t}))}catch{}}const N=[{id:"bilan_hydrique",title:"Irrigation",icon:"bi-droplet-fill",color:"#0172A4",active:!0,available:!0,fixed:!1},{id:"previsions",title:"Prévisions",icon:"bi-cloud-sun-fill",color:"#f5a623",active:!0,available:!0,fixed:!1},{id:"cumuls",title:"Cumuls",icon:"bi-bar-chart-fill",color:"#bf5af2",active:!0,available:!0,fixed:!1},{id:"temps_reel",title:"Mesures",icon:"bi-activity",color:"#ff9f0a",active:!0,available:!0,fixed:!1},{id:"traitements",title:"Traitements",icon:"bi-shield-fill",color:"#4ecdc4",active:!0,available:!0,fixed:!1},{id:"cultures",title:"Cultures",icon:"bi-flower1",color:"#a2c4c9",active:!0,available:!0,fixed:!1},{id:"evenements",title:"Anomalies capteurs",icon:"bi-exclamation-triangle-fill",color:"#ff3b30",active:!0,available:!0,fixed:!1},{id:"mon_reseau",title:"Infos Réseau",icon:"bi-diagram-3-fill",color:"#5b8dd9",active:!0,available:!0,fixed:!0},{id:"support",title:"Support",icon:"bi-question-circle-fill",color:"#30d158",active:!0,available:!0,fixed:!0}];function oe(t){var n;const i=document.getElementById("phone-screen");(n=document.querySelector(".m-toast"))==null||n.remove();const e=document.createElement("div");e.className="m-toast",e.textContent=t,i.appendChild(e),requestAnimationFrame(()=>e.classList.add("m-toast--show")),setTimeout(()=>{e.classList.remove("m-toast--show"),setTimeout(()=>e.remove(),300)},2200)}function je({title:t,body:i,doneLabel:e="Fermer",onDone:n}={}){var l;const r=document.getElementById("phone-screen");(l=document.querySelector(".m-sheet-overlay"))==null||l.remove();const s=document.createElement("div");s.className="m-sheet-overlay",s.innerHTML=`
    <div class="m-sheet">
      <div class="m-sheet-handle"></div>
      <div class="m-sheet-hd">
        <button class="m-sheet-cancel">Annuler</button>
      ...
      <div class="m-sheet-body"></div>
    </div>`,s.querySelector(".m-sheet-body").appendChild(typeof i=="string"?Object.assign(document.createElement("div"),{innerHTML:i}):i),r.appendChild(s),requestAnimationFrame(()=>s.classList.add("m-sheet-overlay--show"));const a=()=>{s.classList.remove("m-sheet-overlay--show"),setTimeout(()=>s.remove(),280)};return s.querySelector(".m-sheet-cancel").addEventListener("click",a),s.querySelector(".m-sheet-done").addEventListener("click",()=>{n==null||n(),a()}),s.addEventListener("click",d=>{d.target===s&&a()}),s}const lt=[{icon:"bi-sun-fill",label:"Ensoleillé",color:"#f5c842"},{icon:"bi-cloud-sun-fill",label:"Nuageux",color:"#8e8e93"},{icon:"bi-cloud-fill",label:"Couvert",color:"#636366"},{icon:"bi-cloud-drizzle-fill",label:"Averses",color:"#5b8dd9"},{icon:"bi-cloud-rain-fill",label:"Pluie",color:"#45b7d1"}];function ot(){return Array.from({length:14},(t,i)=>i).map(t=>{const i=new Date;i.setDate(i.getDate()+t);const e=lt[Math.floor(Math.random()*lt.length)],n=e.label==="Pluie"||e.label==="Averses",r=Math.round(8+Math.random()*8),s=Math.round(16+Math.random()*14),a=Array.from({length:24},(l,d)=>{const c=Math.sin(Math.PI*(d-6)/12),o=Math.round(r+(s-r)*Math.max(0,c)),v=n&&d>=8&&d<=16&&Math.random()>.6?+(Math.random()*3).toFixed(1):0;return{h:d,label:`${String(d).padStart(2,"0")}h`,temp:o,pluie:v,hum:Math.round(85-40*Math.max(0,c)),vent:Math.round(10+Math.random()*20),icon:v>0?"bi-cloud-rain-fill":d<7||d>20?"bi-moon-fill":e.icon}});return{dayLabel:t===0?"Aujourd'hui":t===1?"Demain":i.toLocaleDateString("fr-FR",{weekday:"long"}),dateStr:i.toLocaleDateString("fr-FR",{day:"numeric",month:"short"}),...e,pluie:n?Math.round(2+Math.random()*18):0,etp:+(1+Math.random()*5).toFixed(1),tMin:r,tMinHeure:`0${Math.floor(4+Math.random()*4)}h`.slice(-3),tMax:s,tMaxHeure:`${13+Math.floor(Math.random()*4)}h`,humMoy:Math.round(45+Math.random()*45),ventMoy:Math.round(10+Math.random()*25),ventRafales:Math.round(20+Math.random()*35),hours:a}})}function He(t){const i=t.id,e=t.reserveHydrique||50,n=+((i*2.3+7)%32).toFixed(1),r=+((i*1.1+14)%14+10).toFixed(1),s=+((i*.6+1)%6).toFixed(1),a=Math.round(e*((i%5+1)/10)),l=Math.max(0,+(a+n-r-s).toFixed(0)),d=l<a?a-l:0;return{j0:a,j7:l,bilan:d}}const Ne=4,rt=["#0172A4","#ff8500","#30d158","#bf5af2"],Be={pluie:"Pluie",temperature:"Température",humidite:"Humidité",etp:"Évapotranspiration",rayonnement:"Rayonnement solaire",temp_rosee:"Temp. rosée",vent:"Vent",par:"Ray. PAR",humectation:"Humectation foliaire",pothydr:"Potentiel hydrique",teneur:"Teneur en eau",temp_sol:"Temp. sol"},Gt={pluie:"mm",temperature:"°C",humidite:"%",etp:"mm",rayonnement:"W/m²",temp_rosee:"°C",vent:"km/h",par:"µmol/m²/s",humectation:"%",pothydr:"kPa",teneur:"%vol",temp_sol:"°C"},ct={"P+":["pluie","temperature","humidite"],PT:["pluie","temperature"],P:["pluie"],SMV:["pluie","temperature","humidite"],TH:["temperature","humidite"],W:["vent"],PYRANO:["rayonnement"],PAR:["par"],LWS:["humectation"],"CHP-15/30":["pothydr","temp_sol"],"CHP-30/60":["pothydr","temp_sol"],"CHP-60/90":["pothydr","temp_sol"],"CAPA-30-3":["teneur","temp_sol"],"CAPA-60-6":["teneur","temp_sol"],T_MINI:["temp_sol"],EC:["teneur","temp_sol"]},Jt=[{id:"365d",label:"365 derniers jours"},{id:"30d",label:"30 derniers jours"},{id:"7d",label:"7 derniers jours"},{id:"hier",label:"Hier"},{id:"1d",label:"Aujourd'hui"}];function wt(t){return t==="1d"||t==="hier"?[{id:"raw",label:"Mesures brutes"},{id:"1h",label:"Heure"},{id:"1d",label:"Jour"}]:t==="7d"?[{id:"1h",label:"Heure"},{id:"1d",label:"Jour"}]:[{id:"1d",label:"Jour"},{id:"1w",label:"Semaine"},{id:"1mo",label:"Mois"}]}function Ut(t,i){const e=["etp","rayonnement","temp_rosee"];if(!t)return[];if(t.startsWith("p-")){const r=new Set(e);return i.filter(s=>s.parcelId===+t.slice(2)).forEach(s=>(ct[s.model]||[]).forEach(a=>r.add(a))),[...r].filter(s=>s in Be)}const n=i.find(r=>r.id===+t.slice(2));return n?ct[n.model]||[]:[]}function Zt(t,i){return t==="1d"||t==="hier"?["0h","6h","12h","18h","24h"]:i==="1h"?["J-7","J-5","J-3","J-1","Auj."]:i==="1d"?t==="365d"?["Jan","Avr","Jul","Oct","Déc"]:t==="30d"?["J-30","J-22","J-14","J-7","Auj."]:["J-7","J-5","J-3","J-1","Auj."]:i==="1w"?t==="365d"?["S-52","S-38","S-26","S-13","Auj."]:["S-4","S-3","S-2","S-1","Auj."]:i==="1mo"?t==="365d"?["Jan","Avr","Jul","Oct","Déc"]:["M-4","M-3","M-2","M-1","Auj."]:[]}let ae=[],de=[];(()=>{const t=ze();if(t.catalog){const i=t.catalog.map(e=>e.id);N.sort((e,n)=>{const r=i.indexOf(e.id),s=i.indexOf(n.id);return(r<0?999:r)-(s<0?999:s)}),t.catalog.forEach(e=>{const n=N.find(r=>r.id===e.id);n&&(n.active=e.active)})}t.mesuresList&&(ae=t.mesuresList),t.cumulsList&&(de=t.cumulsList)})();function Yt(t,i,e){const n=[...t+i].reduce((a,l)=>a+l.charCodeAt(0),1),r=a=>(Math.sin(n*.07+a*.5)+Math.sin(n*.03+a*1.3))/2+.5,s={pluie:{base:0,amp:18,sparse:!0},temperature:{base:10,amp:14},humidite:{base:50,amp:38},etp:{base:1,amp:4},rayonnement:{base:100,amp:550},temp_rosee:{base:4,amp:9},vent:{base:4,amp:22},par:{base:100,amp:1400},humectation:{base:0,amp:100,sparse:!0},pothydr:{base:20,amp:130},teneur:{base:18,amp:18},temp_sol:{base:7,amp:9}}[i]||{base:40,amp:40};return Array.from({length:e},(a,l)=>s.sparse&&r(l*3.7)>.28?0:Math.max(0,s.base+s.amp*r(l*.28+1.2)))}function Xt(t,i){const e={"1d":24,hier:24,"7d":42,"30d":60,"365d":90}[t.period]||42,n=Yt(t.subjectKey,t.metricId,e),r=270,s=60,a=26,l=12,d=Math.max(...n,1),c=n.map((b,$)=>`${a+Math.round($/(e-1)*r)},${s-l-Math.round(b/d*(s-l-4))}`).join(" ");let o="";for(let b=0;b<=2;b++){const $=Math.round(b/2*(s-l-4)+4);o+=`<line x1="${a}" y1="${$}" x2="${a+r}" y2="${$}" stroke="#E8E6E0" stroke-width=".5"/>`,o+=`<text x="${a-3}" y="${$+3}" text-anchor="end" font-size="7" fill="#B0AEA8">${+(d*(1-b/2)).toFixed(d<5?1:0)}</text>`}const v=Zt(t.period,t.step),y=v.map((b,$)=>`<text x="${a+Math.round($/(v.length-1)*r)}" y="${s+2}" text-anchor="middle" font-size="7" fill="#B0AEA8">${b}</text>`).join(""),m=JSON.stringify(n.map(b=>+b.toFixed(2)));return`
    <div class="m-wf-card">
      ...
      <div class="m-tr-chart-wrap" data-unit="${t.unit}" data-series='${m}' style="position:relative;margin-top:4px">
        <svg viewBox="0 0 ${a+r} ${s+6}" style="width:100%;display:block;overflow:visible">
          ${o}
    ...
    </div>`}function dt(t,i){const e=ae.length>=Ne,n=t.map(l=>`<option value="p-${l.id}">${l.name}</option>`).join(""),r=i.filter(l=>l.parcelId).map(l=>{const d=t.find(c=>c.id===l.parcelId);return`<option value="s-${l.id}">${l.model} — ${l.serial}${d?` · ${d.name}`:""}</option>`}).join(""),s=wt("7d"),a=ae.length?ae.map(Xt).join(""):'<div class="m-wf-empty">Aucune mesure enregistrée</div>';return`
    ...
    <div class="m-wf-form${e?" m-wf-disabled":""}">
      ...
      <div class="m-wf-row">
        <select class="m-wf-sel" id="msr-period" ${e?"disabled":""}>
          ${Jt.map(l=>`<option value="${l.id}"${l.id==="7d"?" selected":""}>${l.label}</option>`).join("")}
        </select>
    ...
    <div id="msr-list">${a}</div>`}const _e=8;function Kt(t){const i=t.id;return!t.irrigation||t.irrigation==="Pas d'irrigation"?0:i%3===0?Math.round((i*1.7+8)%30+5):0}function mt(t,i=!1){if(!t.length)return'<div class="m-widget-empty"><i class="bi bi-check-circle" style="color:#30d158;font-size:28px"></i><p>Aucune parcelle</p></div>';const e=[...t].sort((a,l)=>He(l).bilan-He(a).bilan),r=(i?e:e.slice(0,_e)).map(a=>{const{j0:l,j7:d,bilan:c}=He(a),o=Kt(a);return`
      ...
      <div class="m-bh-td m-bh-td--planif">${o>0?o:"—"}</div>`}).join(""),s=!i&&e.length>_e?`<button class="m-bh-expand" id="bh-expand">Afficher les ${t.length-_e} autres parcelles <i class="bi bi-chevron-down"></i></button>`:"";return`
    ...
    </div>`}function Qt(t,i,e){const n=Object.fromEntries(J.map(o=>[o.id,o])),r=t.map(o=>{var m;const v=o.ville||((m=n[o.orgId])==null?void 0:m.ville)||null,y=[o.name,o.crop||null,v].filter(Boolean).join(" · ");return`<option value="p-${o.id}">${y}</option>`}).join(""),s=i.map(o=>`<option value="s-${o.id}">${o.model} — ${o.serial}</option>`).join(""),a=`
    <optgroup label="Parcelles">${r}</optgroup>
    ${s?`<optgroup label="Capteurs">${s}</optgroup>`:""}`,l=(o,v)=>{const y=`${o.dayLabel.charAt(0).toUpperCase()+o.dayLabel.slice(1)} · ${o.dateStr}`;return`
    ...
    </div>`}const ce=[{id:"pluie",label:"Cumul de pluie",unit:"mm",base:45,amp:80,needsModels:["P+","PT","P","SMV"]},{id:"dj",label:"Degrés-jours",unit:"DJ",base:120,amp:300,needsModels:["P+","PT","SMV","TH"]},{id:"hf",label:"Heures de froid",unit:"h",base:30,amp:120,needsModels:["P+","PT","SMV","TH"]},{id:"etp",label:"Évapotranspiration",unit:"mm",base:20,amp:60,needsModels:["P+","PT","SMV"]},{id:"rayo",label:"Rayonnement solaire",unit:"MJ",base:8,amp:20,needsModels:["PYRANO"]},{id:"humec",label:"Humectation foliaire",unit:"h",base:10,amp:40,needsModels:["LWS"]}],ei=new Set(ce.flatMap(t=>t.needsModels||[]));function ti(t){if(!t)return ce;if(t.startsWith("s-")){const e=z.find(n=>n.id===+t.slice(2));return e?ce.filter(n=>n.needsModels===null||n.needsModels.includes(e.model)):ce}const i=new Set(z.filter(e=>e.parcelId===+t.slice(2)).map(e=>e.model));return ce.filter(e=>e.needsModels===null||e.needsModels.some(n=>i.has(n)))}const ii={pluie:{icon:"bi-droplet-fill",color:"#45b7d1"},dj:{icon:"bi-thermometer-sun",color:"#ff9f0a"},hf:{icon:"bi-thermometer-low",color:"#5ac8fa"},etp:{icon:"bi-moisture",color:"#30d158"},rayo:{icon:"bi-sun-fill",color:"#f5c842"},humec:{icon:"bi-droplet-half",color:"#bf5af2"}};function si(){return de.length?de.map((t,i)=>{const e=new Date(t.fromDate).toLocaleDateString("fr-FR",{day:"numeric",month:"short",year:"numeric"});return`<div class="m-cumuls-saved-card" style="position:relative">
    ...
    </div>`}).join(""):'<div style="text-align:center;padding:16px;font-size:13px;color:#8e8e93">Aucun cumul enregistré</div>'}function ai(t,i,e){if(!t||!i)return null;const n=ce.find(a=>a.id===e)||ce[0],r=Math.max(1,Math.round((Date.now()-new Date(i))/864e5)),s=t.split("").reduce((a,l)=>a+l.charCodeAt(0),0)+r;return+(n.base+s%(n.amp*10)/10).toFixed(1)}function ut(t,i){const e=de.length>=Ne,n=`${new Date().getFullYear()}-01-01`,r=i.filter(o=>o.parcelId&&ei.has(o.model)),s=new Set(r.map(o=>o.parcelId)),l=t.filter(o=>s.has(o.id)).map(o=>`<option value="p-${o.id}">${o.name}</option>`).join(""),d=r.map(o=>{const v=t.find(y=>y.id===o.parcelId);return`<option value="s-${o.id}">${o.model} — ${o.serial}${v?` · ${v.name}`:""}</option>`}).join(""),c=de.length?si():'<div class="m-wf-empty">Aucun cumul enregistré</div>';return`
    ...
    <div class="m-wf-form${e?" m-wf-disabled":""}">
      ...
      <div class="m-wf-row">
        <div class="m-wf-field">
          ...
          <input type="date" class="m-wf-date" id="cumuls-from" value="${n}" ${e?"disabled":""}>
        </div>
      </div>
    ...
    <div id="cumuls-saved-list">${c}</div>`}const ni={"Blé tendre":["Prosaro","Aviator Xpro","Input Xpro"],Maïs:["Mercantor Gold","Callisto","Milagro"],Orge:["Comet Pro","Siltra Xpro","Variano Xpro"],Colza:["Karate Zeon","Plenum","Caryx"],"Prairie permanente":["Duplosan KV","Starane Premium","—"],Tournesol:["Adengo","Merlin Flexx","Pulsar Plus"],Betterave:["Betanal Expert","Debut","Safari"]};function li(t){const i=t.id,e=new Date,n=ni[t.crop]||["—"],r=n[i%n.length];let s,a;i%5===3?(s=0,a=(e.getHours()+2+i%3*3)%24):(s=(i*2+1)%6+1,a=6+i%5*2);const l=2+i%3,d=new Date(e);d.setDate(d.getDate()+s);const c=s===0?"Aujourd'hui":d.toLocaleDateString("fr-FR",{day:"2-digit",month:"2-digit"}),o=s*1440+a*60-(e.getHours()*60+e.getMinutes()),v=o>=0&&o<=600;return{product:r,winDateStr:c,winHour:a,winDur:l,isUrgent:v,minutesFromNow:o}}function oi(t){const e=t.filter(s=>s.crop).map(s=>({p:s,d:li(s)})).filter(({d:s})=>s.minutesFromNow>=0&&s.minutesFromNow<=2880).sort((s,a)=>s.d.minutesFromNow-a.d.minutesFromNow);return e.length?`<div class="m-w-list">${e.slice(0,10).map(({p:s,d:a})=>{const l=a.isUrgent?"#ff9f0a":"#1c1c1e",d=a.isUrgent?'<i class="bi bi-alarm-fill" style="color:#ff9f0a"></i> ':"",c=String(a.winHour).padStart(2,"0");return`<div class="m-w-row">
      <div class="m-w-row-main">
        <div class="m-w-row-name">${s.name}</div>
        <div class="m-w-row-sub">${s.crop}</div>
      </div>
      <div style="text-align:right;flex-shrink:0">
        <div style="font-size:12px;font-weight:600;color:${l}">${d}${a.winDateStr} · ${c}:00</div>
        <div style="font-size:11px;color:#8e8e93">fenêtre de ${a.winDur} heures</div>
      </div>
    </div>`}).join("")}</div>
    <div class="m-w-see-more" data-action="weephyt">
      <i class="bi bi-box-arrow-up-right"></i> Voir les fenêtres des autres parcelles
    </div>`:'<div class="m-widget-empty">Aucune fenêtre favorable dans les prochaines 48h</div>'}const ri={"capteur couché":{icon:"bi-arrow-down-circle-fill",color:"#ff9f0a"},"émissions interrompues":{icon:"bi-wifi-off",color:"#ff3b30"},"capteur déplacé":{icon:"bi-geo-alt-fill",color:"#ff9f0a"},"cuillère bloquée":{icon:"bi-x-octagon-fill",color:"#ff3b30"}};function ci(t,i){const e=i.filter(n=>n.event&&(Array.isArray(n.event)?n.event.length>0:!0));return e.length?`<div class="m-w-list">${e.map(n=>{const r=t.find(l=>l.id===n.parcelId),a=(Array.isArray(n.event)?n.event:[n.event]).map(l=>{const d=ri[l]||{icon:"bi-exclamation-circle-fill",color:"#ff9f0a"};return`<span class="m-ev-badge" style="color:${d.color}"><i class="bi ${d.icon}"></i> ${l}</span>`}).join("");return`<div class="m-w-row m-w-row--clickable" data-sensor-id="${n.id}" style="flex-direction:column;align-items:flex-start;gap:4px">
    ...
    </details>`}).join("")}`}function pi(){const t=F.map(n=>n.orgId).filter((n,r,s)=>s.indexOf(n)===r&&n!==100).length,i=z.length,e=F.length;return`
    ...
    <div class="m-sheet m-chat-sheet">
    ...
    </div>`,t.appendChild(i),requestAnimationFrame(()=>i.classList.add("m-sheet-overlay--show"));const e=i.querySelector("#chat-messages"),n=i.querySelector("#chat-input"),r=i.querySelector("#chat-send"),s=()=>{i.classList.remove("m-sheet-overlay--show"),setTimeout(()=>i.remove(),280)};i.querySelector("#chat-close").addEventListener("click",s),i.addEventListener("click",o=>{o.target===i&&s()});function a(o,v){const y=document.createElement("div");y.className=`m-chat-msg m-chat-msg--${v}`,y.innerHTML=`<div class="m-chat-bubble">${o}</div>`,e.appendChild(y),e.scrollTop=e.scrollHeight}function l(){const o=document.createElement("div");return o.className="m-chat-msg m-chat-msg--bot m-chat-typing",o.innerHTML='<div class="m-chat-bubble"><span></span><span></span><span></span></div>',e.appendChild(o),e.scrollTop=e.scrollHeight,o}function d(){const o=n.value.trim();if(!o)return;a(o,"user"),n.value="",r.disabled=!0;const v=l();setTimeout(()=>{v.remove();const y=pt[Math.floor(Math.random()*pt.length)];a(y,"bot"),r.disabled=!1,n.focus()},1200+Math.random()*800)}r.addEventListener("click",d),n.addEventListener("keydown",o=>{o.key==="Enter"&&d()}),setTimeout(()=>n.focus(),350)}function fi(t,i){let e=t.querySelector("#dashboard-content");e||(e=document.createElement("div"),e.id="dashboard-content",t.appendChild(e));const n=Vt[i]||1,r=n===100?F:F.filter(f=>f.orgId===n),s=new Set(r.map(f=>f.id)),a=z.filter(f=>s.has(f.parcelId));let l=ot();const d=ze(),c=new Set(["mon_reseau","support"]),o=new Set(d.collapsed??N.map(f=>f.id).filter(f=>!c.has(f)));function v(){Wt({catalog:N.map(f=>({id:f.id,active:f.active})),collapsed:[...o],mesuresList:ae,cumulsList:de})}function y(f,u){const p=f.fixed?"":`<button class="m-widget-menu" data-widget="${f.id}" type="button">•••</button>`,h=o.has(f.id);return`
      <div class="m-widget${h?" m-widget--collapsed":""}" data-widget="${f.id}">
        <div class="m-widget-hd m-widget-hd--toggle" data-collapse="${f.id}">
          ...
          <i class="bi ${h?"bi-chevron-down":"bi-chevron-up"}" style="font-size:14px;color:#636366;flex-shrink:0;margin-left:auto;margin-right:${f.fixed?"0":"8px"}"></i>
          ${p}
        </div>
        <div class="m-widget-bd" style="${h?"display:none":""}">${u}</div>
      </div>`}function m(){l=ot();const f=N.filter(p=>p.active&&!p.fixed),u=N.filter(p=>p.active&&p.fixed);e.innerHTML=`
      ...
      <div class="m-detail-header">
        ...
        <div class="m-detail-row2" style="justify-content:space-between;align-items:center;padding:4px 16px 10px">
          <button class="m-day-nav" id="prev-day" ${u===0?"disabled":""}>‹</button>
          <div style="display:flex;align-items:center;gap:6px"><i class="bi ${p.icon}" style="color:${p.color};font-size:22px"></i><span class="m-d-name">${h}</span></div>
          <button class="m-day-nav" id="next-day" ${u>=f.length-1?"disabled":""}>›</button>
        </div>
      </div>
      ...
      <div id="detail-content" class="m-detail-content" style="top:84px">
        <div style="padding:12px 16px 0">
          ...
          <div style="background:#fff;border-radius:12px;border:1px solid rgba(0,0,0,.07);overflow:hidden;margin-bottom:24px">
      ...
      </div>`}function C(f,u,p){var h,g;f.querySelector(".m-detail-back").addEventListener("click",re),(h=f.querySelector("#prev-day"))==null||h.addEventListener("click",()=>{f.innerHTML=$(u,p-1),C(f,u,p-1)}),(g=f.querySelector("#next-day"))==null||g.addEventListener("click",()=>{f.innerHTML=$(u,p+1),C(f,u,p+1)})}function M(f,u){const p=xe($(f,u));C(p,f,u)}function E(){var j,G,me,Le,Ye;(j=t.querySelector(".m-navbar-action"))==null||j.addEventListener("click",T),(G=e.querySelector("#dash-add-widget-btn"))==null||G.addEventListener("click",k),e.querySelectorAll(".m-widget-hd--toggle").forEach(L=>{L.addEventListener("click",_=>{if(_.target.closest(".m-widget-menu"))return;const I=L.dataset.collapse;o.has(I)?o.delete(I):o.add(I),v(),m()})}),(me=e.querySelector('[data-action="weephyt"]'))==null||me.addEventListener("click",()=>{oe("Page Weephyt — à venir")}),e.querySelectorAll("[data-sensor-id]").forEach(L=>{L.addEventListener("click",()=>{const _=a.find(I=>I.id===+L.dataset.sensorId);_&&se(()=>Promise.resolve().then(()=>zi),void 0).then(I=>I.initSensorDetail(_,"params"))})}),e.querySelectorAll('[data-widget="cultures"] [data-plot-id]').forEach(L=>{L.addEventListener("click",()=>{const _=F.find(I=>I.id===+L.dataset.plotId);_&&se(()=>Promise.resolve().then(()=>vt),void 0).then(I=>I.initParcelDetail(_,[],"params"))})}),(Le=e.querySelector("#bh-expand"))==null||Le.addEventListener("click",()=>{const L=e.querySelector('[data-widget="bilan_hydrique"] .m-widget-bd');L&&(L.innerHTML=mt(r,!0),u(),f())});function f(){e.querySelectorAll(".m-bh-plot-link").forEach(L=>{L.addEventListener("click",()=>{const _=F.find(I=>I.id===+L.dataset.plotId);_&&se(()=>Promise.resolve().then(()=>vt),void 0).then(I=>I.initParcelDetail(_,[]))})})}function u(){var L,_,I;(L=e.querySelector("#bh-btn-calendar"))==null||L.addEventListener("click",()=>{se(()=>import("./irrigation-CBjc6n12.js"),__vite__mapDeps([0,1,2,3,4,5,6,7])).then(O=>O.openCalendar(r,""))}),(_=e.querySelector("#bh-btn-irrigation"))==null||_.addEventListener("click",()=>{se(()=>import("./irrigation-CBjc6n12.js"),__vite__mapDeps([0,1,2,3,4,5,6,7])).then(O=>O.openIrrigationSaisie(r,oe))}),(I=e.querySelector("#bh-btn-strategie"))==null||I.addEventListener("click",()=>{se(()=>import("./irrigation-CBjc6n12.js"),__vite__mapDeps([0,1,2,3,4,5,6,7])).then(O=>O.openIrrigationStrategie(r,oe))})}f(),u();function p(){const L=e.querySelector('[data-widget="cumuls"] .m-widget-bd');L&&(L.innerHTML=ut(r,a),h())}function h(){var O,W,Q,ee;const L=()=>{var H;const R=(H=e.querySelector("#cumuls-metric"))==null?void 0:H.value,P=e.querySelector("#cumuls-thresholds");P&&(R==="hf"?P.innerHTML=`
            <div class="m-wf-field">
            ...
            </div>`:P.innerHTML="")},_=()=>{var q;const R=e.querySelector("#cumuls-metric"),P=(q=e.querySelector("#cumuls-subject"))==null?void 0:q.value;if(!R)return;const H=ti(P);R.innerHTML='<option value="">— Métrique —</option>'+H.map(D=>`<option value="${D.id}">${D.label}</option>`).join(""),R.disabled=!P||!H.length,L(),I()},I=()=>{var X,te,ie;const R=e.querySelector("#cumuls-create"),P=e.querySelector("#cumuls-date-err"),H=(X=e.querySelector("#cumuls-subject"))==null?void 0:X.value,q=(te=e.querySelector("#cumuls-from"))==null?void 0:te.value,D=(ie=e.querySelector("#cumuls-metric"))==null?void 0:ie.value,V=q?(Date.now()-new Date(q))/864e5>365:!1;P&&(P.style.display=V?"":"none"),R&&(R.disabled=!H||!q||!D||V)};(O=e.querySelector("#cumuls-subject"))==null||O.addEventListener("change",()=>{_(),I()}),(W=e.querySelector("#cumuls-from"))==null||W.addEventListener("change",I),(Q=e.querySelector("#cumuls-metric"))==null||Q.addEventListener("change",()=>{L(),I()}),(ee=e.querySelector("#cumuls-create"))==null||ee.addEventListener("click",()=>{var te,ie,be,ge,ye,Xe;const R=e.querySelector("#cumuls-subject"),P=R==null?void 0:R.value,H=(te=e.querySelector("#cumuls-from"))==null?void 0:te.value,q=(ie=e.querySelector("#cumuls-metric"))==null?void 0:ie.value;if(!P||!H||!q)return;const D=ce.find(Et=>Et.id===q),V=ii[q]||{icon:"bi-bar-chart-fill",color:"#636366"},X=q==="hf"?{cold:+(((be=e.querySelector("#cumuls-th-cold"))==null?void 0:be.value)??7.2)}:q==="dj"?{low:+(((ge=e.querySelector("#cumuls-th-low"))==null?void 0:ge.value)??0),high:+(((ye=e.querySelector("#cumuls-th-high"))==null?void 0:ye.value)??18)}:null;de.push({metricId:q,metricLabel:(D==null?void 0:D.label)||q,unit:(D==null?void 0:D.unit)||"",icon:V.icon,color:V.color,subjectKey:P,subjectLabel:(((Xe=R.options[R.selectedIndex])==null?void 0:Xe.text)||P).trim(),fromDate:H,value:String(ai(P,H,q)??"—"),thresholds:X}),v(),p()}),e.querySelectorAll(".m-cumuls-del").forEach(R=>{R.addEventListener("click",()=>{de.splice(+R.dataset.cidx,1),v(),p()})})}h(),(Ye=e.querySelector("#open-chat-btn"))==null||Ye.addEventListener("click",hi);function g(){e.querySelectorAll(".m-tr-chart-wrap").forEach(L=>{const _=L.querySelector(".m-tr-cursor"),I=L.querySelector(".m-tr-tooltip");if(!I)return;const O=JSON.parse(L.dataset.series||"[]"),W=L.dataset.unit||"",Q=O.length,ee=26,R=270;L.addEventListener("pointermove",P=>{const H=L.getBoundingClientRect(),q=Math.max(0,Math.min(((P.clientX-H.left)*(ee+R)/H.width-ee)/R,1)),D=O[Math.round(q*(Q-1))]??null;if(_){const V=ee+Math.round(q*R);_.setAttribute("x1",V),_.setAttribute("x2",V),_.setAttribute("opacity","1")}I.style.display="",I.style.left=`${Math.max(0,Math.min(P.clientX-H.left-24,H.width-60))}px`,I.textContent=D!==null?`${(+D).toFixed(1)} ${W}`:"—"}),L.addEventListener("pointerleave",()=>{I.style.display="none",_==null||_.setAttribute("opacity","0")})})}function w(){const L=e.querySelector('[data-widget="temps_reel"] .m-widget-bd');L&&(L.innerHTML=dt(r,a),x())}function x(){var O,W,Q,ee,R;const L=()=>{var H,q;const P=e.querySelector("#msr-create");P&&(P.disabled=!((H=e.querySelector("#msr-subject"))!=null&&H.value)||!((q=e.querySelector("#msr-metric"))!=null&&q.value)||ae.length>=Ne)},_=()=>{var D;const P=e.querySelector("#msr-metric"),H=(D=e.querySelector("#msr-subject"))==null?void 0:D.value;if(!P)return;const q=Ut(H,a);P.innerHTML='<option value="">— Métrique —</option>'+q.map(V=>`<option value="${V}">${Be[V]}</option>`).join(""),P.disabled=!H||!q.length,L()},I=()=>{var q;const P=e.querySelector("#msr-step"),H=((q=e.querySelector("#msr-period"))==null?void 0:q.value)||"7d";P&&(P.innerHTML=wt(H).map(D=>`<option value="${D.id}">${D.label}</option>`).join(""),L())};(O=e.querySelector("#msr-subject"))==null||O.addEventListener("change",()=>{_(),L()}),(W=e.querySelector("#msr-period"))==null||W.addEventListener("change",()=>{I(),L()}),(Q=e.querySelector("#msr-metric"))==null||Q.addEventListener("change",L),(ee=e.querySelector("#msr-step"))==null||ee.addEventListener("change",L),(R=e.querySelector("#msr-create"))==null||R.addEventListener("click",()=>{var be,ge,ye;const P=e.querySelector("#msr-subject"),H=e.querySelector("#msr-metric"),q=e.querySelector("#msr-period"),D=e.querySelector("#msr-step"),V=P==null?void 0:P.value,X=H==null?void 0:H.value,te=q==null?void 0:q.value,ie=D==null?void 0:D.value;!V||!X||!te||!ie||(ae.push({subjectKey:V,subjectLabel:(((be=P.options[P.selectedIndex])==null?void 0:be.text)||V).trim(),metricId:X,metricLabel:Be[X]||X,unit:Gt[X]||"",period:te,periodLabel:(((ge=q.options[q.selectedIndex])==null?void 0:ge.text)||te).trim(),step:ie,stepLabel:(((ye=D.options[D.selectedIndex])==null?void 0:ye.text)||ie).trim(),color:rt[ae.length%rt.length]}),v(),w())}),e.querySelectorAll('.m-wf-del[data-widget="temps_reel"]').forEach(P=>{P.addEventListener("click",()=>{ae.splice(+P.dataset.idx,1),v(),w()})}),g()}x(),e.querySelectorAll(".m-prev-card").forEach(L=>{L.addEventListener("click",()=>{M(l,+L.dataset.day)})});const S=e.querySelector(".m-prev-expand-btn");S&&S.addEventListener("click",()=>M(l,3)),e.querySelectorAll(".m-widget-menu").forEach(L=>{L.addEventListener("click",_=>{_.stopPropagation();const I=N.find(Q=>Q.id===L.dataset.widget);if(!I)return;const O=document.createElement("div");O.innerHTML=`
          <div class="m-sheet-links">
          ...
          </div>`;const W=je({title:I.title,body:O,doneLabel:"Fermer",onDone:()=>{}});O.querySelector("#menu-config").addEventListener("click",()=>{W.classList.remove("m-sheet-overlay--show"),setTimeout(()=>{W.remove(),oe("Configuration à venir")},280)}),O.querySelector("#menu-move").addEventListener("click",()=>{W.classList.remove("m-sheet-overlay--show"),setTimeout(()=>{W.remove(),A()},280)}),O.querySelector("#menu-remove").addEventListener("click",()=>{I.active=!1,W.classList.remove("m-sheet-overlay--show"),setTimeout(()=>{W.remove(),v(),m()},280),oe("Widget retiré")})})})}function A(){const f=document.createElement("div"),u=()=>N.filter(h=>h.active&&!h.fixed),p=()=>{const h=u();f.innerHTML=h.map((g,w)=>`
        <div class="m-reorder-row">
          ...
          <div class="m-reorder-btns">
            ...
            <button class="m-reorder-btn" data-i="${w}" data-dir="1" ${w===h.length-1?"disabled":""} type="button">
              <i class="bi bi-arrow-down"></i>
            </button>
          </div>
        </div>`).join(""),f.querySelectorAll(".m-reorder-btn:not([disabled])").forEach(g=>{g.addEventListener("click",()=>{const w=u(),x=+g.dataset.i,S=x+ +g.dataset.dir,j=N.indexOf(w[x]),G=N.indexOf(w[S]);[N[j],N[G]]=[N[G],N[j]],v(),p(),m()})})};p(),je({title:"Réorganiser les widgets",body:f,doneLabel:"Fermer",onDone:()=>{}})}function T(){const u=xe(`
      <div class="m-detail-header">
      ...
      </div>`);u.querySelector(".m-detail-back").addEventListener("click",re),u.querySelectorAll(".m-add-item").forEach(p=>{p.addEventListener("click",()=>{const h=p.dataset.action;h==="irrigation"?(re(),se(()=>import("./irrigation-CBjc6n12.js"),__vite__mapDeps([0,1,2,3,4,5,6,7])).then(g=>g.openIrrigationSaisie(r,oe))):h==="strategie-irrigation"?(re(),se(()=>import("./irrigation-CBjc6n12.js"),__vite__mapDeps([0,1,2,3,4,5,6,7])).then(g=>g.openIrrigationStrategie(r,oe))):h==="calendrier"?(re(),se(()=>import("./irrigation-CBjc6n12.js"),__vite__mapDeps([0,1,2,3,4,5,6,7])).then(g=>g.openCalendar(r,""))):oe("Fonctionnalité à venir")})})}function k(){const f=document.createElement("div"),u=()=>{const p=N.filter(h=>!h.fixed);f.innerHTML=p.map(h=>`
    ...
    </div>`);i.querySelector(".m-detail-back").addEventListener("click",re),i.querySelectorAll(".m-wcat-add").forEach(e=>{e.addEventListener("click",()=>B("Widget bientôt disponible"))})}const Te={etp:{label:"Évapotranspiration",unit:"mm/j",color:"#c090e0",cumul:!0,cumulsType:"etp"},rayonnement:{label:"Rayonnement solaire",unit:"W/m²",color:"#f5c842",cumul:!1,cumulsType:"rayo"},temp_rosee:{label:"Température de rosée",unit:"°C",color:"#80c8e8",cumul:!1},pluie:{label:"Pluie",unit:"mm",color:"#45b7d1",cumul:!0,cumulsType:"pluie"},temperature:{label:"Température",unit:"°C",color:"#e07050",cumul:!1,cumulsType:"temp"},humidite:{label:"Humidité",unit:"%",color:"#4ecdc4",cumul:!1},pothydr:{label:"Potentiel hydrique",unit:"kPa",color:"#5b8dd9",cumul:!1},teneur:{label:"Teneur en eau",unit:"%vol",color:"#f0c060",cumul:!1},temp_sol:{label:"Température sol",unit:"°C",color:"#bb8fce",cumul:!1},humectation:{label:"Humectation foliaire",unit:"%",color:"#60a090",cumul:!1,cumulsType:"hws"},vent:{label:"Vent",unit:"km/h",color:"#82b8e0",cumul:!1},par:{label:"Rayonnement PAR",unit:"µmol/m²/s",color:"#a0d070",cumul:!1}},xt={"P+":["pluie","temperature","humidite"],PT:["pluie","temperature"],P:["pluie"],SMV:["pluie","temperature","humidite"],TH:["temperature","humidite"],W:["vent"],PYRANO:["rayonnement"],PAR:["par"],LWS:["humectation"],"CHP-15/30":["pothydr","temp_sol"],"CHP-30/60":["pothydr","temp_sol"],"CHP-60/90":["pothydr","temp_sol"],"CAPA-30-3":["teneur","temp_sol"],"CAPA-60-6":["teneur","temp_sol"],T_MINI:["temp_sol"],EC:["teneur","temp_sol"]};function Ve(t,i){const e={etp:{base:3,amp:1.5,min:0,max:8},rayonnement:{base:350,amp:300,min:0,max:900},temp_rosee:{base:9,amp:5,min:-2,max:18},pluie:{base:2,amp:6,min:0,max:30,sparse:!0},temperature:{base:15,amp:8,min:-5,max:35},humidite:{base:65,amp:20,min:20,max:100},pothydr:{base:80,amp:60,min:0,max:200},teneur:{base:30,amp:12,min:5,max:50},temp_sol:{base:14,amp:5,min:0,max:35},humectation:{base:20,amp:80,min:0,max:100,sparse:!0},vent:{base:15,amp:15,min:0,max:80},par:{base:900,amp:800,min:0,max:2e3}}[t]||{base:50,amp:20,min:0,max:100};return Array.from({length:i},(n,r)=>{const s=r/i*Math.PI*4;if(e.sparse&&Math.random()>.25)return 0;const a=e.base+e.amp*Math.sin(s-1)+(Math.random()-.5)*e.amp*.5;return Math.max(e.min,Math.min(e.max,a))})}const We={"365d":52,"30d":60,"7d":84,hier:48,"1d":24,custom:60},Ge={"365d":525600,"30d":43200,"7d":10080,hier:1440,"1d":1440,custom:10080};function yi(t,i,e,n,r,s=20){const a=Ge[t]||10080,l=new Date,d=y=>t==="1d"||t==="hier"?`${String(y.getHours()).padStart(2,"0")}h`:t==="365d"?y.toLocaleDateString("fr-FR",{month:"short"}):`${String(y.getDate()).padStart(2,"0")}/${String(y.getMonth()+1).padStart(2,"0")}`,c=4,o=i-e-n,v=r-s;return Array.from({length:c+1},(y,m)=>{const b=m/c,$=new Date(l.getTime()-(1-b)*a*6e4),C=(e+b*o).toFixed(1),M=m===0?"start":m===c?"end":"middle";return[`<line x1="${C}" y1="${v}" x2="${C}" y2="${v+4}" stroke="rgba(0,0,0,.2)" stroke-width="1"/>`,`<text x="${C}" y="${r-3}" text-anchor="${M}" font-size="9" fill="#8e8e93" font-family="-apple-system">${d($)}</text>`].join("")}).join("")}function wi(t,i,e,n="7d"){const r=We[n]||60,s=Ve(t,r),a=320,l=100,d=34,c=6,o=10,v=20,y=a-d-c,m=l-o-v,b=e?0:Math.min(...s),$=Math.max(...s,b+.001),C=$-b,M=x=>d+x/(s.length-1)*y,E=x=>o+m-(x-b)/C*m,A=`g${Math.random().toString(36).slice(2,8)}`,T=[0,.5,1].map(x=>{const S=b+x*C,j=o+m-x*m;return`<text x="${d-3}" y="${(j+3).toFixed(1)}" text-anchor="end" font-size="9" fill="#8e8e93" font-family="-apple-system">${S<10?S.toFixed(1):Math.round(S)}</text>`}).join(""),k=[.25,.5,.75].map(x=>{const S=(o+m-x*m).toFixed(1);return`<line x1="${d}" y1="${S}" x2="${a-c}" y2="${S}" stroke="rgba(0,0,0,.07)" stroke-width="1" stroke-dasharray="3,3"/>`}).join(""),f=`<line x1="${d}" y1="${o+m}" x2="${a-c}" y2="${o+m}" stroke="rgba(0,0,0,.12)" stroke-width="1"/>`,u=yi(n,a,d,c,l);if(e){const x=y/s.length*.7,S=s.map((j,G)=>{const me=(j-b)/C*m,Le=o+m-me;return`<rect x="${(M(G)-x/2).toFixed(1)}" y="${Le.toFixed(1)}" width="${x.toFixed(1)}" height="${me.toFixed(1)}" fill="${i}" opacity=".8" rx="1"/>`}).join("");return`<svg viewBox="0 0 ${a} ${l}" width="100%" height="${l}" preserveAspectRatio="none">${T}${k}${f}${u}${S}</svg>`}const h=s.map((x,S)=>[M(S),E(x)]).map(([x,S],j)=>`${j?"L":"M"}${x.toFixed(1)},${S.toFixed(1)}`).join(" "),g=`${h} L${M(s.length-1).toFixed(1)},${(o+m).toFixed(1)} L${d},${(o+m).toFixed(1)} Z`;return`<div class="m-chart-svg-wrap" data-chart="${encodeURIComponent(JSON.stringify({vals:s.map(x=>+x.toFixed(2)),minV:+b.toFixed(2),maxV:+$.toFixed(2)}))}" data-color="${i}" style="position:relative">
  ...
  </div>`}function $i(t,i,e){if(!e)return"";const n=We[i]||60,s=(Ge[i]||10080)/(n*60),a=Ve(t,n);let l=[];if(e==="temp"){const d=a.reduce((o,v)=>o+Math.max(0,v),0)*(s/24),c=a.filter(o=>o<7).length*s;l=[{label:"Degrés jours",val:`${Math.round(d)} DJ`},{label:"Heures de froid",val:`${Math.round(c)} h`}]}else if(e==="pluie")l=[{label:"Cumul pluie",val:`${a.reduce((c,o)=>c+o,0).toFixed(1)} mm`}];else if(e==="rayo"){const d=a.filter(c=>c>120).length*s;l=[{label:"Ensoleillement",val:`${Math.round(d)} h`}]}else if(e==="etp")l=[{label:"ETP cumulée",val:`${(a.reduce((c,o)=>c+o,0)*(s/24)).toFixed(1)} mm`}];else if(e==="hws"){const d=a.filter(c=>c>50).length*s;l=[{label:"Heures d'humectation",val:`${Math.round(d)} h`}]}return l.length?`<div class="m-chart-cumuls">${l.map(d=>`<div class="m-chart-cumul-chip">
    ...
    <div class="m-chart-card">
      ...
      ${$i(t,i,e.cumulsType)}
    </div>`:""}function Ci(t){const i=JSON.parse(decodeURIComponent(t.dataset.chart||"{}"));if(!i.vals)return;const{vals:e,minV:n,maxV:r}=i,s=t.querySelector(".m-chart-tip"),a=t.querySelector(".m-chart-crosshair"),l=t.dataset.color||"#0172A4";function d(o){const v=t.getBoundingClientRect(),y=Math.max(0,Math.min(1,(o-v.left)/v.width)),m=Math.round(y*(e.length-1)),b=e[m],$=y*100;a.style.cssText=`display:block;position:absolute;top:0;bottom:20px;left:${$}%;width:1px;background:${l};opacity:.5`,s.style.cssText=`display:block;position:absolute;top:8px;left:${Math.min($,75)}%;background:#1a1a1a;color:#fff;font-size:12px;font-weight:700;padding:3px 8px;border-radius:6px;white-space:nowrap;pointer-events:none`,s.textContent=b<10?b.toFixed(1):String(Math.round(b))}function c(){a.style.display="none",s.style.display="none"}t.addEventListener("pointermove",o=>{o.preventDefault(),d(o.clientX)}),t.addEventListener("pointerdown",o=>d(o.clientX)),t.addEventListener("pointerup",c),t.addEventListener("pointerleave",c),t.style.cursor="crosshair"}function Si(t){const i=At(F.filter(m=>m.orgId===t.orgId)),e=new Set([t.name]);i.filter(m=>m.ids.includes(t.id)).forEach(m=>e.add(m.label));const n=Tt.filter(m=>e.has(m.label)),r=new Date().toISOString().split("T")[0],s=n.filter(m=>m.real),a=n.filter(m=>!m.real),l=s.reduce((m,b)=>m+b.mm,0),d=a.reduce((m,b)=>m+b.mm,0),c=a.filter(m=>m.iso>=r).sort((m,b)=>m.iso<b.iso?-1:1)[0],o=["jan","fév","mar","avr","mai","jun","jul","aoû","sep","oct","nov","déc"],v=m=>{const[,b,$]=m.split("-");return`${+$} ${o[+b-1]}`},y=t.irrigation;return n.length?`
    <div class="m-placeholder-widget" style="flex-direction:column;align-items:flex-start;gap:10px">
      ...
      <div style="display:flex;gap:20px;width:100%">
        <div>
          ...
          <div style="font-size:22px;font-weight:700;color:#E07820;line-height:1.1">${l} <span style="font-size:12px;font-weight:400;color:#8e8e93">mm</span></div>
      ...
      ${c?`<div style="font-size:12px;color:#3a3a3c"><i class="bi bi-arrow-right-circle" style="color:#0172A4"></i> Prochaine · <strong>${v(c.iso)}</strong> · ${c.mm} mm</div>`:""}
    </div>`:`
    ...
    </div>`}function Mi(t,i){const e=new Blob(["\uFEFF"+t],{type:"text/csv;charset=utf-8;"}),n=Object.assign(document.createElement("a"),{href:URL.createObjectURL(e),download:i});document.body.appendChild(n),n.click(),document.body.removeChild(n),setTimeout(()=>URL.revokeObjectURL(n.href),100)}function Ei(t,i,e){const n=new Set;i.forEach(m=>{const b=z.find($=>$.id===m);b&&(xt[b.model]||[]).forEach($=>n.add($))});const r=[...new Set(["etp","rayonnement","temp_rosee",...n])].filter(m=>Te[m]),s=We[e]||60,a=Ge[e]||10080,l=a/s*6e4,d=new Date,c=new Date(d-a*6e4),o=["Horodatage",...r.map(m=>`${Te[m].label} (${Te[m].unit})`)].join(";"),v=Array.from({length:s},(m,b)=>[new Date(c.getTime()+b*l).toISOString().replace("T"," ").slice(0,19),...r.map(C=>Ve(C,1)[0].toFixed(2))].join(";")),y=(t.name||"parcelle").replace(/[^\w]/g,"_");Mi([o,...v].join(`\r
`),`${y}_${e}_${new Date().toISOString().slice(0,10)}.csv`)}function Ai(t,i="7d",e="1h"){const n=new Set;t.forEach(s=>{const a=z.find(l=>l.id===s);a&&(xt[a.model]||[]).forEach(l=>n.add(l))});const r=[...new Set(["etp","rayonnement","temp_rosee",...n])];return`
    ...
    <div class="m-detail-section">
      ${r.map(s=>xi(s,i)).join("")}
    </div>`}function Ti(t,i,e){const n=e.map(r=>{const s=z.find(a=>a.id===r);return s?`${s.model} — ${s.serial}`:null}).filter(Boolean);return`
    <div class="m-detail-section">
      ...
      <div class="m-list">
        ${n.length?n.map((r,s)=>`<div class="m-list-row${s===n.length-1?" m-list-row--last":""}">
    ...
    </div>`}function Fe(t,i=[],e="widgets"){const n=J.find(m=>m.id===t.orgId);let r=e,s="7d",a="1h",l=!1;const d=(n==null?void 0:n.ville)||"",c=xe(`
    <div class="m-detail-header">
      <div class="m-detail-topbar">
    ...
    <div id="detail-content" class="m-detail-content"></div>`);function o(){const m=c.querySelector("#detail-content");r==="widgets"&&(m.innerHTML=Li(t)),r==="donnees"&&(m.innerHTML=Ai(i,s,a)),r==="params"&&(m.innerHTML=Ti(t,n,i),v()),y()}function v(){const m=window.L;m&&setTimeout(()=>{var C;const b=c.querySelector("#parcel-minimap");if(!b)return;const $=m.map(b,{zoomControl:!1,attributionControl:!1,dragging:!1,scrollWheelZoom:!1});if(m.tileLayer("https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}").addTo($),((C=t.latlngs)==null?void 0:C.length)>=3){const M=m.polygon(t.latlngs,{color:"#fff",weight:2,fillColor:"#0172A4",fillOpacity:.4}).addTo($);$.fitBounds(M.getBounds(),{padding:[8,8]})}else $.setView([t.lat,t.lng],14),m.circleMarker([t.lat,t.lng],{radius:8,color:"#fff",weight:2,fillColor:"#0172A4",fillOpacity:.9}).addTo($)},50)}function y(){var m,b,$,C;(m=c.querySelector(".m-period-sel"))==null||m.addEventListener("change",M=>{s=M.target.value,o()}),(b=c.querySelector(".m-step-sel"))==null||b.addEventListener("change",M=>{a=M.target.value,o()}),($=c.querySelector(".m-export-btn"))==null||$.addEventListener("click",()=>Ei(t,i,s)),c.querySelectorAll(".m-chart-svg-wrap").forEach(M=>Ci(M)),c.querySelectorAll(".m-list-row[data-action]").forEach(M=>{M.addEventListener("click",()=>B("Fonctionnalité à venir"))}),c.querySelectorAll(".m-widget-menu").forEach(M=>{M.addEventListener("click",E=>{E.stopPropagation(),B("Options widget")})}),(C=c.querySelector(".m-add-widget-btn"))==null||C.addEventListener("click",gi)}c.querySelectorAll(".m-detail-tab").forEach(m=>{m.addEventListener("click",()=>{c.querySelectorAll(".m-detail-tab").forEach(b=>b.classList.remove("active")),m.classList.add("active"),r=m.dataset.view,o()})}),c.querySelector(".m-detail-back").addEventListener("click",re),c.querySelector("#d-star").addEventListener("click",()=>{l=!l;const m=c.querySelector("#d-star");m.querySelector("i").className=l?"bi bi-star-fill":"bi bi-star",m.style.color=l?"#f5c842":"",B(l?"Ajouté aux favoris":"Retiré des favoris")}),c.querySelector("#d-plus").addEventListener("click",()=>{const m=`
      ...
      <a class="m-sheet-link" data-a="traitement"><i class="bi bi-eyedropper"></i> Traitement</a>`,b=document.createElement("div");b.innerHTML=m;const $=U({title:"Ajouter à la parcelle",body:b,doneLabel:"Fermer",onDone:()=>{}});b.querySelectorAll("[data-a]").forEach(C=>{C.addEventListener("click",()=>{const M=C.dataset.a;$.classList.remove("m-sheet-overlay--show"),setTimeout(()=>{$.remove(),B(M==="integration"?"Disponible sur la version web":"Fonctionnalité à venir")},280)})})}),o()}const vt=Object.freeze(Object.defineProperty({__proto__:null,initParcelDetail:Fe},Symbol.toStringTag,{value:"Module"})),we=100,ki={pluie:["P+","PT","P"],vent:["W"],par:["PAR"],humectation:["LWS"]};function $e(t,i){const e=ki[i];return e?z.some(n=>n.parcelId===t.id&&e.includes(n.model)):!0}const Me=[{id:"pluie",label:"Pluie",unit:"mm",aggs:["Aujourd'hui","Hier","7 derniers jours","30 jours"],defaultAgg:"7 derniers jours"},{id:"irrigation",label:"Irrigations",unit:"mm",aggs:["30 derniers jours","7 derniers jours","Aujourd'hui","Demain","7 prochains jours","30 prochains jours","Toute la saison"],defaultAgg:"Aujourd'hui"},{id:"etp",label:"Évapotranspiration",unit:"mm",aggs:["Aujourd'hui","7 derniers jours"],defaultAgg:"Aujourd'hui"},{id:"temp",label:"Température air",unit:"°C",aggs:["Actuel","Min du jour","Max du jour"],defaultAgg:"Actuel"},{id:"temp_rosee",label:"Température de rosée",unit:"°C",aggs:["Actuel"],defaultAgg:"Actuel"},{id:"rayonnement",label:"Rayonnement solaire",unit:"W/m²",aggs:["Actuel","Journalier"],defaultAgg:"Actuel"},{id:"rfu",label:"Réservoir",unit:"mm",aggs:["Actuel"],defaultAgg:"Actuel"},{id:"hum",label:"Humidité",unit:"%",aggs:["Actuel","Moyenne du jour"],defaultAgg:"Actuel"},{id:"vent",label:"Vent",unit:"km/h",aggs:["Actuel","Moyen du jour","Rafales"],defaultAgg:"Actuel"},{id:"par",label:"Rayonnement PAR",unit:"µmol/m²/s",aggs:["Actuel","Journalier"],defaultAgg:"Actuel"},{id:"humectation",label:"Humectation foliaire",unit:"%",aggs:["Actuel","Heures du jour"],defaultAgg:"Actuel"}];function Pi(t){switch(t){case"irrigation":return Math.round(Math.random()>.4?Math.random()*45:0);case"pluie":return+(Math.random()*50).toFixed(1);case"etp":return+(Math.random()*8).toFixed(1);case"temp":return+(8+Math.random()*22).toFixed(1);case"temp_rosee":return+(2+Math.random()*14).toFixed(1);case"rayonnement":return Math.round(Math.random()*900);case"rfu":return Math.round(20+Math.random()*110);case"hum":return Math.round(40+Math.random()*55);case"vent":return+(Math.random()*40).toFixed(1);case"par":return Math.round(Math.random()*1800);case"humectation":return Math.round(Math.random()*100);default:return+(Math.random()*100).toFixed(1)}}function Ii(t,i){let e=t.querySelector("#parcelles-content");e||(e=document.createElement("div"),e.id="parcelles-content",t.appendChild(e));const n=i==="admin",r=J.filter(E=>E.id!==we);Object.fromEntries(J.map(E=>[E.id,E]));let s=null,a=null;const l={};let d="carte",c="pluie",o="7 derniers jours",v="all";function y(E){const A=`${E}-${c}-${o}`;return A in l||(l[A]=Pi(c)),l[A]}function m(){return n?v==="all"?F:v===String(we)?F.filter(E=>E.orgId===we):F.filter(E=>String(E.orgId)===v):F.filter(E=>E.orgId===1)}function b(){if(s){try{s.remove()}catch{}s=null,a=null}}function $(){b();const E=Me.find(u=>u.id===c)||Me[0],A=m(),T=n?`
      <select class="m-filter-select" id="org-filter">
        <option value="all">Toutes les organisations</option>
        <option value="${we}"${v===String(we)?" selected":""}>Breiz'Agri Conseil (réseau)</option>
        ${r.map(u=>`<option value="${u.id}"${v===String(u.id)?" selected":""}>${u.name}</option>`).join("")}
      </select>`:"",k=[...A].sort((u,p)=>{const h=$e(u,c),g=$e(p,c);return h&&!g?-1:!h&&g?1:h?y(p.id)-y(u.id):0}),f=k.length?`<div class="m-plain-list">${k.map(u=>{const p=[u.crop,u.irrigation].filter(Boolean).join(" · "),h=$e(u,c);return`
            <div class="m-plain-row m-tappable" data-plot-id="${u.id}">
              ...
              <div style="display:flex;align-items:center;gap:6px">
                <span class="m-plain-data${h?"":" m-plain-na"}">${h?`${y(u.id)} ${E.unit}`:"—"}</span>
      ...
      <div class="m-screen-controls">
        ...
        <div class="m-filter-row">
          <select class="m-filter-select" id="metric-sel">
            ${Me.map(u=>`<option value="${u.id}"${u.id===c?" selected":""}>${u.label}</option>`).join("")}
          </select>
          <select class="m-filter-select" id="agg-sel">
            ${E.aggs.map(u=>`<option${u===o?" selected":""}>${u}</option>`).join("")}
          </select>
        </div>
        ${T}
      </div>
      ${d==="carte"?'<div class="m-map-view"><div id="parcel-map" class="m-map-container"></div></div>':`<div class="m-list-view">${f}</div>`}`,M(),d==="carte"&&C(A,E)}function C(E,A){const T=window.L;T&&setTimeout(()=>{const k=e.querySelector("#parcel-map");if(!k)return;s=T.map(k,{zoomControl:!1,attributionControl:!1}),T.tileLayer("https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}").addTo(s);const f=[];E.forEach(u=>{const p=$e(u,c)?`${y(u.id)} ${A.unit}`:"—",h=z.filter(j=>j.parcelId===u.id).map(j=>j.id),g=()=>Fe(u,h),w=[u.lat,u.lng];u.latlngs&&u.latlngs.length>=3?(T.polygon(u.latlngs,{color:"#fff",weight:2,fillColor:"#0172A4",fillOpacity:.35}).addTo(s).on("click",g),f.push(...u.latlngs)):f.push(w);const x=$e(u,c),S=T.circleMarker(w,{radius:x?8:6,color:"#fff",weight:2,fillColor:"#0172A4",fillOpacity:x?.95:.4}).addTo(s);x&&S.bindTooltip(p,{permanent:!0,direction:"top",className:"m-map-tip",interactive:!0}),S.on("click",g)}),f.length&&(a=f,s.fitBounds(f,{padding:[32,32]})),s.invalidateSize()},0)}window.addEventListener("m-tab-change",E=>{E.detail==="parcelles"&&d==="carte"&&s&&setTimeout(()=>{s.invalidateSize(),a!=null&&a.length&&s.fitBounds(a,{padding:[32,32]})},50)});function M(){var E,A,T;e.querySelectorAll(".m-view-btn").forEach(k=>k.addEventListener("click",()=>{d=k.dataset.view,$()})),(E=e.querySelector("#metric-sel"))==null||E.addEventListener("change",k=>{var f;c=k.target.value,o=((f=Me.find(u=>u.id===c))==null?void 0:f.defaultAgg)||"",$()}),(A=e.querySelector("#agg-sel"))==null||A.addEventListener("change",k=>{o=k.target.value,$()}),(T=e.querySelector("#org-filter"))==null||T.addEventListener("change",k=>{v=k.target.value,$()}),e.querySelectorAll(".m-tappable[data-plot-id]").forEach(k=>{k.addEventListener("click",()=>{const f=F.find(p=>p.id===+k.dataset.plotId);if(!f)return;const u=z.filter(p=>p.parcelId===f.id).map(p=>p.id);Fe(f,u)})})}$()}const Ct={"P+":"Station météo",PT:"Station météo",P:"Pluviomètre",SMV:"Station météo virtuelle",TH:"Thermo-hygromètre",T_MINI:"Thermomètre de sol",W:"Anémomètre",PYRANO:"Pyranomètre",PAR:"Capteur PAR",LWS:"Humectation foliaire",T_GEL:"Capteur gel","CHP-15/30":"Tensiomètre","CHP-30/60":"Tensiomètre","CHP-60/90":"Tensiomètre","CAPA-30-3":"Sonde capacitive","CAPA-60-6":"Sonde capacitive",EC:"Sonde fertirrigation"},qi={"P+":"Weenat",PT:"Weenat",P:"Weenat",TH:"Weenat",W:"Weenat",PYRANO:"Weenat",T_MINI:"Weenat",T_GEL:"Weenat",LWS:"Weenat","CHP-15/30":"CoRHIZE","CHP-30/60":"CoRHIZE","CHP-60/90":"CoRHIZE","CAPA-30-3":"CoRHIZE","CAPA-60-6":"CoRHIZE",EC:"CoRHIZE",SMV:"Weenat (virtuel)"},St={"P+":[{id:"pluie",label:"Pluie",unit:"mm",color:"#45b7d1",cumul:!0,cumulsType:"pluie"},{id:"temp",label:"Température",unit:"°C",color:"#e07050",cumul:!1,cumulsType:"temp"},{id:"humidite",label:"Humidité",unit:"%",color:"#4ecdc4",cumul:!1}],PT:[{id:"pluie",label:"Pluie",unit:"mm",color:"#45b7d1",cumul:!0,cumulsType:"pluie"},{id:"temp",label:"Température",unit:"°C",color:"#e07050",cumul:!1,cumulsType:"temp"}],P:[{id:"pluie",label:"Pluie",unit:"mm",color:"#45b7d1",cumul:!0,cumulsType:"pluie"}],SMV:[{id:"pluie",label:"Pluie",unit:"mm",color:"#45b7d1",cumul:!0,cumulsType:"pluie"},{id:"temp",label:"Température",unit:"°C",color:"#e07050",cumul:!1,cumulsType:"temp"},{id:"humidite",label:"Humidité",unit:"%",color:"#4ecdc4",cumul:!1}],TH:[{id:"temp",label:"Température",unit:"°C",color:"#e07050",cumul:!1,cumulsType:"temp"},{id:"humidite",label:"Humidité",unit:"%",color:"#4ecdc4",cumul:!1}],T_MINI:[{id:"temp_sol",label:"Température sol",unit:"°C",color:"#bb8fce",cumul:!1}],T_GEL:[{id:"tseche",label:"Température sèche",unit:"°C",color:"#e07050",cumul:!1},{id:"thumide",label:"Température humide",unit:"°C",color:"#80c8e8",cumul:!1}],W:[{id:"vent",label:"Vent",unit:"km/h",color:"#82b8e0",cumul:!1}],PYRANO:[{id:"rayonnement",label:"Rayonnement solaire",unit:"W/m²",color:"#f5c842",cumul:!1,cumulsType:"rayo"}],PAR:[{id:"par",label:"Rayonnement PAR",unit:"µmol/m²/s",color:"#a0d070",cumul:!1}],LWS:[{id:"humectation",label:"Humectation foliaire",unit:"%",color:"#60a090",cumul:!1,cumulsType:"hws"}],"CHP-15/30":[{id:"pothydr",label:"Potentiel hydrique",unit:"kPa",color:"#5b8dd9",cumul:!1},{id:"temp_sol",label:"Température sol",unit:"°C",color:"#bb8fce",cumul:!1}],"CHP-30/60":[{id:"pothydr",label:"Potentiel hydrique",unit:"kPa",color:"#5b8dd9",cumul:!1},{id:"temp_sol",label:"Température sol",unit:"°C",color:"#bb8fce",cumul:!1}],"CHP-60/90":[{id:"pothydr",label:"Potentiel hydrique",unit:"kPa",color:"#5b8dd9",cumul:!1},{id:"temp_sol",label:"Température sol",unit:"°C",color:"#bb8fce",cumul:!1}],"CAPA-30-3":[{id:"teneur",label:"Teneur en eau",unit:"%vol",color:"#f0c060",cumul:!1},{id:"temp_sol",label:"Température sol",unit:"°C",color:"#bb8fce",cumul:!1}],"CAPA-60-6":[{id:"teneur",label:"Teneur en eau",unit:"%vol",color:"#f0c060",cumul:!1},{id:"temp_sol",label:"Température sol",unit:"°C",color:"#bb8fce",cumul:!1}],EC:[{id:"teneur",label:"Teneur en eau",unit:"%vol",color:"#f0c060",cumul:!1},{id:"temp_sol",label:"Température sol",unit:"°C",color:"#bb8fce",cumul:!1}]};function Je(t,i){const e={pluie:{base:2,amp:6,min:0,sparse:!0},temp:{base:15,amp:8,min:-5},humidite:{base:65,amp:20,min:20,max:100},pothydr:{base:80,amp:60,min:0,max:200},teneur:{base:30,amp:12,min:5,max:50},temp_sol:{base:14,amp:5,min:0,max:35},tseche:{base:14,amp:6,min:-5},thumide:{base:10,amp:5,min:-8},rayonnement:{base:350,amp:300,min:0,max:900},humectation:{base:20,amp:80,min:0,max:100,sparse:!0},vent:{base:15,amp:15,min:0,max:80},par:{base:900,amp:800,min:0,max:2e3}}[t]||{base:50,amp:20,min:0};return Array.from({length:i},(n,r)=>{const s=r/i*Math.PI*4;if(e.sparse&&Math.random()>.25)return 0;const a=e.base+e.amp*Math.sin(s-1)+(Math.random()-.5)*e.amp*.5;return Math.max(e.min??0,Math.min(e.max??9999,a))})}const Ue={"365d":525600,"30d":43200,"7d":10080,hier:1440,"1d":1440,custom:10080};function ji(t,i,e,n,r,s=20){const a=Ue[t]||10080,l=new Date,d=y=>t==="1d"||t==="hier"?`${String(y.getHours()).padStart(2,"0")}h`:t==="365d"?y.toLocaleDateString("fr-FR",{month:"short"}):`${String(y.getDate()).padStart(2,"0")}/${String(y.getMonth()+1).padStart(2,"0")}`,c=4,o=i-e-n,v=r-s;return Array.from({length:c+1},(y,m)=>{const b=m/c,$=new Date(l.getTime()-(1-b)*a*6e4),C=(e+b*o).toFixed(1),M=m===0?"start":m===c?"end":"middle";return[`<line x1="${C}" y1="${v}" x2="${C}" y2="${v+4}" stroke="rgba(0,0,0,.2)" stroke-width="1"/>`,`<text x="${C}" y="${r-3}" text-anchor="${M}" font-size="9" fill="#8e8e93" font-family="-apple-system">${d($)}</text>`].join("")}).join("")}function Hi(t,i,e,n="7d"){const r=Ze[n]||60,s=Je(t,r),a=320,l=100,d=34,c=6,o=10,v=20,y=a-d-c,m=l-o-v,b=e?0:Math.min(...s),$=Math.max(...s,b+.001),C=$-b,M=x=>d+x/(s.length-1)*y,E=x=>o+m-(x-b)/C*m,A=`g${Math.random().toString(36).slice(2,8)}`,T=[0,.5,1].map(x=>{const S=b+x*C,j=o+m-x*m;return`<text x="${d-3}" y="${(j+3).toFixed(1)}" text-anchor="end" font-size="9" fill="#8e8e93" font-family="-apple-system">${S<10?S.toFixed(1):Math.round(S)}</text>`}).join(""),k=[.25,.5,.75].map(x=>`<line x1="${d}" y1="${(o+m-x*m).toFixed(1)}" x2="${a-c}" y2="${(o+m-x*m).toFixed(1)}" stroke="rgba(0,0,0,.07)" stroke-width="1" stroke-dasharray="3,3"/>`).join(""),f=`<line x1="${d}" y1="${o+m}" x2="${a-c}" y2="${o+m}" stroke="rgba(0,0,0,.12)" stroke-width="1"/>`,u=ji(n,a,d,c,l);if(e){const x=y/s.length*.7;return`<svg viewBox="0 0 ${a} ${l}" width="100%" height="${l}" preserveAspectRatio="none">
      ${T}${k}${f}
      ${s.map((S,j)=>{const G=(S-b)/C*m,me=o+m-G;return`<rect x="${(M(j)-x/2).toFixed(1)}" y="${me.toFixed(1)}" width="${x.toFixed(1)}" height="${G.toFixed(1)}" fill="${i}" opacity=".75" rx="1"/>`}).join("")}
      ${u}
    </svg>`}const h=s.map((x,S)=>[M(S),E(x)]).map(([x,S],j)=>`${j?"L":"M"}${x.toFixed(1)},${S.toFixed(1)}`).join(" "),g=`${h} L${M(s.length-1).toFixed(1)},${(o+m).toFixed(1)} L${d},${(o+m).toFixed(1)} Z`;return`<div class="m-chart-svg-wrap" data-chart="${encodeURIComponent(JSON.stringify({vals:s.map(x=>+x.toFixed(2)),minV:+b.toFixed(2),maxV:+$.toFixed(2)}))}" data-color="${i}" style="position:relative">
    <svg viewBox="0 0 ${a} ${l}" width="100%" height="${l}" preserveAspectRatio="none">
      <defs><linearGradient id="${A}" x1="0" y1="0" x2="0" y2="1">
        <stop offset="0%" stop-color="${i}" stop-opacity=".25"/>
        <stop offset="100%" stop-color="${i}" stop-opacity=".02"/>
    ...
    <div class="m-chart-crosshair" style="display:none"></div>
    <div class="m-chart-tip" style="display:none"></div>
  </div>`}function _i(t){const i=JSON.parse(decodeURIComponent(t.dataset.chart||"{}"));if(!i.vals)return;const{vals:e}=i,n=t.querySelector(".m-chart-tip"),r=t.querySelector(".m-chart-crosshair"),s=t.dataset.color||"#0172A4";function a(d){const c=t.getBoundingClientRect(),o=Math.max(0,Math.min(1,(d-c.left)/c.width)),v=Math.round(o*(e.length-1)),y=e[v],m=o*100;r.style.cssText=`display:block;position:absolute;top:0;bottom:20px;left:${m}%;width:1px;background:${s};opacity:.5`,n.style.cssText=`display:block;position:absolute;top:8px;left:${Math.min(m,75)}%;background:#1a1a1a;color:#fff;font-size:12px;font-weight:700;padding:3px 8px;border-radius:6px;white-space:nowrap;pointer-events:none`,n.textContent=y<10?y.toFixed(1):String(Math.round(y))}function l(){r.style.display="none",n.style.display="none"}t.addEventListener("pointermove",d=>{d.preventDefault(),a(d.clientX)}),t.addEventListener("pointerdown",d=>a(d.clientX)),t.addEventListener("pointerup",l),t.addEventListener("pointerleave",l),t.style.cursor="crosshair"}const Ze={"365d":52,"30d":60,"7d":84,hier:48,"1d":24,custom:60};function Di(t,i,e){if(!e)return"";const n=Ze[i]||60,s=(Ue[i]||10080)/(n*60),a=Je(t,n);let l=[];if(e==="temp"){const d=a.reduce((o,v)=>o+Math.max(0,v),0)*(s/24),c=a.filter(o=>o<7).length*s;l=[{label:"Degrés jours",val:`${Math.round(d)} DJ`},{label:"Heures de froid",val:`${Math.round(c)} h`}]}else if(e==="pluie")l=[{label:"Cumul pluie",val:`${a.reduce((c,o)=>c+o,0).toFixed(1)} mm`}];else if(e==="rayo"){const d=a.filter(c=>c>120).length*s;l=[{label:"Ensoleillement",val:`${Math.round(d)} h`}]}else if(e==="hws"){const d=a.filter(c=>c>50).length*s;l=[{label:"Heures d'humectation",val:`${Math.round(d)} h`}]}return l.length?`<div class="m-chart-cumuls">${l.map(d=>`<div class="m-chart-cumul-chip">
      <span class="m-chart-cumul-label">${d.label}</span>
      <span class="m-chart-cumul-val">${d.val}</span>
    </div>`).join("")}</div>`:""}function Ri(t,i){const e=new Blob(["\uFEFF"+t],{type:"text/csv;charset=utf-8;"}),n=Object.assign(document.createElement("a"),{href:URL.createObjectURL(e),download:i});document.body.appendChild(n),n.click(),document.body.removeChild(n),setTimeout(()=>URL.revokeObjectURL(n.href),100)}function Bi(t,i){const e=St[t.model]||[];if(!e.length)return;const n=Ze[i]||60,r=Ue[i]||10080,s=r/n*6e4,a=new Date,l=new Date(a-r*6e4),d=["Horodatage",...e.map(o=>`${o.label} (${o.unit})`)].join(";"),c=Array.from({length:n},(o,v)=>[new Date(l.getTime()+v*s).toISOString().replace("T"," ").slice(0,19),...e.map(m=>Je(m.id,1)[0].toFixed(2))].join(";"));Ri([d,...c].join(`\r
`),`${t.serial}_${i}_${new Date().toISOString().slice(0,10)}.csv`)}function Fi(t,i="7d",e="1h"){const n=St[t.model]||[];if(!n.length)return'<div class="m-empty-state"><i class="bi bi-broadcast"></i><p>Aucune donnée disponible</p></div>';const r=n.map(s=>`
      <div class="m-chart-card">
        <div class="m-chart-card-hd">
          <span class="m-chart-label" style="color:${s.color}">${s.label}</span>
        </div>
        ${Hi(s.id,s.color,s.cumul,i)}
        ${Di(s.id,i,s.cumulsType)}
      </div>`).join("");return`
    <div class="m-period-bar">
      <select class="m-period-sel">
        <option value="365d"${i==="365d"?" selected":""}>365 jours</option>
    ...
    <div class="m-detail-section">${r}</div>`}function Oi(t){const i=t.parcelId?F.find(a=>a.id===t.parcelId):null,e=i?J.find(a=>a.id===i.orgId):null,n=t.networkQuality||0,r=n>70?"#30d158":n>40?"#ff9f0a":"#ff3b30",s=t.event?[t.event]:[];return`
    <div class="m-detail-section">
      <div class="m-list-section-header">Identification</div>
      <div class="m-list">
        <div class="m-list-row">
      ...
      <div class="m-list">
        ${s.length?s.map(a=>`<div class="m-list-row"><i class="bi bi-exclamation-triangle-fill" style="color:#ff3b30"></i><span class="m-list-row-label" style="color:#ff3b30">${a}</span></div>`).join(""):'<div class="m-list-row"><i class="bi bi-check-circle-fill" style="color:#30d158"></i><span class="m-list-row-label">Aucun événement en cours</span></div>'}
        <div class="m-list-row">
          <span class="m-list-row-label">Qualité du signal</span>
          <span class="m-list-row-value" style="color:${r};font-weight:600">${n}%</span>
        </div>
        <div class="m-list-row m-list-row--last">
      ...
      <div style="height:24px"></div>
    </div>`}function Oe(t,i="donnees"){var y;const e=t.parcelId?F.find(m=>m.id===t.parcelId):null;let n=i,r="7d",s="1h",a=!1;const l=e&&((y=J.find(m=>m.id===e.orgId))==null?void 0:y.ville)||"",d=xe(`
    <div class="m-detail-header">
      <div class="m-detail-topbar">
      ...
      <div class="m-detail-identity">
        ...
        <div class="m-detail-title-block">
          ...
          <div class="m-detail-subtitle">${[Ct[t.model]||t.model,l].filter(Boolean).join(" · ")}</div>
        </div>
      </div>
    </div>
    <div class="m-detail-tabs">
    ...
    <div id="detail-content" class="m-detail-content"></div>`);function c(){const m=d.querySelector("#detail-content");n==="donnees"&&(m.innerHTML=Fi(t,r,s)),n==="params"&&(m.innerHTML=Oi(t),o()),v()}function o(){const m=window.L;!m||!e||setTimeout(()=>{const b=d.querySelector("#sensor-minimap");if(!b)return;const $=m.map(b,{zoomControl:!1,attributionControl:!1,dragging:!1,scrollWheelZoom:!1});m.tileLayer("https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}").addTo($),$.setView([e.lat,e.lng],15),m.circleMarker([e.lat,e.lng],{radius:9,color:"#fff",weight:2,fillColor:"#5b8dd9",fillOpacity:.9}).addTo($)},50)}function v(){var m,b,$;(m=d.querySelector(".m-period-sel"))==null||m.addEventListener("change",C=>{r=C.target.value,c()}),(b=d.querySelector(".m-step-sel"))==null||b.addEventListener("change",C=>{s=C.target.value,c()}),($=d.querySelector(".m-export-btn"))==null||$.addEventListener("click",()=>Bi(t,r)),d.querySelectorAll(".m-chart-svg-wrap").forEach(C=>_i(C)),d.querySelectorAll(".m-list-row[data-action]").forEach(C=>{C.addEventListener("click",()=>B("Fonctionnalité à venir"))})}d.querySelectorAll(".m-detail-tab").forEach(m=>{m.addEventListener("click",()=>{d.querySelectorAll(".m-detail-tab").forEach(b=>b.classList.remove("active")),m.classList.add("active"),n=m.dataset.view,c()})}),d.querySelector(".m-detail-back").addEventListener("click",re),d.querySelector("#d-star").addEventListener("click",()=>{a=!a;const m=d.querySelector("#d-star");m.querySelector("i").className=a?"bi bi-star-fill":"bi bi-star",m.style.color=a?"#f5c842":"",B(a?"Ajouté aux favoris":"Retiré des favoris")}),d.querySelector("#d-plus").addEventListener("click",()=>{const m=`
      ...
      <button class="m-sheet-option" data-a="traitement"><i class="bi bi-eyedropper"></i> Traitement</button>`,b=document.createElement("div");b.innerHTML=m;const $=U({title:"Ajouter au capteur",body:b,doneLabel:"Fermer",onDone:()=>{}});b.querySelectorAll("[data-a]").forEach(C=>{C.addEventListener("click",()=>{$.classList.remove("m-sheet-overlay--show"),setTimeout(()=>{$.remove(),B("Fonctionnalité à venir")},280)})})}),c()}const zi=Object.freeze(Object.defineProperty({__proto__:null,initSensorDetail:Oe},Symbol.toStringTag,{value:"Module"})),fe=100,ht=1,De=["P+","PT","P","SMV","TH","W","PYRANO","T_GEL"],Ni={"P+":"Station météo",PT:"Station météo",P:"Pluviomètre",SMV:"Station météo virtuelle",TH:"Thermo-hygromètre",T_MINI:"Thermomètre de sol",W:"Anémomètre",PYRANO:"Pyranomètre",PAR:"Capteur PAR",LWS:"Humectation foliaire",T_GEL:"Capteur gel","CHP-15/30":"Tensiomètre","CHP-30/60":"Tensiomètre","CHP-60/90":"Tensiomètre","CAPA-30-3":"Sonde capacitive","CAPA-60-6":"Sonde capacitive",EC:"Sonde fertirrigation"},Vi={"P+":["pluie","temp","hum"],PT:["pluie","temp"],P:["pluie"],SMV:["pluie","temp","hum"],TH:["temp","hum"],T_MINI:["temp_sol"],W:["vent"],PYRANO:["rayonnement"],PAR:["par"],LWS:["humectation"],T_GEL:["temp_sche","temp_hum"],"CHP-15/30":["pothydr","temp_sol"],"CHP-30/60":["pothydr","temp_sol"],"CHP-60/90":["pothydr","temp_sol"],"CAPA-30-3":["teneur","temp_sol"],"CAPA-60-6":["teneur","temp_sol"],EC:["teneur","temp_sol"]};function Ee(t,i){return(Vi[t]||[]).includes(i)}function Wi(t){return Ni[t]||t}const Ae=[{id:"pluie",label:"Pluie",unit:"mm",aggs:["Aujourd'hui","Hier","7 jours","30 jours","1 an"],defaultAgg:"7 jours"},{id:"temp",label:"Température",unit:"°C",aggs:["Actuel","Min du jour","Max du jour","Moy. 7 jours","Moy. 30 jours"],defaultAgg:"Actuel"},{id:"hum",label:"Humidité",unit:"%",aggs:["Actuel","Min du jour","Max du jour","Moy. 7 jours","Moy. 30 jours"],defaultAgg:"Actuel"},{id:"pothydr",label:"Potentiel hydrique",unit:"kPa",aggs:["Actuel","Min du jour","Max du jour","Moy. 7 jours"],defaultAgg:"Actuel"},{id:"teneur",label:"Teneur en eau du sol",unit:"%vol",aggs:["Actuel","Min du jour","Max du jour","Moy. 7 jours"],defaultAgg:"Actuel"},{id:"temp_sol",label:"Température du sol",unit:"°C",aggs:["Actuel","Min du jour","Max du jour","Moy. 7 jours"],defaultAgg:"Actuel"},{id:"temp_sche",label:"Température sèche",unit:"°C",aggs:["Actuel","Min du jour","Max du jour","Moy. 7 jours"],defaultAgg:"Actuel"},{id:"temp_hum",label:"Température humide",unit:"°C",aggs:["Actuel","Min du jour","Max du jour","Moy. 7 jours"],defaultAgg:"Actuel"},{id:"rayonnement",label:"Rayonnement solaire",unit:"W/m²",aggs:["Actuel","Journalier"],defaultAgg:"Actuel"},{id:"par",label:"Rayonnement PAR",unit:"µmol/m²/s",aggs:["Actuel","Journalier"],defaultAgg:"Actuel"},{id:"vent",label:"Vent",unit:"km/h",aggs:["Actuel","Moyen du jour","Rafales"],defaultAgg:"Actuel"},{id:"humectation",label:"Humectation foliaire",unit:"%",aggs:["Actuel","Heures du jour"],defaultAgg:"Actuel"}];function Gi(t){switch(t){case"pluie":return+(Math.random()*50).toFixed(1);case"temp":return+(8+Math.random()*22).toFixed(1);case"hum":return Math.round(40+Math.random()*55);case"pothydr":return Math.round(10+Math.random()*180);case"teneur":return+(10+Math.random()*35).toFixed(1);case"temp_sol":return+(5+Math.random()*20).toFixed(1);case"temp_sche":return+(8+Math.random()*20).toFixed(1);case"temp_hum":return+(4+Math.random()*18).toFixed(1);case"rayonnement":return Math.round(Math.random()*900);case"par":return Math.round(Math.random()*1800);case"vent":return+(Math.random()*40).toFixed(1);case"humectation":return Math.round(Math.random()*100);default:return+(Math.random()*100).toFixed(1)}}function Ji(t,i){let e=t.querySelector("#capteurs-content");e||(e=document.createElement("div"),e.id="capteurs-content",t.appendChild(e));const n=i==="admin",r=J.filter(f=>f.id!==fe),s=Object.fromEntries(F.map(f=>[f.id,f])),a=Object.fromEntries(J.map(f=>[f.id,f]));let l=null,d=null;const c={};let o="carte",v="pluie",y="7 derniers jours",m="all";function b(f){const u=`${f}-${v}-${y}`;return u in c||(c[u]=Gi(v)),c[u]}function $(){if(n){if(m==="all")return z;if(m===String(fe)){const g=new Set(F.filter(w=>w.orgId===fe).map(w=>w.id));return z.filter(w=>g.has(w.parcelId))}const h=new Set(F.filter(g=>String(g.orgId)===m).map(g=>g.id));return z.filter(g=>h.has(g.parcelId))}const f=new Set(F.filter(h=>h.orgId===ht).map(h=>h.id)),u=z.filter(h=>f.has(h.parcelId)),p=z.filter(h=>!f.has(h.parcelId)&&De.includes(h.model));return m==="mine"?u:m==="network"?p:[...u,...p]}function C(f){const u=f.parcelId?s[f.parcelId]:null;if(!u)return null;const p=(f.id*7919%1e3-500)/1e6,h=(f.id*6271%1e3-500)/1e6;return{lat:u.lat+p,lng:u.lng+h,name:u.name}}function M(f){var p;const u=f.parcelId?s[f.parcelId]:null;return u&&((p=a[u.orgId])==null?void 0:p.ville)||null}function E(){if(l){try{l.remove()}catch{}l=null,d=null}}function A(){E();const f=Ae.find(w=>w.id===v)||Ae[0],u=$();let p;if(n)p=`
        ...
        </select>`;else{const w=J.find(S=>S.id===ht),x=J.find(S=>S.id===fe);p=`
        <select class="m-filter-select" id="org-filter">
          ...
          <option value="network"${m==="network"?" selected":""}>${(x==null?void 0:x.name)||"Breiz'Agri Conseil"}</option>
        </select>`}const h=[...u].sort((w,x)=>{const S=Ee(w.model,v),j=Ee(x.model,v);return S&&!j?-1:!S&&j?1:S?b(x.id)-b(w.id):0}),g=h.length?`<div class="m-plain-list">${h.map(w=>{const x=De.includes(w.model),j=Ee(w.model,v)?`<span class="m-sensor-val">${b(w.id)} ${f.unit}</span>`:'<span class="m-sensor-val m-sensor-val--na">—</span>';return`
            <div class="m-sensor-row m-tappable" data-sensor-id="${w.id}">
              ...
              <div class="m-sensor-info">
                ...
                <span class="m-sensor-sub">${w.serial}${M(w)?` · ${M(w)}`:""}</span>
              </div>
              ${j}
      ...
      <div class="m-screen-controls">
        ...
        <div class="m-filter-row">
          <select class="m-filter-select" id="metric-sel">
            ${Ae.map(w=>`<option value="${w.id}"${w.id===v?" selected":""}>${w.label}</option>`).join("")}
          </select>
          <select class="m-filter-select" id="agg-sel">
      ...
      ${o==="carte"?'<div class="m-map-view"><div id="sensor-map" class="m-map-container"></div></div>':`<div class="m-list-view">${g}</div>`}`,k(),o==="carte"&&T(u,f)}function T(f,u){const p=window.L;p&&setTimeout(()=>{const h=e.querySelector("#sensor-map");if(!h)return;l=p.map(h,{zoomControl:!1,attributionControl:!1}),p.tileLayer("https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}").addTo(l);const g=[];f.forEach(w=>{const x=C(w);if(!x)return;const S=Ee(w.model,v),j=De.includes(w.model),G=p.circleMarker([x.lat,x.lng],{radius:S?10:7,color:"#fff",weight:2,fillColor:j?"#0172A4":"#5b8dd9",fillOpacity:S?.95:.45}).addTo(l);S&&G.bindTooltip(`${b(w.id)} ${u.unit}`,{permanent:!0,direction:"top",className:"m-map-tip",interactive:!0}),G.on("click",()=>Oe(w)),g.push([x.lat,x.lng])}),g.length&&(d=g,l.fitBounds(g,{padding:[32,32]})),l.invalidateSize()},0)}window.addEventListener("m-tab-change",f=>{f.detail==="capteurs"&&o==="carte"&&l&&setTimeout(()=>{l.invalidateSize(),d!=null&&d.length&&l.fitBounds(d,{padding:[32,32]})},50)});function k(){var f,u,p;e.querySelectorAll(".m-view-btn").forEach(h=>h.addEventListener("click",()=>{o=h.dataset.view,A()})),(f=e.querySelector("#metric-sel"))==null||f.addEventListener("change",h=>{var g;v=h.target.value,y=((g=Ae.find(w=>w.id===v))==null?void 0:g.defaultAgg)||"",A()}),(u=e.querySelector("#agg-sel"))==null||u.addEventListener("change",h=>{y=h.target.value,A()}),(p=e.querySelector("#org-filter"))==null||p.addEventListener("change",h=>{m=h.target.value,A()}),e.querySelectorAll(".m-tappable[data-sensor-id]").forEach(h=>{h.addEventListener("click",()=>{const g=z.find(w=>w.id===+h.dataset.sensorId);g&&Oe(g)})})}A()}const Re=100,ft=1,Ui=["Arboriculture","Viticulture","Maraîchage","Grandes cultures","Polyculture-Élevage","Pépiniériste","Floriculture","Trufficulture","Organismes publics / semi-publics","Coopérative","Négoce","Concessionnaire","Semencier","Laboratoire / Institut / Recherche","Autre"],Zi=["Essentiel","Plus","Expert"],Yi=["Administrateur","Agent","Lecteur"];function Xi(t){const i=(t||"").match(/(\d{5})/);if(i){const e=t.indexOf(i[0]);return{rue:t.slice(0,e).trim().replace(/,\s*$/,""),cp:i[0],ville:t.slice(e+5).trim().replace(/^,?\s*/,"")}}return{rue:t||"",cp:"",ville:""}}function bt({rue:t,cp:i,ville:e}){return[t,i&&e?`${i} ${e}`:i||e].filter(Boolean).join(", ")}function Ki(t){const[i,e,n]=t.split("-");return`${n}/${e}/${i}`}function Qi(t,i){if(!t)return{};const e=i==="admin",n=J.find(u=>u.id===(e?Re:ft));if(!n)return{};const s=(e?Ie.filter(u=>{var p;return!((p=u.orgIds)!=null&&p.length)||u.orgIds.includes(Re)}):Ie.filter(u=>{var p;return(p=u.orgIds)==null?void 0:p.includes(ft)})).map(u=>({...u})),a=J.filter(u=>u.id!==Re&&u.statut!=="inactif").length,l=Xi(n.adresse||""),d={rue:"",cp:"",ville:""},c={name:n.name,metiers:[e?"Coopérative":"Grandes cultures"],adresseFactu:l,adresseLivrai:d,markerLat:n.lat||48.117,markerLng:n.lng||-1.678,plan:n.plan||"Plus",contrat:{numero:e?"CTR-NET-2022-00001":n.codeAdherent||"CTR-2022-00418",dateAdhesion:n.dateAdhesion||"2022-03-15",licencesMembres:e?Ie.length:3,licencesAdherents:e?a:null,licencesIntegrations:e?27:2}};let o=null,v=null,y=null;function m(){if(!y)return;const u=t.querySelector(`#${y}`);if(!u)return;if(o){try{o.remove()}catch{}o=null,v=null}const p=window.L;p&&(o=p.map(u,{zoomControl:!0,attributionControl:!1}),p.tileLayer("https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}").addTo(o),o.setView([c.markerLat,c.markerLng],14),v=p.marker([c.markerLat,c.markerLng],{draggable:!0}).addTo(o),v.on("dragend",()=>{const h=v.getLatLng();c.markerLat=h.lat,c.markerLng=h.lng,B("Position mise à jour")}),setTimeout(()=>o==null?void 0:o.invalidateSize(),50))}function b(){if(y=`expl-map-${Math.random().toString(36).slice(2,8)}`,o){try{o.remove()}catch{}o=null,v=null}const u=bt(c.adresseFactu)||"—",p=bt(c.adresseLivrai);t.innerHTML=`
      ...
      <div class="m-list">
        <div class="m-list-row" data-action="adresse-factu">
          ...
          <span class="m-list-row-value" style="text-align:right;max-width:190px;font-size:12px">${u}</span>
          <i class="bi bi-chevron-right m-list-chevron"></i>
        </div>
      ...
      <div class="m-list">
        ${s.length?s.map((h,g)=>`
          <div class="m-list-row${g===s.length-1?" m-list-row--last":""} m-tappable" data-member-idx="${g}">
            <div class="m-list-row-col">
      ...
      <div style="height:32px"></div>`,$()}function $(){t.querySelectorAll(".m-list-row[data-action]").forEach(u=>{u.addEventListener("click",()=>{switch(u.dataset.action){case"name":C("Nom de l'exploitation",c.name,p=>{c.name=p,b()});break;case"metier":E();break;case"adresse-factu":M("Adresse de facturation",c.adresseFactu,p=>{c.adresseFactu=p,b()});break;case"adresse-livrai":M("Adresse de livraison",c.adresseLivrai,p=>{c.adresseLivrai=p,b()});break;case"plan":A("Abonnement",Zi,c.plan,p=>{c.plan=p,b()});break}})}),t.querySelectorAll("[data-member-idx]").forEach(u=>{u.addEventListener("click",()=>T(+u.dataset.memberIdx))})}function C(u,p,h){const g=document.createElement("div");g.innerHTML=`<input class="m-sheet-input" type="text" value="${(p||"").replace(/"/g,"&quot;")}" placeholder="${u}">`;const w=g.querySelector("input");U({title:u,body:g,doneLabel:"Enregistrer",onDone:()=>{const x=w.value.trim();x&&(h(x),B("Enregistré"))}}),setTimeout(()=>w.focus(),300)}function M(u,p,h){const g=document.createElement("div");g.innerHTML=`
      ...
      <input class="m-sheet-input" type="text" placeholder="Ville" id="f-ville" value="${(p.ville||"").replace(/"/g,"&quot;")}">`,U({title:u,body:g,doneLabel:"Enregistrer",onDone:()=>{h({rue:g.querySelector("#f-rue").value.trim(),cp:g.querySelector("#f-cp").value.trim(),ville:g.querySelector("#f-ville").value.trim()}),B("Enregistré")}}),setTimeout(()=>g.querySelector("#f-rue").focus(),300)}function E(){const u=new Set(c.metiers),p=document.createElement("div"),h=()=>{p.innerHTML=Ui.map(g=>`
        <div class="m-sheet-option${u.has(g)?" m-sheet-option--active":""}" data-m="${g}" style="justify-content:space-between">
          <span>${g}</span>
          ${u.has(g)?'<i class="bi bi-check-circle-fill" style="color:#007aff;font-size:16px"></i>':'<i class="bi bi-circle" style="color:#c7c7cc;font-size:16px"></i>'}
        </div>`).join(""),p.querySelectorAll("[data-m]").forEach(g=>{g.addEventListener("click",()=>{const w=g.dataset.m;u.has(w)?u.delete(w):u.add(w),h()})})};h(),U({title:"Métiers",body:p,doneLabel:"Valider",onDone:()=>{c.metiers=[...u],b()}})}function A(u,p,h,g){const w=document.createElement("div");w.innerHTML=p.map((S,j)=>`
      <div class="m-sheet-option${S===h?" m-sheet-option--active":""}" data-i="${j}">
        <span>${S}</span>${S===h?'<i class="bi bi-check" style="color:#007aff;font-size:18px"></i>':""}
      </div>`).join("");const x=U({title:u,body:w,doneLabel:"Fermer",onDone:()=>{}});w.querySelectorAll(".m-sheet-option").forEach(S=>{S.addEventListener("click",()=>{g(p[+S.dataset.i]),x.classList.remove("m-sheet-overlay--show"),setTimeout(()=>x.remove(),280),B("Enregistré")})})}function T(u){const p=s[u];if(!p)return;const h=document.createElement("div");h.innerHTML=`
      <div class="m-sheet-links">
        <a class="m-sheet-link" id="mem-delete" style="color:#ff3b30">Supprimer ${p.prenom} ${p.nom}</a>
      </div>`;const g=U({title:`${p.prenom} ${p.nom}`,body:h,doneLabel:"Fermer",onDone:()=>{}});h.querySelector("#mem-delete").addEventListener("click",()=>{s.splice(u,1),g.classList.remove("m-sheet-overlay--show"),setTimeout(()=>{g.remove(),b()},280),B("Membre retiré")})}function k(){const u=document.createElement("div");u.innerHTML=`
      ...
      </select>`,U({title:"Inviter un membre",body:u,doneLabel:"Envoyer",onDone:()=>B("Invitation envoyée")}),setTimeout(()=>u.querySelector("#inv-email").focus(),300)}b();function f(){requestAnimationFrame(()=>setTimeout(m,100))}return{onAdd:k,refresh:f}}const es=100,ts=["Essentiel","Plus","Expert"],is={actif:{label:"Actif",color:"#30d158"},"actif en essai":{label:"Essai",color:"#ff9f0a"},"invitation en attente":{label:"Invité",color:"#007aff"},"demande en attente":{label:"En attente",color:"#ff9f0a"},inactif:{label:"Inactif",color:"#8e8e93"}};function gt(t){return is[t]||{label:t||"—",color:"#8e8e93"}}function ss(t,i){if(!t)return{};if(i!=="admin")return t.innerHTML='<div class="m-empty-state" style="margin-top:40px"><i class="bi bi-lock"></i><p>Réservé aux administrateurs réseau</p></div>',{};const e=J.filter(a=>a.id!==es).map(a=>({...a}));function n(){const a=e.filter(l=>l.statut!=="inactif");t.innerHTML=`
      <div class="m-list-section-header" style="margin-top:16px">Adhérents — ${a.length} actifs sur ${e.length}</div>
      <div class="m-list">
        ${e.map((l,d)=>{const c=gt(l.statut);return`
      ...
      <div style="height:32px"></div>`,t.querySelectorAll("[data-org-idx]").forEach(l=>{l.addEventListener("click",()=>r(e[+l.dataset.orgIdx],+l.dataset.orgIdx))})}function r(a,l){var m,b;const d=gt(a.statut),c=a.statut==="invitation en attente",o=`https://app.weenat.com/invitation?code=${a.codeAdherent||"ADZ-XXX"}`,v=document.createElement("div");v.innerHTML=`
      <div class="m-sheet-info-rows">
        ...
        <div class="m-sheet-info-row"><span>Parcelles</span><span>${F.filter($=>$.orgId===a.id).length}</span></div>
        <div class="m-sheet-info-row"><span>Capteurs</span><span>${(()=>{const $=new Set(F.filter(C=>C.orgId===a.id).map(C=>C.id));return z.filter(C=>$.has(C.parcelId)).length})()} </span></div>
      ...
      </div>`;const y=U({title:a.name,body:v,doneLabel:"Fermer",onDone:()=>{}});(m=v.querySelector("#lnk-copy"))==null||m.addEventListener("click",()=>{var $;($=navigator.clipboard)==null||$.writeText(o).catch(()=>{}),B("Lien copié !")}),(b=v.querySelector("#lnk-cancel"))==null||b.addEventListener("click",()=>{a.statut="inactif",y.classList.remove("m-sheet-overlay--show"),setTimeout(()=>{y.remove(),n(),B("Invitation annulée")},280)}),v.querySelector("#lnk-delete").addEventListener("click",()=>{e.splice(l,1),y.classList.remove("m-sheet-overlay--show"),setTimeout(()=>{y.remove(),n(),B("Adhérent supprimé")},280)})}function s(){const a=document.createElement("div");a.innerHTML=`
      ...
      </select>`,U({title:"Inviter un adhérent",body:a,doneLabel:"Envoyer",onDone:()=>{const l=a.querySelector("#adh-email").value.trim(),d=a.querySelector("#adh-code").value.trim();if(!l||!d){B("Email et code requis");return}e.push({id:Date.now(),name:l,proprietaire:l,email:l,codeAdherent:d,plan:a.querySelector("#adh-plan").value,statut:"invitation en attente",nbMembres:0}),n(),B("Invitation envoyée")}}),setTimeout(()=>a.querySelector("#adh-email").focus(),300)}return n(),{onAdd:s}}const as=new URLSearchParams(window.location.search),K=as.get("role")==="adherent"?"adherent":"admin";function Lt(){const t=document.getElementById("status-time");if(!t)return;const i=new Date;t.textContent=i.toLocaleTimeString("fr-FR",{hour:"2-digit",minute:"2-digit"})}Lt();setInterval(Lt,1e4);const ne=["dashboard","parcelles","capteurs","alertes","parametres"];let ke="dashboard";function pe(t){var i,e;!ne.includes(t)||t===ke||(ke=t,document.querySelectorAll(".m-screen").forEach(n=>n.classList.remove("active")),document.querySelectorAll(".nav-item").forEach(n=>n.classList.remove("active")),(i=document.getElementById(`screen-${t}`))==null||i.classList.add("active"),(e=document.querySelector(`.nav-item[data-tab="${t}"]`))==null||e.classList.add("active"),window.dispatchEvent(new CustomEvent("m-tab-change",{detail:t})))}function ns(t){var e;(e=document.getElementById("abandon-modal"))==null||e.remove();const i=document.createElement("div");i.id="abandon-modal",i.style.cssText="position:absolute;inset:0;background:rgba(0,0,0,.45);z-index:3000;display:flex;align-items:flex-end",i.innerHTML=`
    ...
    </div>`,document.getElementById("phone-screen").appendChild(i),i.querySelector("#abandon-cancel").addEventListener("click",()=>i.remove()),i.querySelector("#abandon-ok").addEventListener("click",()=>{i.remove(),t()})}document.getElementById("phone-screen").addEventListener("click",t=>{var i;t.target.closest(".m-navbar-logo")&&((i=document.querySelector('.nav-item[data-tab="dashboard"]'))==null||i.click())});document.getElementById("bottom-nav").addEventListener("click",t=>{const i=t.target.closest(".nav-item");if(!i)return;const e=i.dataset.tab;Ke()>0&&kt()?ns(()=>{window.dispatchEvent(new CustomEvent("m-tab-change",{detail:e})),pe(e)}):(Ke()>0&&window.dispatchEvent(new CustomEvent("m-tab-change",{detail:e})),pe(e))});let Y=null,Ce=null;const Mt=50,Se=document.getElementById("screen-stack");Se.addEventListener("mousedown",t=>{if(t.target.closest(".leaflet-container")){Y=null;return}Y=t.clientX,Ce=t.clientY});Se.addEventListener("mouseup",t=>{if(Y===null)return;const i=t.clientX-Y,e=t.clientY-Ce;if(Math.abs(i)>Mt&&Math.abs(i)>Math.abs(e)){const n=ne.indexOf(ke);i<0&&n<ne.length-1&&pe(ne[n+1]),i>0&&n>0&&pe(ne[n-1])}Y=null,Ce=null});Se.addEventListener("mouseleave",()=>{Y=null});Se.addEventListener("touchstart",t=>{if(t.target.closest(".leaflet-container")){Y=null;return}Y=t.touches[0].clientX,Ce=t.touches[0].clientY},{passive:!0});Se.addEventListener("touchend",t=>{if(Y===null)return;const i=t.changedTouches[0].clientX-Y,e=t.changedTouches[0].clientY-Ce;if(Math.abs(i)>Mt&&Math.abs(i)>Math.abs(e)){const n=ne.indexOf(ke);i<0&&n<ne.length-1&&pe(ne[n+1]),i>0&&n>0&&pe(ne[n-1])}Y=null},{passive:!0});const ls=[{id:"param-compte",label:"Mon compte"},{id:"param-exploitation",label:"Mon exploitation"},...K==="admin"?[{id:"param-reseau",label:"Mon réseau"}]:[]],Pe={};function os(t){const i=document.getElementById("param-plus-btn"),e=document.getElementById("param-plus-spacer"),n=Pe[t];i&&e&&(n!=null&&n.onAdd?(i.style.display="",e.style.display="none",i.onclick=n.onAdd):(i.style.display="none",e.style.display=""))}function rs(){var i;const t=document.getElementById("param-segment");t&&(K==="adherent"&&((i=document.getElementById("param-reseau"))==null||i.style.setProperty("display","none")),ls.forEach((e,n)=>{const r=document.createElement("button");r.className="m-segment-btn"+(n===0?" active":""),r.textContent=e.label,r.dataset.target=e.id,r.addEventListener("click",()=>{var s,a,l;t.querySelectorAll(".m-segment-btn").forEach(d=>d.classList.remove("active")),r.classList.add("active"),document.querySelectorAll(".m-subscreen").forEach(d=>d.classList.remove("active")),(s=document.getElementById(e.id))==null||s.classList.add("active"),os(e.id),(l=(a=Pe[e.id])==null?void 0:a.refresh)==null||l.call(a)}),t.appendChild(r)}))}rs();fi(document.getElementById("screen-dashboard"),K);Ii(document.getElementById("screen-parcelles"),K);Ji(document.getElementById("screen-capteurs"),K);Ot(document.getElementById("screen-alertes"),K);_t(document.getElementById("param-compte"),K);Pe["param-exploitation"]=Qi(document.getElementById("param-exploitation"),K);Pe["param-reseau"]=ss(document.getElementById("param-reseau"),K);function cs(){var n;const t=K==="admin",i=document.getElementById("phone-screen");(n=document.getElementById("m-add-modal"))==null||n.remove();const e=document.createElement("div");e.id="m-add-modal",e.style.cssText="position:absolute;inset:0;background:rgba(0,0,0,.45);z-index:3000;display:flex;align-items:flex-end",e.innerHTML=`

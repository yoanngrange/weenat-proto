import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css             */import{o as f}from"./orgs-Cx4wNzLL.js";import{s as b}from"./sensors-C_yA0hbg.js";import{p as h}from"./plots-kiLnwOqV.js";import{n as a}from"./network-YzWdS0n_.js";import{u as y}from"./breadcrumb-DEBQjfiD.js";const e={nom:a.nom,description:a.description,email:a.email,telephone:a.telephone,siteWeb:a.siteWeb,siege:{...a.siege},antennes:a.antennes.map(s=>({...s}))};document.addEventListener("DOMContentLoaded",()=>{y(),g(),l()});const w=["Grand Ouest","Météo Sud","Comptoirs du Nord","Réseaux Landais","Grande Beauce"];function g(){const s=document.getElementById("settings-form-col");s.innerHTML=`

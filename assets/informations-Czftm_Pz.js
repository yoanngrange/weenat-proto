import"./main-DdpHcqUd.js";import{o as v}from"./orgs-b3kLTQ0f.js";import{p as r}from"./plots-2cw7TYeY.js";import{s as p}from"./sensors-DXWoBEPb.js";import{n as s}from"./network-YzWdS0n_.js";import{u as f}from"./breadcrumb-DEBQjfiD.js";document.addEventListener("DOMContentLoaded",()=>{f(),m()});function m(){const o=document.getElementById("network-info"),n=p.length,a=r.length,t=v.length;function i(e){return(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function l(e){return(e||"?").split(/[\s\-']+/).slice(0,2).map(c=>c[0]).join("").toUpperCase().slice(0,2)}const d=s.antennes.map(e=>`

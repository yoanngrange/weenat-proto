import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css             */import{p as oe}from"./plots-DhtWL7s_.js";import{s as F}from"./sensors-CRadjF8G.js";import{o as Ve}from"./orgs-DnFmvGlp.js";import{m as ne}from"./members-Cr98hVG_.js";import{u as xt}from"./breadcrumb-CzFWtd6d.js";import{d as ae,c as Ce}from"./store-c0FlIf2T.js";import{I as O,g as Gt,s as Ct}from"./irrigations-C22Dtsoo.js";import{S as Yt,a as De,E as Jt,I as St}from"./constants-CJpDUNiw.js";const Mt=new URLSearchParams(window.location.search),T=parseInt(Mt.get("id")),S=oe.find(e=>e.id===T);function x(e,t){return Math.floor(Math.random()*(t-e+1))+e}function R(e,t){return parseFloat((Math.random()*(t-e)+e).toFixed(2))}const Ge=[{id:"etp",name:"Évapotranspiration (ETP)",unit:"mm/j",color:"#7DBDD7",base:()=>R(.5,5),cumul:{label:"Cumul d'ETP",unit:"mm"},isCumul:!1,chartType:"bar"},{id:"rayonnement",name:"Rayonnement",unit:"W/m²",color:"#CBCB0B",base:()=>x(0,900),cumul:{label:"Énergie",unit:"Wh/m²"},isCumul:!1},{id:"temp_rosee",name:"Température de rosée",unit:"°C",color:"#72B0D8",base:()=>x(2,16),isCumul:!1}],Ut={id:"irrigation",name:"Irrigation",unit:"mm",color:"#FF8C00",base:()=>0,isCumul:!0,chartType:"bar",isIrrigation:!0},q={"P+":[{id:"pluie",name:"Pluie",unit:"mm",color:"#2E75B6",base:()=>x(0,8),cumul:{label:"Cumul de pluie",unit:"mm"},isCumul:!0,chartType:"bar"},{id:"temp",name:"Température",unit:"°C",color:"#FBAF05",base:()=>x(10,28),cumul:{label:"Cumul de degrés jour",unit:"°j"}},{id:"humidite",name:"Humidité",unit:"%",color:"#5B12A4",base:()=>x(40,90)}],PT:[{id:"pluie",name:"Pluie",unit:"mm",color:"#2E75B6",base:()=>x(0,8),cumul:{label:"Cumul de pluie",unit:"mm"},isCumul:!0,chartType:"bar"},{id:"temp",name:"Température",unit:"°C",color:"#FBAF05",base:()=>x(10,28),cumul:{label:"Cumul de degrés jour",unit:"°j"}},{id:"etp",name:"Évapotranspiration (ETP)",unit:"mm/j",color:"#7DBDD7",base:()=>R(.5,5),cumul:{label:"Cumul ETP",unit:"mm"},isCumul:!1,chartType:"bar"}],P:[{id:"pluie",name:"Pluie",unit:"mm",color:"#2E75B6",base:()=>x(0,8),cumul:{label:"Cumul de pluie",unit:"mm"},isCumul:!0,chartType:"bar"}],SMV:[{id:"pluie",name:"Pluie",unit:"mm",color:"#2E75B6",base:()=>x(0,8),cumul:{label:"Cumul de pluie",unit:"mm"},isCumul:!0,chartType:"bar"},{id:"temp",name:"Température",unit:"°C",color:"#FBAF05",base:()=>x(10,28),cumul:{label:"Cumul de degrés jour",unit:"°j"}},{id:"humidite",name:"Humidité",unit:"%",color:"#5B12A4",base:()=>x(40,90)},{id:"etp",name:"Évapotranspiration (ETP)",unit:"mm/j",color:"#7DBDD7",base:()=>R(.5,5),cumul:{label:"Cumul ETP",unit:"mm"},isCumul:!1,chartType:"bar"}],TH:[{id:"temp",name:"Température",unit:"°C",color:"#FBAF05",base:()=>x(10,28),cumul:{label:"Cumul de degrés jour",unit:"°j"}},{id:"humidite",name:"Humidité",unit:"%",color:"#5B12A4",base:()=>x(40,90)}],"CHP-15/30":[{id:"pothydr",name:"Potentiel hydrique",unit:"kPa",color:"#A6C157",base:()=>x(10,150)},{id:"tsol",name:"Température du sol",unit:"°C",color:"#795548",base:()=>x(8,22)}],"CHP-30/60":[{id:"pothydr",name:"Potentiel hydrique",unit:"kPa",color:"#A6C157",base:()=>x(10,150)},{id:"tsol",name:"Température du sol",unit:"°C",color:"#795548",base:()=>x(8,22)}],"CHP-60/90":[{id:"pothydr",name:"Potentiel hydrique",unit:"kPa",color:"#A6C157",base:()=>x(10,150)},{id:"tsol",name:"Température du sol",unit:"°C",color:"#795548",base:()=>x(8,22)}],"CAPA-30-3":[{id:"vwc10",name:"Teneur en eau du sol 10 cm",unit:"%vol",color:"#105200",base:()=>x(15,45)},{id:"vwc20",name:"Teneur en eau du sol 20 cm",unit:"%vol",color:"#8C5E82",base:()=>x(15,45)},{id:"vwc30",name:"Teneur en eau du sol 30 cm",unit:"%vol",color:"#46DA82",base:()=>x(15,45)},{id:"tsol",name:"Température du sol",unit:"°C",color:"#795548",base:()=>x(8,22)}],"CAPA-60-6":[{id:"vwc10",name:"Teneur en eau du sol 10 cm",unit:"%vol",color:"#105200",base:()=>x(15,45)},{id:"vwc20",name:"Teneur en eau du sol 20 cm",unit:"%vol",color:"#8C5E82",base:()=>x(15,45)},{id:"vwc30",name:"Teneur en eau du sol 30 cm",unit:"%vol",color:"#46DA82",base:()=>x(15,45)},{id:"vwc40",name:"Teneur en eau du sol 40 cm",unit:"%vol",color:"#949494",base:()=>x(17,43)},{id:"vwc50",name:"Teneur en eau du sol 50 cm",unit:"%vol",color:"#870021",base:()=>x(18,42)},{id:"vwc60",name:"Teneur en eau du sol 60 cm",unit:"%vol",color:"#F608C2",base:()=>x(18,42)},{id:"tsol",name:"Température du sol",unit:"°C",color:"#795548",base:()=>x(8,22)}],T_MINI:[{id:"tsol",name:"Température du sol",unit:"°C",color:"#795548",base:()=>x(8,22)}],LWS:[{id:"humec",name:"Humectation foliaire",unit:"h",color:"#00887E",base:()=>x(0,12)}],T_GEL:[{id:"tseche",name:"Temp. sèche",unit:"°C",color:"#23B19B",base:()=>x(-2,12)},{id:"thumide",name:"Temp. humide",unit:"°C",color:"#5E88EC",base:()=>x(-4,10)}],W:[{id:"_vent",name:"Vent",unit:"km/h · direction",color:"#7bc4b0",isWindComposite:!0,base:()=>x(0,40)}],EC:[{id:"ec",name:"Conductivité",unit:"mS/cm",color:"#f0a030",base:()=>R(.1,3)},{id:"tsol",name:"Température du sol",unit:"°C",color:"#bb8fce",base:()=>x(8,22)}],PYRANO:[{id:"rayonnement",name:"Rayonnement",unit:"W/m²",color:"#f5c842",base:()=>x(0,900),cumul:{label:"Énergie",unit:"Wh/m²"}}],PAR:[{id:"par",name:"Densité de flux de photons photosynthétiques",unit:"µmol/m²/s",color:"#c47a00",base:()=>x(0,2e3)}]},_=["CHP-15/30","CHP-30/60","CHP-60/90"],Oe=[{name:"Tensiomètre (CHP)",models:new Set(["CHP-15/30","CHP-30/60","CHP-60/90"])},{name:"Sonde capacitive (CAPA)",models:new Set(["CAPA-30-3","CAPA-60-6"])},{name:"Sonde fertirrigation (EC)",models:new Set(["EC"])},{name:"Thermomètre de sol (T_MINI)",models:new Set(["T_MINI"])}];function Ne(e){return Oe.find(t=>t.models.has(e))||null}const Xt={"CAPA-30-3":[{depth:10,label:"10 cm",vwcColor:"#105200",tsolColor:"#FFA040"},{depth:20,label:"20 cm",vwcColor:"#8C5E82",tsolColor:"#E07050"},{depth:30,label:"30 cm",vwcColor:"#46DA82",tsolColor:"#A04030"}],"CAPA-60-6":[{depth:10,label:"10 cm",vwcColor:"#105200",tsolColor:"#FFA040"},{depth:20,label:"20 cm",vwcColor:"#8C5E82",tsolColor:"#E07050"},{depth:30,label:"30 cm",vwcColor:"#46DA82",tsolColor:"#A04030"},{depth:40,label:"40 cm",vwcColor:"#949494",tsolColor:"#804828"},{depth:50,label:"50 cm",vwcColor:"#870021",tsolColor:"#603818"},{depth:60,label:"60 cm",vwcColor:"#F608C2",tsolColor:"#402810"}]},Ue=["CAPA-30-3","CAPA-60-6"],ee={"P+":"Station météo",PT:"Station météo",P:"Pluviomètre",SMV:"Station météo virtuelle",TH:"Thermomètre-hygromètre",T_MINI:"Thermomètre de sol",W:"Anémomètre",PYRANO:"Pyranomètre",PAR:"Capteur PAR",LWS:"Capteur d'humectation foliaire",T_GEL:"Capteur de gel","CHP-15/30":"Tensiomètre","CHP-30/60":"Tensiomètre","CHP-60/90":"Tensiomètre","CAPA-30-3":"Sonde capacitive","CAPA-60-6":"Sonde capacitive",EC:"Sonde de fertirrigation"};function Kt(e,t=null,i=null,n=null){const a=Math.max(2,Math.min(200,Math.floor(fe()/be()))),s=Array.from({length:a},()=>x(5,35)),c=s.map(k=>Math.min(k+x(3,18),80)),l=Array.from({length:a},()=>x(0,359)),m=600,d=200,f=46,r=16,o=16,p=28,u=m-f-r,h=d-o-p,v=Math.ceil(Math.max(...c)/10)*10||50,$=k=>f+k/Math.max(a-1,1)*u,g=k=>o+h-k/v*h,w=c.map((k,I)=>`${$(I).toFixed(1)},${g(k).toFixed(1)}`).join("L"),y=[...s].reverse().map((k,I)=>`${$(a-1-I).toFixed(1)},${g(k).toFixed(1)}`).join("L"),E=`M${w}L${y}Z`,b=s.map((k,I)=>`${I?"L":"M"}${$(I).toFixed(1)},${g(k).toFixed(1)}`).join(""),C=[.25,.5,.75].map(k=>{const I=(o+h-k*h).toFixed(1);return`<line x1="${f}" y1="${I}" x2="${m-r}" y2="${I}" stroke="rgba(0,0,0,.06)" stroke-width="1" stroke-dasharray="3,3"/>`}).join(""),B=[0,.5,1].map(k=>{const I=o+h-k*h;return`<text x="${f-4}" y="${(I+4).toFixed(1)}" text-anchor="end" font-size="10" fill="var(--txt3)">${Math.round(k*v)}</text>`}).join(""),j=`<line x1="${f}" y1="${o+h}" x2="${m-r}" y2="${o+h}" stroke="var(--bdr2)" stroke-width="1"/>`,A=Math.max(1,Math.floor(a/6));let P="";for(let k=0;k<a;k+=A){const I=(a-1-k)/Math.max(a-1,1)*fe();P+=`<text x="${$(k).toFixed(1)}" y="${(o+h+14).toFixed(1)}" text-anchor="middle" font-size="10" font-family="var(--font)" fill="var(--txt3)">${ge(I)}</text>`}const W=Math.max(1,Math.round(a/25)),Z=[];for(let k=0;k<a;k+=W){const I=$(k).toFixed(1),N=(o+h*.35).toFixed(1);Z.push(`<g transform="translate(${I},${N}) rotate(${l[k]})">
    ...
    <div class="add-modal-content" style="max-width:520px">
      ...
      ${si.map(d=>{const f=d.items.filter(l);return f.length?`
  ...
  `,e.appendChild(m),m}function $i(e,t,i=null,n=null,a=null){jt(e,t,"vwcColor","Teneur en eau du sol","%vol","capa-svg","capa",a)}function xi(e,t,i=null,n=null,a=null){jt(e,t,"tsolColor","Température du sol par horizon","°C","capa-tsol-svg","capaT",a)}function _e(e,t,i=null,n=null,a=null,s=!1,c=null){var u;const l=t.base(),m=document.createElement("div");m.className="chart-card",m.dataset.base=l,m.dataset.color=t.color,m.dataset.cumul=t.isCumul?"1":"",m.dataset.chartType=t.chartType||"line",m.dataset.metricId=t.id,m.dataset.metricName=t.name,m.dataset.metricUnit=t.unit,t.isIrrigation&&(m.dataset.isIrrigation="1"),a&&(m.dataset.cardKey=a,m.draggable=!0);const d=t.cumul?`<div class="chart-cumul"><span class="chart-cumul-label">${t.cumul.label} : <strong>${st(t)} ${t.cumul.unit}</strong></span><button class="chart-cumul-add-btn" data-cumul-label="${t.cumul.label}" data-cumul-val="${st(t)} ${t.cumul.unit}" title="Ajouter au tableau de bord"><i class="bi bi-house-add"></i></button></div>`:"",f=i?`<span class="chart-card-source">${i}</span>`:"",r=n!=null?`<span class="chart-card-emission">il y a ${n} min</span>`:"";let o="";if(c){const h=((u=document.getElementById("time-step"))==null?void 0:u.value)||"1h";o=`<a class="chart-card-expand" href="capteur-graphique.html?sensorId=${c}&metricId=${t.id}&parcelId=${T}&period=${J}&step=${h}" title="Graphique plein écran"><i class="bi bi-fullscreen"></i></a>`}const p=s?'<div class="chart-unavailable">Données indisponibles pour ce pas de temps</div>':'<svg class="chart-svg" width="100%" height="180" viewBox="0 0 600 180" preserveAspectRatio="none"></svg>';m.innerHTML=`
    ...
    ${p}
    ${d}
  `,e.appendChild(m)}let we=null;function Ci(){return we||(we=document.createElement("div"),we.className="chart-tooltip",document.body.appendChild(we)),we}function Si(e,t){return t==="temp"||t==="temperature"?["#6eb4d4","#e07050"]:t==="tseche"||t==="thumide"?["#6eb4d4","#e07050"]:t==="temp_rosee"?["#a0d0f0","#4090c0"]:[Mi(e,.55),e]}function Mi(e,t){const i=parseInt(e.slice(1,3),16),n=parseInt(e.slice(3,5),16),a=parseInt(e.slice(5,7),16),s=Math.round(i+(255-i)*t),c=Math.round(n+(255-n)*t),l=Math.round(a+(255-a)*t);return`#${s.toString(16).padStart(2,"0")}${c.toString(16).padStart(2,"0")}${l.toString(16).padStart(2,"0")}`}function Pe(e){if(e.length<2)return"";if(e.length===2)return`M${e[0].x},${e[0].y} L${e[1].x},${e[1].y}`;let t=`M${e[0].x.toFixed(1)},${e[0].y.toFixed(1)}`;for(let i=0;i<e.length-1;i++){const n=e[Math.max(i-1,0)],a=e[i],s=e[i+1],c=e[Math.min(i+2,e.length-1)],l=a.x+(s.x-n.x)/6,m=a.y+(s.y-n.y)/6,d=s.x-(c.x-a.x)/6,f=s.y-(c.y-a.y)/6;t+=` C${l.toFixed(1)},${m.toFixed(1)} ${d.toFixed(1)},${f.toFixed(1)} ${s.x.toFixed(1)},${s.y.toFixed(1)}`}return t}function ge(e){const t=new Date(Date.now()-e*6e4);return e<1440?`${String(t.getHours()).padStart(2,"0")}h`:e>=43200?["jan","fév","mar","avr","mai","juin","juil","aoû","sep","oct","nov","déc"][t.getMonth()]:`${String(t.getDate()).padStart(2,"0")}/${String(t.getMonth()+1).padStart(2,"0")}`}function it(e){const t=Date.now()-e*6e4;return new Date(t).getHours()+new Date(t).getMinutes()/60}function Ei(e){return Math.max(0,Math.sin(Math.PI*(e-6)/12))}function nt(e){return .5+.5*Math.sin(2*Math.PI*(e-4)/24-Math.PI/2)}function Bi(e){const t=Math.floor((Date.now()-e*6e4)/864e5),i=Math.sin(t*12.9898+78.233)*43758.5453;return i-Math.floor(i)}function de(e,t,i,n=.15){const a=it(i),s=nt(a),c=Ei(a),l=Bi(i),m=()=>1+(Math.random()-.5)*2*n;switch(e){case"temp":{const d=.6+l*.8;return(t-6+s*12*d)*m()}case"tseche":case"thumide":{const d=.6+l*.8;return(t-4+s*8*d)*m()}case"temp_rosee":{const d=.6+l*.8,f=t-6+s*12*d;return Math.min(f-1,t-8+s*6*d)*m()}case"tsol":{const d=it(i+120),f=.7+l*.6;return(t-3+nt(d)*6*f)*m()}case"humidite":{const d=1.4-l*.8;return Math.min(100,Math.max(20,(t+(1-s)*25*d-s*15)*m()))}case"rayonnement":{const d=.4+l*.9;return Math.max(0,c*t*1.3*d*m())}case"etp":{const d=.4+l*.9;return Math.max(0,c*t*1.5*d*m())}case"humec":{const d=1.4-l*.8;return Math.max(0,t*Math.max(0,.8-c*1.2)*d*m())}case"pluie":{const d=.06+(1-l)*.22;return Math.random()<d?t*Math.random()*2.5*(1.3-l):0}case"vent":case"rafales":{const d=.5+l;return Math.max(0,t*(.6+c*.8)*d*m())}default:return Math.max(0,t*m())}}function ji(){const e=ni(),t=be(),i=ai();F.filter(a=>M.linkedSensorIds.includes(a.id)).filter(a=>_.includes(a.model)),document.querySelectorAll(".chart-card").forEach(a=>{if(a.classList.contains("tensio-multi-card")){const p=a.querySelector(".tensio-svg"),u=JSON.parse(a.dataset.tensioCurves||"[]");p&&u.length>0&&ki(p,u,e,t);return}if(a.classList.contains("capa-multi-card")){const p=a.querySelector(".capa-svg"),u=JSON.parse(a.dataset.capaCurves||"[]");p&&u.length>0&&at(p,u,e,t,"vwc");return}if(a.classList.contains("capaT-multi-card")){const p=a.querySelector(".capa-tsol-svg"),u=JSON.parse(a.dataset.capaTCurves||"[]");p&&u.length>0&&at(p,u,e,t,"tsol");return}const s=a.querySelector(".chart-svg");if(!s)return;const c=parseFloat(a.dataset.base),l=a.dataset.color,m=a.dataset.cumul==="1",d=a.dataset.chartType||"line",f=a.dataset.metricId||"",r=a.dataset.metricName||"",o=a.dataset.metricUnit||"";if(a.dataset.isIrrigation)Hi(s,l,e,t,i);else{const p=i>0&&ei.has(f);Ai(s,c,l,e,t,m,d,f,r,o,i,p)}}),kt(),At()}function ki(e,t,i,n){const c={t:14,r:10,b:28,l:46},l=600-c.l-c.r,m=180-c.t-c.b,d=t.map(w=>{const y=20+w.depth*.8+Math.random()*20;return Array.from({length:i},(E,b)=>{const C=(i-1-b)*n;return Math.max(0,de("pothydr",y,C))})}),f=d.flat(),r=Math.min(...f),o=Math.max(...f),p=o-r||1,u=w=>c.l+w/Math.max(i-1,1)*l,h=w=>c.t+m-(w-r)/p*m,v=`tc-${Math.random().toString(36).slice(2)}`;let $=`<defs><clipPath id="${v}"><rect x="${c.l}" y="${c.t}" width="${l}" height="${m}"/></clipPath></defs>`;for(let w=0;w<=4;w++){const y=c.t+w/4*m,E=o-w/4*p;$+=`<line x1="${c.l}" y1="${y.toFixed(1)}" x2="${600-c.r}" y2="${y.toFixed(1)}" stroke="var(--bdr2)" stroke-width="1"/>`,$+=`<text x="${c.l-5}" y="${(y+4).toFixed(1)}" text-anchor="end" font-size="10" font-family="var(--font)" fill="var(--txt3)">${E.toFixed(0)}</text>`}d.forEach((w,y)=>{const E=w.map((C,B)=>({x:u(B),y:h(C)})),b=Pe(E);$+=`<path d="${b}" fill="none" stroke="${t[y].color}" stroke-width="2" stroke-linecap="round" clip-path="url(#${v})"/>`}),$+=`<line x1="${c.l}" y1="${c.t+m}" x2="${600-c.r}" y2="${c.t+m}" stroke="var(--bdr2)" stroke-width="1"/>`;const g=Math.max(1,Math.floor(i/6));for(let w=0;w<i;w+=g){const y=(i-1-w)*n;$+=`<text x="${u(w).toFixed(1)}" y="${(c.t+m+14).toFixed(1)}" text-anchor="middle" font-size="10" font-family="var(--font)" fill="var(--txt3)">${ge(y)}</text>`}e.innerHTML=$}function at(e,t,i,n,a="vwc"){const l={t:14,r:10,b:28,l:46},m=600-l.l-l.r,d=180-l.t-l.b,f=t.map((y,E)=>{if(a==="tsol"){const C=16-y.depth*.06+E*.5+Math.random()*3;return Array.from({length:i},(B,j)=>{const A=(i-1-j)*n;return de("tsol",C,A)})}const b=35-y.depth*.15+E*2+Math.random()*8;return Array.from({length:i},(C,B)=>{const j=(i-1-B)*n;return Math.max(10,Math.min(55,de("teneur-eau",b,j)))})}),r=f.flat(),o=Math.floor(Math.min(...r)-2),p=Math.ceil(Math.max(...r)+2),u=p-o||1,h=y=>l.l+y/Math.max(i-1,1)*m,v=y=>l.t+d-(y-o)/u*d,$=`cc-${Math.random().toString(36).slice(2)}`;let g=`<defs><clipPath id="${$}"><rect x="${l.l}" y="${l.t}" width="${m}" height="${d}"/></clipPath></defs>`;for(let y=0;y<=4;y++){const E=l.t+y/4*d,b=p-y/4*u;g+=`<line x1="${l.l}" y1="${E.toFixed(1)}" x2="${600-l.r}" y2="${E.toFixed(1)}" stroke="var(--bdr2)" stroke-width="1"/>`,g+=`<text x="${l.l-5}" y="${(E+4).toFixed(1)}" text-anchor="end" font-size="10" font-family="var(--font)" fill="var(--txt3)">${b.toFixed(0)}</text>`}f.forEach((y,E)=>{const b=y.map((B,j)=>({x:h(j),y:v(B)})),C=Pe(b);g+=`<path d="${C}" fill="none" stroke="${t[E].color}" stroke-width="2" stroke-linecap="round" clip-path="url(#${$})"/>`}),g+=`<line x1="${l.l}" y1="${l.t+d}" x2="${600-l.r}" y2="${l.t+d}" stroke="var(--bdr2)" stroke-width="1"/>`;const w=Math.max(1,Math.floor(i/6));for(let y=0;y<i;y+=w){const E=(i-1-y)*n;g+=`<text x="${h(y).toFixed(1)}" y="${(l.t+d+14).toFixed(1)}" text-anchor="middle" font-size="10" font-family="var(--font)" fill="var(--txt3)">${ge(E)}</text>`}e.innerHTML=g}function Ai(e,t,i,n,a,s,c="line",l="",m="",d="",f=0,r=!1){const u={t:14,r:10,b:28,l:46},h=600-u.l-u.r,v=180-u.t-u.b,$=n+f,g=r?f:0,w=n+g,y=Math.max(1,Math.round(a/15)),E=Array.from({length:w},(H,k)=>{const I=(n-1-k)*a;if(s){let N=0;for(let V=0;V<y;V++)N+=de(l,t/y,I+V*(a/y));return N}else if(y>1){let N=0;for(let V=0;V<y;V++)N+=de(l,t,I+V*(a/y));return N/y}else return de(l,t,I)}),b=c==="bar"?0:Math.min(...E),C=Math.max(...E),B=C-b||1,j=H=>u.l+H/Math.max($-1,1)*h,A=H=>u.t+v-(H-b)/B*v,P=`grad_${Math.random().toString(36).slice(2)}`,[W,Z]=Si(i,l);let D=`<defs>
  ...
  </defs>`;if(f>0){const H=j(n-.5),k=`stripe_${P}`;D+=`<defs><pattern id="${k}" width="8" height="8" patternUnits="userSpaceOnUse" patternTransform="rotate(45)">
        <rect width="8" height="8" fill="rgba(142,142,147,.05)"/>
        <line x1="0" y1="0" x2="0" y2="8" stroke="rgba(142,142,147,.16)" stroke-width="4"/>
      </pattern></defs>
      <rect x="${H.toFixed(1)}" y="${u.t}" width="${(600-u.r-H).toFixed(1)}" height="${v}" fill="url(#${k})"/>
      <line x1="${H.toFixed(1)}" y1="${u.t}" x2="${H.toFixed(1)}" y2="${u.t+v}" stroke="rgba(142,142,147,.4)" stroke-width="1" stroke-dasharray="2,2"/>
      <text x="${(600-u.r-4).toFixed(1)}" y="${(u.t+12).toFixed(1)}" text-anchor="end" font-size="10" font-family="var(--font)" fill="var(--txt3)" font-style="italic">Prévisions</text>`}for(let H=0;H<=4;H++){const k=u.t+H/4*v,I=C-H/4*B,N=Math.abs(I)>=100?I.toFixed(0):Math.abs(I)>=10?I.toFixed(1):I.toFixed(2);D+=`<line x1="${u.l}" y1="${k.toFixed(1)}" x2="${600-u.r}" y2="${k.toFixed(1)}" stroke="var(--bdr2)" stroke-width="1"/>`,D+=`<text x="${u.l-5}" y="${(k+4).toFixed(1)}" text-anchor="end" font-size="10" font-family="var(--font)" fill="var(--txt3)">${N}</text>`}D+=`<line x1="${u.l}" y1="${u.t+v}" x2="${600-u.r}" y2="${u.t+v}" stroke="var(--bdr2)" stroke-width="1"/>`;const ye=Math.max(1,Math.floor($/6));for(let H=0;H<$;H+=ye){const k=j(H).toFixed(1),I=(n-H)*a;D+=`<line x1="${k}" y1="${u.t}" x2="${k}" y2="${u.t+v}" stroke="var(--bdr2)" stroke-width="1" stroke-dasharray="3,3"/>`,D+=`<text x="${k}" y="${u.t+v+14}" text-anchor="middle" font-size="10" font-family="var(--font)" fill="var(--txt3)">${ge(I)}</text>`}if(c==="bar"){const H=Math.max(2,h/$*.65);E.forEach((k,I)=>{if(k<=0)return;const N=I>=n,V=j(I),Ee=A(k),Fe=u.t+v-Ee;D+=`<rect x="${(V-H/2).toFixed(1)}" y="${Ee.toFixed(1)}" width="${H.toFixed(1)}" height="${Fe.toFixed(1)}" fill="${N?"#C7C7CC":`url(#${P})`}" opacity="${N?"0.5":"0.9"}" rx="1"/>`})}else{const H=E.slice(0,n).map((N,V)=>({x:j(V),y:A(N)})),k=Pe(H),I=k+` L${j(n-1).toFixed(1)},${u.t+v} L${u.l.toFixed(1)},${u.t+v} Z`;if(D+=`<path d="${I}" fill="${Z}" opacity="0.07" clip-path="url(#clip_${P})"/>`,D+=`<path d="${k}" fill="none" stroke="url(#${P})" stroke-width="2" stroke-linejoin="round" stroke-linecap="round" clip-path="url(#clip_${P})"/>`,g>0){const N=E.slice(n-1).map((Ee,Fe)=>({x:j(n-1+Fe),y:A(Ee)})),V=Pe(N);D+=`<path d="${V}" fill="none" stroke="url(#${P})" stroke-width="2" stroke-dasharray="5,4" stroke-linejoin="round" stroke-linecap="round" opacity="0.5" clip-path="url(#clip_${P})"/>`}}D+=`<rect class="chart-hover-rect" x="${u.l}" y="${u.t}" width="${h}" height="${v}" fill="transparent" style="cursor:crosshair"/>`,e.innerHTML=D,Ti(e,E,j,A,b,C,$,n,a,m,d,i,u,600)}function Ti(e,t,i,n,a,s,c,l,m,d,f,r,o,p,u){const h=Ci(),v=e.querySelector(".chart-hover-rect");if(!v)return;const g=document.createElementNS("http://www.w3.org/2000/svg","circle");g.setAttribute("r","4"),g.setAttribute("fill",r),g.setAttribute("stroke","#fff"),g.setAttribute("stroke-width","1.5"),g.style.display="none",g.style.pointerEvents="none",e.appendChild(g),v.addEventListener("mousemove",w=>{const y=e.getBoundingClientRect(),E=p/y.width,b=(w.clientX-y.left)*E,C=p-o.l-o.r,B=Math.max(0,Math.min(1,(b-o.l)/C)),j=Math.round(B*(c-1));if(j<0||j>=t.length)return;const A=t[j],P=i(j),W=n(A);g.setAttribute("cx",P),g.setAttribute("cy",W),g.style.display="";const Z=(l-j)*m,D=ge(Z),ye=Math.abs(A)>=100?A.toFixed(1):A.toFixed(2);h.innerHTML=`
    ...
    `,h.style.display="block";const H=w.clientX+12,k=w.clientY-10;h.style.left=`${Math.min(H,window.innerWidth-160)}px`,h.style.top=`${k}px`}),v.addEventListener("mouseleave",()=>{h.style.display="none",g.style.display="none"})}function Ii(e,t,i,n=0){const a=Date.now(),s=i*6e4,c=a-t*s,l=t+n,m=new Array(l).fill(0);return O.filter(d=>d.plotId===e).forEach(d=>{const f=new Date(d.iso).getTime();if(f<c)return;const r=Math.min(l-1,Math.floor((f-c)/s));r>=0&&(m[r]+=d.mm||0)}),m}function Li(e){return e.id%3===2}function Pi(e,t){const i=(e.id*13+t*23)%17/17;return i>.4?+(3+i*12).toFixed(1):0}function Hi(e,t,i,n,a=0){const l={t:12,r:8,b:28,l:44},m=600-l.l-l.r,d=180-l.t-l.b,f=n===1440&&Li(S),r=i+a,o=Ii(T,i,n,a),p=n*6e4,u=Date.now()-i*p,h=[];if(f){const b=new Date;b.setHours(0,0,0,0);for(let C=1;C<=7;C++){const B=Pi(S,C);if(B<=0)continue;const j=b.getTime()+C*864e5+12*36e5,A=Math.floor((j-u)/p);A>=i&&A<r&&h.push({idx:A,v:B})}}const v=Math.max(...o,...h.map(b=>b.v),1),$=b=>l.l+b/Math.max(r-1,1)*m,g=b=>l.t+d-b/v*d;let w="";for(let b=0;b<=4;b++){const C=l.t+b/4*d,B=(v-b/4*v).toFixed(1);w+=`<line x1="${l.l}" y1="${C}" x2="${600-l.r}" y2="${C}" stroke="var(--bdr2)" stroke-width="1"/>`,w+=`<text x="${l.l-4}" y="${C+4}" text-anchor="end" font-size="10" fill="var(--txt3)">${B}</text>`}w+=`<line x1="${l.l}" y1="${l.t+d}" x2="${600-l.r}" y2="${l.t+d}" stroke="var(--bdr2)" stroke-width="1"/>`;const y=Math.max(1,Math.floor(r/6));for(let b=0;b<r;b+=y){const C=$(b).toFixed(1),B=(i-b)*n,j=n>=1440||B<0?(()=>{const A=new Date(Date.now()-B*6e4);return`${String(A.getDate()).padStart(2,"0")}/${String(A.getMonth()+1).padStart(2,"0")}`})():ge(B);w+=`<text x="${C}" y="${(l.t+d+14).toFixed(1)}" text-anchor="middle" font-size="10" font-family="var(--font)" fill="var(--txt3)">${j}</text>`}if(a>0){const b=$(i-.5),C=`irrig_stripe_${Math.random().toString(36).slice(2,8)}`;w+=`<defs><pattern id="${C}" width="8" height="8" patternUnits="userSpaceOnUse" patternTransform="rotate(45)">
        <rect width="8" height="8" fill="rgba(142,142,147,.05)"/>
        <line x1="0" y1="0" x2="0" y2="8" stroke="rgba(142,142,147,.16)" stroke-width="4"/>
      </pattern></defs>
...
Voulez-vous l'ajouter quand même ?`))return}}z({linkedSensorIds:[...M.linkedSensorIds,u]}),ht(h),Te(),U(),ue()})}function We(){var c;const e=document.getElementById("panel-integrations"),t=M.integrations||[],i=Zt.filter(l=>!t.includes(l));let n="";t.length===0?n+='<div class="panel-empty" style="margin-bottom:8px">Aucune intégration active</div>':n+=t.map(l=>`
  ...
  </div>`}function ce(){var r;Ji();const e=((r=document.getElementById("sidebar"))==null?void 0:r.getAttribute("data-role"))==="adherent-reseau",t=document.getElementById("panel-membres"),i=document.getElementById("panel-membres-section"),n=ne.filter(o=>{var p;return o.source==="adherent"&&((p=o.orgIds)==null?void 0:p.includes(S.orgId))}),a=n.filter(o=>K.includes(o.id));i&&(i.style.display=!e&&n.length===0?"none":""),t&&(t.innerHTML=a.length?a.map(o=>pt(o,!0,!1)).join(""):'<p class="panel-empty">Aucun membre associé.</p>',t.querySelectorAll(".remove-membre-btn").forEach(o=>{o.addEventListener("click",()=>{const p=parseInt(o.dataset.id),u=ne.find(h=>h.id===p);Se({title:"Retirer le membre",message:`Retirer <strong>${u?`${u.prenom} ${u.nom}`:`membre #${p}`}</strong> de cette parcelle ?`,confirmLabel:"Retirer",onConfirm:()=>{K=K.filter(h=>h!==p),ae(T,{linkedOrgMemberIds:K}),ce()}})})}));const s=document.getElementById("add-membre-org-row");s&&(s.style.display="");const c=document.getElementById("add-membre-org-select");c&&(c.innerHTML='<option value="">Associer un membre…</option>',n.filter(o=>!K.includes(o.id)).forEach(o=>{const p=document.createElement("option");p.value=o.id,p.textContent=`${o.prenom} ${o.nom}`,c.appendChild(p)})),document.getElementById("add-membre-org-btn").onclick=()=>{const o=parseInt(c==null?void 0:c.value);!o||K.includes(o)||(K.push(o),ae(T,{linkedOrgMemberIds:K}),ce())};const l=document.getElementById("panel-conseillers"),m=document.getElementById("panel-conseillers-section"),d=ne.filter(o=>o.source==="réseau"&&Q.includes(o.id));m&&(m.style.display=e&&d.length===0?"none":""),l&&(l.innerHTML=d.length?d.map(o=>pt(o,!e,!0)).join(""):'<p class="panel-empty">Aucun conseiller associé.</p>',e||l.querySelectorAll(".remove-membre-btn").forEach(o=>{o.addEventListener("click",()=>{const p=parseInt(o.dataset.id),u=ne.find(h=>h.id===p);Se({title:"Retirer le conseiller",message:`Retirer <strong>${u?`${u.prenom} ${u.nom}`:`conseiller #${p}`}</strong> de cette parcelle ?`,confirmLabel:"Retirer",onConfirm:()=>{Q=Q.filter(h=>h!==p),ae(T,{linkedConseillerIds:Q}),ce()}})})}));const f=document.getElementById("add-conseiller-row");if(f&&(f.style.display=e?"none":""),!e){const o=document.getElementById("add-membre-select");o&&(o.innerHTML='<option value="">Ajouter un conseiller…</option>',ne.filter(p=>p.source==="réseau"&&!Q.includes(p.id)).forEach(p=>{const u=document.createElement("option");u.value=p.id,u.textContent=`${p.prenom} ${p.nom} (${p.role})`,o.appendChild(u)})),document.getElementById("add-membre-btn").onclick=()=>{const p=parseInt(o==null?void 0:o.value);!p||Q.includes(p)||(Q.push(p),ae(T,{linkedConseillerIds:Q}),ce())}}}function Je(){const e=document.getElementById("panel-alertes"),t=M.alertes||[],i={seuil:"bi-graph-up-arrow",cumul:"bi-droplet",absence:"bi-wifi-off"};let n="";t.length===0?n+='<div class="panel-empty" style="margin-bottom:8px">Aucune alerte configurée</div>':n+=t.map((a,s)=>`
    ...
    `).join(""),n+='<button id="create-alert-btn" class="action-btn action-btn--primary" style="margin-top:6px"><i class="bi bi-plus"></i> Créer une alerte</button>',e.innerHTML=n,e.querySelectorAll(".remove-alert-btn").forEach(a=>{a.addEventListener("click",()=>{const s=parseInt(a.dataset.idx),c=[...M.alertes];c.splice(s,1),z({alertes:c}),Je()})}),document.getElementById("create-alert-btn").addEventListener("click",()=>{Xi(e)})}function Ui(){const e=[];return F.filter(i=>M.linkedSensorIds.includes(i.id)).forEach(i=>{(q[i.model]||[]).forEach(a=>{e.find(s=>s.id===a.id)||e.push({id:a.id,name:a.name,unit:a.unit})})}),Ge.forEach(i=>{e.find(n=>n.id===i.id)||e.push({id:i.id,name:i.name,unit:i.unit})}),e}function Xi(e){if(e.querySelector(".alert-create-form"))return;const i=Ui(),n=document.createElement("div");n.className="alert-create-form",n.innerHTML=`
...
`),`${r}_${J}_${new Date().toISOString().slice(0,10)}.csv`)}function Se({title:e,message:t,confirmLabel:i="Confirmer",onConfirm:n}){const a=document.createElement("div");a.className="modal add-modal",a.style.zIndex="9999",a.innerHTML=`
    ...
    <div class="w-weephyt-actions">
      ...
      </div>`}).join("")}</div>${r}`,e.querySelectorAll(".w-cumul-del").forEach(o=>{o.addEventListener("click",p=>{p.stopPropagation(),s.add(o.dataset.cid),je({hidden:[...s]}),Ie(e)})}),e.querySelectorAll(".w-cumul-restore").forEach(o=>{o.addEventListener("click",p=>{p.stopPropagation(),s.delete(o.dataset.cid),je({hidden:[...s]}),Ie(e)})}),e.querySelectorAll(".w-cumul-date-input").forEach(o=>{o.addEventListener("change",()=>{c[o.dataset.cid]=o.value,je({dates:c})})}),e.querySelectorAll(".w-cumul-cfg").forEach(o=>{o.addEventListener("click",p=>{var $;p.stopPropagation();const u=o.dataset.cid,h=d.find(g=>g.id===u);if(!(h!=null&&h.cfgFields))return;($=e.querySelector(".w-cumul-cfg-panel"))==null||$.remove();const v=document.createElement("div");v.className="w-cumul-cfg-panel",v.style.gridColumn="1 / -1",v.innerHTML=`<div class="w-cumul-cfg-title">Paramétrer ${h.label}</div>`+h.cfgFields.map(g=>`
          <label class="w-cumul-cfg-row">
            <span>${g.label} (°C)</span>
            <input type="number" class="w-cumul-cfg-inp" data-key="${g.key}" value="${l[g.key]??g.def}" step="0.1">
          </label>`).join("")+'<button class="w-cumul-cfg-ok">OK</button>',o.closest(".w-cumul-item").after(v),v.querySelector(".w-cumul-cfg-ok").addEventListener("click",()=>{v.querySelectorAll(".w-cumul-cfg-inp").forEach(g=>{l[g.dataset.key]=parseFloat(g.value)||0}),je({cfg:l}),v.remove(),Ie(e)})})})}function cn(e){if(!F.filter(r=>M.linkedSensorIds.includes(r.id)).some(r=>r.model==="T_GEL")){e.innerHTML='<div class="dash-empty">Capteur T_GEL non lié</div>';return}const i=25,n=R(0,5),a=Array.from({length:i},(r,o)=>+(n+o*.18+R(-.8,.8)).toFixed(1)),s=a.map(r=>+(r-R(1,2.5)).toFixed(1)),c=Lt([{values:a,color:"#23B19B"},{values:s,color:"#5E88EC"}],380,100),l=a[i-1],m=s[i-1],d=x(5,8),f=String(Math.floor(Math.random()*60)).padStart(2,"0");e.innerHTML=`<div class="w-gel-wrap">
  ...
  </div>`}function un(e){if(!F.filter(o=>M.linkedSensorIds.includes(o.id)).some(o=>{const p=q[o.model]||[];return p.some(u=>u.id==="temp")&&p.some(u=>u.id==="humidite")})){e.innerHTML='<div class="dash-empty">Capteur T+HR requis</div>';return}const n=R(20,35),a=x(45,90),s=+(n-.55*(1-a/100)*(n-14.5)).toFixed(0),c=s<68?"#2d9e5f":s<72?"#f5c842":s<79?"#f5a030":"#e07050",l=s<68?"Confort":s<72?"Stress léger":s<79?"Stress modéré":"Stress sévère",m=["Dim","Lun","Mar","Mer","Jeu","Ven","Sam"],d=new Date,f=Array.from({length:3},(o,p)=>{const u=new Date(d);return u.setDate(u.getDate()+p+1),{day:m[u.getDay()],m:x(64,72),j:x(68,80),s:x(62,70)}}),r=o=>o<68?"#2d9e5f":o<72?"#f5c842":"#f5a030";e.innerHTML=`<div class="w-thi-wrap">
    ...
    ${Lt([{values:s,color:"#FBAF05"},{values:l,color:"#72B0D8"}],380,100)}
  ...
  </div>`}function pn(e){if(!F.filter(j=>M.linkedSensorIds.includes(j.id)).some(j=>(q[j.model]||[]).some(A=>A.id==="tsol"))){e.innerHTML='<div class="dash-empty">Capteur T. sol requis</div>';return}const n=48,a=R(14,20),s=Array.from({length:n},(j,A)=>+(a+3*Math.sin(A/24*2*Math.PI-Math.PI/2)+R(-.4,.4)).toFixed(1)),c=15,l=22,m=380,d=100,f=28,r=8,o=6,p=20,u=m-f-r,h=d-o-p,v=[...s,c,l],$=Math.min(...v)-1,g=Math.max(...v)+1,w=j=>(f+j/(n-1)*u).toFixed(1),y=j=>(o+h-(j-$)/(g-$)*h).toFixed(1),E=+y(c),b=+y(l),C=[.25,.5,.75].map(j=>{const A=(o+j*h).toFixed(1);return`<line x1="${f}" y1="${A}" x2="${m-r}" y2="${A}" stroke="rgba(0,0,0,.06)" stroke-width="1"/>`}).join(""),B=s.map((j,A)=>`${A?"L":"M"}${w(A)},${y(j)}`).join("");e.innerHTML=`<div class="w-tsol-wrap">
    <svg width="100%" height="${d}" viewBox="0 0 ${m} ${d}" preserveAspectRatio="none">
      ${C}
  ...
  </div>`}const Ft=[{id:"j7",label:"J-7"},{id:"j1",label:"J-1"},{id:"j0",label:"J0"},{id:"last",label:"Dernières données"}],vn=Ft.filter(e=>e.id==="j7"||e.id==="j1"),vt=()=>`w-reservoir-agg-${T}`,bt=()=>`w-profil-reservoir-agg-${T}`;function Dt(e,t="j0"){return localStorage.getItem(e())||t}function qt(e,t){localStorage.setItem(e(),t)}function Rt(e){const t=S.reserveHydrique||80,i=(S.id*17+13)%41,n={j7:-8,j1:-2,j0:0,last:1},a=Math.min(95,Math.max(15,55+i+(n[e]||0))),s=Math.round(t*a/100);return{rhu:t,pct:a,mm:s}}function Ot(e,t=Ft){return`<select class="w-reservoir-agg-sel">
    ...
    </div>`,e.querySelector(".w-reservoir-agg-sel").addEventListener("change",c=>{qt(vt,c.target.value),Nt(e)})}function zt(e){const t=Dt(bt,"j1"),{pct:i}=Rt(t),n=(S.id*17+13)%41,a=[{label:"10 cm",pct:Math.min(100,Math.max(0,i+n%12-5)),color:"#f0cc60"},{label:"30 cm",pct:Math.min(100,Math.max(0,i+n%8)),color:"#c89c30"},{label:"60 cm",pct:Math.min(100,Math.max(0,i-n%10+3)),color:"#a07010"}];e.innerHTML=`
    <div class="w-bilan-layout">
      ${Ot(t,vn)}
    ...
    Widget bientôt disponible
      ...
      <div class="w-sensor-ts">Dernière mesure : ${f}</div>`;const r=(o=t.closest(".dash-block"))==null?void 0:o.querySelector(".dash-block-ft-link");if(r){const u=((p=document.getElementById("time-step"))==null?void 0:p.value)||"1h";r.href=`capteur-graphique.html?sensorId=${a.id}&parcelId=${T}&period=${J}&step=${u}`,r.removeAttribute("data-tab")}}}const gt="#bf5af2";function yt(e){return t=>{const i=e==="pluie"?{color:"#2E75B6",unit:"mm"}:{color:"#7DBDD7",unit:"mm"},n=new Date;n.setHours(0,0,0,0);const a=[];for(let b=-7;b<=7;b++){const C=new Date(n);C.setDate(C.getDate()+b);const B=(T*31+(b+7)*17)%101/101,j=e==="pluie"?B>.72?+(2+B*18).toFixed(1):B>.5?+(B*4).toFixed(1):0:+(1.2+B*4.2).toFixed(1);a.push({d:C,off:b,val:j,isFc:b>0})}const s=Math.max(1,...a.map(b=>b.val)),c=600,l=130,m=14,d=22,f=4,r=4,o=l-m-d,p=(c-f-r)/a.length,u=`w-hist-stripe-${e}`,h=a.findIndex(b=>b.off===0),$=f+h*p+p,g=a.map((b,C)=>{const B=f+C*p,j=Math.max(0,b.val/s*o),A=m+o-j,P=b.off===0?gt:b.isFc?`${i.color}66`:i.color;return`<rect x="${(B+p*.15).toFixed(1)}" y="${A.toFixed(1)}" width="${(p*.7).toFixed(1)}" height="${j.toFixed(1)}" rx="2" fill="${P}"/>`}).join(""),w=a.map((b,C)=>{if(b.off%4!==0)return"";const B=f+C*p+p/2,j=b.off===0?"Auj.":`${b.d.getDate()}/${b.d.getMonth()+1}`;return`<text x="${B.toFixed(1)}" y="${l-6}" font-size="8" text-anchor="middle" fill="var(--txt3)">${j}</text>`}).join(""),y=a.filter(b=>!b.isFc).reduce((b,C)=>b+C.val,0),E=a.filter(b=>b.isFc).reduce((b,C)=>b+C.val,0);t.innerHTML=`
      <div class="w-hist-summary">
        ...
        <span class="w-hist-summary-item"><span class="w-hist-dot" style="background:${gt}"></span>Prévision 7j : <strong>${E.toFixed(1)} ${i.unit}</strong></span>
      </div>
      <svg class="w-hist-svg" width="100%" height="110" viewBox="0 0 ${c} ${l}" preserveAspectRatio="none">
    ...
    <div class="w-bilan-layout">
    ...
    </div>`}function _t(e){const t=document.createElement("div");if(t.className="journal-form-overlay",e==="vol"){const i=Ce(T).volumeMaxM3??"",n=Ce(T).debitM3h??"";t.innerHTML=`
      ...
      </div>`,document.body.appendChild(t),t.querySelector("#iwa-cancel").onclick=()=>t.remove(),t.querySelector("#iwa-save").onclick=()=>{const a=t.querySelector("#iwa-vol-inp").value,s=t.querySelector("#iwa-debit-inp").value;ae(T,{volumeMaxM3:a!==""?parseInt(a):null,debitM3h:s!==""?parseFloat(s):null}),t.remove(),document.querySelector("#dblock-irrigations")&&Me(document.querySelector("#dblock-irrigations"))}}else{const i=M.irrigation||"";t.innerHTML=`
      <div class="journal-form-modal">
    ...
    </div>`,document.body.appendChild(t),t.addEventListener("click",i=>{i.target===t&&t.remove()}),t.querySelector("#irr-m-s-cancel").onclick=()=>t.remove(),t.querySelector("#irr-m-s-save").onclick=()=>{const i=t.querySelector("#irr-m-s-date").value,n=parseInt(t.querySelector("#irr-m-s-qty").value)||0;if(!i||!n)return;const a=i>se,s=()=>{O.push({iso:i,mm:n,real:!a,plotId:S.id,fromStrategy:!1}),Ct(),t.remove(),Me(e),Vt("Irrigation enregistrée",[`Date : ${ze(i)}`,`Quantité : ${n} mm`])},c=O.filter(l=>l.plotId===S.id&&l.iso===i);if(c.length){Wt(c.length,()=>{O.splice(0,O.length,...O.filter(l=>!(l.plotId===S.id&&l.iso===i))),s()});return}s()}}function $t(e){const t=document.createElement("div");t.className="journal-form-overlay",t.innerHTML=`
    <div class="journal-form-modal">

import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css             */import{I as m,R as ve,g as Ze,s as U}from"./irrigations-C22Dtsoo.js";import{I as et}from"./constants-CJpDUNiw.js";import{p as Ee}from"./plots-DhtWL7s_.js";import{s as yt}from"./sensors-CRadjF8G.js";import{o as tt}from"./orgs-DnFmvGlp.js";import{u as ht}from"./breadcrumb-CzFWtd6d.js";import{d as we,e as Ge,c as rt,f as it}from"./store-CX9wca99.js";import"./irrigation-web-9Pu0RyDl.js";const $t=["CHP-15/30","CHP-30/60","CHP-60/90"],st=1,qe=(localStorage.getItem("menuRole")||"admin-reseau")==="admin-reseau";let ne=null,_=qe?Ee:Ee.filter(e=>e.orgId===st);const x=new Date().toISOString().split("T")[0];let W=null,Te=!1,ie=0,oe=!1,Le=!1,ae=!1,He=!1,Ne=!1;const ke={},lt={};let Ce=!0,Pe=!0,$e=!0,Be=!0,Re=!0,xe=!0,me=!0,Z=null;function X(e,t){const i=new Date(e);return i.setDate(i.getDate()+t),i.toISOString().split("T")[0]}function G(e){const t=["jan.","fév.","mar.","avr.","mai","jun.","jul.","aoû.","sep.","oct.","nov.","déc."],[,i,s]=e.split("-");return`${parseInt(s)} ${t[parseInt(i)-1]} ${e.split("-")[0]}`}function ce(e){const t=["jan","fév","mar","avr","mai","jun","jul","aoû","sep","oct","nov","déc"],[,i,s]=e.split("-");return`${parseInt(s)} ${t[parseInt(i)-1]}`}function xt(e){const[,t,i]=e.split("-");return`${i}/${t}`}const St=["Dim","Lun","Mar","Mer","Jeu","Ven","Sam"];function Ke(e){const[t,i,s]=e.split("-").map(Number);return new Date(Date.UTC(t,i-1,s)).getUTCDay()}function Ve(e){const[t,i,s]=e.split("-").map(Number),n=new Date(Date.UTC(t,i-1,s)),l=n.getUTCDay()||7;n.setUTCDate(n.getUTCDate()+4-l);const o=new Date(Date.UTC(n.getUTCFullYear(),0,1));return Math.ceil(((n-o)/864e5+1)/7)}function wt(e){return[e.name+(e.area?` (${e.area} ha)`:""),e.crop,e.irrigation].filter(Boolean).join(" — ")}const _e=new Set(["Non irrigué","Non renseigné",""]);function nt(e){return!!e.irrigation&&!_e.has(e.irrigation)}function se(e,t){return Math.round(e*(t??0)*10)}function Q(e){return e.toLocaleString("fr-FR")+" m³"}function at(e){const t=Math.floor(e),i=Math.round((e-t)*60);return t<=0?`${i} min`:i>0?`${t} h ${String(i).padStart(2,"0")} min`:`${t} h`}function Et(e){var i;const t=it(e).volumeMax;return t!==void 0?t:((i=tt.find(s=>s.id===e))==null?void 0:i.volumeMax)??null}function qt(e){const t=it(e).prixM3;return t!==void 0?t:.37}function je(e){return e.toLocaleString("fr-FR",{maximumFractionDigits:0})+" €"}function ot(e){return rt(e).volumeMaxM3??null}function fe(e){return rt(e).debitM3h??null}function Lt(e){const t=fe(e),i=_.find(s=>s.id===e);document.querySelectorAll(`tr[data-row-plot="${e}"] .irr-gl-irrig`).forEach(s=>{var o;(o=s.querySelector(".irr-gl-dur-i"))==null||o.remove();const n=+s.dataset.mm;if(!t||!n||!me)return;const l=document.createElement("span");l.className="irr-gl-dur-i",l.dataset.tip=`Durée estimée : ${at(se(n,i==null?void 0:i.area)/t)}`,l.textContent="i",s.appendChild(l)})}function kt(){const e=document.querySelector(".irr-gl-legend");if(!e)return;const t=_.some(s=>fe(s.id)),i=e.querySelector('.irr-gl-filter[data-filter="duration"]');if(t&&!i){const s=document.createElement("label");s.className="irr-gl-filter-item",s.innerHTML='<input type="checkbox" class="irr-gl-filter" data-filter="duration" checked><span class="irr-gl-dur-i">i</span>&nbsp;Durées',e.appendChild(s),s.querySelector(".irr-gl-filter").addEventListener("change",n=>{me=n.target.checked,N()})}else!t&&i&&i.closest(".irr-gl-filter-item").remove()}function Ie(){return[..._].sort((e,t)=>e.name.localeCompare(t.name,"fr"))}function dt(e){return e.id%3===2}function ct(e){return 25+e.id*7%20}function It(e){return e.id%9===2}function Mt(e,t){const[,i,s]=t.split("-").map(Number);return Math.min(65,Math.max(5,30+(e.id*7+i*3+s*2)%30))}function Dt(e){const t=(e.irrigation||"").toLowerCase();return["rampe","pivot","enrouleur"].some(i=>t.includes(i))}function At(e){return yt.some(t=>(t.parcelIds||[]).includes(e.id)&&(t.model.startsWith("CAPA-")||$t.includes(t.model)))}function Ft(e){return!!e.crop}function Tt(e){return m.some(t=>t.plotId===e.id&&t.fromStrategy)}function Ct(e){const t=new Date(x).getFullYear(),i=new Date(t,2,21),s=47,n=new Date(i);return n.setDate(n.getDate()+e.id*13%s),n.toISOString().split("T")[0]}function Pt(e){return At(e)&&Ft(e)&&!Tt(e)}function Bt(e){if(!Dt(e))return[];const t=[];let i=e.id*17,s=new Date(X(x,-45));const n=new Date(X(x,-1));for(;s<=n;){const l=s.toISOString().split("T")[0],o=i%7-3;i=(i*31+17)%1e3,t.push({iso:l,mm:Math.max(8,15+o),real:!0,plotId:e.id,fromDetector:!0}),s.setDate(s.getDate()+5+i%3),i=(i*31+17)%1e3}return t}function ze(e,t={}){const{allBtn:i=!1}=t,s=Ie().map(n=>`
  ...
  </div>`}function Oe(e,t){const i=e.querySelector(`#${t}`);if(!i)return;const s=i.querySelector(".irr-msel-search"),n=i.querySelector(".irr-msel-count"),l=i.querySelector(".irr-msel-all-btn"),o=()=>{const a=i.querySelectorAll(".irr-msel-cb:checked").length;n.textContent=`${a} sélectionnée${a!==1?"s":""}`};s.addEventListener("input",()=>{const a=s.value.toLowerCase();i.querySelectorAll(".irr-msel-item").forEach($=>{$.style.display=$.querySelector(".irr-msel-name").textContent.toLowerCase().includes(a)?"":"none"})}),i.querySelectorAll(".irr-msel-cb").forEach(a=>a.addEventListener("change",o)),l==null||l.addEventListener("click",()=>{const a=[...i.querySelectorAll(".irr-msel-cb")].filter(S=>S.closest(".irr-msel-item").style.display!=="none"),$=a.some(S=>!S.checked);a.forEach(S=>{S.checked=$}),o()})}function Se(e,t){const i=e.querySelector(`#${t}`);return i?[...i.querySelectorAll(".irr-msel-cb:checked")].map(s=>+s.value):[]}function de(e,t){var n;(n=document.querySelector(".irr-save-confirm"))==null||n.remove();const i=document.createElement("div");i.className="irr-save-confirm",i.innerHTML=`
  ...
  </div>`}function Me(){var z,T;const e=document.getElementById("irr-vol-banner-wrap");if(!e)return;const t=qe?ne:st;if(!t){e.innerHTML="";return}const i=new Set(_.filter(f=>f.orgId===t).map(f=>f.id));qe||_.forEach(f=>i.add(f.id));const s=new Map(_.map(f=>[f.id,f])),n=m.filter(f=>i.has(f.plotId)&&f.real).reduce((f,L)=>{var A;return f+se(L.mm,((A=s.get(L.plotId))==null?void 0:A.area)??0)},0),l=m.filter(f=>i.has(f.plotId)&&!f.real).reduce((f,L)=>{var A;return f+se(L.mm,((A=s.get(L.plotId))==null?void 0:A.area)??0)},0),o=n+l,a=Et(t),$=a?Math.min(100,Math.round(n/a*100)):0,S=a?Math.min(100-$,Math.round(l/a*100)):0,F=$+S,h=qt(t),b=h?n*h:0,O=h?l*h:0,j=f=>f!=null?f.toLocaleString("fr-FR"):"";e.innerHTML=`
    <div class="irr-vol-banner">
      ...
      <div class="irr-vol-controls">
        ...
        ${h?`<div class="irr-vol-total">${je(b+O)}</div>
             <div class="irr-vol-sub"><span style="color:#FF8500">▪ ${je(b)}</span> effectués · <span style="color:#FFB705">▪ ${je(O)}</span> planifiés</div>`:'<div class="irr-vol-bar-nomax">Définissez un prix du m³ →</div>'}
        <div class="irr-vol-ctrl-row" style="margin-top:6px">
    ...
    </div>`,(z=e.querySelector("#irr-vol-max-inp"))==null||z.addEventListener("change",f=>{const L=f.target.value.replace(/\s/g,"").replace(/\./g,"").replace(/,/g,""),A=L!==""?parseInt(L):null;A!==null&&(f.target.value=A.toLocaleString("fr-FR")),Ge(t,{volumeMax:A}),Me()}),(T=e.querySelector("#irr-prix-m3-inp"))==null||T.addEventListener("change",f=>{const L=f.target.value.replace(/\s/g,"").replace(",","."),A=L!==""?parseFloat(L):null;A!==null&&(f.target.value=A.toLocaleString("fr-FR",{maximumFractionDigits:2})),Ge(t,{prixM3:A}),Me()})}function N(e=!1){var w,q,I;Me();const t=document.getElementById("irr-right"),i=X(x,60),s=[...m.map(r=>r.iso),...ve.filter(r=>r.iso<=i).map(r=>r.iso),...ae?[X(x,-45)]:[],X(x,-1),i];if(!m.length&&!ve.length){t.innerHTML=`<div class="irr-pr-empty" style="padding-top:60px"><i class="bi bi-table"></i><p>Il manque des données de pluie ou d'irrigations sur au moins une parcelle pour afficher cette vue</p></div>`;return}const n=[...s].sort()[0],l=m.length?[...m].map(r=>r.iso).sort().at(-1):null,o=l&&l>i?l:i,a=new Date(o);a.setMonth(a.getMonth()+ie);const $=a.toISOString().split("T")[0],S=e?null:((w=t.querySelector("#irr-gl-body"))==null?void 0:w.scrollLeft)??null,F=[];let h=new Date(n);const b=new Date($);for(;h<=b;)F.push(h.toISOString().split("T")[0]),h.setDate(h.getDate()+1);const O={};for(const r of ve)O[r.iso]=r.mm;function j(r){if(r<=x||r>X(x,13))return 0;const[,y,E]=r.split("-").map(Number),M=(y*17+E*13)%100;return M<65?0:3+M%9}function z(r,y,E){const M=`${r}_${y}`;if(ke[M]!==void 0)return ke[M];if(!E)return 0;const[,P,D]=y.split("-").map(Number);if((r*13+P*7+D*3)%100<12)return 0;const H=.75+(r*11+D*5)%50/100;return Math.round(E*H)}const T=X(x,7);let f="",L="",A=0,c=null;for(const r of F){const y=r===x,E=Ke(r),M=E===0,P=M?" irr-gl-th--week-end":"";c===null&&(c=Ve(r)),A++;const D=oe&&r>x&&r<=T;f+=`<th class="irr-gl-th${y?" irr-gl-th--today":""}${P}${D?" irr-gl-th--advisor-range":""}"><span class="irr-gl-day-name">${St[E]}</span>${xt(r)}</th>`;const V=r===F[F.length-1];(M||V)&&(L+=`<th class="irr-gl-week-hd${M?" irr-gl-th--week-end":""}" colspan="${A}">S${c}</th>`,A=0,c=null),oe&&r===T&&(f+='<th class="irr-gl-th irr-gl-th--advisor">Reco J+7</th>',L+='<th class="irr-gl-week-hd"></th>')}function g(r){const y=ae?Bt(r):[],E=oe&&dt(r),M=Le&&It(r),P=Ne&&Pt(r)?Ct(r):null;let D="";for(const p of F){const B=p===x,J=m.filter(R=>R.iso===p&&R.plotId===r.id),K=J.length===0?y.filter(R=>R.iso===p):[],C=J.filter(R=>!R.detectorDismissed).filter(R=>R.detectorConfirmed?ae&&Re:R.real?Ce:Pe),Y=Be?K:[],ge=[...C,...Y],be=ge.reduce((R,te)=>R+te.mm,0),pt=ge.some(R=>R.real),vt=(r.id*7+3)%3-1,Ye=X(p,vt),ue=z(r.id,p,O[Ye]??j(Ye)),mt=`${r.id}_${p}`;let We="";if(ue&&$e){const R=lt[mt]?'<span class="irr-gl-rain-corr-badge" title="Irrigation détectée corrigée en pluie">C</span>':"";We=p<=x?`<span class="irr-gl-rain irr-gl-rain--edit" data-rain-plotid="${r.id}" data-rain-iso="${p}" data-rain-mm="${ue}" title="Modifier la pluie">${ue} mm${R}</span>`:`<span class="irr-gl-rain">${ue} mm${R}</span>`}const Je=P===p?'<i class="bi bi-star-fill irr-gl-star" title="Début de campagne suggéré (1er apport)"></i>':"";let De="";if(be){const R=pt?"#E07820":"#FFB705",te=C.map(le=>m.indexOf(le)).filter(le=>le>=0).join(","),he=Y.length?'<span class="irr-gl-det-badge" title="Détecté automatiquement">D</span>':C.some(le=>le.detectorConfirmed)?'<span class="irr-gl-conf-badge" title="Irrigation confirmée">C</span>':"",Ae=Y.reduce((le,bt)=>le+bt.mm,0),re=fe(r.id),Fe=re&&me?`<span class="irr-gl-dur-i" data-tip="Durée estimée : ${at(se(be,r.area)/re)}">i</span>`:"";De=`<span class="irr-gl-val irr-gl-irrig" style="color:${R};cursor:pointer" data-mm="${be}"${te?` draggable="true" data-plot-id="${r.id}"`:""}${te?` data-idxs="${te}" data-iso="${p}"`:` data-det-plotid="${r.id}" data-det-plotname="${r.name}" data-det-iso="${p}" data-det-mm="${Ae}" data-det-rain="${ue}"`}>${be} mm${he}${Fe}</span>${Je}`}else De=`<button class="irr-gl-add" data-plot-id="${r.id}" data-plot-name="${r.name}" data-iso="${p}">+</button>${Je}`;let Qe="";M&&xe&&p<x&&(Qe=`<span class="irr-gl-res">${Mt(r,p)} mm</span>`);let ye="";$e&&(ye+=`<div class="irr-gl-slot">${We}</div>`),ye+=`<div class="irr-gl-slot">${De}</div>`,M&&xe&&(ye+=`<div class="irr-gl-slot">${Qe}</div>`);const ft=Ke(p)===0,gt=E&&p>x&&p<=T;if(D+=`<td class="irr-gl-td${B?" irr-gl-td--today":""}${ft?" irr-gl-td--week-end":""}${gt?" irr-gl-td--advisor-range":""}" data-iso="${p}" data-plot-id="${r.id}">${ye}</td>`,oe&&p===T){let R="";if(E){const te=ct(r),he=m.filter(re=>re.plotId===r.id&&re.iso>x&&re.iso<=T).reduce((re,Fe)=>re+Fe.mm,0),Ae=he>=te?"#24B066":"#E05252";R=`<span class="irr-gl-advisor">${te} mm</span><span style="display:block;font-size:10px;font-weight:600;color:${Ae}">${he} mm planifié</span>`}D+=`<td class="irr-gl-td irr-gl-td--advisor">${R}</td>`}}const V=[r.crop,r.irrigation].filter(Boolean).join(" · "),H=r.area?`<span class="irr-gl-plot-area">(${r.area} ha)</span>`:"";let k="";const d=ot(r.id);if(d){const p=r.area??0,B=m.filter(C=>C.plotId===r.id&&C.real).reduce((C,Y)=>C+se(Y.mm,p),0),J=m.filter(C=>C.plotId===r.id&&!C.real).reduce((C,Y)=>C+se(Y.mm,p),0),K=B+J;if(K>0)if(K>d)k=`<span class="irr-gl-plot-deficit">Dépassement ${Q(K-d)}</span>`;else{const C=Math.round(B/d*100),Y=Math.min(100-C,Math.round(J/d*100));k=`<span class="irr-gl-plot-mini-bar"><span class="irr-gl-plot-mini-r" style="width:${C}%"></span><span class="irr-gl-plot-mini-p" style="width:${Y}%"></span></span>`}}return`<tr data-row-plot="${r.id}"><td class="irr-gl-plot"><span class="irr-gl-plot-link" data-plot-id="${r.id}">${r.name}</span>${H}${V?`<span class="irr-gl-plot-sub">${V}</span>`:""}${k}</td>${D}</tr>`}const u=Ie().map(g).join(""),v=_.some(r=>fe(r.id));t.innerHTML=`
    <div class="irr-gl-outer">
      <div class="irr-gl-sticky-hd" id="irr-gl-sticky-hd">
        <div class="irr-gl-legend">
          ...
          <label class="irr-gl-filter-item"><input type="checkbox" class="irr-gl-filter" data-filter="plan-irrig" ${Pe?"checked":""}><span class="irr-gl-dot" style="background:#FFB705"></span>Irrig. planifiée</label>
          ${ae?`<label class="irr-gl-filter-item"><input type="checkbox" class="irr-gl-filter" data-filter="detected" ${Be?"checked":""}><span class="irr-gl-det-badge">D</span>&nbsp;Irrig. détectée</label><label class="irr-gl-filter-item"><input type="checkbox" class="irr-gl-filter" data-filter="confirmed" ${Re?"checked":""}><span class="irr-gl-conf-badge">C</span>&nbsp;Irrig. corrigée</label>`:""}
    ...
    </div>`,document.body.appendChild(l),l.addEventListener("click",a=>{a.target===l&&l.remove()}),l.querySelector("#irr-rain-close").addEventListener("click",()=>l.remove()),l.querySelector("#irr-rain-cancel").addEventListener("click",()=>l.remove()),l.querySelector("#irr-rain-save").addEventListener("click",()=>{const a=parseInt(l.querySelector("#irr-rain-qty").value);!isNaN(a)&&a>=0&&(ke[`${e}_${t}`]=a),l.remove(),N()})}function Nt(e,t,i,s,n=0){var a;(a=document.querySelector(".irr-edit-overlay"))==null||a.remove();let l=s;const o=document.createElement("div");o.className="irr-edit-overlay",o.innerHTML=`
    <div class="irr-edit-modal">
      <div class="irr-edit-hd">

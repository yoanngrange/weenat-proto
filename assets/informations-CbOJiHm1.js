import"./main-CTKmqMeY.js";import{o as v}from"./orgs-Cx4wNzLL.js";import{p as r}from"./plots-Dwluc99O.js";import{s as p}from"./sensors-CeUIY8ag.js";import{n as s}from"./network-YzWdS0n_.js";import{u as f}from"./breadcrumb-DEBQjfiD.js";document.addEventListener("DOMContentLoaded",()=>{f(),m()});function m(){const o=document.getElementById("network-info"),n=p.length,a=r.length,t=v.length;function i(e){return(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function l(e){return(e||"?").split(/[\s\-']+/).slice(0,2).map(c=>c[0]).join("").toUpperCase().slice(0,2)}const d=s.antennes.map(e=>`

import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css             */import{p as ae}from"./plots-DHZTuoR0.js";import{s as T}from"./sensors-CS05Ml5Z.js";import{o as Ne}from"./orgs-DnFmvGlp.js";import{m as te}from"./members-CuDabgg3.js";import{u as dt}from"./breadcrumb-CzFWtd6d.js";import{d as ie,c as Be}from"./store-BGemiHCf.js";import{I as _,g as Bt,s as ut}from"./irrigations-C22Dtsoo.js";import{S as kt,a as je,I as mt,E as jt}from"./constants-D_Yu58_o.js";const pt=new URLSearchParams(window.location.search),I=parseInt(pt.get("id")),E=ae.find(e=>e.id===I);function $(e,t){return Math.floor(Math.random()*(t-e+1))+e}function D(e,t){return parseFloat((Math.random()*(t-e)+e).toFixed(2))}const Oe=[{id:"etp",name:"Évapotranspiration (ETP)",unit:"mm/j",color:"#7DBDD7",base:()=>D(.5,5),cumul:{label:"Cumul d'ETP",unit:"mm"},isCumul:!1,chartType:"bar"},{id:"rayonnement",name:"Rayonnement",unit:"W/m²",color:"#CBCB0B",base:()=>$(0,900),cumul:{label:"Énergie",unit:"Wh/m²"},isCumul:!1},{id:"temp_rosee",name:"Température de rosée",unit:"°C",color:"#72B0D8",base:()=>$(2,16),isCumul:!1}],F={"P+":[{id:"pluie",name:"Pluie",unit:"mm",color:"#2E75B6",base:()=>$(0,8),cumul:{label:"Cumul de pluie",unit:"mm"},isCumul:!0,chartType:"bar"},{id:"temp",name:"Température",unit:"°C",color:"#FBAF05",base:()=>$(10,28),cumul:{label:"Cumul de degrés jour",unit:"°j"}},{id:"humidite",name:"Humidité",unit:"%",color:"#5B12A4",base:()=>$(40,90)}],PT:[{id:"pluie",name:"Pluie",unit:"mm",color:"#2E75B6",base:()=>$(0,8),cumul:{label:"Cumul de pluie",unit:"mm"},isCumul:!0,chartType:"bar"},{id:"temp",name:"Température",unit:"°C",color:"#FBAF05",base:()=>$(10,28),cumul:{label:"Cumul de degrés jour",unit:"°j"}},{id:"etp",name:"Évapotranspiration (ETP)",unit:"mm/j",color:"#7DBDD7",base:()=>D(.5,5),cumul:{label:"Cumul ETP",unit:"mm"},isCumul:!1,chartType:"bar"}],P:[{id:"pluie",name:"Pluie",unit:"mm",color:"#2E75B6",base:()=>$(0,8),cumul:{label:"Cumul de pluie",unit:"mm"},isCumul:!0,chartType:"bar"}],SMV:[{id:"pluie",name:"Pluie",unit:"mm",color:"#2E75B6",base:()=>$(0,8),cumul:{label:"Cumul de pluie",unit:"mm"},isCumul:!0,chartType:"bar"},{id:"temp",name:"Température",unit:"°C",color:"#FBAF05",base:()=>$(10,28),cumul:{label:"Cumul de degrés jour",unit:"°j"}},{id:"humidite",name:"Humidité",unit:"%",color:"#5B12A4",base:()=>$(40,90)},{id:"etp",name:"Évapotranspiration (ETP)",unit:"mm/j",color:"#7DBDD7",base:()=>D(.5,5),cumul:{label:"Cumul ETP",unit:"mm"},isCumul:!1,chartType:"bar"}],TH:[{id:"temp",name:"Température",unit:"°C",color:"#FBAF05",base:()=>$(10,28),cumul:{label:"Cumul de degrés jour",unit:"°j"}},{id:"humidite",name:"Humidité",unit:"%",color:"#5B12A4",base:()=>$(40,90)}],"CHP-15/30":[{id:"pothydr",name:"Potentiel hydrique",unit:"kPa",color:"#A6C157",base:()=>$(10,150)},{id:"tsol",name:"Température du sol",unit:"°C",color:"#795548",base:()=>$(8,22)}],"CHP-30/60":[{id:"pothydr",name:"Potentiel hydrique",unit:"kPa",color:"#A6C157",base:()=>$(10,150)},{id:"tsol",name:"Température du sol",unit:"°C",color:"#795548",base:()=>$(8,22)}],"CHP-60/90":[{id:"pothydr",name:"Potentiel hydrique",unit:"kPa",color:"#A6C157",base:()=>$(10,150)},{id:"tsol",name:"Température du sol",unit:"°C",color:"#795548",base:()=>$(8,22)}],"CAPA-30-3":[{id:"vwc10",name:"Teneur en eau du sol 10 cm",unit:"%vol",color:"#105200",base:()=>$(15,45)},{id:"vwc20",name:"Teneur en eau du sol 20 cm",unit:"%vol",color:"#8C5E82",base:()=>$(15,45)},{id:"vwc30",name:"Teneur en eau du sol 30 cm",unit:"%vol",color:"#46DA82",base:()=>$(15,45)},{id:"tsol",name:"Température du sol",unit:"°C",color:"#795548",base:()=>$(8,22)}],"CAPA-60-6":[{id:"vwc10",name:"Teneur en eau du sol 10 cm",unit:"%vol",color:"#105200",base:()=>$(15,45)},{id:"vwc20",name:"Teneur en eau du sol 20 cm",unit:"%vol",color:"#8C5E82",base:()=>$(15,45)},{id:"vwc30",name:"Teneur en eau du sol 30 cm",unit:"%vol",color:"#46DA82",base:()=>$(15,45)},{id:"vwc40",name:"Teneur en eau du sol 40 cm",unit:"%vol",color:"#949494",base:()=>$(17,43)},{id:"vwc50",name:"Teneur en eau du sol 50 cm",unit:"%vol",color:"#870021",base:()=>$(18,42)},{id:"vwc60",name:"Teneur en eau du sol 60 cm",unit:"%vol",color:"#F608C2",base:()=>$(18,42)},{id:"tsol",name:"Température du sol",unit:"°C",color:"#795548",base:()=>$(8,22)}],T_MINI:[{id:"tsol",name:"Température du sol",unit:"°C",color:"#795548",base:()=>$(8,22)}],LWS:[{id:"humec",name:"Humectation foliaire",unit:"h",color:"#00887E",base:()=>$(0,12)}],T_GEL:[{id:"tseche",name:"Temp. sèche",unit:"°C",color:"#23B19B",base:()=>$(-2,12)},{id:"thumide",name:"Temp. humide",unit:"°C",color:"#5E88EC",base:()=>$(-4,10)}],W:[{id:"_vent",name:"Vent",unit:"km/h · direction",color:"#7bc4b0",isWindComposite:!0,base:()=>$(0,40)}],EC:[{id:"ec",name:"Conductivité",unit:"mS/cm",color:"#f0a030",base:()=>D(.1,3)},{id:"tsol",name:"Température du sol",unit:"°C",color:"#bb8fce",base:()=>$(8,22)}],PYRANO:[{id:"rayonnement",name:"Rayonnement",unit:"W/m²",color:"#f5c842",base:()=>$(0,900),cumul:{label:"Énergie",unit:"Wh/m²"}}],PAR:[{id:"par",name:"Densité de flux de photons photosynthétiques",unit:"µmol/m²/s",color:"#c47a00",base:()=>$(0,2e3)}]},W=["CHP-15/30","CHP-30/60","CHP-60/90"],Le=[{name:"Tensiomètre (CHP)",models:new Set(["CHP-15/30","CHP-30/60","CHP-60/90"])},{name:"Sonde capacitive (CAPA)",models:new Set(["CAPA-30-3","CAPA-60-6"])},{name:"Sonde fertirrigation (EC)",models:new Set(["EC"])},{name:"Thermomètre de sol (T_MINI)",models:new Set(["T_MINI"])}];function Pe(e){return Le.find(t=>t.models.has(e))||null}const At={"CAPA-30-3":[{depth:10,label:"10 cm",vwcColor:"#105200",tsolColor:"#FFA040"},{depth:20,label:"20 cm",vwcColor:"#8C5E82",tsolColor:"#E07050"},{depth:30,label:"30 cm",vwcColor:"#46DA82",tsolColor:"#A04030"}],"CAPA-60-6":[{depth:10,label:"10 cm",vwcColor:"#105200",tsolColor:"#FFA040"},{depth:20,label:"20 cm",vwcColor:"#8C5E82",tsolColor:"#E07050"},{depth:30,label:"30 cm",vwcColor:"#46DA82",tsolColor:"#A04030"},{depth:40,label:"40 cm",vwcColor:"#949494",tsolColor:"#804828"},{depth:50,label:"50 cm",vwcColor:"#870021",tsolColor:"#603818"},{depth:60,label:"60 cm",vwcColor:"#F608C2",tsolColor:"#402810"}]},Ve=["CAPA-30-3","CAPA-60-6"],Z={"P+":"Station météo",PT:"Station météo",P:"Pluviomètre",SMV:"Station météo virtuelle",TH:"Thermomètre-hygromètre",T_MINI:"Thermomètre de sol",W:"Anémomètre",PYRANO:"Pyranomètre",PAR:"Capteur PAR",LWS:"Capteur d'humectation foliaire",T_GEL:"Capteur de gel","CHP-15/30":"Tensiomètre","CHP-30/60":"Tensiomètre","CHP-60/90":"Tensiomètre","CAPA-30-3":"Sonde capacitive","CAPA-60-6":"Sonde capacitive",EC:"Sonde de fertirrigation"};function Tt(e,t=null,i=null,n=null){const a=Math.max(2,Math.min(200,Math.floor(ue()/we()))),s=Array.from({length:a},()=>$(5,35)),l=s.map(P=>Math.min(P+$(3,18),80)),u=Array.from({length:a},()=>$(0,359)),m=600,r=200,d=46,c=16,o=16,p=28,v=m-d-c,h=r-o-p,f=Math.ceil(Math.max(...l)/10)*10||50,b=P=>d+P/Math.max(a-1,1)*v,g=P=>o+h-P/f*h,w=l.map((P,z)=>`${b(z).toFixed(1)},${g(P).toFixed(1)}`).join("L"),y=[...s].reverse().map((P,z)=>`${b(a-1-z).toFixed(1)},${g(P).toFixed(1)}`).join("L"),S=`M${w}L${y}Z`,C=s.map((P,z)=>`${z?"L":"M"}${b(z).toFixed(1)},${g(P).toFixed(1)}`).join(""),j=[.25,.5,.75].map(P=>{const z=(o+h-P*h).toFixed(1);return`<line x1="${d}" y1="${z}" x2="${m-c}" y2="${z}" stroke="rgba(0,0,0,.06)" stroke-width="1" stroke-dasharray="3,3"/>`}).join(""),B=[0,.5,1].map(P=>{const z=o+h-P*h;return`<text x="${d-4}" y="${(z+4).toFixed(1)}" text-anchor="end" font-size="10" fill="var(--txt3)">${Math.round(P*f)}</text>`}).join(""),M=`<line x1="${d}" y1="${o+h}" x2="${m-c}" y2="${o+h}" stroke="var(--bdr2)" stroke-width="1"/>`,q=Math.max(1,Math.floor(a/6));let k="";for(let P=0;P<a;P+=q){const z=(a-1-P)/Math.max(a-1,1)*ue();k+=`<text x="${b(P).toFixed(1)}" y="${(o+h+14).toFixed(1)}" text-anchor="middle" font-size="10" font-family="var(--font)" fill="var(--txt3)">${$e(z)}</text>`}const A=Math.max(1,Math.round(a/25)),H=[];for(let P=0;P<a;P+=A){const z=b(P).toFixed(1),Mt=(o+h*.35).toFixed(1);H.push(`<g transform="translate(${z},${Mt}) rotate(${u[P]})">
  ...
  </defs>`;for(let k=0;k<=4;k++){const A=o.t+k/4*v,H=g-k/4*w,R=Math.abs(H)>=100?H.toFixed(0):Math.abs(H)>=10?H.toFixed(1):H.toFixed(2);M+=`<line x1="${o.l}" y1="${A.toFixed(1)}" x2="${600-o.r}" y2="${A.toFixed(1)}" stroke="var(--bdr2)" stroke-width="1"/>`,M+=`<text x="${o.l-5}" y="${(A+4).toFixed(1)}" text-anchor="end" font-size="10" font-family="var(--font)" fill="var(--txt3)">${R}</text>`}M+=`<line x1="${o.l}" y1="${o.t+v}" x2="${600-o.r}" y2="${o.t+v}" stroke="var(--bdr2)" stroke-width="1"/>`;const q=Math.max(1,Math.floor(n/6));for(let k=0;k<n;k+=q){const A=y(k).toFixed(1),H=(n-k)*a;M+=`<line x1="${A}" y1="${o.t}" x2="${A}" y2="${o.t+v}" stroke="var(--bdr2)" stroke-width="1" stroke-dasharray="3,3"/>`,M+=`<text x="${A}" y="${o.t+v+14}" text-anchor="middle" font-size="10" font-family="var(--font)" fill="var(--txt3)">${$e(H)}</text>`}if(l==="bar"){const k=Math.max(2,p/n*.65);f.forEach((A,H)=>{if(A<=0)return;const R=y(H),N=S(A),he=o.t+v-N;M+=`<rect x="${(R-k/2).toFixed(1)}" y="${N.toFixed(1)}" width="${k.toFixed(1)}" height="${he.toFixed(1)}" fill="url(#${C})" opacity="0.9" rx="1"/>`})}else{const k=f.map((R,N)=>({x:y(N),y:S(R)})),A=We(k),H=A+` L${y(n-1).toFixed(1)},${o.t+v} L${o.l.toFixed(1)},${o.t+v} Z`;M+=`<path d="${H}" fill="${B}" opacity="0.07" clip-path="url(#clip_${C})"/>`,M+=`<path d="${A}" fill="none" stroke="url(#${C})" stroke-width="2" stroke-linejoin="round" stroke-linecap="round" clip-path="url(#clip_${C})"/>`}M+=`<rect class="chart-hover-rect" x="${o.l}" y="${o.t}" width="${p}" height="${v}" fill="transparent" style="cursor:crosshair"/>`,e.innerHTML=M,oi(e,f,y,S,b,g,n,a,m,r,i,o,600)}function oi(e,t,i,n,a,s,l,u,m,r,d,c,o,p){const v=Qt(),h=e.querySelector(".chart-hover-rect");if(!h)return;const b=document.createElementNS("http://www.w3.org/2000/svg","circle");b.setAttribute("r","4"),b.setAttribute("fill",d),b.setAttribute("stroke","#fff"),b.setAttribute("stroke-width","1.5"),b.style.display="none",b.style.pointerEvents="none",e.appendChild(b),h.addEventListener("mousemove",g=>{const w=e.getBoundingClientRect(),y=o/w.width,S=(g.clientX-w.left)*y,C=o-c.l-c.r,j=Math.max(0,Math.min(1,(S-c.l)/C)),B=Math.round(j*(l-1));if(B<0||B>=t.length)return;const M=t[B],q=i(B),k=n(M);b.setAttribute("cx",q),b.setAttribute("cy",k),b.style.display="";const A=(l-B)*u,H=$e(A),R=Math.abs(M)>=100?M.toFixed(1):M.toFixed(2);v.innerHTML=`
  ...
  `,Q(t,"name",i.name||"",r=>{O({name:r}),dt(r,{label:"Parcelles",href:"parcelles.html"})}),Q(t,"crop",s,r=>O({crop:r})),Q(t,"env",l||"",r=>O({env:r||null})),Q(t,"texture",n||"",r=>{const d=r||null,c={texture:d};d!==je&&(c.soilAnalysis=null),O(c),yt(e)}),u&&(Q(t,"soilArgile",String(m.argile??""),r=>O({soilAnalysis:{...x.soilAnalysis,argile:+r}})),Q(t,"soilLimon",String(m.limon??""),r=>O({soilAnalysis:{...x.soilAnalysis,limon:+r}})),Q(t,"soilSable",String(m.sable??""),r=>O({soilAnalysis:{...x.soilAnalysis,sable:+r}}))),Q(t,"irrigation",a||"",r=>O({irrigation:r||null}))}function xe(e,t,i,n="text"){const a=(t||"").replace(/"/g,"&quot;");return`
    ...
    </div>`}function Ae(e,t,i,n,a="—"){const l=n.includes(a)?"":`<option value=""${t?"":" selected"}>${a}</option>`;return`
    <div class="panel-row" data-field="${i}">
      <span class="panel-row-key">${e}</span>
      <select class="panel-field-input" data-val>
        ${l}

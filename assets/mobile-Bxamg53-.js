...
import"./modulepreload-polyfill-B5Qt9EMX.js";import{p as re}from"./plots-DhtWL7s_.js";import{d as Ne,b as Ds,c as Re,l as In}from"./store-CX9wca99.js";import{s as ce}from"./sensors-CRadjF8G.js";import{o as we}from"./orgs-DnFmvGlp.js";import{n as Ge}from"./network-YzWdS0n_.js";import{I as me,s as nt,g as jn}from"./irrigations-C22Dtsoo.js";import{I as Xt,S as Di,M as zs,A as gi,a as $t,E as qn,b as ni}from"./constants-CJpDUNiw.js";import{m as ai}from"./members-Cr98hVG_.js";const Pn="modulepreload",Dn=function(e){return"/weenat-proto/"+e},Ni={},ye=function(i,t,n){let a=Promise.resolve();if(t&&t.length>0){document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),l=(s==null?void 0:s.nonce)||(s==null?void 0:s.getAttribute("nonce"));a=Promise.allSettled(t.map(m=>{if(m=Dn(m),m in Ni)return;Ni[m]=!0;const d=m.endsWith(".css"),p=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${m}"]${p}`))return;const v=document.createElement("link");if(v.rel=d?"stylesheet":Pn,d||(v.as="script"),v.crossOrigin="",v.href=m,l&&v.setAttribute("nonce",l),document.head.appendChild(v),d)return new Promise((u,c)=>{v.addEventListener("load",u),v.addEventListener("error",()=>c(new Error(`Unable to preload CSS for ${m}`)))})}))}function o(s){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=s,window.dispatchEvent(l),!l.defaultPrevented)throw s}return a.then(s=>{for(const l of s||[])l.status==="rejected"&&o(l.reason);return i().catch(o)})},ct=[];function $e(e){const i=document.getElementById("phone-screen"),t=document.createElement("div");return t.className="m-detail-layer",t.innerHTML=e,i.appendChild(t),requestAnimationFrame(()=>t.classList.add("m-detail-layer--in")),ct.push(t),t}function fe(){const e=ct.pop();e&&(e.classList.remove("m-detail-layer--in"),setTimeout(()=>e.remove(),300))}function Vi(){return ct.length}function zn(){return ct.some(e=>e.dataset.dirty==="true")}function _s(){ct.forEach(e=>delete e.dataset.dirty)}window.addEventListener("m-tab-change",()=>{ct.forEach(e=>e.remove()),ct.length=0});const _n=[{key:"orgs",label:"Organisations",icon:"bi-building",desc:"Ajouts de membres, changements d'organisation, nouvelles exploitations"},{key:"capteurs",label:"Capteurs",icon:"bi-broadcast",desc:"Anomalies, changements d'état, mise à jour firmware"},{key:"alertes",label:"Alertes",icon:"bi-bell",desc:"Déclenchements de seuils et alertes météo configurées"}],Wi=[{key:"email",label:"Email",icon:"bi-envelope"},{key:"sms",label:"SMS",icon:"bi-phone"},{key:"push",label:"Push",icon:"bi-bell"}],Fn=["Mon réseau","Mon organisation","Mon secteur"],oi={orgs:"Mon organisation",capteurs:"Mon réseau",alertes:"Mon secteur"},Ji={orgs:{email:!0,sms:!1,push:!0},capteurs:{email:!0,sms:!1,push:!0},alertes:{email:!0,sms:!0,push:!0}};function Bn(e){let i=(()=>{try{return JSON.parse(localStorage.getItem("weenat-mobile-notif"))||JSON.parse(JSON.stringify(Ji))}catch{return JSON.parse(JSON.stringify(Ji))}})(),t=(()=>{try{return JSON.parse(localStorage.getItem("weenat-mobile-notif-peri"))||JSON.parse(JSON.stringify(oi))}catch{return JSON.parse(JSON.stringify(oi))}})();function n(){localStorage.setItem("weenat-mobile-notif",JSON.stringify(i)),localStorage.setItem("weenat-mobile-notif-peri",JSON.stringify(t)),e("Préférences enregistrées")}function a(s){const l=i[s.key]||{},m=t[s.key]||oi[s.key];return`
      ...
      <div class="m-list">
        ${Wi.map((d,p)=>{const v=p===Wi.length-1&&!0;return`<div class="m-list-row">
        ...
        <div class="m-list-row m-list-row--last" style="align-items:center;gap:8px">
          ...
          <select class="notif-peri-sel" data-cat="${s.key}" style="border:none;background:transparent;font-size:14px;color:#636366;font-family:inherit;text-align:right;flex:1;min-width:0;outline:none;cursor:pointer">
            ${Fn.map(d=>`<option value="${d}"${d===m?" selected":""}>${d}</option>`).join("")}
          </select>
        </div>
      </div>`}const o=$e(`
  ...
  `,n.querySelector(".m-sheet-key-copy").addEventListener("click",()=>{var o;(o=navigator.clipboard)==null||o.writeText(e.value).catch(()=>{}),Ve("Clé copiée !")});const a=dt({title:"Clé API",body:n,doneLabel:"Fermer",onDone:()=>{}});n.querySelector(".m-sheet-key-delete").addEventListener("click",()=>{const o=i.findIndex(s=>s.id===e.id);o!==-1&&i.splice(o,1),a.classList.remove("m-sheet-overlay--show"),setTimeout(()=>{a.remove(),t()},280),Ve("Clé supprimée")})}function Nn(){const e="ABCDEFGHJKLMNPQRSTUVWXYZabcdefghjkmnpqrstuvwxyz23456789";return"sk-wnt-"+Array.from({length:32},()=>e[Math.floor(Math.random()*e.length)]).join("")}function Vn(e){const i=document.createElement("div");i.innerHTML='<input class="m-sheet-input" type="text" placeholder="Nom de la clé (ex: Application mobile)">';const t=i.querySelector("input");dt({title:"Nouvelle clé API",body:i,doneLabel:"Générer",onDone:()=>{const n=t.value.trim();if(!n){Ve("Entrez un nom");return}const a={id:Date.now(),name:n,created:new Date().toLocaleDateString("fr-FR"),value:Nn()};e(a),Ve("Clé générée")}}),setTimeout(()=>t.focus(),300)}function Wn(e,i){Qe={profile:JSON.parse(JSON.stringify(Gi[i]||Gi.admin)),langue:"Français",unites:Ui[0]};const n=localStorage.getItem("mobile_avatarUrl")||null;function a(){const s=Qe.profile,l=n?`<img src="${n}" alt="avatar" style="width:100%;height:100%;object-fit:cover">`:`<span>${s.initials}</span>`,m=s.apiKeys.map(p=>`
    ...
    <div class="m-sheet">
      ...
      <div class="m-sheet-body" style="padding:4px 16px 32px">
        ...
        <div class="m-alert-card" data-id="${s.id}">
          ...
          <button class="m-widget-details-link m-alert-detail-btn" type="button" data-id="${s.id}" style="margin:8px 14px 14px;width:calc(100% - 28px)">Voir détails →</button>
        </div>`}).join(""),o()}function o(){t.querySelectorAll(".m-alert-toggle input").forEach(s=>{s.addEventListener("change",l=>{l.stopPropagation();const m=+s.dataset.id,d=n.find(p=>p.id===m);d&&(d.statut=s.checked?"actif":"inactif",a(),X(`Alerte ${s.checked?"activée":"désactivée"}`))})}),t.querySelectorAll(".m-alert-edit-btn").forEach(s=>{s.addEventListener("click",l=>{l.stopPropagation(),X("Modification à venir")})}),t.querySelectorAll(".m-alert-detail-btn").forEach(s=>{s.addEventListener("click",l=>{l.stopPropagation();const m=+s.dataset.id,d=n.find(f=>f.id===m);if(!d)return;Xi(d);const p=document.createElement("div"),v=Jn(m);function u(){const f=d.sensorIds.map((k,A)=>{const q=ce.find($=>$.id===k);return q?{label:`${q.model} ${q.serial}`,type:"sensor",idx:A}:null}).filter(Boolean),S=d.parcelIds.map((k,A)=>{const q=re.find($=>$.id===k);return q?{label:q.name,type:"parcel",idx:A}:null}).filter(Boolean),h=[...f,...S];return h.length?h.map(k=>`<div class="m-perimetre-item" data-type="${k.type}" data-idx="${k.idx}">
                <span>${k.label}</span>
            ...
            <div class="m-sheet-info-row"><span>Métrique</span><span>${Zi[d.metric]||d.metric}</span></div>
            <div class="m-sheet-info-row"><span>Paramètres</span><span>${d.params||"—"}</span></div>
            <div class="m-sheet-info-row"><span>Dernier déclenchement</span><span>${li(d.lastTriggered)}</span></div>
            <div class="m-sheet-info-row"><span>Créée le</span><span>${li(d.created)}</span></div>
    ...
    ${xi(n,!1)}
  </div>${a}`}function $i({title:e,body:i,onSave:t,onDelete:n,saveLabel:a="Enregistrer"}){var m,d;const o=document.getElementById("phone-screen");(m=document.querySelector(".irr-sheet-overlay"))==null||m.remove();const s=document.createElement("div");s.className="irr-sheet-overlay",s.innerHTML=`
    <div class="irr-sheet">
  ...
  `));c.dataset.dirty="true",v(c),p(c),c.querySelector("#irr-back").addEventListener("click",fe),c.querySelector("#irr-date").addEventListener("change",r=>{s=r.target.value,d(c),p(c)}),c.querySelector("#irr-qty").addEventListener("input",r=>{l=parseInt(r.target.value)||1,p(c)}),c.querySelector(".irr-save-btn").addEventListener("click",()=>{const r=o;Hs(r,e,()=>{const g=s>Ie;r.forEach(k=>{me.push({iso:s,mm:l,real:!g,plotId:k,fromStrategy:!1})}),nt();const S=[{title:null,names:[...r].map(k=>{var A;return(A=e.find(q=>q.id===k))==null?void 0:A.name}).filter(Boolean)}],h=r.size===1?String([...r][0]):"all";_s(),Os({title:r.size>1?"Irrigations enregistrées":"Irrigation enregistrée",params:[{label:"Date",value:wt(s)},{label:"Quantité",value:`${l} mm`}],parcelSections:S,isFut:g,plots:e,calFilter:h,addedCount:r.size,stackDepth:1,backToParcel:n,onBack:a})})})}function wi(e,i,t=null,n=null,a=!1,o=null){let s=new Set((t==null?void 0:t.ids)??[]),l=Ie,m=new Date(new Date().setMonth(new Date().getMonth()+4)).toISOString().split("T")[0],d=10,p=7,v=null,u=null;if(n){const h=me.filter(k=>k.fromStrategy&&n.has(k.seasonId));if(h.length){const k=h.map(q=>q.iso).sort();l=k[0],m=k[k.length-1],d=h[0].mm;const A=[...new Set(k)];p=A.length>=2?Math.round((new Date(A[1])-new Date(A[0]))/864e5):7,v=l,u=m}}function c(){if(!l||!m||p<=0)return[];const h=[],k=new Date(m);let A=new Date(l);for(;A<=k&&h.length<100;)h.push(new Date(A)),A.setDate(A.getDate()+p);return h}function r(){const h=c();s.size;const k=h.length>0?`<span class="irr-preview-ok">↗ ${h.length} irrigations · ${h.length*d} mm au total</span>`:'<span style="color:#8e8e93">Ajustez les dates et la fréquence</span>';return`
  ...
  `));S.querySelector("#conf-edit").addEventListener("click",()=>{s>0&&me.splice(me.length-s,s),fe()}),S.querySelector("#conf-back").addEventListener("click",()=>{for(let h=0;h<=l;h++)fe();d==null||d()}),S.querySelector("#conf-calendar").addEventListener("click",()=>{Ns(a,o)})}const Qn=["jan","fév","mar","avr","mai","jun","jul","aoû","sep","oct","nov","déc"];function Ns(e,i){let t=i||"";function n(c){if(!c||c==="all")return null;const r=e.find(g=>String(g.id)===String(c));return r?{ids:[r.id],label:r.name}:null}function a(){return!t||t==="all"?me:me.filter(c=>c.plotId===+t)}function o(c){const r=c.filter(h=>h.real),g=c.filter(h=>!h.real),f=r.reduce((h,k)=>h+k.mm,0),S=g.reduce((h,k)=>h+k.mm,0);return`<div class="irr-cumuls-bar">
      ...
      <div class="irr-fields-row" style="margin-bottom:10px">
        <div class="irr-field-card">
          ...
          <div id="edit-date-hint">${yi(c.iso)}</div>
        </div>
        <div class="irr-field-card">
          <div class="irr-field-lbl">Quantité <span class="irr-unit">(mm)</span></div>
  ...
  `));u.querySelector("#cal-back").addEventListener("click",fe),u.querySelector("#cal-filter-sel").addEventListener("change",c=>{t=c.target.value,p(u)}),p(u)}const et=Object.freeze(Object.defineProperty({__proto__:null,buildSelectionHTML:Qt,checkIcon:xi,flexLayer:ut,goToPlot:Bs,openCalendar:Ns,openIrrigationSaisie:Rs,openIrrigationStrategie:wi},Symbol.toStringTag,{value:"Module"})),ea=[{name:"Allier AgriTech",distance:8,adherents:31,capteurs:198,parcelles:1140,sharedSensorTypes:["Capteurs météo","Capteurs d'irrigation"]},{name:"Auvergne Agri Conseil",distance:15,adherents:54,capteurs:361,parcelles:2080,sharedSensorTypes:["Capteurs météo","Stations météo virtuelles"]},{name:"Réseau Bourbonnais",distance:22,adherents:18,capteurs:112,parcelles:630,sharedSensorTypes:["Capteurs météo","Capteurs d'irrigation"]},{name:"Creuse Agri Net",distance:38,adherents:12,capteurs:74,parcelles:410,sharedSensorTypes:["Capteurs d'irrigation"]},{name:"Puy-de-Dôme Connect",distance:45,adherents:39,capteurs:255,parcelles:1490,sharedSensorTypes:["Capteurs météo","Stations météo virtuelles"]}],ts={name:"Breiz'Agri Conseil",city:"Rennes (35)",phone:"02 99 XX XX XX",email:"contact@breizagri.fr",capteurs:312,parcelles:1830,sharedSensorTypes:["Capteurs météo"]},ta=["Capteurs météo","Capteurs d'irrigation","Stations météo virtuelles"];function is(e){return e.split(" ").filter(i=>i.length>2).slice(0,2).map(i=>i[0].toUpperCase()).join("")}const He={prenom:"Pierre",nom:"Jourdain",email:"pierre@gaec-jourdain.fr",phone:"06 71 23 45 67",orgName:"GAEC Jourdain",adresse:"Lieu-dit La Croix Blanche, 03500 Saint-Pourçain-sur-Sioule",selectedPlan:"expert",joinNetwork:!0},Vs={"P+":"Station météo",PT:"Station météo",P:"Pluviomètre",TH:"Thermomètre-hygromètre",SMV:"Station météo virtuelle",W:"Anémomètre",PYRANO:"Pyranomètre",PAR:"Capteur PAR",LWS:"Capteur d'humectation foliaire",T_GEL:"Sonde gel",T_MINI:"Thermo. sol","CHP-15/30":"Tensiomètre 15/30 cm","CHP-30/60":"Tensiomètre 30/60 cm","CHP-60/90":"Tensiomètre 60/90 cm","CAPA-30-3":"Sonde capacitive","CAPA-60-6":"Sonde capacitive",EC:"Fertirrigation"},ia={"P+":["pluie","temperature","humidite"],PT:["pluie","temperature"],P:["pluie"],TH:["temperature","humidite"],SMV:["pluie","temperature","humidite"],"CHP-15/30":["pothydr","temp_sol"],"CHP-30/60":["pothydr","temp_sol"],"CHP-60/90":["pothydr","temp_sol"],"CAPA-30-3":["teneur","temp_sol"],"CAPA-60-6":["teneur","temp_sol"],EC:["teneur","temp_sol"]},sa=new Set(["CHP-15/30","CHP-30/60","CHP-60/90"]),na={"CHP-15/30":[15,30],"CHP-30/60":[30,60],"CHP-60/90":[45,90]},ri=[{id:"essential",name:"Weenat Essential",priceNum:0,price:"Gratuit",color:"#636366",features:["Aucun capteur physique","Historique illimité","Alertes","Accès API","2 stations météo virtuelles","Parcelles illimitées"]},{id:"plus",name:"Weenat Plus",priceNum:16.5,price:"16,5 €/mois",color:"#00B093",features:["Historique illimité","Alertes","Intégrations","Exports","Accès API","2 stations météo virtuelles","Parcelles illimitées"]},{id:"expert",name:"Weenat Expert",priceNum:30,price:"30 €/mois",color:"#006798",features:["Historique illimité","Alertes","Intégrations","Exports","Accès API","2 stations météo virtuelles","Parcelles illimitées","Capteurs irrigation","Fonctionnalités irrigation"]}],ci={Administrateur:[{section:"Parcelles",items:[{label:"Consulter et exporter les données",ok:!0},{label:"Créer, modifier, archiver et supprimer",ok:!0}]},{section:"Capteurs",items:[{label:"Consulter et exporter les données",ok:!0},{label:"Ajouter, retirer et lier à une parcelle",ok:!0}]},{section:"Membres",items:[{label:"Consulter les informations",ok:!0},{label:"Inviter, modifier et retirer",ok:!0}]},{section:"Exploitations adhérentes",items:[{label:"Consulter les informations",ok:!0},{label:"Inviter, modifier et retirer",ok:!0}]},{section:"Facturation",items:[{label:"Consulter et modifier les informations",ok:!0}]}],Agent:[{section:"Parcelles",items:[{label:"Consulter et exporter les données",ok:!0},{label:"Créer, modifier, archiver et supprimer",ok:!0}]},{section:"Capteurs",items:[{label:"Consulter et exporter les données",ok:!0},{label:"Ajouter, retirer et lier à une parcelle",ok:!0}]},{section:"Membres",items:[{label:"Consulter les informations",ok:!0},{label:"Inviter, modifier et retirer",ok:!1}]},{section:"Exploitations adhérentes",items:[{label:"Consulter les informations",ok:!0},{label:"Inviter, modifier et retirer",ok:!1}]},{section:"Facturation",items:[{label:"Consulter et modifier les informations",ok:!1}]}],Lecteur:[{section:"Parcelles",items:[{label:"Consulter et exporter les données",ok:!0},{label:"Créer, modifier, archiver et supprimer",ok:!1}]},{section:"Capteurs",items:[{label:"Consulter et exporter les données",ok:!0},{label:"Ajouter, retirer et lier à une parcelle",ok:!1}]},{section:"Membres",items:[{label:"Consulter les informations",ok:!0},{label:"Inviter, modifier et retirer",ok:!1}]},{section:"Exploitations adhérentes",items:[{label:"Consulter les informations",ok:!1},{label:"Inviter, modifier et retirer",ok:!1}]},{section:"Facturation",items:[{label:"Consulter et modifier les informations",ok:!1}]}]};function aa(e,i,t,n){const a=i==="essential",o=i==="expert";return e==="new-member-admin"||e==="new-member-agent"||e==="new-member-reader"?["signup","verify","emailVerified","creating","done"]:e==="new-adherent"?["signup","verify","emailVerified","orgName","geoloc","orgInfo","networkInfo","invite","plan",...o?["volumeChoice"]:[],"creating","done"]:["signup","verify","emailVerified","orgName","geoloc","orgInfo","networkChoice",...t?["networkPick"]:[],"invite","plan",...a?[]:["payment","paymentConfirmed"],...o?["volumeChoice"]:[],"creating","done"]}function oa(e,i,t,n){return aa(e,i,t)}const la={signup:"Inscription",verify:"Vérification",orgName:"Exploitation",geoloc:"Localisation",orgInfo:"Informations",networkChoice:"Réseau",networkPick:"Choisir un réseau",networkInfo:"Mon réseau",invite:"Invitations",plan:"Abonnement",payment:"Paiement",paymentConfirmed:"Paiement",volumeChoice:"Volume autorisé",parcelMap:"Parcelle",parcelSource:"Source de données",parcelConfig:"Paramétrage",parcelDone:"Confirmation"};function ra(e,i){const t=document.getElementById("phone-screen");let n=0,a=e==="new-adherent"?"expert":He.selectedPlan,o=He.joinNetwork,s=!1,l=0,m=!0,d=46.3021,p=3.2938,v=null,u=null,c="smv",r=[],g="Parcelle 1";const f=document.createElement("div");f.id="onboarding-overlay",f.className="m-ob-overlay",t.appendChild(f);function S(){return oa(e,a,o)}function h(){return S()[n]}function k(){return S().filter(J=>!["creating","done","parcelDone","emailVerified","paymentConfirmed"].includes(J)).length}function A(){return ri.find(J=>J.id===a)}function q(){const J=S().slice(0,n).filter(V=>V!=="creating"&&V!=="done"&&V!=="parcelDone").length;return`<div class="m-ob-progress-bar"><div class="m-ob-progress-fill" style="width:${Math.round(J/k()*100)}%"></div></div>`}function $(J,U=!0){const V=h(),H=new Set(["creating","done","parcelDone","emailVerified","paymentConfirmed"]),_=U&&n>0&&!H.has(V),R=la[V]||"";return`
    ...
    `)}function x(){const J=zs.map(U=>`<button type="button" class="m-ob-pill" data-metier="${U}">${U}</button>`).join("");return $(`
    ...
    `)}function T(){var U;const J=ts;return $(`
      <div class="m-ob-hero m-ob-hero--compact">
    ...
    `)}function O(){const J=e==="new-adherent",U=ts;if(J){const H=ri.find(R=>R.id==="expert"),_=H.features.map(R=>`<li class="m-ob-feat-item"><i class="bi bi-check-circle-fill" style="color:${H.color}"></i> ${R}</li>`).join("");return $(`
        <div class="m-ob-hero m-ob-hero--compact">
      ...
      <button class="m-ob-cta" id="ob-next" style="margin-top:20px">Continuer</button>
    `)}function N(){const J=A(),U=l+1,V=U*J.priceNum,H=V*12,_=R=>R%1===0?`${R}`:R.toFixed(1).replace(".",",");return $(`
      <div class="m-ob-hero m-ob-hero--compact">
    ...
    `)}function Ee(){const J=new Set(["CHP-15/30","CHP-30/60","CHP-60/90","CAPA-30-3","CAPA-60-6","EC"]),U=new Set(["EC"]),V=ce.filter(R=>r.includes(R.id)),H=V.some(R=>J.has(R.model)),_=V.some(R=>U.has(R.model));return $(`
      <div class="m-ob-hero m-ob-hero--compact">
...
<circle cx="${_}" cy="${C}" r="4.5" fill="#4CAF50" stroke="#fff" stroke-width="1.5" style="pointer-events:none"/>`}).join("");let Q="",W="";for(let V=n;V<n+a;V++){const H=new Date(d.getTime()+V*864e5);if(H.getDate()===1){const _=D(V).toFixed(1);Q+=`<line x1="${_}" y1="${u.t}" x2="${_}" y2="${C}" stroke="rgba(0,0,0,.18)" stroke-width="1" stroke-dasharray="3,4"/>`;const R=new Date(H.getFullYear(),H.getMonth()+1,1),Y=Math.round((R-d)/864e5),K=Math.min(Y,n+a-1),le=D((V+K)/2).toFixed(1),ae=String(H.getFullYear()).slice(-2),ge=`${Ks[H.getMonth()]} ${ae}`;W+=`<text x="${le}" y="${i-6}" text-anchor="middle" font-size="12" font-family="-apple-system,sans-serif" fill="#8e8e93">${ge}</text>`}}const Z=`
  ...
  </div>`}function $a(e,i){const{nDays:t,nFcDays:n,pluie:a,etp:o,drainage:s,irrigation:l}=e,m=e.reservoir.length,{startIdx:d,displayLen:p}=Ys(i,t,n,m),v=Math.min(d+p,t),u=r=>r.slice(d,v).reduce((g,f)=>g+f,0),c=(r,g,f)=>`<div style="display:flex;justify-content:space-between;align-items:baseline;gap:6px;padding:11px 0;border-bottom:.5px solid rgba(0,0,0,.07)">
  ...
  </div>`}function wa(e,i,t,n,a){const{reservoir:o,ru:s,rfu:l,nDays:m,nFcDays:d,apr1:p,ruArr:v,rfuArr:u,pluie:c,etp:r,drainage:g,irrigation:f}=i,S=Zs,h=a+Ei.t,k=e.clientWidth,A=e.clientHeight,q=k-S.l-S.r;e.style.position="relative";const $=document.createElement("div");$.style.cssText="position:absolute;background:rgba(28,28,30,.88);color:#fff;border-radius:10px;padding:6px 11px;font-size:13px;font-weight:600;pointer-events:none;display:none;white-space:nowrap;z-index:20;transform:translate(-50%,-100%);margin-top:-10px;font-family:-apple-system,sans-serif;box-shadow:0 2px 10px rgba(0,0,0,.25)";const E=document.createElement("div");E.style.cssText=`position:absolute;width:1px;background:rgba(100,100,100,.35);pointer-events:none;display:none;top:${S.t}px`,E.style.height=A-S.t-Ei.b+"px",e.appendChild(E),e.appendChild($);const F=b=>{const y=Math.max(0,Math.min(1,(b-S.l)/q));return Math.max(0,Math.min(o.length-1,Math.round(t+y*(n-1))))},D=(b,y,T)=>{const j=o[b],z=b>=m,B=v?v[Math.min(b,v.length-1)]:s,L=u?u[Math.min(b,u.length-1)]:l,M=+(j-B).toFixed(1),O=ei(j,L,B),N=I(b);$.innerHTML=`<span style="color:${O}">${M} mm</span>&ensp;<span style="font-size:11px;opacity:.7">${N}${z?" ·&thinsp;prév.":""}</span>`,$.style.left=Math.max(60,Math.min(e.clientWidth-60,y))+"px",$.style.top=Math.min(T,a-20)+"px",$.style.display="block"},C=(b,y,T)=>{const j=I(b),B=[...b>m+d?[]:[["#2E75B6","Pluie",c[b]],["#00887E","ETP",r[b]],["#8B1A1A","Drainage",g[b]]],["#FF8C00","Irrigation",f[b]]].filter(([,,L])=>L>0);$.innerHTML=B.length?B.map(([L,M,O])=>`<span style="color:${L}">${M} ${O} mm</span>`).join("&ensp;·&ensp;")+`&ensp;<span style="font-size:11px;opacity:.7">${j}</span>`:`<span style="opacity:.7">Aucun mouvement</span>&ensp;<span style="font-size:11px;opacity:.7">${j}</span>`,$.style.left=Math.max(60,Math.min(e.clientWidth-60,y))+"px",$.style.top=Math.max(h+14,Math.min(T,e.clientHeight-10))+"px",$.style.display="block"},I=b=>new Date(p.getTime()+b*864e5).toLocaleDateString("fr-FR",{day:"numeric",month:"short"}),P=(b,y)=>{const T=e.getBoundingClientRect(),j=y-T.top;if(j>e.clientHeight){w();return}const z=b-T.left,B=F(z);j<=a?D(B,z,j):C(B,z,j),E.style.left=z+"px",E.style.display="block"},w=()=>{$.style.display="none",E.style.display="none"};e.addEventListener("mousemove",b=>P(b.clientX,b.clientY)),e.addEventListener("mouseleave",w),e.addEventListener("touchmove",b=>{b.preventDefault(),P(b.touches[0].clientX,b.touches[0].clientY)},{passive:!1}),e.addEventListener("touchend",w);let x=null;e.querySelectorAll(".il-stade-dot").forEach(b=>{b.addEventListener("click",y=>{y.stopPropagation();const T=e.getBoundingClientRect(),j=y.clientX-T.left,z=y.clientY-T.top;$.innerHTML=`<span style="color:#34c759">${b.dataset.label}</span>`,$.style.left=Math.max(60,Math.min(e.clientWidth-60,j))+"px",$.style.top=z+"px",$.style.display="block",E.style.display="none",clearTimeout(x),x=setTimeout(w,2200)})})}function Sa(e,i,t="saison"){const n=e.clientWidth,a=e.clientHeight;if(!n||!a)return;const{nDays:o,nFcDays:s}=i,l=i.reservoir.length,{startIdx:m,displayLen:d}=Ys(t,o,s,l),p=Math.round(a*3/5),v=a-p;e.innerHTML=ga(n,p,i,m,d)+ya(n,v,i,m,d),wa(e,i,m,d,p)}function ka(e,i){const t=ft(e.id),n=document.createElement("div");n.innerHTML=`
  ...
  </div>`:'<div class="m-widget-empty"><i class="bi bi-droplet" style="color:#0172A4;font-size:28px"></i><p>Aucune parcelle avec le service Irré-LIS</p></div>'}function ht(e,i=!1,t=vt().sensorlessEnabled??!0,n=vt().irrigAdvisor??!1){if(!e.length)return'<div class="m-widget-empty"><i class="bi bi-check-circle" style="color:#30d158;font-size:28px"></i><p>Aucune parcelle</p></div>';const a=$=>$.id%3===2,o=e.slice(),s=($,E)=>os(E).bilan-os($).bilan,l=o.slice().sort(s),m=i?l:l.slice(0,ds),d=new Set(m.map($=>$.id)),p=l.length-m.length,v=$=>Math.round(($.id*2.3+7)%32*10)/10,u=$=>Math.round((($.id*1.1+14)%14+10)*10)/10,c="font-size:11px;font-weight:700;color:#8e8e93;text-align:right;padding-bottom:6px;text-transform:uppercase;letter-spacing:.03em;line-height:1.3",r=$=>`<span style="display:block;font-size:9px;font-weight:400;text-transform:none;color:#b0aead;letter-spacing:0">${$}</span>`,g="border-top:none",f=($,E)=>{const F=Da($),D=v($),C=u($),I=E===0?"border-top:none":"border-top:.5px solid rgba(0,0,0,.18);padding-top:8px;margin-top:2px",P=`<button class="m-bh-th-n m-bh-plot-link" data-plot-id="${$.id}" style="grid-column:1/-1;white-space:normal;overflow:visible;text-overflow:unset;text-align:left;${I}">${$.name}</button>`;if(n){const x=a($)?za($):null,b=x!==null?F>=x?"#24B066":"#E05252":null,y=x!==null?`<span style="color:${b};font-weight:700">${x}</span>`:'<span style="color:#c7c7cc">—</span>';return`
        ${P}
  ...
  `));l(m),s(m),m.querySelector("#trait-back").addEventListener("click",fe),m.querySelector(".irr-save-btn").addEventListener("click",()=>{const d=m.querySelector("#trait-date").value||a,p=m.querySelector("#trait-produit").value.trim()||"—",v=m.querySelector("#trait-dose").value.trim()||"—",u=Et();u.unshift({id:Date.now(),date:d,produit:p,dose:v,plotIds:[...t]}),Fi(u),fe(),i("Traitement enregistré")})}function Wa(e,i,t){const n=i==="adherent"?tn.adherent:null,a=n!==null?re.filter(d=>d.orgId===n):re;let o=null;const s=$e(`
    ...
    ${Object.entries(t).map(([a,o])=>{const s=o.map(l=>{const m=!!dn[l.crop],d=m?Ka(l):null,p=m&&d.variety!=="—"?d.variety:"",v=m?d.stage.split(" (BBCH")[0]:"Stade non renseigné";return`<div class="m-w-row m-w-row--clickable" data-plot-id="${l.id}">
    ...
    <div class="m-sheet m-chat-sheet">
      ...
      </div>`}function A(){d==null||d.remove(),d=null,l=as();const w=new Set(["previsions","support"]),x=Ae.filter(y=>y.active&&!y.fixed&&(i!=="new"||w.has(y.id))),b=Ae.filter(y=>y.active&&y.fixed&&(i!=="new"||w.has(y.id)));t.innerHTML=`
      ...
      ${[...x,...b].map(y=>{let T="";return y.id==="bilan_hydrique"?T=v()+ht(p()):y.id==="previsions"?T=Fa(a,s,l):y.id==="cumuls"?T=vs(a,s):y.id==="temps_reel"?T=cs(a,s):y.id==="traitements"?T=Na(a):y.id==="evenements"?T=Ua(a,s):y.id==="cultures"?T=Za(a):y.id==="notes"?T=bs(i):y.id==="radar_pluie"?T=S():y.id==="irrelis"?T=_a(a):y.id==="mon_reseau"?T=Xa(i):y.id==="support"&&(T=Qa()),k(y,T)}).join("")}
      ...
      </div>`);x.querySelector(".m-detail-back").addEventListener("click",fe),x.querySelectorAll(".m-add-item").forEach(b=>{b.addEventListener("click",()=>{const y=b.dataset.action;y==="irrigation"?(fe(),ye(()=>Promise.resolve().then(()=>et),void 0).then(T=>T.openIrrigationSaisie(a,Ue))):y==="strategie-irrigation"?(fe(),ye(()=>Promise.resolve().then(()=>et),void 0).then(T=>T.openIrrigationStrategie(a,Ue))):Ue("Fonctionnalité à venir")})})}function P(){const w=document.createElement("div"),x=()=>{const b=Ae.filter(y=>!y.fixed);w.innerHTML=b.map(y=>`
...
`),`${g}_${t}_${new Date().toISOString().slice(0,10)}.csv`)}function jo(e,i="7d",t="1h",n=null){const a=new Set,o={};e.forEach(c=>{const r=ce.find(g=>g.id===c);r&&(Ct[r.model]||[]).forEach(g=>{a.add(g),o[g]||(o[g]=c)})});const s=me.some(c=>c.plotId===n),l=new Set(["CHP-15/30","CHP-30/60","CHP-60/90","CAPA-30-3","CAPA-60-6","EC"]),m=e.some(c=>{const r=ce.find(g=>g.id===c);return r&&l.has(r.model)}),d=["pluie","irrigation","temperature","humidite","pothydr","teneur","temp_sol","vent","rayonnement","humectation","par","temp_rosee","etp"],p=[...new Set([...a,"etp","rayonnement","temp_rosee",...m?["rfu"]:["nrs"],...s?["irrigation"]:[]])].filter(c=>We[c]).sort((c,r)=>{const g=d.indexOf(c),f=d.indexOf(r);return(g===-1?999:g)-(f===-1?999:f)}),v=new Date().toISOString().slice(0,10),u=new Date(Date.now()-7*864e5).toISOString().slice(0,10);return`
    ...
    <div class="m-detail-section">
      ${(()=>{const c=e[0]??null,r=n!=null?re.find(f=>f.id===n):null,g=r?{key:`p-${r.id}`,label:r.name}:null;return p.map(f=>f==="irrigation"?ws(f,i,null,n,t,g):ws(f,i,o[f]??c,null,t,g)).join("")})()}
    ...
    </div>`}function Ti(e,i=[],t="widgets",n="Parcelles"){let a=we.find(C=>C.id===e.orgId),o=t,s="j7j2",l="1d",m=!1;const d=(a==null?void 0:a.ville)||"",p=$e(`
    <div class="m-detail-header">
      <div class="m-detail-topbar">
      ...
      <div class="m-detail-identity">
        ...
        <div class="m-detail-title-block">
          ...
          ${Ut(e,d)?`<div class="m-detail-subtitle">${Ut(e,d)}</div>`:""}
        </div>
    ...
    <div id="detail-content" class="m-detail-content"></div>`);function v(){const C=we.filter(x=>x.id!==100&&x.statut!=="inactif"),I=document.createElement("div"),P=()=>{I.innerHTML=C.map(x=>`
      ...
      </div>`).join("");const w=ue({title:"Culture",body:P,doneLabel:"Fermer",onDone:()=>{}});P.querySelectorAll("[data-pick-crop]").forEach(x=>{x.addEventListener("click",()=>{const b=x.dataset.pickCrop;w.classList.remove("m-sheet-overlay--show"),setTimeout(()=>w.remove(),280),b!==I&&(Ne(e.id,{crop:b,phenoStage:null}),e.crop=b,e.phenoStage=null,Fe(e.id,{type:"modification",date:new Date().toISOString().slice(0,10),texte:`Culture modifiée : ${I||"—"} → ${b}.`}),E(),X("Culture mise à jour"))})})}function h(){const C=io(e.crop),I=e.phenoStage,P=document.createElement("div");P.innerHTML=C.map(x=>`
      ...
      <select class="m-filter-select" id="org-filter" style="flex:0 0 44px;height:44px">
        ...
        ${a.map(E=>`<option value="${E.id}"${v===String(E.id)?" selected":""}>${E.name}</option>`).join("")}
            ...
            <div class="m-plain-row m-tappable" data-plot-id="${E.id}">
              ...
              <div style="display:flex;align-items:center;gap:6px">
                ${(()=>{const b=C&&!(d==="irrigation"&&!me.some(T=>T.plotId===E.id)),y=b?u(E.id):null;return`<span class="m-plain-data${b?"":" m-plain-na"}"${b?` style="color:${ks(d,y)}"`:""}>${b?`${y} ${h.unit}`:"—"}</span>`})()}
  ...
  `);p.querySelector("#anom-back").addEventListener("click",fe);function v(){p.querySelectorAll(".m-anom-tab").forEach(u=>{u.addEventListener("click",()=>{n=u.dataset.tab,p.querySelector("#anom-tabs-bar").innerHTML=m(),p.querySelector("#anom-content").innerHTML=d(),v()})})}v()}const ji={"P+":"Station météo",PT:"Station météo",P:"Pluviomètre",SMV:"Station météo virtuelle",TH:"Thermomètre-hygromètre",T_MINI:"Thermomètre de sol",W:"Anémomètre",PYRANO:"Pyranomètre",PAR:"Capteur PAR",LWS:"Capteur d'humectation foliaire",T_GEL:"Capteur de gel","CHP-15/30":"Tensiomètre","CHP-30/60":"Tensiomètre","CHP-60/90":"Tensiomètre","CAPA-30-3":"Sonde capacitive","CAPA-60-6":"Sonde capacitive",EC:"Sonde de fertirrigation"},Xo={"P+":"Weenat",PT:"Weenat",P:"Weenat",TH:"Weenat",W:"Weenat",PYRANO:"Weenat",T_MINI:"Weenat",T_GEL:"Weenat",LWS:"Weenat","CHP-15/30":"CoRHIZE","CHP-30/60":"CoRHIZE","CHP-60/90":"CoRHIZE","CAPA-30-3":"CoRHIZE","CAPA-60-6":"CoRHIZE",EC:"CoRHIZE",SMV:"Weenat (virtuel)"};function Hi(e){return e==="CHP-15/30"?[15,30]:e==="CHP-30/60"?[30,60]:e==="CHP-60/90"?[45,90]:null}function Es(e,i){const t=ji[e.model]?`${ji[e.model]} · ${e.model}`:e.model,n=Hi(e.model)&&e.depth!=null?`${e.depth} cm`:null;return[t,n,i].filter(Boolean).join(" · ")}const Mt={"P+":[{id:"pluie",label:"Pluie",unit:"mm",color:"#2E75B6",cumul:!0,cumulsType:"pluie"},{id:"temp",label:"Température",unit:"°C",color:"#FBAF05",cumul:!1,cumulsType:"temp"},{id:"humidite",label:"Humidité",unit:"%",color:"#5B12A4",cumul:!1}],PT:[{id:"pluie",label:"Pluie",unit:"mm",color:"#2E75B6",cumul:!0,cumulsType:"pluie"},{id:"temp",label:"Température",unit:"°C",color:"#FBAF05",cumul:!1,cumulsType:"temp"}],P:[{id:"pluie",label:"Pluie",unit:"mm",color:"#2E75B6",cumul:!0,cumulsType:"pluie"}],SMV:[{id:"pluie",label:"Pluie",unit:"mm",color:"#2E75B6",cumul:!0,cumulsType:"pluie"},{id:"temp",label:"Température",unit:"°C",color:"#FBAF05",cumul:!1,cumulsType:"temp"},{id:"humidite",label:"Humidité",unit:"%",color:"#5B12A4",cumul:!1}],TH:[{id:"temp",label:"Température",unit:"°C",color:"#FBAF05",cumul:!1,cumulsType:"temp"},{id:"humidite",label:"Humidité",unit:"%",color:"#5B12A4",cumul:!1}],T_MINI:[{id:"temp_sol",label:"Température sol",unit:"°C",color:"#795548",cumul:!1}],T_GEL:[{id:"tseche",label:"Température sèche",unit:"°C",color:"#23B19B",cumul:!1},{id:"thumide",label:"Température humide",unit:"°C",color:"#5E88EC",cumul:!1}],W:[{id:"vent",label:"Vent",unit:"km/h",color:"#616161",cumul:!1}],PYRANO:[{id:"rayonnement",label:"Rayonnement solaire",unit:"W/m²",color:"#CBCB0B",cumul:!1,cumulsType:"rayo"}],PAR:[{id:"par",label:"Rayonnement PAR",unit:"µmol/m²/s",color:"#4CBB17",cumul:!1}],LWS:[{id:"humectation",label:"Humectation foliaire",unit:"%",color:"#00887E",cumul:!1,cumulsType:"hws"}],"CHP-15/30":[{id:"pothydr",label:"Potentiel hydrique",unit:"kPa",color:"#A6C157",cumul:!1},{id:"temp_sol",label:"Température sol",unit:"°C",color:"#795548",cumul:!1}],"CHP-30/60":[{id:"pothydr",label:"Potentiel hydrique",unit:"kPa",color:"#A6C157",cumul:!1},{id:"temp_sol",label:"Température sol",unit:"°C",color:"#795548",cumul:!1}],"CHP-60/90":[{id:"pothydr",label:"Potentiel hydrique",unit:"kPa",color:"#A6C157",cumul:!1},{id:"temp_sol",label:"Température sol",unit:"°C",color:"#795548",cumul:!1}],"CAPA-30-3":[{id:"teneur",label:"Teneur en eau",unit:"%vol",color:"#ED9A2C",cumul:!1},{id:"temp_sol",label:"Température sol",unit:"°C",color:"#795548",cumul:!1}],"CAPA-60-6":[{id:"teneur",label:"Teneur en eau",unit:"%vol",color:"#ED9A2C",cumul:!1},{id:"temp_sol",label:"Température sol",unit:"°C",color:"#795548",cumul:!1}],EC:[{id:"teneur",label:"Teneur en eau",unit:"%vol",color:"#ED9A2C",cumul:!1},{id:"temp_sol",label:"Température sol",unit:"°C",color:"#795548",cumul:!1}]};function $n(e,i){const t={pluie:{base:2,amp:6,min:0,sparse:!0},temp:{base:15,amp:8,min:-5},humidite:{base:65,amp:20,min:20,max:100},pothydr:{base:80,amp:60,min:0,max:200},teneur:{base:30,amp:12,min:5,max:50},temp_sol:{base:14,amp:5,min:0,max:35},tseche:{base:14,amp:6,min:-5},thumide:{base:10,amp:5,min:-8},rayonnement:{base:350,amp:300,min:0,max:900},humectation:{base:20,amp:80,min:0,max:100,sparse:!0},vent:{base:15,amp:15,min:0,max:80},par:{base:900,amp:800,min:0,max:2e3}}[e]||{base:50,amp:20,min:0};return Array.from({length:i},(n,a)=>{const o=a/i*Math.PI*4;if(t.sparse&&Math.random()>.25)return 0;const s=t.base+t.amp*Math.sin(o-1)+(Math.random()-.5)*t.amp*.5;return Math.max(t.min??0,Math.min(t.max??9999,s))})}const wn={"365d":525600,"30d":43200,"7d":10080,hier:1440,"1d":1440,custom:10080};function Qo(e,i,t,n,a,o=20){const s=wn[e]||10080,l=new Date,m=u=>e==="1d"||e==="hier"?`${String(u.getHours()).padStart(2,"0")}h`:e==="365d"?u.toLocaleDateString("fr-FR",{month:"short"}):`${String(u.getDate()).padStart(2,"0")}/${String(u.getMonth()+1).padStart(2,"0")}`,d=4,p=i-t-n,v=a-o;return Array.from({length:d+1},(u,c)=>{const r=c/d,g=new Date(l.getTime()-(1-r)*s*6e4),f=(t+r*p).toFixed(1),S=c===0?"start":c===d?"end":"middle";return[`<line x1="${f}" y1="${v}" x2="${f}" y2="${v+4}" stroke="rgba(0,0,0,.2)" stroke-width="1"/>`,`<text x="${f}" y="${a-3}" text-anchor="${S}" font-size="9" fill="#8e8e93" font-family="-apple-system">${m(g)}</text>`].join("")}).join("")}function el(e,i,t,n="7d",a=""){const o=Sn[n]||60,s=$n(e,o),l=320,m=100,d=34,p=6,v=10,u=20,c=l-d-p,r=m-v-u,g=t?0:Math.min(...s),f=Math.max(...s,g+.001),S=f-g,h=w=>d+w/(s.length-1)*c,k=w=>v+r-(w-g)/S*r,A=`g${Math.random().toString(36).slice(2,8)}`,q=[0,.5,1].map(w=>{const x=g+w*S,b=v+r-w*r;return`<text x="${d-3}" y="${(b+3).toFixed(1)}" text-anchor="end" font-size="9" fill="#8e8e93" font-family="-apple-system">${x<10?x.toFixed(1):Math.round(x)}</text>`}).join(""),$=[.25,.5,.75].map(w=>`<line x1="${d}" y1="${(v+r-w*r).toFixed(1)}" x2="${l-p}" y2="${(v+r-w*r).toFixed(1)}" stroke="rgba(0,0,0,.07)" stroke-width="1" stroke-dasharray="3,3"/>`).join(""),E=`<line x1="${d}" y1="${v+r}" x2="${l-p}" y2="${v+r}" stroke="rgba(0,0,0,.12)" stroke-width="1"/>`,F=Qo(n,l,d,p,m);if(t){const w=c/s.length*.7;return`<svg viewBox="0 0 ${l} ${m}" width="100%" height="${m}" preserveAspectRatio="none">
    ...
    </div>`}).join("")}</div>`:""}function nl(e,i="7d",t="1h"){const n=Mt[e.model]||[];if(!n.length)return'<div class="m-empty-state"><i class="bi bi-broadcast"></i><p>Aucune donnée disponible</p></div>';const a={temp:"temperature",tseche:"temp_seche",thumide:"temp_humide"},o={temp:"temperature"},s=new Set(["tseche","thumide"]),l=n.map(p=>{const v=a[p.id]||p.id,u=sl(p.id,i,p.cumulsType),c=s.has(p.id)?"":`<button class="m-msr-add-btn" data-msr-metric-id="${o[p.id]||p.id}" data-msr-label="${p.label}" data-msr-unit="${p.unit||""}" data-msr-color="${p.color}" data-msr-period="${i}" data-msr-step="${t}" title="Ajouter aux mesures préférées"><i class="bi bi-house-add"></i></button>`;return`
    ...
    <div class="m-detail-section">
      ...
      <div style="height:24px"></div>
    </div>`}function qi(e,i="donnees",t="admin"){var c;e.parcelIds||(e.parcelIds=[]);const n=e.parcelIds.length?re.find(r=>e.parcelIds.includes(r.id)):null;let a=i,o="7d",s="1h",l=!1;const m=n&&((c=we.find(r=>r.id===n.orgId))==null?void 0:c.ville)||"",d=$e(`
    <div class="m-detail-header">
      <div class="m-detail-topbar">
    ...
    `;l.length===0?d+='<div style="padding:40px 16px;text-align:center;color:#8e8e93;font-size:14px">Aucune entrée dans le journal.</div>':(d+='<div class="m-jrn-timeline">',l.forEach((v,u)=>{const c=n[v.type]||{label:v.type,icon:"bi-circle",color:"#8e8e93"},r=u===l.length-1,g=!!v._fromDashboard,f=v.type==="note"&&!v._system;d+=`
          ...
          </div>`}),d+="</div>"),o.innerHTML=d,(p=o.querySelector("#sjrn-add-btn"))==null||p.addEventListener("click",()=>Ms(e.id,a)),o.querySelectorAll(".m-jrn-del").forEach(v=>{v.addEventListener("click",()=>{const u=parseInt(v.dataset.id);Ri(e.id,Kt(e.id).filter(c=>c.id!==u)),a()})})}a(),i.openForm&&Ms(e.id,a)}function cl(e){if(!e)return"";const i={membre:{label:"Membre",bg:"#f2f2f7",color:"#636366"},conseiller:{label:"Conseiller",bg:"#eef4ff",color:"#3a7bd5"}},t=i[e]||i.membre;return`<span style="font-size:10px;background:${t.bg};color:${t.color};border-radius:4px;padding:1px 5px;font-weight:500">${t.label}</span>`}function Ms(e,i){const t=new Date().toISOString().slice(0,10),n=document.createElement("div");n.innerHTML=`
    <div class="m-sheet-input-group" style="display:flex;flex-direction:column;gap:10px">
      ...
      <div>
        ...
        </div>`}const C=[...E].sort((P,w)=>{const x=Ht(P.model,v),b=Ht(w.model,v);return x&&!b?-1:!x&&b?1:x?r(w.id)-r(P.id):0}),I=C.length?`<div class="m-plain-list">${C.map(P=>{const w=fi.includes(P.model),x=Ht(P.model,v),b=x?r(P.id):null,y=x?`<span class="m-sensor-val" style="color:${Ts(v,b)}">${b} ${$.unit}</span>`:'<span class="m-sensor-val m-sensor-val--na">—</span>',T=P.event&&(Array.isArray(P.event)?P.event.length>0:!0);return`
      ...
      <div id="mbr-list-content" style="padding-bottom:32px"></div>`),z=j.querySelector("#mbr-list-content");function B(){var N;const L=T(),M=L.slice(0,y),O=L.length-M.length;z.innerHTML=`
        ...
        </div>`,z.querySelectorAll("[data-mbr-idx]").forEach(Q=>{Q.addEventListener("click",()=>F(+Q.dataset.mbrIdx,B))}),(N=z.querySelector("#mbr-load-more"))==null||N.addEventListener("click",()=>{y+=20,B()})}j.querySelector(".m-detail-back").addEventListener("click",fe),j.querySelector("#mbr-invite-btn").addEventListener("click",I),j.querySelector("#mbr-search").addEventListener("input",L=>{x=L.target.value,y=20,B()}),B()}function C(){const x=qs();let b="";function y(){if(!b)return x;const B=b.toLowerCase();return x.filter(L=>L.numero.toLowerCase().includes(B)||L.statut.toLowerCase().includes(B)||String(L.montant).includes(B))}const T=$e(`
      <div class="m-detail-header">
        <div class="m-detail-topbar">
          <button class="m-detail-back"><i class="bi bi-chevron-left"></i><span>Mon exploitation</span></button>
      ...
      <input class="m-sheet-input" type="text" placeholder="Ville" id="s-ville" value="${n.siege.ville.replace(/"/g,"&quot;")}">`,ue({title:"Adresse du siège",body:c,doneLabel:"Enregistrer",onDone:()=>{n.siege.adresse=c.querySelector("#s-rue").value.trim(),n.siege.codePostal=c.querySelector("#s-cp").value.trim(),n.siege.ville=c.querySelector("#s-ville").value.trim(),l(),X("Enregistré")}}),setTimeout(()=>c.querySelector("#s-rue").focus(),300)}function p(){const c=document.createElement("div");(()=>{c.innerHTML=n.antennes.map((g,f)=>`
        ...
        </div>`).join('<hr style="border:none;border-top:1px solid #e5e5ea;margin:4px 0">')})(),ue({title:"Antennes",body:c,doneLabel:"Fermer",onDone:()=>{}})}function v(c,r,g){var q,$;const f=bi(c.statut),S=c.statut==="invitation en attente",h=`https://app.weenat.com/invitation?code=${c.codeAdherent||"ADZ-XXX"}`,k=document.createElement("div");k.innerHTML=`

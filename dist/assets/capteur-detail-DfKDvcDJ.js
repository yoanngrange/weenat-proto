import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css             */import{s as Y}from"./sensors-DDe0aa9W.js";import{p as U}from"./plots-kVXhO61e.js";import{o as se}from"./orgs-Cx4wNzLL.js";import{m as Q}from"./members-C_ssoUx1.js";import{u as $e}from"./breadcrumb-DEBQjfiD.js";import{a as de,p as q}from"./store-DzkjdUGR.js";const Ae=new URLSearchParams(window.location.search),I=parseInt(Ae.get("id")),d=Y.find(e=>e.id===I),xe={pluie:{name:"Pluie",unit:"mm",color:"#45b7d1",baseVal:()=>u(0,8),cumul:{label:"Cumul pluie",unit:"mm"},isCumul:!0},temperature:{name:"Température",unit:"°C",color:"#e07050",baseVal:()=>u(10,28),cumul:{label:"Degrés-jours (DJC)",unit:"°j"}},humidite_air:{name:"Humidité",unit:"%",color:"#4ecdc4",baseVal:()=>u(40,90)},dpv:{name:"DPV",unit:"kPa",color:"#a8d8b0",baseVal:()=>te(.1,2.5)},vent_vitesse:{name:"Vent – vitesse",unit:"km/h",color:"#7bc4b0",baseVal:()=>u(0,40)},vent_rafales:{name:"Vent – rafales",unit:"km/h",color:"#5aa490",baseVal:()=>u(5,60)},vent_direction:{name:"Vent – direction",unit:"°",color:"#3a8070",baseVal:()=>u(0,360)},vent_direction_rafales:{name:"Vent – direction rafales",unit:"°",color:"#1a6050",baseVal:()=>u(0,360)},rayonnement:{name:"Rayonnement",unit:"W/m²",color:"#f5c842",baseVal:()=>u(0,900),cumul:{label:"Énergie",unit:"Wh/m²"}},etp:{name:"ETP",unit:"mm/j",color:"#c090e0",baseVal:()=>te(.5,5),cumul:{label:"Cumul ETP",unit:"mm"}},temperature_min:{name:"Température min",unit:"°C",color:"#90b0e0",baseVal:()=>u(-2,15),cumul:{label:"Heures de froid",unit:"h"}},humidite_sol_10:{name:"Teneur en eau du sol 10 cm",unit:"%vol",color:"#f0cc60",baseVal:()=>u(15,45)},humidite_sol_20:{name:"Teneur en eau du sol 20 cm",unit:"%vol",color:"#dab448",baseVal:()=>u(15,45)},humidite_sol_30:{name:"Teneur en eau du sol 30 cm",unit:"%vol",color:"#c09830",baseVal:()=>u(15,45)},humidite_sol_40:{name:"Teneur en eau du sol 40 cm",unit:"%vol",color:"#a87c18",baseVal:()=>u(17,43)},humidite_sol_50:{name:"Teneur en eau du sol 50 cm",unit:"%vol",color:"#906200",baseVal:()=>u(18,42)},humidite_sol_60:{name:"Teneur en eau du sol 60 cm",unit:"%vol",color:"#784800",baseVal:()=>u(18,42)},humidite_sol_90:{name:"Teneur en eau du sol 90 cm",unit:"%vol",color:"#603000",baseVal:()=>u(20,40)},temp_sol:{name:"Température du sol",unit:"°C",color:"#bb8fce",baseVal:()=>u(8,22)},potentiel_hydrique:{name:"Potentiel hydrique",unit:"kPa",color:"#5b8dd9",baseVal:()=>{const e=new Date().getMonth();return Math.round(10+(.5-.5*Math.cos(2*Math.PI*e/12))*140)}},tensio_30:{name:"Tension sol 30 cm",unit:"cbar",color:"#98d8c8",baseVal:()=>u(10,80)},tensio_60:{name:"Tension sol 60 cm",unit:"cbar",color:"#78b8a8",baseVal:()=>u(10,80)},tensio_90:{name:"Tension sol 90 cm",unit:"cbar",color:"#589888",baseVal:()=>u(10,80)},tensio_120:{name:"Tension sol 120 cm",unit:"cbar",color:"#387868",baseVal:()=>u(10,80)},tensio_150:{name:"Tension sol 150 cm",unit:"cbar",color:"#185848",baseVal:()=>u(10,80)},tensio_180:{name:"Tension sol 180 cm",unit:"cbar",color:"#003828",baseVal:()=>u(10,80)},conductivite:{name:"Conductivité",unit:"mS/cm",color:"#f0a030",baseVal:()=>te(.1,3)},humectation:{name:"Humectation foliaire",unit:"h",color:"#78d8a0",baseVal:()=>u(0,12)},par:{name:"Densité de flux de photons photosynthétiques",unit:"µmol/m²/s",color:"#c47a00",baseVal:()=>u(0,2e3)},temperature_gel:{name:"Temp. feuille/gel",unit:"°C",color:"#a0d8a0",baseVal:()=>u(-3,12),cumul:{label:"Heures de gel",unit:"h"}},temp_rosee:{name:"Température de rosée",unit:"°C",color:"#7ec8e0",baseVal:()=>u(4,16)},temp_seche:{name:"Température sèche",unit:"°C",color:"#e07050",baseVal:()=>u(-5,10)},temp_humide:{name:"Température humide",unit:"°C",color:"#60b8d0",baseVal:()=>u(-7,8)}},He={"P+":["pluie","temperature","humidite_air"],PT:["pluie","temperature"],P:["pluie"],TH:["temperature","humidite_air"],T_MINI:["temp_sol"],W:["_vent"],"CHP-15/30":["potentiel_hydrique","temp_sol"],"CHP-30/60":["potentiel_hydrique","temp_sol"],"CHP-60/90":["humidite_sol_60","humidite_sol_90","temp_sol"],"CAPA-30-3":["_capa_vwc","_capa_temp"],"CAPA-60-6":["_capa_vwc","_capa_temp"],EC:["humidite_sol_30","temp_sol","conductivite"],LWS:["_lws_intensite","_lws_duree"],PYRANO:["rayonnement"],PAR:["par"],T_GEL:["temp_seche","temp_humide"]},pe={_capa_vwc:{name:"Humidité sol par horizon",unit:"%vol",color:"#4e9fd4",isVirtual:!0},_capa_temp:{name:"Température du sol par horizon",unit:"°C",color:"#bb8fce",isVirtual:!0},_lws_intensite:{name:"Intensité d'humectation",unit:"mV",color:"#78d8a0",isVirtual:!0},_lws_duree:{name:"Durée d'humectation",unit:"h",color:"#45c090",isVirtual:!0},_vent:{name:"Vent",unit:"km/h",color:"#7bc4b0",isVirtual:!0}},we={"CAPA-30-3":[{id:"humidite_sol_10",label:"10 cm",color:"#f0cc60"},{id:"humidite_sol_20",label:"20 cm",color:"#c89c30"},{id:"humidite_sol_30",label:"30 cm",color:"#a07010"}],"CAPA-60-6":[{id:"humidite_sol_10",label:"10 cm",color:"#f0d070"},{id:"humidite_sol_20",label:"20 cm",color:"#d8b050"},{id:"humidite_sol_30",label:"30 cm",color:"#c09030"},{id:"humidite_sol_40",label:"40 cm",color:"#a87010"},{id:"humidite_sol_50",label:"50 cm",color:"#905200"},{id:"humidite_sol_60",label:"60 cm",color:"#783400"}]};function u(e,t){return Math.floor(Math.random()*(t-e+1))+e}function te(e,t){return parseFloat((Math.random()*(t-e)+e).toFixed(2))}function R(e){return(He[e.model]||["temperature","humidite_air"]).map(a=>{if(pe[a])return{id:a,...pe[a],current:null};const n=xe[a];return n?{id:a,...n,current:n.baseVal()}:null}).filter(Boolean)}let P=null,D="7d",J=null,G=null;function _e(){const e={"1d":1440,hier:1440,"3d":4320,"7d":10080,"30d":43200,"365d":525600};return D==="custom"&&J&&G?Math.max(60,Math.round((G-J)/6e4)):e[D]??10080}function ne(){var t;const e=((t=document.getElementById("time-step"))==null?void 0:t.value)||"1h";return{max:15,"1h":60,"1d":1440,"1w":10080,"1mo":43200}[e]??60}function Ve(e){return e==="365d"?"1mo":e==="30d"?"1w":e==="7d"?"1d":"1h"}function ue(){const e=_e(),t=ne();return Math.max(2,Math.min(200,Math.floor(e/t)))}const Pe={"P+":"Station météo",PT:"Station météo",P:"Pluviomètre",SMV:"Station météo virtuelle",TH:"Thermo-hygromètre",T_MINI:"Thermomètre de sol",W:"Anémomètre",PYRANO:"Pyranomètre",PAR:"Capteur PAR",LWS:"Humectation foliaire",T_GEL:"Capteur gel","CHP-15/30":"Tensiomètre","CHP-30/60":"Tensiomètre","CHP-60/90":"Tensiomètre","CAPA-30-3":"Sonde capacitive","CAPA-60-6":"Sonde capacitive",EC:"Sonde fertirrigation"};function Be(){const e=document.getElementById("breadcrumb-title");if(!e)return;const t=e.querySelector("span:last-child");if(!t)return;const a=Y.filter(o=>o.orgId===d.orgId).sort((o,l)=>o.serial.localeCompare(l.serial)),n=document.createElement("span");n.className="breadcrumb-nav-wrap";const s=document.createElement("select");s.className="breadcrumb-nav-select",s.innerHTML=a.map(o=>`<option value="${o.id}"${o.id===I?" selected":""}>${Pe[o.model]||o.model} · ${o.serial}</option>`).join(""),s.addEventListener("change",()=>{window.location.href=`capteur-detail.html?id=${s.value}`}),n.appendChild(s),t.replaceWith(n)}document.addEventListener("DOMContentLoaded",()=>{var t;if(!d){document.body.innerHTML='<div style="padding:40px"><h1>Capteur non trouvé</h1></div>';return}$e(`Capteur ${d.serial}`,{label:"Capteurs",href:"capteurs.html"}),Be(),Fe(),N(),Qe(),ut(),Xe(),Ze(),dt(),mt(),me(),(t=document.getElementById("btn-export-csv"))==null||t.addEventListener("click",it);const e=document.getElementById("sidebar");e&&new MutationObserver(()=>{const a=U.find(n=>n.id===d.parcelId)||null;z(a)}).observe(e,{attributes:!0,attributeFilter:["data-role"]})});function Fe(){var a,n;const e=document.getElementById("latest-strip");if(!e)return;const t=R(d);if(t.forEach(s=>{if(s.isVirtual)return;const o=document.createElement("div");o.className="latest-card",o.style.borderTop=`3px solid ${s.color}`,o.innerHTML=`
    ...
    ${a}
    ${s}
  `,t}function qe(e,t){R(t).forEach(n=>{if(n.isVirtual){Ee(e,n,t);return}e.appendChild(Me(n))})}function he(e,t,a){t.isVirtual?Ee(e,t,a):e.appendChild(Me(t))}function N(){var t;const e=document.getElementById("charts-container");if(e.innerHTML="",P){e.className="compare-rows";const a=Y.find(i=>i.id===P),n=document.createElement("div");n.className="compare-header-row",n.innerHTML=`
      ...
      </div>`,e.appendChild(n),(t=n.querySelector(".compare-close-btn"))==null||t.addEventListener("click",()=>{P=null,ae(),N()});const s=R(d),o=a?R(a):[],l=s.map(i=>i.id);[...l,...o.map(i=>i.id).filter(i=>!l.includes(i))].forEach(i=>{const m=s.find(w=>w.id===i),f=o.find(w=>w.id===i),p=document.createElement("div");p.className="compare-row";const h=document.createElement("div");m?he(h,m,d):h.innerHTML='<div class="compare-chart-empty">—</div>';const y=document.createElement("div");f?he(y,f,a):y.innerHTML='<div class="compare-chart-empty">—</div>',p.appendChild(h),p.appendChild(y),e.appendChild(p)})}else e.className="charts-stack",qe(e,d);Ue(),Re()}function De(e){const t=e==="temperature_min",a=Math.round(Math.random()*200+50),n=Math.round(Math.random()*400+100);return`
  ...
  </defs>`;for(let x=0;x<=4;x++){const T=p.t+x/4*y,A=g-x/4*k,W=Math.abs(A)>=100?A.toFixed(0):Math.abs(A)>=10?A.toFixed(1):A.toFixed(2);C+=`<line x1="${p.l}" y1="${T.toFixed(1)}" x2="${600-p.r}" y2="${T.toFixed(1)}" stroke="var(--bdr2)" stroke-width="1"/>`,C+=`<text x="${p.l-5}" y="${(T+4).toFixed(1)}" text-anchor="end" font-size="10" font-family="var(--font)" fill="var(--txt3)">${W}</text>`}const b=Math.max(1,Math.floor(n/6));for(let x=0;x<n;x+=b){const T=v(x).toFixed(1);C+=`<line x1="${T}" y1="${p.t}" x2="${T}" y2="${p.t+y}" stroke="var(--bdr2)" stroke-width="1" stroke-dasharray="3,3"/>`,C+=`<text x="${T}" y="174" text-anchor="middle" font-size="10" font-family="var(--font)" fill="var(--txt3)">${ie((n-x)*s)}</text>`}const M=c.map((x,T)=>({x:v(T),y:_(x)})),K=Ce(M),ke=K+` L${v(n-1).toFixed(1)},${p.t+y} L${p.l.toFixed(1)},${p.t+y} Z`;C+=`<path d="${ke}" fill="${O}" opacity="0.07" clip-path="url(#clip_${E})"/>`,C+=`<path d="${K}" fill="none" stroke="url(#${E})" stroke-width="2" stroke-linejoin="round" stroke-linecap="round" clip-path="url(#clip_${E})"/>`,C+=`<rect class="chart-hover-rect" x="${p.l}" y="${p.t}" width="${h}" height="${y}" fill="transparent" style="cursor:crosshair"/>`,e.innerHTML=C;const X=Oe(),oe=e.querySelector(".chart-hover-rect");if(!oe)return;const S=document.createElementNS("http://www.w3.org/2000/svg","circle");S.setAttribute("r","4"),S.setAttribute("fill",a),S.setAttribute("stroke","#fff"),S.setAttribute("stroke-width","1.5"),S.style.display="none",S.style.pointerEvents="none",e.appendChild(S),oe.addEventListener("mousemove",x=>{const T=e.getBoundingClientRect(),A=(x.clientX-T.left)*(600/T.width),W=Math.max(0,Math.min(1,(A-p.l)/h)),B=Math.round(W*(n-1));if(B<0||B>=c.length)return;const ee=c[B];S.setAttribute("cx",v(B)),S.setAttribute("cy",_(ee)),S.style.display="";const je=Math.abs(ee)>=100?ee.toFixed(1):ee.toFixed(2);X.innerHTML=`
      <div style="font-size:11px;color:var(--txt3);margin-bottom:2px">${r}</div>
      <div class="chart-tooltip-val" style="color:${a}">${je} <span style="font-size:12px;font-weight:400;color:var(--txt2)">${i}</span></div>
      <div class="chart-tooltip-ts">${ie((n-B)*s)}</div>
    `,X.style.display="block",X.style.left=`${Math.min(x.clientX+12,window.innerWidth-160)}px`,X.style.top=`${x.clientY-10}px`}),oe.addEventListener("mouseleave",()=>{X.style.display="none",S.style.display="none"})}function Ye(e){const a={pluie:()=>u(20,120),temperature:()=>u(80,400),rayonnement:()=>u(500,3e3),etp:()=>te(15,80),temperature_min:()=>u(50,500),temperature_gel:()=>u(0,80)}[e.id];return a?a():"—"}function Xe(){const e=document.getElementById("period-presets"),t=document.getElementById("custom-date-row"),a=document.getElementById("time-step"),n=new Date,s=new Date(n-7*864e5);document.getElementById("date-from").value=s.toISOString().slice(0,10),document.getElementById("date-to").value=n.toISOString().slice(0,10),e.addEventListener("click",o=>{const l=o.target.closest(".period-preset-btn");l&&(e.querySelectorAll(".period-preset-btn").forEach(r=>r.classList.remove("active")),l.classList.add("active"),D=l.dataset.period,D==="custom"?t.style.display="flex":(t.style.display="none",a&&(a.value=Ve(D)),N()))}),document.getElementById("date-from").addEventListener("change",be),document.getElementById("date-to").addEventListener("change",be),a.addEventListener("change",N)}function be(){const e=document.getElementById("date-from").value,t=document.getElementById("date-to").value;e&&t&&(J=new Date(e),G=new Date(t+"T23:59:59"),J<G&&N())}function Ze(){ae()}function ae(){var t,a,n;const e=document.getElementById("compare-control");if(e)if(P){const s=Y.find(l=>l.id===P),o=s?`${s.model} — ${s.serial}`:"Capteur";e.innerHTML=`<button class="compare-btn compare-btn--active" id="compare-open-btn"><i class="bi bi-layout-split"></i> ${o} <i class="bi bi-x-lg compare-clear-icon" style="opacity:.7"></i></button>`,(t=e.querySelector(".compare-clear-icon"))==null||t.addEventListener("click",l=>{l.stopPropagation(),P=null,ae(),N()}),(a=e.querySelector("#compare-open-btn"))==null||a.addEventListener("click",ye)}else e.innerHTML='<button class="compare-btn" id="compare-open-btn"><i class="bi bi-layout-split"></i> Comparer avec…</button>',(n=e.querySelector("#compare-open-btn"))==null||n.addEventListener("click",ye)}function ye(){const e=document.getElementById("compare-dropdown");if(e){e.remove();return}const t=document.getElementById("compare-control"),a=Y.filter(o=>o.id!==I),n=document.createElement("div");n.id="compare-dropdown",n.className="compare-dropdown",n.innerHTML=`
    <input class="compare-search-input" type="text" placeholder="Rechercher un capteur…">
    <div class="compare-dropdown-list">
      ${a.map(o=>`<div class="compare-dropdown-item${o.id===P?" active":""}" data-id="${o.id}"><i class="bi bi-broadcast"></i> ${o.model} — ${o.serial}</div>`).join("")}
    </div>
  `,t.appendChild(n);const s=n.querySelector(".compare-search-input");s.focus(),s.addEventListener("input",o=>{const l=o.target.value.toLowerCase();n.querySelectorAll(".compare-dropdown-item").forEach(r=>{r.style.display=r.textContent.toLowerCase().includes(l)?"":"none"})}),n.querySelectorAll(".compare-dropdown-item").forEach(o=>{o.addEventListener("click",()=>{P=parseInt(o.dataset.id),n.remove(),ae(),N()})}),setTimeout(()=>{document.addEventListener("click",function o(l){!n.contains(l.target)&&!t.contains(l.target)&&(n.remove(),document.removeEventListener("click",o))})},0)}function Qe(){const e=U.find(n=>n.id===d.parcelId),t=e?se.find(n=>n.id===e.orgId):d.orgId?se.find(n=>n.id===d.orgId):null,a=de(I);Ke(e,t,a),le(),et(e,t),tt(),nt(),at(),ot(),z(e),rt(),lt()}function Ke(e,t,a){let n=a.label||`Capteur ${d.serial}`;const s=document.getElementById("panel-ident");s.innerHTML=`
  ...
  `).join("")}function ot(){const e=document.getElementById("panel-config");if(!e)return;const t=d.model||"",a=t.startsWith("CHP"),n=t.startsWith("CAPA"),s=t==="EC",o=d.isVirtual;let l="";if(o&&(l+=`
    ...
    `),l?e.innerHTML=l:e.innerHTML='<div class="panel-empty">Pas de configuration spécifique pour ce modèle.</div>'}let H=U.filter(e=>e.orgId===d.orgId&&e.id===d.parcelId).map(e=>e.id);(function(){const t=de(I);t.linkedPlotIds?H=t.linkedPlotIds:q(I,{linkedPlotIds:H})})();function le(){var l,r;const e=document.getElementById("panel-plots");if(!e)return;const t=d.orgId||((l=U.find(i=>i.id===d.parcelId))==null?void 0:l.orgId),a=U.filter(i=>i.orgId===t),n=a.filter(i=>H.includes(i.id)),s=a.filter(i=>!H.includes(i.id));let o="";n.length?o+=n.map(i=>`
    ...
    `),e.innerHTML=o,e.querySelectorAll(".remove-plot-btn").forEach(i=>{i.addEventListener("click",()=>{H=H.filter(m=>m!==parseInt(i.dataset.id)),q(I,{linkedPlotIds:H}),le()})}),(r=document.getElementById("add-plot-btn"))==null||r.addEventListener("click",()=>{const i=parseInt(document.getElementById("add-plot-select").value);!i||H.includes(i)||(H.push(i),q(I,{linkedPlotIds:H}),le())})}function st(e,t){const a=new Blob(["\uFEFF"+e],{type:"text/csv;charset=utf-8;"}),n=Object.assign(document.createElement("a"),{href:URL.createObjectURL(a),download:t});document.body.appendChild(n),n.click(),document.body.removeChild(n),setTimeout(()=>URL.revokeObjectURL(n.href),100)}function it(){const e=R(d).filter(f=>f.baseVal);let t;if(P){const f=Y.find(h=>h.id===P),p=f?R(f).filter(h=>h.baseVal):[];t=[...e.map(h=>({h:`[${d.serial}] ${h.name} (${h.unit})`,gen:h.baseVal})),...p.map(h=>({h:`[${f.serial}] ${h.name} (${h.unit})`,gen:h.baseVal}))]}else t=e.map(f=>({h:`${f.name} (${f.unit})`,gen:f.baseVal}));const a=_e()*6e4,n=ne()*6e4,s=D==="custom"&&G?G:new Date,o=D==="custom"&&J?J:new Date(s-a),l=Math.min(Math.ceil((s-o)/n)+1,500),r=(s-o)/Math.max(l-1,1),i=["Horodatage",...t.map(f=>f.h)].join(";"),m=Array.from({length:l},(f,p)=>[new Date(o.getTime()+p*r).toISOString().replace("T"," ").slice(0,19),...t.map(y=>y.gen())].join(";"));st([i,...m].join(`\r
`),`${d.serial}_${D}_${new Date().toISOString().slice(0,10)}.csv`)}function rt(){document.getElementById("panel-actions").innerHTML=`

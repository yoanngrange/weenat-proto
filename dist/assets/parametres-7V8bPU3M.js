            ...
            <div style="display:flex;flex-direction:column;gap:10px;padding:14px 16px;background:var(--bg2);border:1px solid var(--bdr);border-radius:8px;min-width:280px;flex:1">
              <div style="display:flex;align-items:flex-start;gap:12px">
                ...
                <div style="flex:1;min-width:0">
                  ...
                  <div style="font-size:12px;color:var(--txt2);margin-top:3px">${e.distance} km <br> ${e.capteurs} capteurs <br> ${e.parcelles} parcelles <br> ${e.adherents} adhérents </div>
                  <div style="font-size:12px;color:var(--txt3);margin-top:3px">${e.ville} <br> ${e.telephone}</div>
                </div>
              </div>

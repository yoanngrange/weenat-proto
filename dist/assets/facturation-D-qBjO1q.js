import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css             */import{u as $}from"./breadcrumb-DEBQjfiD.js";import{m as y}from"./members-CuDabgg3.js";import{o as h}from"./orgs-Cx4wNzLL.js";import{n as d}from"./network-YzWdS0n_.js";document.addEventListener("DOMContentLoaded",()=>{$(),I()});const c={plan:"Plus",anniversaire:"2022-03-15",numero:"CTR-2022-00418",licencesMembres:y.length,licencesAdherents:h.filter(e=>e.id!==100&&e.statut!=="inactif").length,licencesIntegrations:27,licencesTotal:y.length+h.filter(e=>e.id!==100&&e.statut!=="inactif").length},n={societe:d.nom,siret:d.siret,adresse:d.siege.adresse,cp:d.siege.codePostal,ville:d.siege.ville,pays:d.siege.pays};function I(){const e=document.getElementById("billing-page");if(!e)return;const l=T();e.innerHTML=`

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/irrigation-BeOjfEPP.js","assets/irrigations-Dbn0IxRs.js","assets/plots-hjmThJP8.js","assets/store-DZP_FQdH.js","assets/modulepreload-polyfill-B5Qt9EMX.js","assets/sensors-DDe0aa9W.js","assets/orgs-Cx4wNzLL.js","assets/network-YzWdS0n_.js","assets/members-C_ssoUx1.js"])))=>i.map(i=>d[i]);
import"./modulepreload-polyfill-B5Qt9EMX.js";import{p as B}from"./plots-hjmThJP8.js";import{d as zt}from"./store-DZP_FQdH.js";import{s as N}from"./sensors-DDe0aa9W.js";import{o as W}from"./orgs-Cx4wNzLL.js";import{n as pe}from"./network-YzWdS0n_.js";import{b as We,I as Et}from"./irrigations-Dbn0IxRs.js";import{m as qe}from"./members-C_ssoUx1.js";const he=[];function be(t){const i=document.getElementById("phone-screen"),e=document.createElement("div");return e.className="m-detail-layer",e.innerHTML=t,i.appendChild(e),requestAnimationFrame(()=>e.classList.add("m-detail-layer--in")),he.push(e),e}function ne(){const t=he.pop();t&&(t.classList.remove("m-detail-layer--in"),setTimeout(()=>t.remove(),300))}function nt(){return he.length}function Vt(){return he.some(t=>t.dataset.dirty==="true")}function Bs(){he.forEach(t=>delete t.dataset.dirty)}window.addEventListener("m-tab-change",()=>{he.forEach(t=>t.remove()),he.length=0});const lt={admin:{initials:"JD",prenom:"Jean",nom:"Dupont",email:"jean.dupont@ferme-du-bocage.fr",phones:[{label:"Principal",numero:"+33 6 12 34 56 78"},{label:"Sophie Dupont",numero:"+33 6 98 76 54 32"}],apiKeys:[{id:1,name:"Application mobile",created:"10/01/2026",value:"sk-wnt-mbl4X9pQr2Lz7vNcKwJ1eYtU6sSoD8aF"},{id:2,name:"Intégration Agreo",created:"28/02/2026",value:"sk-wnt-agr8B3mTxP5nVcLqR1uZoK7wJ9dE2sY"},{id:3,name:"Script export nuit",created:"01/04/2026",value:"sk-wnt-xpt2H7kNpQ4rVmLcJ9sT1oY6uB3wF8dE"}]},adherent:{initials:"MM",prenom:"Marie",nom:"Martin",email:"marie.martin@ferme-du-bocage.fr",phones:[{label:"Principal",numero:"+33 7 52 18 93 46"}],apiKeys:[{id:1,name:"Application mobile",created:"14/02/2026",value:"sk-wnt-mbl9Z2xQr5Lp7vNcKwA1eYtU3sRoD4bG"}]}},Wt=["Français","English","Español","Deutsch","Italiano","Português","Polski","Nederlands"],ot=["Métrique (mm, °C, km/h…)","Impérial (in, °F, mph…)"];let oe={};function Y(t){var a;const i=document.getElementById("phone-screen");(a=document.querySelector(".m-toast"))==null||a.remove();const e=document.createElement("div");e.className="m-toast",e.textContent=t,i.appendChild(e),requestAnimationFrame(()=>e.classList.add("m-toast--show")),setTimeout(()=>{e.classList.remove("m-toast--show"),setTimeout(()=>e.remove(),300)},2200)}function fe({title:t,body:i,onDone:e,doneLabel:a="OK"}){var l;const r=document.getElementById("phone-screen");(l=document.querySelector(".m-sheet-overlay"))==null||l.remove();const s=document.createElement("div");s.className="m-sheet-overlay",s.innerHTML=`
    <div class="m-sheet">
  ...
  `).join("");const s=fe({title:t,body:r,doneLabel:"Fermer",onDone:()=>{}});r.querySelectorAll(".m-sheet-option").forEach(n=>{n.addEventListener("click",()=>{a(i[+n.dataset.i]),s.classList.remove("m-sheet-overlay--show"),setTimeout(()=>s.remove(),280),Y("Enregistré")})})}function Jt(t,i){const e=document.createElement("div"),a=()=>{var r;e.innerHTML=t.map((s,n)=>`
    ...
    `).join("")+'<button class="m-sheet-add-phone"><i class="bi bi-plus-circle"></i> Ajouter un numéro</button>',e.querySelectorAll("input").forEach(s=>{s.addEventListener("input",()=>{t[+s.dataset.i][s.dataset.f]=s.value})}),e.querySelectorAll(".m-sheet-remove").forEach(s=>{s.addEventListener("click",()=>{t.splice(+s.dataset.i,1),a()})}),(r=e.querySelector(".m-sheet-add-phone"))==null||r.addEventListener("click",()=>{t.push({label:"",numero:""}),a()})};a(),fe({title:"Téléphone(s)",body:e,doneLabel:"Enregistrer",onDone:()=>{i(t),Y("Enregistré")}})}function Gt(t,i,e){const a=document.createElement("div");a.innerHTML=`
  ...
  `,a.querySelector(".m-sheet-key-copy").addEventListener("click",()=>{var s;(s=navigator.clipboard)==null||s.writeText(t.value).catch(()=>{}),Y("Clé copiée !")});const r=fe({title:"Clé API",body:a,doneLabel:"Fermer",onDone:()=>{}});a.querySelector(".m-sheet-key-delete").addEventListener("click",()=>{const s=i.findIndex(n=>n.id===t.id);s!==-1&&i.splice(s,1),r.classList.remove("m-sheet-overlay--show"),setTimeout(()=>{r.remove(),e()},280),Y("Clé supprimée")})}function Ut(){const t="ABCDEFGHJKLMNPQRSTUVWXYZabcdefghjkmnpqrstuvwxyz23456789";return"sk-wnt-"+Array.from({length:32},()=>t[Math.floor(Math.random()*t.length)]).join("")}function Yt(t){const i=document.createElement("div");i.innerHTML='<input class="m-sheet-input" type="text" placeholder="Nom de la clé (ex: Application mobile)">';const e=i.querySelector("input");fe({title:"Nouvelle clé API",body:i,doneLabel:"Générer",onDone:()=>{const a=e.value.trim();if(!a){Y("Entrez un nom");return}const r={id:Date.now(),name:a,created:new Date().toLocaleDateString("fr-FR"),value:Ut()};t(r),Y("Clé générée")}}),setTimeout(()=>e.focus(),300)}function Zt(t,i){oe={profile:JSON.parse(JSON.stringify(lt[i]||lt.admin)),langue:"Français",unites:ot[0]};const a=localStorage.getItem("mobile_avatarUrl")||null;function r(){const n=oe.profile,l=a?`<img src="${a}" alt="avatar" style="width:100%;height:100%;object-fit:cover">`:`<span>${n.initials}</span>`,d=n.apiKeys.map(o=>`
    ...
    `,s()}function s(){var l;const n=oe.profile;(l=t.querySelector("#m-avatar-upload"))==null||l.addEventListener("change",d=>{const c=d.target.files[0];if(!c)return;const o=new FileReader;o.onload=m=>{localStorage.setItem("mobile_avatarUrl",m.target.result),t.querySelector("#m-avatar").innerHTML=`<img src="${m.target.result}" alt="avatar" style="width:100%;height:100%;object-fit:cover">`},o.readAsDataURL(c)}),t.querySelectorAll(".m-list-row[data-action]").forEach(d=>{d.addEventListener("click",()=>{switch(d.dataset.action){case"prenom":rt("Prénom",n.prenom,c=>{n.prenom=c,r()});break;case"nom":rt("Nom",n.nom,c=>{n.nom=c,r()});break;case"email":fe({title:"Adresse email",body:Object.assign(document.createElement("div"),{innerHTML:`<div class="m-sheet-info"><i class="bi bi-envelope-check" style="font-size:32px;color:#007aff"></i><p>${n.email}</p><p class="m-sheet-info-sub">Pour modifier votre email, un lien de vérification sera envoyé à la nouvelle adresse.</p></div>`}),doneLabel:"Modifier",onDone:()=>Y("Fonctionnalité à venir")});break;case"phones":Jt(n.phones,c=>{n.phones=c,r()});break;case"mdp":fe({title:"Mot de passe",body:Object.assign(document.createElement("div"),{innerHTML:`
                ...
                `}),doneLabel:"Modifier",onDone:()=>Y("Fonctionnalité à venir")});break;case"langue":ct("Langue",Wt,oe.langue,c=>{oe.langue=c,t.querySelector("#val-langue").textContent=c});break;case"unites":ct("Unités",ot,oe.unites,c=>{oe.unites=c,t.querySelector("#val-unites").textContent=c.split(" ")[0]});break;case"gen-key":Yt(c=>{n.apiKeys.push(c),r()});break;case"delete":Y("Contactez le support pour supprimer votre compte");break}})}),t.querySelectorAll(".m-list-row[data-key-id]").forEach(d=>{d.addEventListener("click",()=>{const c=n.apiKeys.find(o=>o.id===+d.dataset.keyId);c&&Gt(c,n.apiKeys,r)})}),t.querySelectorAll(".m-toggle input[data-notif]").forEach(d=>{d.addEventListener("change",()=>Y("Préférence enregistrée"))})}r()}function O(t){var a;const i=document.getElementById("phone-screen");(a=document.querySelector(".m-toast"))==null||a.remove();const e=document.createElement("div");e.className="m-toast",e.textContent=t,i.appendChild(e),requestAnimationFrame(()=>e.classList.add("m-toast--show")),setTimeout(()=>{e.classList.remove("m-toast--show"),setTimeout(()=>e.remove(),300)},2200)}function U({title:t,body:i,doneLabel:e="Fermer",onDone:a}={}){var l;const r=document.getElementById("phone-screen");(l=document.querySelector(".m-sheet-overlay"))==null||l.remove();const s=document.createElement("div");s.className="m-sheet-overlay",s.innerHTML=`
    <div class="m-sheet">
      <div class="m-sheet-handle"></div>
      <div class="m-sheet-hd">
        <button class="m-sheet-cancel">Annuler</button>
      ...
      <div class="m-sheet-body"></div>
        ...
        <div class="m-alert-card" data-id="${l.id}">
          ...
          <div class="m-alert-body">
        ...
        </div>`}).join(""),s()}function s(){e.querySelectorAll(".m-alert-toggle input").forEach(l=>{l.addEventListener("change",d=>{d.stopPropagation();const c=+l.dataset.id,o=a.find(m=>m.id===c);o&&(o.statut=l.checked?"actif":"inactif",r(),O(`Alerte ${l.checked?"activée":"désactivée"}`))})}),e.querySelectorAll(".m-alert-more-btn").forEach(l=>{l.addEventListener("click",d=>{d.stopPropagation();const c=+l.dataset.id,o=a.find($=>$.id===c);if(!o)return;ut(o);const m=document.createElement("div"),p=Xt(c);function u(){const $=o.sensorIds.map((A,T)=>{const j=N.find(S=>S.id===A);return j?{label:`${j.model} ${j.serial}`,type:"sensor",idx:T}:null}).filter(Boolean),L=o.parcelIds.map((A,T)=>{const j=B.find(S=>S.id===A);return j?{label:j.name,type:"parcel",idx:T}:null}).filter(Boolean),E=[...$,...L];return E.length?E.map(A=>`<div class="m-perimetre-item" data-type="${A.type}" data-idx="${A.idx}">
                <span>${A.label}</span>
                <button class="m-perimetre-del" data-type="${A.type}" data-idx="${A.idx}"><i class="bi bi-x-lg"></i></button>
              </div>`).join(""):'<span style="color:#8e8e93;font-size:13px">—</span>'}const v=document.createElement("div");v.className="m-sheet-info-rows";function w(){var A;m.innerHTML="";const $=document.createElement("div");$.className="m-sheet-info-rows",$.innerHTML=`
            ...
            ${p.map(T=>`<div class="m-history-row">
          ...
          </div>`;const p=U({title:o.name,body:m,doneLabel:"Fermer",onDone:()=>{}});m.querySelector("#al-edit").addEventListener("click",()=>{p.classList.remove("m-sheet-overlay--show"),setTimeout(()=>{p.remove(),O("Modification à venir")},280)}),m.querySelector("#al-delete").addEventListener("click",()=>{const u=a.findIndex(v=>v.id===c);u!==-1&&a.splice(u,1),p.classList.remove("m-sheet-overlay--show"),setTimeout(()=>{p.remove(),r()},280),O("Alerte supprimée")})})})}(n=t.querySelector(".m-navbar-action"))==null||n.addEventListener("click",()=>{O("Création d'alerte — à venir")}),r()}const ii="modulepreload",si=function(t){return"/weenat-proto/"+t},mt={},re=function(i,e,a){let r=Promise.resolve();if(e&&e.length>0){document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),l=(n==null?void 0:n.nonce)||(n==null?void 0:n.getAttribute("nonce"));r=Promise.allSettled(e.map(d=>{if(d=si(d),d in mt)return;mt[d]=!0;const c=d.endsWith(".css"),o=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${o}`))return;const m=document.createElement("link");if(m.rel=c?"stylesheet":ii,c||(m.as="script"),m.crossOrigin="",m.href=d,l&&m.setAttribute("nonce",l),document.head.appendChild(m),c)return new Promise((p,u)=>{m.addEventListener("load",p),m.addEventListener("error",()=>u(new Error(`Unable to preload CSS for ${d}`)))})}))}function s(n){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=n,window.dispatchEvent(l),!l.defaultPrevented)throw n}return r.then(n=>{for(const l of n||[])l.status==="rejected"&&s(l.reason);return i().catch(s)})},ai={admin:100,adherent:1},At="weenat-m-dash";function Je(){try{return JSON.parse(localStorage.getItem(At))||{}}catch{return{}}}function ni(t){try{localStorage.setItem(At,JSON.stringify({...Je(),...t}))}catch{}}const z=[{id:"bilan_hydrique",title:"Irrigation",icon:"bi-droplet-fill",color:"#0172A4",active:!0,available:!0,fixed:!1},{id:"previsions",title:"Prévisions",icon:"bi-cloud-sun-fill",color:"#f5a623",active:!0,available:!0,fixed:!1},{id:"cumuls",title:"Cumuls",icon:"bi-bar-chart-fill",color:"#bf5af2",active:!0,available:!0,fixed:!1},{id:"temps_reel",title:"Mesures",icon:"bi-activity",color:"#ff9f0a",active:!0,available:!0,fixed:!1},{id:"traitements",title:"Traitements",icon:"bi-shield-fill",color:"#4ecdc4",active:!0,available:!0,fixed:!1},{id:"cultures",title:"Cultures",icon:"bi-flower1",color:"#a2c4c9",active:!0,available:!0,fixed:!1},{id:"evenements",title:"Anomalies capteurs",icon:"bi-exclamation-triangle-fill",color:"#ff3b30",active:!0,available:!0,fixed:!1},{id:"mon_reseau",title:"Infos Réseau",icon:"bi-diagram-3-fill",color:"#5b8dd9",active:!0,available:!0,fixed:!0},{id:"support",title:"Support",icon:"bi-question-circle-fill",color:"#30d158",active:!0,available:!0,fixed:!0}];function ce(t){var a;const i=document.getElementById("phone-screen");(a=document.querySelector(".m-toast"))==null||a.remove();const e=document.createElement("div");e.className="m-toast",e.textContent=t,i.appendChild(e),requestAnimationFrame(()=>e.classList.add("m-toast--show")),setTimeout(()=>{e.classList.remove("m-toast--show"),setTimeout(()=>e.remove(),300)},2200)}function _e({title:t,body:i,doneLabel:e="Fermer",onDone:a}={}){var l;const r=document.getElementById("phone-screen");(l=document.querySelector(".m-sheet-overlay"))==null||l.remove();const s=document.createElement("div");s.className="m-sheet-overlay",s.innerHTML=`
    <div class="m-sheet">
      <div class="m-sheet-handle"></div>
      <div class="m-sheet-hd">
        <button class="m-sheet-cancel">Annuler</button>
    ...
    <div class="m-wf-card">
      ...
      <div class="m-tr-chart-wrap" data-unit="${t.unit}" data-series='${v}' style="position:relative;margin-top:4px">
        ${o}
    ...
    <div class="m-wf-form${e?" m-wf-disabled":""}">
      ...
      <div class="m-wf-row">
        <select class="m-wf-sel" id="msr-period" ${e?"disabled":""}>
          ${ri.map(l=>`<option value="${l.id}"${l.id==="7d"?" selected":""}>${l.label}</option>`).join("")}
        </select>
    ...
    <div id="msr-list">${n}</div>`}function vi(t,i){const e=new Date().toISOString().split("T")[0],a=new Date;a.setDate(a.getDate()+7);const r=a.toISOString().split("T")[0],s=new Set([t.name]);return We(i).filter(n=>n.ids.includes(t.id)).forEach(n=>s.add(n.label)),Et.filter(n=>!n.real&&n.iso>=e&&n.iso<=r&&s.has(n.label)).reduce((n,l)=>n+l.mm,0)}const gt=9;function De(t,i=!1){if(!t.length)return'<div class="m-widget-empty"><i class="bi bi-check-circle" style="color:#30d158;font-size:28px"></i><p>Aucune parcelle</p></div>';const e=We(t),a=new Set(e.flatMap(p=>p.ids)),r=t.filter(p=>!a.has(p.id)),s=[...e.flatMap(p=>p.ids.map(u=>t.find(v=>v.id===u)).filter(Boolean)),...r],n=i?s:s.slice(0,gt),l=new Set(n.map(p=>p.id)),d=s.length-n.length,c=p=>{const{j0:u,j7:v,bilan:w}=li(p),$=vi(p,t);return`
      <button class="m-bh-th-n m-bh-plot-link" data-plot-id="${p.id}">${p.name}</button>
      <div class="m-bh-td">${u}</div>
      <div class="m-bh-td">${v}</div>
      <div class="m-bh-td m-bh-td--reco">${w>0?w:"—"}</div>
      <div class="m-bh-td m-bh-td--planif">${$>0?$:"—"}</div>`};let o="";for(const p of e){const u=p.ids.map(v=>t.find(w=>w.id===v)).filter(Boolean).filter(v=>l.has(v.id));u.length&&(o+=`<div class="m-bh-group-row">⬡ ${p.label}</div>`,o+=u.map(c).join(""))}o+=r.filter(p=>l.has(p.id)).map(c).join("");const m=s.length>gt?`<button class="m-bh-expand" id="bh-expand" data-expanded="${i}">
    ...
    </div>`}function hi(t,i,e){const a=Object.fromEntries(W.map(o=>[o.id,o])),r=t.map(o=>{var u;const m=o.ville||((u=a[o.orgId])==null?void 0:u.ville)||null,p=[o.name,o.crop||null,m].filter(Boolean).join(" · ");return`<option value="p-${o.id}">${p}</option>`}).join(""),s=i.map(o=>`<option value="s-${o.id}">${o.model} — ${o.serial}</option>`).join(""),n=`
    <optgroup label="Parcelles">${r}</optgroup>
    ${s?`<optgroup label="Capteurs">${s}</optgroup>`:""}`,l=(o,m)=>{const p=`${o.dayLabel.charAt(0).toUpperCase()+o.dayLabel.slice(1)} · ${o.dateStr}`;return`
    <div class="m-prev-card" data-day="${m}" role="button">
      <div class="m-prev-card-hd">
        ...
        <div class="m-prev-card-hd-info">
          <span class="m-prev-card-day">${p}</span>
    ...
    </div>`}const de=[{id:"pluie",label:"Cumul de pluie",unit:"mm",base:45,amp:80,needsModels:["P+","PT","P","SMV"]},{id:"dj",label:"Degrés-jours",unit:"DJ",base:120,amp:300,needsModels:["P+","PT","SMV","TH"]},{id:"hf",label:"Heures de froid",unit:"h",base:30,amp:120,needsModels:["P+","PT","SMV","TH"]},{id:"etp",label:"Évapotranspiration",unit:"mm",base:20,amp:60,needsModels:["P+","PT","SMV"]},{id:"rayo",label:"Rayonnement solaire",unit:"MJ",base:8,amp:20,needsModels:["PYRANO"]},{id:"humec",label:"Humectation foliaire",unit:"h",base:10,amp:40,needsModels:["LWS"]}],bi=new Set(de.flatMap(t=>t.needsModels||[]));function fi(t){if(!t)return de;if(t.startsWith("s-")){const e=N.find(a=>a.id===+t.slice(2));return e?de.filter(a=>a.needsModels===null||a.needsModels.includes(e.model)):de}const i=new Set(N.filter(e=>e.parcelId===+t.slice(2)).map(e=>e.model));return de.filter(e=>e.needsModels===null||e.needsModels.some(a=>i.has(a)))}const gi={pluie:{icon:"bi-droplet-fill",color:"#45b7d1"},dj:{icon:"bi-thermometer-sun",color:"#ff9f0a"},hf:{icon:"bi-thermometer-low",color:"#5ac8fa"},etp:{icon:"bi-moisture",color:"#30d158"},rayo:{icon:"bi-sun-fill",color:"#f5c842"},humec:{icon:"bi-droplet-half",color:"#bf5af2"}};function yi(){return ue.length?ue.map((t,i)=>{const e=new Date(t.fromDate).toLocaleDateString("fr-FR",{day:"numeric",month:"short",year:"numeric"});return`<div class="m-cumuls-saved-card" style="position:relative">
    ...
    </div>`}).join(""):'<div style="text-align:center;padding:16px;font-size:13px;color:#8e8e93">Aucun cumul enregistré</div>'}function $i(t,i,e){if(!t||!i)return null;const a=de.find(n=>n.id===e)||de[0],r=Math.max(1,Math.round((Date.now()-new Date(i))/864e5)),s=t.split("").reduce((n,l)=>n+l.charCodeAt(0),0)+r;return+(a.base+s%(a.amp*10)/10).toFixed(1)}function yt(t,i){const e=ue.length>=Ge,a=`${new Date().getFullYear()}-01-01`,r=i.filter(o=>o.parcelId&&bi.has(o.model)),s=new Set(r.map(o=>o.parcelId)),l=t.filter(o=>s.has(o.id)).map(o=>`<option value="p-${o.id}">${o.name}</option>`).join(""),d=r.map(o=>{const m=t.find(p=>p.id===o.parcelId);return`<option value="s-${o.id}">${o.model} — ${o.serial}${m?` · ${m.name}`:""}</option>`}).join(""),c=ue.length?yi():'<div class="m-wf-empty">Aucun cumul enregistré</div>';return`
    ...
    <div id="cumuls-saved-list">${c}</div>`}const wi={"Blé tendre":["Prosaro","Aviator Xpro","Input Xpro"],Maïs:["Mercantor Gold","Callisto","Milagro"],Orge:["Comet Pro","Siltra Xpro","Variano Xpro"],Colza:["Karate Zeon","Plenum","Caryx"],"Prairie permanente":["Duplosan KV","Starane Premium","—"],Tournesol:["Adengo","Merlin Flexx","Pulsar Plus"],Betterave:["Betanal Expert","Debut","Safari"]};function xi(t){const i=t.id,e=new Date,a=wi[t.crop]||["—"],r=a[i%a.length];let s,n;i%5===3?(s=0,n=(e.getHours()+2+i%3*3)%24):(s=(i*2+1)%6+1,n=6+i%5*2);const l=2+i%3,d=new Date(e);d.setDate(d.getDate()+s);const c=s===0?"Aujourd'hui":d.toLocaleDateString("fr-FR",{day:"2-digit",month:"2-digit"}),o=s*1440+n*60-(e.getHours()*60+e.getMinutes()),m=o>=0&&o<=600;return{product:r,winDateStr:c,winHour:n,winDur:l,isUrgent:m,minutesFromNow:o}}function Ci(t){const e=t.filter(s=>s.crop).map(s=>({p:s,d:xi(s)})).filter(({d:s})=>s.minutesFromNow>=0&&s.minutesFromNow<=2880).sort((s,n)=>s.d.minutesFromNow-n.d.minutesFromNow);return e.length?`<div class="m-w-list">${e.slice(0,10).map(({p:s,d:n})=>{const l=n.isUrgent?"#ff9f0a":"#1c1c1e",d=n.isUrgent?'<i class="bi bi-alarm-fill" style="color:#ff9f0a"></i> ':"",c=String(n.winHour).padStart(2,"0");return`<div class="m-w-row">
    ...
    </div>`:'<div class="m-widget-empty">Aucune fenêtre favorable dans les prochaines 48h</div>'}const Si={"capteur couché":{icon:"bi-arrow-down-circle-fill",color:"#ff9f0a"},"émissions interrompues":{icon:"bi-wifi-off",color:"#ff3b30"},"capteur déplacé":{icon:"bi-geo-alt-fill",color:"#ff9f0a"},"cuillère bloquée":{icon:"bi-x-octagon-fill",color:"#ff3b30"}};function Mi(t,i){const e=i.filter(a=>a.event&&(Array.isArray(a.event)?a.event.length>0:!0));return e.length?`<div class="m-w-list">${e.map(a=>{const r=t.find(l=>l.id===a.parcelId),n=(Array.isArray(a.event)?a.event:[a.event]).map(l=>{const d=Si[l]||{icon:"bi-exclamation-circle-fill",color:"#ff9f0a"};return`<span class="m-ev-badge" style="color:${d.color}"><i class="bi ${d.icon}"></i> ${l}</span>`}).join("");return`<div class="m-w-row m-w-row--clickable" data-sensor-id="${a.id}" style="flex-direction:column;align-items:flex-start;gap:4px">
    ...
    </details>`}).join("")}`}function Ti(t){const i=B.map(r=>r.orgId).filter((r,s,n)=>n.indexOf(r)===s&&r!==100).length,e=N.length,a=B.length;return`
    ...
    ${t==="admin"?'<div style="padding:10px 16px;font-size:12px;color:#8e8e93;text-align:center;border-top:.5px solid rgba(0,0,0,.08)">Infos modifiables sur la version web.</div>':""}`}function ji(){return`
    ...
    <div class="m-sheet m-chat-sheet">
    ...
    </div>`,t.appendChild(i),requestAnimationFrame(()=>i.classList.add("m-sheet-overlay--show"));const e=i.querySelector("#chat-messages"),a=i.querySelector("#chat-input"),r=i.querySelector("#chat-send"),s=()=>{i.classList.remove("m-sheet-overlay--show"),setTimeout(()=>i.remove(),280)};i.querySelector("#chat-close").addEventListener("click",s),i.addEventListener("click",o=>{o.target===i&&s()});function n(o,m){const p=document.createElement("div");p.className=`m-chat-msg m-chat-msg--${m}`,p.innerHTML=`<div class="m-chat-bubble">${o}</div>`,e.appendChild(p),e.scrollTop=e.scrollHeight}function l(){const o=document.createElement("div");return o.className="m-chat-msg m-chat-msg--bot m-chat-typing",o.innerHTML='<div class="m-chat-bubble"><span></span><span></span><span></span></div>',e.appendChild(o),e.scrollTop=e.scrollHeight,o}function d(){const o=a.value.trim();if(!o)return;n(o,"user"),a.value="",r.disabled=!0;const m=l();setTimeout(()=>{m.remove();const p=$t[Math.floor(Math.random()*$t.length)];n(p,"bot"),r.disabled=!1,a.focus()},1200+Math.random()*800)}r.addEventListener("click",d),a.addEventListener("keydown",o=>{o.key==="Enter"&&d()}),setTimeout(()=>a.focus(),350)}function Pi(t,i){let e=t.querySelector("#dashboard-content");e||(e=document.createElement("div"),e.id="dashboard-content",t.appendChild(e));const a=ai[i]||1,r=a===100?B:B.filter(h=>h.orgId===a),s=new Set(r.map(h=>h.id)),n=N.filter(h=>s.has(h.parcelId));let l=vt(),d=null;function c(){return d===null?B:B.filter(h=>h.orgId===d)}function o(){return i!=="admin"?"":`<select id="bh-org-select" style="width:100%;padding:8px 10px;border:none;border-bottom:.5px solid rgba(0,0,0,.1);background:#f9f9fb;font-size:14px;font-family:inherit;color:#1c1c1e;outline:none">
    ...
    </select>`}const m=Je(),p=new Set(["mon_reseau","support"]),u=new Set(m.collapsed??z.map(h=>h.id).filter(h=>!p.has(h)));function v(){ni({catalog:z.map(h=>({id:h.id,active:h.active})),collapsed:[...u],mesuresList:ae,cumulsList:ue})}function w(h,y){const b=h.fixed?"":`<button class="m-widget-menu" data-widget="${h.id}" type="button">•••</button>`,g=u.has(h.id);return`
      ...
      ${[...h,...y].map(b=>{let g="";return b.id==="bilan_hydrique"?g=o()+De(c()):b.id==="previsions"?g=hi(r,n,l):b.id==="cumuls"?g=yt(r,n):b.id==="temps_reel"?g=ft(r,n):b.id==="traitements"?g=Ci(r):b.id==="evenements"?g=Mi(r,n):b.id==="cultures"?g=Ai(r):b.id==="mon_reseau"?g=Ti(i):b.id==="support"&&(g=ji()),w(b,g)}).join("")}
      ...
      <div id="detail-content" class="m-detail-content" style="top:84px">
        ...
        </div>`).join(""),h.querySelectorAll(".m-reorder-btn:not([disabled])").forEach(C=>{C.addEventListener("click",()=>{const k=y(),G=+C.dataset.i,Q=G+ +C.dataset.dir,me=z.indexOf(k[G]),$e=z.indexOf(k[Q]);[z[me],z[$e]]=[z[$e],z[me]],v(),b(),$()})})};b(),_e({title:"Réorganiser les widgets",body:h,doneLabel:"Fermer",onDone:()=>{}})}function f(){const h=i==="admin",y=be(`
      <div class="m-detail-header">
      ...
      <div id="detail-content" class="m-detail-content" style="top:52px">
      ...
      </div>`);y.querySelector(".m-detail-back").addEventListener("click",ne),y.querySelectorAll(".m-add-item").forEach(b=>{b.addEventListener("click",()=>{const g=b.dataset.action;g==="irrigation"?(ne(),re(()=>import("./irrigation-BeOjfEPP.js"),__vite__mapDeps([0,1,2,3,4,5,6,7,8])).then(C=>C.openIrrigationSaisie(r,ce))):g==="strategie-irrigation"?(ne(),re(()=>import("./irrigation-BeOjfEPP.js"),__vite__mapDeps([0,1,2,3,4,5,6,7,8])).then(C=>C.openIrrigationStrategie(r,ce))):ce("Fonctionnalité à venir")})})}function x(){const h=document.createElement("div"),y=()=>{const b=z.filter(g=>!g.fixed);h.innerHTML=b.map(g=>`
        ...
        </div>`).join(""),h.querySelectorAll("[data-cid]").forEach(g=>{g.addEventListener("click",()=>{const C=z.find(k=>k.id===g.dataset.cid);C&&(C.active=!C.active,v(),y(),$())})})};y(),_e({title:"Widgets disponibles",body:h,doneLabel:"Fermer",onDone:()=>{}})}$()}new URLSearchParams(window.location.search).get("role");const Ii=[{title:"Cumuls",items:["Cumul Degrés jours","Cumul Pluie","Cumul Ensoleillement","Cumul Evapotranspiration","Cumul Heures froides","Cumul Humectation foliaire"]},{title:"Outils aide à la décision",items:["Maï'zy","Suivi de culture","Weephyt","Decitrait","Tavelure Pomme"]},{title:"Indicateurs",items:["DPV","THI","Température de rosée","Température du sol","Rayonnement solaire","Gel"]},{title:"Prévisions",items:["Prévisions à 5 jours","Prévisions à 6 heures","Prévisions du jour","Prévisions de tensiométrie"]},{title:"Capteurs",items:["Anémomètre","Capteur d'humectation foliaire","Capteur PAR","Pyranomètre","Station météo","Station Météo Virtuelle","Thermomètre de sol","Thermomètre-Hygromètre"]},{title:"Irrigation",items:["Bilan hydrique","Irrigations","Sonde capacitive","Tensiomètre","Sonde de fertirrigation","Profil capteurs","Niveau de réservoir en eau utilisable","Profil de niveau de réservoir"]}];function qi(){const t=Ii.map(e=>`
    ...
    <div class="m-chart-card">
      ...
      ${_i(t,i,e.cumulsType)}
    </div>`:""}function Ri(t){const i=JSON.parse(decodeURIComponent(t.dataset.chart||"{}"));if(!i.vals)return;const{vals:e,minV:a,maxV:r}=i,s=t.querySelector(".m-chart-tip"),n=t.querySelector(".m-chart-crosshair"),l=t.dataset.color||"#0172A4";function d(o){const m=t.getBoundingClientRect(),p=Math.max(0,Math.min(1,(o-m.left)/m.width)),u=Math.round(p*(e.length-1)),v=e[u],w=p*100;n.style.cssText=`display:block;position:absolute;top:0;bottom:20px;left:${w}%;width:1px;background:${l};opacity:.5`,s.style.cssText=`display:block;position:absolute;top:8px;left:${Math.min(w,75)}%;background:#1a1a1a;color:#fff;font-size:12px;font-weight:700;padding:3px 8px;border-radius:6px;white-space:nowrap;pointer-events:none`,s.textContent=v<10?v.toFixed(1):String(Math.round(v))}function c(){n.style.display="none",s.style.display="none"}t.addEventListener("pointermove",o=>{o.preventDefault(),d(o.clientX)}),t.addEventListener("pointerdown",o=>d(o.clientX)),t.addEventListener("pointerup",c),t.addEventListener("pointerleave",c),t.style.cursor="crosshair"}function Bi(t){const i=We(B.filter(v=>v.orgId===t.orgId)),e=new Set([t.name]);i.filter(v=>v.ids.includes(t.id)).forEach(v=>e.add(v.label));const a=[t.crop,t.irrigation].filter(Boolean).join(" · ");a&&e.add(a);const r=Et.filter(v=>e.has(v.label)),s=new Date().toISOString().split("T")[0],n=r.filter(v=>v.real),l=r.filter(v=>!v.real),d=n.reduce((v,w)=>v+w.mm,0),c=l.reduce((v,w)=>v+w.mm,0),o=l.filter(v=>v.iso>=s).sort((v,w)=>v.iso<w.iso?-1:1)[0],m=["jan","fév","mar","avr","mai","jun","jul","aoû","sep","oct","nov","déc"],p=v=>{const[,w,$]=v.split("-");return`${+$} ${m[+w-1]}`},u=t.irrigation;return r.length?`
    <div class="m-placeholder-widget" style="flex-direction:column;align-items:flex-start;gap:10px">
      <div style="display:flex;align-items:center;justify-content:space-between;width:100%">
        <span style="font-size:13px;font-weight:700;color:#1c1c1e;display:flex;align-items:center;gap:6px">
          ...
          ${t.texture?`<span style="background:#f0f0f0;color:#636366;border-radius:20px;padding:1px 8px;font-size:11px;font-weight:500">${t.texture}</span>`:""}
        </span>
      ...
      ${o?`<div style="font-size:12px;color:#3a3a3c"><i class="bi bi-arrow-right-circle" style="color:#0172A4"></i> Prochaine · <strong>${p(o.iso)}</strong> · ${o.mm} mm</div>`:""}
    </div>`:`
      ...
      </div>`}function Oi(t,i=[]){const e=i.map(r=>N.find(s=>s.id===r)).filter(Boolean),a=zi(e);return`
    ...
    <div class="m-widget-card">
      ...
      ${a}
    </div>`}function Fi(t){const i=t.id||1,e=(o,m)=>+(o+(i*9301+49297)%233280/233280*(m-o)).toFixed(1),a=e(40,180),r=e(60,200),s=Math.round(e(80,320)),n=Math.round(e(120,600)),l=Math.round(e(20,120)),c=`
    ...
    <div class="m-widget-footer">Depuis le 1er janvier 2026</div>`;return Ze("Cumuls saison","bi-bar-chart-line","#0172A4",c)}function Ni(){const t=["Dim","Lun","Mar","Mer","Jeu","Ven","Sam"],i=["bi-sun","bi-cloud-sun","bi-cloud","bi-cloud-rain","bi-cloud-drizzle","bi-cloud-lightning","bi-cloud-snow"],e=new Date,a=e.getDate(),s=`
    <div class="m-wprev5-grid">
      ${Array.from({length:5},(n,l)=>{const d=new Date(e);d.setDate(e.getDate()+l);const c=a+l*7,o=Math.round(16+(c*127+31)%100/100*12),m=Math.round(o-4-(c*31+17)%40/10),p=(c*41+13)%100<35?Math.round(2+c*13%18):0,u=i[p>0?p>8?3:4:c%3===0?1:c%5===0?2:0];return{day:t[d.getDay()],tmax:o,tmin:m,pluie:p,icon:u}}).map((n,l)=>`
    ...
    <div class="m-widget-footer">Source : Modèle Arome · 3 km</div>`;return Ze("Prévisions 5 jours","bi-cloud-sun","#4ecdc4",s)}function zi(t){if(!t.length)return"";const i={"P+":"bi-cloud-rain-heavy",PT:"bi-cloud-rain-heavy",P:"bi-cloud-rain-heavy",TH:"bi-thermometer-half",SMV:"bi-cloud-sun",W:"bi-wind",PYRANO:"bi-brightness-high",PAR:"bi-brightness-alt-high",LWS:"bi-droplet",T_GEL:"bi-snow",T_MINI:"bi-thermometer-half","CHP-15/30":"bi-moisture","CHP-30/60":"bi-moisture","CHP-60/90":"bi-moisture","CAPA-30-3":"bi-moisture","CAPA-60-6":"bi-moisture",EC:"bi-plug"},e={"P+":"Station météo",PT:"Station météo",P:"Pluviomètre",TH:"Thermo-hygro",SMV:"Station météo virtuelle",W:"Anémomètre",PYRANO:"Pyranomètre",PAR:"Capteur PAR",LWS:"Humectation",T_GEL:"Sonde gel",T_MINI:"Thermo. sol","CHP-15/30":"Tensiomètre","CHP-30/60":"Tensiomètre","CHP-60/90":"Tensiomètre","CAPA-30-3":"Sonde capacitive","CAPA-60-6":"Sonde capacitive",EC:"Fertirrigation"},a={"P+":"#45b7d1",PT:"#45b7d1",P:"#45b7d1",TH:"#e07050",SMV:"#c090e0",W:"#82b8e0",PYRANO:"#f5c842",PAR:"#a0d070",LWS:"#60a090",T_GEL:"#7bc4b0",T_MINI:"#bb8fce","CHP-15/30":"#5b8dd9","CHP-30/60":"#5b8dd9","CHP-60/90":"#5b8dd9","CAPA-30-3":"#f0c060","CAPA-60-6":"#f0c060",EC:"#f0a030"},r={"P+":["pluie","temperature","humidite"],PT:["pluie","temperature"],P:["pluie"],TH:["temperature","humidite"],SMV:["pluie","temperature","humidite"],W:["vent"],PYRANO:["rayonnement"],PAR:["par"],LWS:["humectation"],T_GEL:["temperature"],T_MINI:["temp_sol"],"CHP-15/30":["pothydr"],"CHP-30/60":["pothydr"],"CHP-60/90":["pothydr"],"CAPA-30-3":["teneur"],"CAPA-60-6":["teneur"],EC:["teneur"]};return t.slice(0,4).map(s=>{const n=i[s.model]||"bi-broadcast",l=e[s.model]||s.model,d=a[s.model]||"#0172A4",c=r[s.model]||[],o=ye[c[0]],m=c[0],p=`
      ...
      <div class="m-wsensor-vals">
        ${c.slice(0,3).map(u=>{const v=ye[u];if(!v)return"";const $=Pe(u,1)[0],L=$<10?$.toFixed(1):Math.round($);return`<div class="m-wsensor-val-row">
            <span class="m-wsensor-metric">${v.label}</span>
            <span class="m-wsensor-value" style="color:${v.color}">${L} ${v.unit}</span>
          </div>`}).join("")}
      </div>
      <div class="m-widget-footer">${s.serial}</div>`;return Ze(l,n,d,p)}).join("")}function Vi(t,i){const e=new Blob(["\uFEFF"+t],{type:"text/csv;charset=utf-8;"}),a=Object.assign(document.createElement("a"),{href:URL.createObjectURL(e),download:i});document.body.appendChild(a),a.click(),document.body.removeChild(a),setTimeout(()=>URL.revokeObjectURL(a.href),100)}function Wi(t,i,e){const a=new Set;i.forEach(u=>{const v=N.find(w=>w.id===u);v&&(kt[v.model]||[]).forEach(w=>a.add(w))});const r=[...new Set(["etp","rayonnement","temp_rosee",...a])].filter(u=>ye[u]),s=Ue[e]||60,n=Ye[e]||10080,l=n/s*6e4,d=new Date,c=new Date(d-n*6e4),o=["Horodatage",...r.map(u=>`${ye[u].label} (${ye[u].unit})`)].join(";"),m=Array.from({length:s},(u,v)=>[new Date(c.getTime()+v*l).toISOString().replace("T"," ").slice(0,19),...r.map($=>Pe($,1)[0].toFixed(2))].join(";")),p=(t.name||"parcelle").replace(/[^\w]/g,"_");Vi([o,...m].join(`\r
`),`${p}_${e}_${new Date().toISOString().slice(0,10)}.csv`)}function Ji(t,i="7d",e="1h"){const a=new Set;t.forEach(s=>{const n=N.find(l=>l.id===s);n&&(kt[n.model]||[]).forEach(l=>a.add(l))});const r=[...new Set(["etp","rayonnement","temp_rosee",...a])];return`
    ...
    <div class="m-detail-section">
      ${r.map(s=>Di(s,i)).join("")}
    </div>`}function Gi(t,i,e){const a=e.map(r=>{const s=N.find(n=>n.id===r);return s?`${s.model} — ${s.serial}`:null}).filter(Boolean);return`
    <div class="m-detail-section">
      ...
      <div class="m-list">
        <div class="m-list-row" data-action="edit-env">
          ...
          <span class="m-list-row-value">${t.env||"—"}</span>
          <i class="bi bi-chevron-right m-list-chevron"></i>
        </div>
    ...
    <div id="detail-content" class="m-detail-content"></div>`);function o(){const u=c.querySelector("#detail-content");r==="widgets"&&(u.innerHTML=Oi(t,i)),r==="donnees"&&(u.innerHTML=Ji(i,s,n)),r==="params"&&(u.innerHTML=Gi(t,a,i),m()),p()}function m(){const u=window.L;u&&setTimeout(()=>{var $;const v=c.querySelector("#parcel-minimap");if(!v)return;const w=u.map(v,{zoomControl:!1,attributionControl:!1,dragging:!1,scrollWheelZoom:!1});if(u.tileLayer("https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}").addTo(w),(($=t.latlngs)==null?void 0:$.length)>=3){const L=u.polygon(t.latlngs,{color:"#fff",weight:2,fillColor:"#0172A4",fillOpacity:.4}).addTo(w);w.fitBounds(L.getBounds(),{padding:[8,8]})}else w.setView([t.lat,t.lng],14),u.circleMarker([t.lat,t.lng],{radius:8,color:"#fff",weight:2,fillColor:"#0172A4",fillOpacity:.9}).addTo(w)},50)}function p(){var u,v,w,$;(u=c.querySelector(".m-period-sel"))==null||u.addEventListener("change",L=>{s=L.target.value,o()}),(v=c.querySelector(".m-step-sel"))==null||v.addEventListener("change",L=>{n=L.target.value,o()}),(w=c.querySelector(".m-export-btn"))==null||w.addEventListener("click",()=>Wi(t,i,s)),c.querySelectorAll(".m-chart-svg-wrap").forEach(L=>Ri(L)),c.querySelectorAll(".m-list-row[data-action]").forEach(L=>{L.addEventListener("click",()=>O("Fonctionnalité à venir"))}),c.querySelectorAll(".m-widget-menu").forEach(L=>{L.addEventListener("click",E=>{E.stopPropagation(),O("Options widget")})}),($=c.querySelector(".m-add-widget-btn"))==null||$.addEventListener("click",qi)}c.querySelectorAll(".m-detail-tab").forEach(u=>{u.addEventListener("click",()=>{c.querySelectorAll(".m-detail-tab").forEach(v=>v.classList.remove("active")),u.classList.add("active"),r=u.dataset.view,o()})}),c.querySelector(".m-detail-back").addEventListener("click",ne),c.querySelector("#d-star").addEventListener("click",()=>{l=!l;const u=c.querySelector("#d-star");u.querySelector("i").className=l?"bi bi-star-fill":"bi bi-star",u.style.color=l?"#f5c842":"",O(l?"Ajouté aux favoris":"Retiré des favoris")}),c.querySelector("#d-plus").addEventListener("click",()=>{const u=`
      ...
      <a class="m-sheet-link" data-a="traitement"><i class="bi bi-eyedropper"></i> Traitement</a>`,v=document.createElement("div");v.innerHTML=u;const w=U({title:"Ajouter à la parcelle",body:v,doneLabel:"Fermer",onDone:()=>{}});v.querySelectorAll("[data-a]").forEach($=>{$.addEventListener("click",()=>{const L=$.dataset.a;w.classList.remove("m-sheet-overlay--show"),setTimeout(()=>{w.remove(),O(L==="integration"?"Disponible sur la version web":"Fonctionnalité à venir")},280)})})}),c.querySelector("#d-journal").addEventListener("click",()=>Ui(t)),o()}const It=t=>`parcel-journal-${t}`;function Ne(t){try{const i=localStorage.getItem(It(t));if(i)return JSON.parse(i)}catch{}return[{id:1,type:"note",category:"Observation générale",date:"2026-05-11",auteur:"Jean Dupont",texte:"Quelques pucerons sur feuilles basses. À surveiller."},{id:2,type:"traitement",date:"2026-05-16",auteur:"Sophie Martin",texte:"Vent < 2 m/s, conditions conformes.",produit:"Karate Zeon",dose:"0,1 L/ha",cible:"Pucerons"}]}function qt(t,i){localStorage.setItem(It(t),JSON.stringify(i))}function Ui(t){const i=W.find(s=>s.id===t.orgId),e=(i==null?void 0:i.ville)||"",a=be(`
    <div class="m-detail-header">
      <div class="m-detail-topbar">
    ...
    `;n.length===0?c+='<div style="padding:40px 16px;text-align:center;color:#8e8e93;font-size:14px">Aucune entrée dans le journal.</div>':(c+='<div class="m-jrn-timeline">',n.forEach((p,u)=>{const v=d[p.type]||d.note,w=p.type==="traitement",$=u===n.length-1;c+=`
          <div class="m-jrn-entry" data-id="${p.id}">
            ...
            <div class="m-jrn-body">
              <div class="m-jrn-hd">
                <span class="m-jrn-date">${l(p.date)}</span>
                <span class="journal-type-badge journal-type-badge--${v.badgeCls}">${v.label}</span>
                <button class="m-jrn-del" data-id="${p.id}"><i class="bi bi-trash3"></i></button>
              </div>
              ${p.texte?`<div class="m-jrn-texte">${p.texte}</div>`:""}
              ${w&&(p.produit||p.dose||p.cible)?`
                <div class="m-jrn-meta">
                  ${p.produit?`<span class="m-jrn-chip"><i class="bi bi-flask"></i>${p.produit}</span>`:""}
                  ${p.dose?`<span class="m-jrn-chip"><i class="bi bi-droplet"></i>${p.dose}</span>`:""}
                  ${p.cible?`<span class="m-jrn-chip"><i class="bi bi-bullseye"></i>${p.cible}</span>`:""}
                </div>`:""}
            </div>
          </div>`}),c+="</div>"),s.innerHTML=c,(o=s.querySelector("#mjrn-add-note"))==null||o.addEventListener("click",()=>wt("note",t.id,r)),(m=s.querySelector("#mjrn-add-trait"))==null||m.addEventListener("click",()=>wt("traitement",t.id,r)),s.querySelectorAll(".m-jrn-del").forEach(p=>{p.addEventListener("click",()=>{const u=parseInt(p.dataset.id);qt(t.id,Ne(t.id).filter(v=>v.id!==u)),r()})})}r()}function wt(t,i,e){const a=t==="traitement",r=new Date().toISOString().slice(0,10),s=document.createElement("div");s.className="modal add-modal",s.innerHTML=`
    <div class="add-modal-content" style="max-width:440px">
        ...
        ${r.map(f=>`<option value="${f.id}"${m===String(f.id)?" selected":""}>${f.name}</option>`).join("")}
      </select>`:"",j=[...A].sort((f,x)=>{const h=Me(f,c),y=Me(x,c);return h&&!y?-1:!h&&y?1:h?p(x.id)-p(f.id):0}),S=j.length?`<div class="m-plain-list">${j.map(f=>{const x=[f.crop,f.irrigation].filter(Boolean).join(" · "),h=Me(f,c);return`
            <div class="m-plain-row m-tappable" data-plot-id="${f.id}">
              ...
              <div style="display:flex;align-items:center;gap:6px">
                <span class="m-plain-data${h?"":" m-plain-na"}">${h?`${p(f.id)} ${E.unit}`:"—"}</span>
    ...
    <div class="m-chart-crosshair" style="display:none"></div>
    <div class="m-chart-tip" style="display:none"></div>
  </div>`}function ts(t){const i=JSON.parse(decodeURIComponent(t.dataset.chart||"{}"));if(!i.vals)return;const{vals:e}=i,a=t.querySelector(".m-chart-tip"),r=t.querySelector(".m-chart-crosshair"),s=t.dataset.color||"#0172A4";function n(d){const c=t.getBoundingClientRect(),o=Math.max(0,Math.min(1,(d-c.left)/c.width)),m=Math.round(o*(e.length-1)),p=e[m],u=o*100;r.style.cssText=`display:block;position:absolute;top:0;bottom:20px;left:${u}%;width:1px;background:${s};opacity:.5`,a.style.cssText=`display:block;position:absolute;top:8px;left:${Math.min(u,75)}%;background:#1a1a1a;color:#fff;font-size:12px;font-weight:700;padding:3px 8px;border-radius:6px;white-space:nowrap;pointer-events:none`,a.textContent=p<10?p.toFixed(1):String(Math.round(p))}function l(){r.style.display="none",a.style.display="none"}t.addEventListener("pointermove",d=>{d.preventDefault(),n(d.clientX)}),t.addEventListener("pointerdown",d=>n(d.clientX)),t.addEventListener("pointerup",l),t.addEventListener("pointerleave",l),t.style.cursor="crosshair"}const Qe={"365d":52,"30d":60,"7d":84,hier:48,"1d":24,custom:60};function is(t,i,e){if(!e)return"";const a=Qe[i]||60,s=(Ke[i]||10080)/(a*60),n=Xe(t,a);let l=[];if(e==="temp"){const d=n.reduce((o,m)=>o+Math.max(0,m),0)*(s/24),c=n.filter(o=>o<7).length*s;l=[{label:"Degrés jours",val:`${Math.round(d)} DJ`},{label:"Heures de froid",val:`${Math.round(c)} h`}]}else if(e==="pluie")l=[{label:"Cumul pluie",val:`${n.reduce((c,o)=>c+o,0).toFixed(1)} mm`}];else if(e==="rayo"){const d=n.filter(c=>c>120).length*s;l=[{label:"Ensoleillement",val:`${Math.round(d)} h`}]}else if(e==="hws"){const d=n.filter(c=>c>50).length*s;l=[{label:"Heures d'humectation",val:`${Math.round(d)} h`}]}return l.length?`<div class="m-chart-cumuls">${l.map(d=>`<div class="m-chart-cumul-chip">
      <span class="m-chart-cumul-label">${d.label}</span>
      <span class="m-chart-cumul-val">${d.val}</span>
    </div>`).join("")}</div>`:""}function ss(t,i){const e=new Blob(["\uFEFF"+t],{type:"text/csv;charset=utf-8;"}),a=Object.assign(document.createElement("a"),{href:URL.createObjectURL(e),download:i});document.body.appendChild(a),a.click(),document.body.removeChild(a),setTimeout(()=>URL.revokeObjectURL(a.href),100)}function as(t,i){const e=_t[t.model]||[];if(!e.length)return;const a=Qe[i]||60,r=Ke[i]||10080,s=r/a*6e4,n=new Date,l=new Date(n-r*6e4),d=["Horodatage",...e.map(o=>`${o.label} (${o.unit})`)].join(";"),c=Array.from({length:a},(o,m)=>[new Date(l.getTime()+m*s).toISOString().replace("T"," ").slice(0,19),...e.map(u=>Xe(u.id,1)[0].toFixed(2))].join(";"));ss([d,...c].join(`\r
`),`${t.serial}_${i}_${new Date().toISOString().slice(0,10)}.csv`)}function ns(t,i="7d",e="1h"){const a=_t[t.model]||[];if(!a.length)return'<div class="m-empty-state"><i class="bi bi-broadcast"></i><p>Aucune donnée disponible</p></div>';const r=a.map(s=>`
      <div class="m-chart-card">
        <div class="m-chart-card-hd">
          <span class="m-chart-label" style="color:${s.color}">${s.label}</span>
        </div>
        ${es(s.id,s.color,s.cumul,i)}
        ${is(s.id,i,s.cumulsType)}
      </div>`).join("");return`
    <div class="m-period-bar">
      <select class="m-period-sel">
        <option value="365d"${i==="365d"?" selected":""}>365 jours</option>
    ...
    <div class="m-detail-section">${r}</div>`}function ls(t){const i=t.parcelId?B.find(n=>n.id===t.parcelId):null,e=i?W.find(n=>n.id===i.orgId):null,a=t.networkQuality||0,r=a>70?"#30d158":a>40?"#ff9f0a":"#ff3b30",s=t.event?[t.event]:[];return`
    <div class="m-detail-section">
      <div class="m-list-section-header">Identification</div>
      <div class="m-list">
        <div class="m-list-row">
          <span class="m-list-row-label">Marque</span>
          <span class="m-list-row-value">${Ki[t.model]||"Weenat"}</span>
        </div>
        <div class="m-list-row">
      ...
      <div style="height:24px"></div>
    </div>`}function ze(t,i="donnees"){var p;const e=t.parcelId?B.find(u=>u.id===t.parcelId):null;let a=i,r="7d",s="1h",n=!1;const l=e&&((p=W.find(u=>u.id===e.orgId))==null?void 0:p.ville)||"",d=be(`
    <div class="m-detail-header">
      <div class="m-detail-topbar">
    ...
    `;s.length===0?l+='<div style="padding:40px 16px;text-align:center;color:#8e8e93;font-size:14px">Aucune entrée dans le journal.</div>':(l+='<div class="m-jrn-timeline">',s.forEach((c,o)=>{const m=e[c.type]||{label:c.type,icon:"bi-circle",color:"#8e8e93"},p=o===s.length-1;l+=`
          ...
          </div>`}),l+="</div>"),r.innerHTML=l,(d=r.querySelector("#sjrn-add-btn"))==null||d.addEventListener("click",()=>rs(t.id,a)),r.querySelectorAll(".m-jrn-del").forEach(c=>{c.addEventListener("click",()=>{const o=parseInt(c.dataset.id);Bt(t.id,Ve(t.id).filter(m=>m.id!==o)),a()})})}a()}function rs(t,i){const e=new Date().toISOString().slice(0,10),a=document.createElement("div");a.className="modal add-modal",a.innerHTML=`
    <div class="add-modal-content" style="max-width:440px">
      <div class="add-modal-header">
      ...
      <div class="journal-form">
          ...
          <option value="mine"${u==="mine"?" selected":""}>${(b==null?void 0:b.name)||"Mon organisation"} uniquement</option>
        </select>`}const h=[...f].sort((b,g)=>{const C=Te(b.model,m),k=Te(g.model,m);return C&&!k?-1:!C&&k?1:C?v(g.id)-v(b.id):0}),y=h.length?`<div class="m-plain-list">${h.map(b=>{const g=Re.includes(b.model),k=Te(b.model,m)?`<span class="m-sensor-val">${v(b.id)} ${S.unit}</span>`:'<span class="m-sensor-val m-sensor-val--na">—</span>';return`
            <div class="m-sensor-row m-tappable" data-sensor-id="${b.id}">
              ...
              <div class="m-sensor-info">
                <span class="m-sensor-name">${ms(b.model)}</span>
      ...
      <div class="m-screen-controls">
        ...
        <div class="m-filter-row">
          ...
          <select class="m-filter-select" id="agg-sel">
            ${S.aggs.map(b=>`<option${b===p?" selected":""}>${b}</option>`).join("")}
          </select>
        </div>
        ${x}
      </div>
      ${o==="carte"?'<div class="m-map-view"><div id="sensor-map" class="m-map-container"></div></div>':`<div class="m-list-view">${y}</div>`}`,j(),o==="carte"&&T(f,S)}function T(S,f){const x=window.L;x&&setTimeout(()=>{const h=e.querySelector("#sensor-map");if(!h)return;l=x.map(h,{zoomControl:!1,attributionControl:!1}),x.tileLayer("https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}").addTo(l);const y=[];S.forEach(b=>{const g=$(b);if(!g)return;const C=Te(b.model,m),k=Re.includes(b.model),G=x.circleMarker([g.lat,g.lng],{radius:C?10:7,color:"#fff",weight:2,fillColor:k?"#0172A4":"#5b8dd9",fillOpacity:C?.95:.45}).addTo(l);C&&G.bindTooltip(`${v(b.id)} ${f.unit}`,{permanent:!0,direction:"top",className:"m-map-tip",interactive:!0}),G.on("click",()=>ze(b)),y.push([g.lat,g.lng])}),y.length&&(d=y,l.fitBounds(y,{padding:[32,32]})),l.invalidateSize()},0)}window.addEventListener("m-tab-change",S=>{S.detail==="capteurs"&&o==="carte"&&l&&setTimeout(()=>{l.invalidateSize(),d!=null&&d.length&&l.fitBounds(d,{padding:[32,32]})},50)});function j(){var S,f,x;e.querySelectorAll(".m-view-btn").forEach(h=>h.addEventListener("click",()=>{o=h.dataset.view,A()})),(S=e.querySelector("#metric-sel"))==null||S.addEventListener("change",h=>{var y;m=h.target.value,p=((y=je.find(b=>b.id===m))==null?void 0:y.defaultAgg)||"",A()}),(f=e.querySelector("#agg-sel"))==null||f.addEventListener("change",h=>{p=h.target.value,A()}),(x=e.querySelector("#org-filter"))==null||x.addEventListener("change",h=>{u=h.target.value,A()}),e.querySelectorAll(".m-tappable[data-sensor-id]").forEach(h=>{h.addEventListener("click",()=>{const y=N.find(b=>b.id===+h.dataset.sensorId);y&&ze(y)})})}A()}const Be=100,St=1,hs=["Arboriculture","Viticulture","Maraîchage","Grandes cultures","Polyculture-Élevage","Pépiniériste","Floriculture","Trufficulture","Organismes publics / semi-publics","Coopérative","Négoce","Concessionnaire","Semencier","Laboratoire / Institut / Recherche","Autre"],bs=["Essentiel","Plus","Expert"],fs=["Administrateur","Agent","Lecteur"];function gs(t){const i=(t||"").match(/(\d{5})/);if(i){const e=t.indexOf(i[0]);return{rue:t.slice(0,e).trim().replace(/,\s*$/,""),cp:i[0],ville:t.slice(e+5).trim().replace(/^,?\s*/,"")}}return{rue:t||"",cp:"",ville:""}}function Mt({rue:t,cp:i,ville:e}){return[t,i&&e?`${i} ${e}`:i||e].filter(Boolean).join(", ")}function ys(t){const[i,e,a]=t.split("-");return`${a}/${e}/${i}`}function $s(t,i){if(!t)return{};const e=i==="admin",a=W.find(f=>f.id===(e?Be:St));if(!a)return{};const s=(e?qe.filter(f=>{var x;return!((x=f.orgIds)!=null&&x.length)||f.orgIds.includes(Be)}):qe.filter(f=>{var x;return(x=f.orgIds)==null?void 0:x.includes(St)})).map(f=>({...f})),n=W.filter(f=>f.id!==Be&&f.statut!=="inactif").length,l=gs(a.adresse||""),d={rue:"",cp:"",ville:""},c={name:a.name,metiers:[e?"Coopérative":"Grandes cultures"],adresseFactu:l,adresseLivrai:d,markerLat:a.lat||48.117,markerLng:a.lng||-1.678,plan:a.plan||"Plus",contrat:{numero:e?"CTR-NET-2022-00001":a.codeAdherent||"CTR-2022-00418",dateAdhesion:a.dateAdhesion||"2022-03-15",licencesMembres:e?qe.length:3,licencesAdherents:e?n:null,licencesIntegrations:e?27:2}};let o=null,m=null,p=null;function u(){if(!p)return;const f=t.querySelector(`#${p}`);if(!f)return;if(o){try{o.remove()}catch{}o=null,m=null}const x=window.L;x&&(o=x.map(f,{zoomControl:!0,attributionControl:!1}),x.tileLayer("https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}").addTo(o),o.setView([c.markerLat,c.markerLng],14),m=x.marker([c.markerLat,c.markerLng],{draggable:!0}).addTo(o),m.on("dragend",()=>{const h=m.getLatLng();c.markerLat=h.lat,c.markerLng=h.lng,O("Position mise à jour")}),setTimeout(()=>o==null?void 0:o.invalidateSize(),50))}function v(){if(p=`expl-map-${Math.random().toString(36).slice(2,8)}`,o){try{o.remove()}catch{}o=null,m=null}const f=Mt(c.adresseFactu)||"—",x=Mt(c.adresseLivrai);t.innerHTML=`
      ...
      <div id="${p}" style="height:200px;margin:0 16px 12px;border-radius:12px;overflow:hidden;border:1px solid rgba(0,0,0,.08);position:relative;z-index:0"></div>
      ...
      <div class="m-list">
        ...
        <div class="m-list-row">
          ...
          <span class="m-list-row-value">${ys(c.contrat.dateAdhesion)}</span>
        </div>
        <div class="m-list-row">
      ...
      <input class="m-sheet-input" type="text" placeholder="Ville" id="f-ville" value="${(x.ville||"").replace(/"/g,"&quot;")}">`,U({title:f,body:y,doneLabel:"Enregistrer",onDone:()=>{h({rue:y.querySelector("#f-rue").value.trim(),cp:y.querySelector("#f-cp").value.trim(),ville:y.querySelector("#f-ville").value.trim()}),O("Enregistré")}}),setTimeout(()=>y.querySelector("#f-rue").focus(),300)}function E(){const f=new Set(c.metiers),x=document.createElement("div"),h=()=>{x.innerHTML=hs.map(y=>`
        ...
        </div>`).join(""),x.querySelectorAll("[data-m]").forEach(y=>{y.addEventListener("click",()=>{const b=y.dataset.m;f.has(b)?f.delete(b):f.add(b),h()})})};h(),U({title:"Métiers",body:x,doneLabel:"Valider",onDone:()=>{c.metiers=[...f],v()}})}function A(f,x,h,y){const b=document.createElement("div");b.innerHTML=x.map((C,k)=>`
      ...
      </div>`;const y=U({title:`${x.prenom} ${x.nom}`,body:h,doneLabel:"Fermer",onDone:()=>{}});h.querySelector("#mem-delete").addEventListener("click",()=>{s.splice(f,1),y.classList.remove("m-sheet-overlay--show"),setTimeout(()=>{y.remove(),v()},280),O("Membre retiré")})}function j(){const f=document.createElement("div");f.innerHTML=`
      ...
      <select class="m-sheet-input" id="inv-role">
        ${fs.map(x=>`<option>${x}</option>`).join("")}
      </select>`,U({title:"Inviter un membre",body:f,doneLabel:"Envoyer",onDone:()=>O("Invitation envoyée")}),setTimeout(()=>f.querySelector("#inv-email").focus(),300)}v();function S(){requestAnimationFrame(()=>setTimeout(u,100))}return{onAdd:j,refresh:S}}const ws=100,xs=["Essentiel","Plus","Expert"],Cs={actif:{label:"Actif",color:"#30d158"},"actif en essai":{label:"Essai",color:"#ff9f0a"},"invitation en attente":{label:"Invité",color:"#007aff"},"demande en attente":{label:"En attente",color:"#ff9f0a"},inactif:{label:"Inactif",color:"#8e8e93"}};function Lt(t){return Cs[t]||{label:t||"—",color:"#8e8e93"}}function Ss(t,i){if(!t)return{};if(i!=="admin")return t.innerHTML='<div class="m-empty-state" style="margin-top:40px"><i class="bi bi-lock"></i><p>Réservé aux administrateurs réseau</p></div>',{};const e=W.filter(n=>n.id!==ws).map(n=>({...n}));function a(){const n=e.filter(l=>l.statut!=="inactif");t.innerHTML=`
      ...
      </div>`;const p=U({title:n.name,body:m,doneLabel:"Fermer",onDone:()=>{}});(u=m.querySelector("#lnk-copy"))==null||u.addEventListener("click",()=>{var w;(w=navigator.clipboard)==null||w.writeText(o).catch(()=>{}),O("Lien copié !")}),(v=m.querySelector("#lnk-cancel"))==null||v.addEventListener("click",()=>{n.statut="inactif",p.classList.remove("m-sheet-overlay--show"),setTimeout(()=>{p.remove(),a(),O("Invitation annulée")},280)}),m.querySelector("#lnk-delete").addEventListener("click",()=>{e.splice(l,1),p.classList.remove("m-sheet-overlay--show"),setTimeout(()=>{p.remove(),a(),O("Adhérent supprimé")},280)})}function s(){const n=document.createElement("div");n.innerHTML=`
    ...
    </div>`,document.getElementById("phone-screen").appendChild(i),i.querySelector("#abandon-cancel").addEventListener("click",()=>i.remove()),i.querySelector("#abandon-ok").addEventListener("click",()=>{i.remove(),t()})}document.getElementById("phone-screen").addEventListener("click",t=>{var i;t.target.closest(".m-navbar-logo")&&((i=document.querySelector('.nav-item[data-tab="dashboard"]'))==null||i.click())});document.getElementById("bottom-nav").addEventListener("click",t=>{const i=t.target.closest(".nav-item");if(!i)return;const e=i.dataset.tab;nt()>0&&Vt()?Ls(()=>{window.dispatchEvent(new CustomEvent("m-tab-change",{detail:e})),ve(e)}):(nt()>0&&window.dispatchEvent(new CustomEvent("m-tab-change",{detail:e})),ve(e))});let Z=null,Le=null;const Ft=50,Ee=document.getElementById("screen-stack");Ee.addEventListener("mousedown",t=>{if(t.target.closest(".leaflet-container")){Z=null;return}Z=t.clientX,Le=t.clientY});Ee.addEventListener("mouseup",t=>{if(Z===null)return;const i=t.clientX-Z,e=t.clientY-Le;if(Math.abs(i)>Ft&&Math.abs(i)>Math.abs(e)){const a=le.indexOf(ke);i<0&&a<le.length-1&&ve(le[a+1]),i>0&&a>0&&ve(le[a-1])}Z=null,Le=null});Ee.addEventListener("mouseleave",()=>{Z=null});Ee.addEventListener("touchstart",t=>{if(t.target.closest(".leaflet-container")){Z=null;return}Z=t.touches[0].clientX,Le=t.touches[0].clientY},{passive:!0});Ee.addEventListener("touchend",t=>{if(Z===null)return;const i=t.changedTouches[0].clientX-Z,e=t.changedTouches[0].clientY-Le;if(Math.abs(i)>Ft&&Math.abs(i)>Math.abs(e)){const a=le.indexOf(ke);i<0&&a<le.length-1&&ve(le[a+1]),i>0&&a>0&&ve(le[a-1])}Z=null},{passive:!0});const Es=[{id:"param-compte",label:"Mon compte"},{id:"param-exploitation",label:"Mon exploitation"},...K==="admin"?[{id:"param-reseau",label:"Mon réseau"}]:[]],Ie={};function As(t){const i=document.getElementById("param-plus-btn"),e=document.getElementById("param-plus-spacer"),a=Ie[t];i&&e&&(a!=null&&a.onAdd?(i.style.display="",e.style.display="none",i.onclick=a.onAdd):(i.style.display="none",e.style.display=""))}function Ts(){var i;const t=document.getElementById("param-segment");t&&(K==="adherent"&&((i=document.getElementById("param-reseau"))==null||i.style.setProperty("display","none")),Es.forEach((e,a)=>{const r=document.createElement("button");r.className="m-segment-btn"+(a===0?" active":""),r.textContent=e.label,r.dataset.target=e.id,r.addEventListener("click",()=>{var s,n,l;t.querySelectorAll(".m-segment-btn").forEach(d=>d.classList.remove("active")),r.classList.add("active"),document.querySelectorAll(".m-subscreen").forEach(d=>d.classList.remove("active")),(s=document.getElementById(e.id))==null||s.classList.add("active"),As(e.id),(l=(n=Ie[e.id])==null?void 0:n.refresh)==null||l.call(n)}),t.appendChild(r)}))}Ts();Pi(document.getElementById("screen-dashboard"),K);Xi(document.getElementById("screen-parcelles"),K);vs(document.getElementById("screen-capteurs"),K);ti(document.getElementById("screen-alertes"),K);Zt(document.getElementById("param-compte"),K);Ie["param-exploitation"]=$s(document.getElementById("param-exploitation"),K);Ie["param-reseau"]=Ss(document.getElementById("param-reseau"),K);function js(){var a;const t=K==="admin",i=document.getElementById("phone-screen");(a=document.getElementById("m-add-modal"))==null||a.remove();const e=document.createElement("div");e.id="m-add-modal",e.style.cssText="position:absolute;inset:0;background:#f2f2f7;z-index:3000;display:flex;flex-direction:column",e.innerHTML=`

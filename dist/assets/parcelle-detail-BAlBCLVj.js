import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css             */import{p as oe}from"./plots-DhtWL7s_.js";import{s as P}from"./sensors-CRadjF8G.js";import{o as Ve}from"./orgs-DnFmvGlp.js";import{m as ne}from"./members-Cr98hVG_.js";import{u as wt}from"./breadcrumb-CzFWtd6d.js";import{d as ae,c as xe}from"./store-c0FlIf2T.js";import{I as O,g as Wt,s as $t}from"./irrigations-C22Dtsoo.js";import{S as Vt,a as He,E as Gt,I as xt}from"./constants-CJpDUNiw.js";const Ct=new URLSearchParams(window.location.search),k=parseInt(Ct.get("id")),C=oe.find(e=>e.id===k);function $(e,t){return Math.floor(Math.random()*(t-e+1))+e}function D(e,t){return parseFloat((Math.random()*(t-e)+e).toFixed(2))}const Ge=[{id:"etp",name:"Évapotranspiration (ETP)",unit:"mm/j",color:"#7DBDD7",base:()=>D(.5,5),cumul:{label:"Cumul d'ETP",unit:"mm"},isCumul:!1,chartType:"bar"},{id:"rayonnement",name:"Rayonnement",unit:"W/m²",color:"#CBCB0B",base:()=>$(0,900),cumul:{label:"Énergie",unit:"Wh/m²"},isCumul:!1},{id:"temp_rosee",name:"Température de rosée",unit:"°C",color:"#72B0D8",base:()=>$(2,16),isCumul:!1}],Yt={id:"irrigation",name:"Irrigation",unit:"mm",color:"#FF8C00",base:()=>0,isCumul:!0,chartType:"bar",isIrrigation:!0},R={"P+":[{id:"pluie",name:"Pluie",unit:"mm",color:"#2E75B6",base:()=>$(0,8),cumul:{label:"Cumul de pluie",unit:"mm"},isCumul:!0,chartType:"bar"},{id:"temp",name:"Température",unit:"°C",color:"#FBAF05",base:()=>$(10,28),cumul:{label:"Cumul de degrés jour",unit:"°j"}},{id:"humidite",name:"Humidité",unit:"%",color:"#5B12A4",base:()=>$(40,90)}],PT:[{id:"pluie",name:"Pluie",unit:"mm",color:"#2E75B6",base:()=>$(0,8),cumul:{label:"Cumul de pluie",unit:"mm"},isCumul:!0,chartType:"bar"},{id:"temp",name:"Température",unit:"°C",color:"#FBAF05",base:()=>$(10,28),cumul:{label:"Cumul de degrés jour",unit:"°j"}},{id:"etp",name:"Évapotranspiration (ETP)",unit:"mm/j",color:"#7DBDD7",base:()=>D(.5,5),cumul:{label:"Cumul ETP",unit:"mm"},isCumul:!1,chartType:"bar"}],P:[{id:"pluie",name:"Pluie",unit:"mm",color:"#2E75B6",base:()=>$(0,8),cumul:{label:"Cumul de pluie",unit:"mm"},isCumul:!0,chartType:"bar"}],SMV:[{id:"pluie",name:"Pluie",unit:"mm",color:"#2E75B6",base:()=>$(0,8),cumul:{label:"Cumul de pluie",unit:"mm"},isCumul:!0,chartType:"bar"},{id:"temp",name:"Température",unit:"°C",color:"#FBAF05",base:()=>$(10,28),cumul:{label:"Cumul de degrés jour",unit:"°j"}},{id:"humidite",name:"Humidité",unit:"%",color:"#5B12A4",base:()=>$(40,90)},{id:"etp",name:"Évapotranspiration (ETP)",unit:"mm/j",color:"#7DBDD7",base:()=>D(.5,5),cumul:{label:"Cumul ETP",unit:"mm"},isCumul:!1,chartType:"bar"}],TH:[{id:"temp",name:"Température",unit:"°C",color:"#FBAF05",base:()=>$(10,28),cumul:{label:"Cumul de degrés jour",unit:"°j"}},{id:"humidite",name:"Humidité",unit:"%",color:"#5B12A4",base:()=>$(40,90)}],"CHP-15/30":[{id:"pothydr",name:"Potentiel hydrique",unit:"kPa",color:"#A6C157",base:()=>$(10,150)},{id:"tsol",name:"Température du sol",unit:"°C",color:"#795548",base:()=>$(8,22)}],"CHP-30/60":[{id:"pothydr",name:"Potentiel hydrique",unit:"kPa",color:"#A6C157",base:()=>$(10,150)},{id:"tsol",name:"Température du sol",unit:"°C",color:"#795548",base:()=>$(8,22)}],"CHP-60/90":[{id:"pothydr",name:"Potentiel hydrique",unit:"kPa",color:"#A6C157",base:()=>$(10,150)},{id:"tsol",name:"Température du sol",unit:"°C",color:"#795548",base:()=>$(8,22)}],"CAPA-30-3":[{id:"vwc10",name:"Teneur en eau du sol 10 cm",unit:"%vol",color:"#105200",base:()=>$(15,45)},{id:"vwc20",name:"Teneur en eau du sol 20 cm",unit:"%vol",color:"#8C5E82",base:()=>$(15,45)},{id:"vwc30",name:"Teneur en eau du sol 30 cm",unit:"%vol",color:"#46DA82",base:()=>$(15,45)},{id:"tsol",name:"Température du sol",unit:"°C",color:"#795548",base:()=>$(8,22)}],"CAPA-60-6":[{id:"vwc10",name:"Teneur en eau du sol 10 cm",unit:"%vol",color:"#105200",base:()=>$(15,45)},{id:"vwc20",name:"Teneur en eau du sol 20 cm",unit:"%vol",color:"#8C5E82",base:()=>$(15,45)},{id:"vwc30",name:"Teneur en eau du sol 30 cm",unit:"%vol",color:"#46DA82",base:()=>$(15,45)},{id:"vwc40",name:"Teneur en eau du sol 40 cm",unit:"%vol",color:"#949494",base:()=>$(17,43)},{id:"vwc50",name:"Teneur en eau du sol 50 cm",unit:"%vol",color:"#870021",base:()=>$(18,42)},{id:"vwc60",name:"Teneur en eau du sol 60 cm",unit:"%vol",color:"#F608C2",base:()=>$(18,42)},{id:"tsol",name:"Température du sol",unit:"°C",color:"#795548",base:()=>$(8,22)}],T_MINI:[{id:"tsol",name:"Température du sol",unit:"°C",color:"#795548",base:()=>$(8,22)}],LWS:[{id:"humec",name:"Humectation foliaire",unit:"h",color:"#00887E",base:()=>$(0,12)}],T_GEL:[{id:"tseche",name:"Temp. sèche",unit:"°C",color:"#23B19B",base:()=>$(-2,12)},{id:"thumide",name:"Temp. humide",unit:"°C",color:"#5E88EC",base:()=>$(-4,10)}],W:[{id:"_vent",name:"Vent",unit:"km/h · direction",color:"#7bc4b0",isWindComposite:!0,base:()=>$(0,40)}],EC:[{id:"ec",name:"Conductivité",unit:"mS/cm",color:"#f0a030",base:()=>D(.1,3)},{id:"tsol",name:"Température du sol",unit:"°C",color:"#bb8fce",base:()=>$(8,22)}],PYRANO:[{id:"rayonnement",name:"Rayonnement",unit:"W/m²",color:"#f5c842",base:()=>$(0,900),cumul:{label:"Énergie",unit:"Wh/m²"}}],PAR:[{id:"par",name:"Densité de flux de photons photosynthétiques",unit:"µmol/m²/s",color:"#c47a00",base:()=>$(0,2e3)}]},_=["CHP-15/30","CHP-30/60","CHP-60/90"],De=[{name:"Tensiomètre (CHP)",models:new Set(["CHP-15/30","CHP-30/60","CHP-60/90"])},{name:"Sonde capacitive (CAPA)",models:new Set(["CAPA-30-3","CAPA-60-6"])},{name:"Sonde fertirrigation (EC)",models:new Set(["EC"])},{name:"Thermomètre de sol (T_MINI)",models:new Set(["T_MINI"])}];function Oe(e){return De.find(t=>t.models.has(e))||null}const Jt={"CAPA-30-3":[{depth:10,label:"10 cm",vwcColor:"#105200",tsolColor:"#FFA040"},{depth:20,label:"20 cm",vwcColor:"#8C5E82",tsolColor:"#E07050"},{depth:30,label:"30 cm",vwcColor:"#46DA82",tsolColor:"#A04030"}],"CAPA-60-6":[{depth:10,label:"10 cm",vwcColor:"#105200",tsolColor:"#FFA040"},{depth:20,label:"20 cm",vwcColor:"#8C5E82",tsolColor:"#E07050"},{depth:30,label:"30 cm",vwcColor:"#46DA82",tsolColor:"#A04030"},{depth:40,label:"40 cm",vwcColor:"#949494",tsolColor:"#804828"},{depth:50,label:"50 cm",vwcColor:"#870021",tsolColor:"#603818"},{depth:60,label:"60 cm",vwcColor:"#F608C2",tsolColor:"#402810"}]},Ue=["CAPA-30-3","CAPA-60-6"],ee={"P+":"Station météo",PT:"Station météo",P:"Pluviomètre",SMV:"Station météo virtuelle",TH:"Thermomètre-hygromètre",T_MINI:"Thermomètre de sol",W:"Anémomètre",PYRANO:"Pyranomètre",PAR:"Capteur PAR",LWS:"Capteur d'humectation foliaire",T_GEL:"Capteur de gel","CHP-15/30":"Tensiomètre","CHP-30/60":"Tensiomètre","CHP-60/90":"Tensiomètre","CAPA-30-3":"Sonde capacitive","CAPA-60-6":"Sonde capacitive",EC:"Sonde de fertirrigation"};function Ut(e,t=null,i=null,a=null){const n=Math.max(2,Math.min(200,Math.floor(ve()/be()))),s=Array.from({length:n},()=>$(5,35)),c=s.map(E=>Math.min(E+$(3,18),80)),l=Array.from({length:n},()=>$(0,359)),u=600,r=200,v=46,o=16,d=16,m=28,p=u-v-o,h=r-d-m,f=Math.ceil(Math.max(...c)/10)*10||50,y=E=>v+E/Math.max(n-1,1)*p,b=E=>d+h-E/f*h,w=c.map((E,A)=>`${y(A).toFixed(1)},${b(E).toFixed(1)}`).join("L"),g=[...s].reverse().map((E,A)=>`${y(n-1-A).toFixed(1)},${b(E).toFixed(1)}`).join("L"),S=`M${w}L${g}Z`,M=s.map((E,A)=>`${A?"L":"M"}${y(A).toFixed(1)},${b(E).toFixed(1)}`).join(""),j=[.25,.5,.75].map(E=>{const A=(d+h-E*h).toFixed(1);return`<line x1="${v}" y1="${A}" x2="${u-o}" y2="${A}" stroke="rgba(0,0,0,.06)" stroke-width="1" stroke-dasharray="3,3"/>`}).join(""),I=[0,.5,1].map(E=>{const A=d+h-E*h;return`<text x="${v-4}" y="${(A+4).toFixed(1)}" text-anchor="end" font-size="10" fill="var(--txt3)">${Math.round(E*f)}</text>`}).join(""),B=`<line x1="${v}" y1="${d+h}" x2="${u-o}" y2="${d+h}" stroke="var(--bdr2)" stroke-width="1"/>`,H=Math.max(1,Math.floor(n/6));let F="";for(let E=0;E<n;E+=H){const A=(n-1-E)/Math.max(n-1,1)*ve();F+=`<text x="${y(E).toFixed(1)}" y="${(d+h+14).toFixed(1)}" text-anchor="middle" font-size="10" font-family="var(--font)" fill="var(--txt3)">${Me(A)}</text>`}const W=Math.max(1,Math.round(n/25)),Z=[];for(let E=0;E<n;E+=W){const A=y(E).toFixed(1),N=(d+h*.35).toFixed(1);Z.push(`<g transform="translate(${A},${N}) rotate(${l[E]})">
    ...
    <div class="add-modal-content" style="max-width:520px">
      ...
      ${ni.map(r=>{const v=r.items.filter(l);return v.length?`
        <div class="add-modal-section">
          <div class="add-modal-section-label">${r.title}</div>
          <div class="wcat-list">
            ${v.map(o=>{const d=Xe[o],m=d&&a.includes(d);return`
              <div class="wcat-item">
                <span>${o}</span>
  ...
  `;a.length===0?l+='<div class="journal-empty">Aucune entrée dans le journal.</div>':a.forEach(o=>{var h;const d=s[o.type]||s.note,m=o.type==="modification"||o._auto===!0,p=o.type==="traitement";l+=`
        <div class="jrn-entry" data-id="${o.id}">
          ...
          <div class="jrn-entry-body">
            ...
            ${(h=o.imageIds)!=null&&h.length?`<div class="jrn-entry-photos-row" data-entry-id="${o.id}"></div>`:""}
          </div>
        </div>
      `}),l+="</div>",e.innerHTML=l;const u=e.querySelector("#jrn-add-btn"),r=e.querySelector("#jrn-add-menu");u==null||u.addEventListener("click",o=>{o.stopPropagation(),r.classList.toggle("open")}),document.addEventListener("click",()=>r==null?void 0:r.classList.remove("open")),e.querySelectorAll(".jrn-add-item").forEach(o=>{o.addEventListener("click",()=>{r.classList.remove("open"),di(o.dataset.type)})}),e.querySelectorAll(".jrn-entry-delete").forEach(o=>{o.addEventListener("click",()=>{var p,h;const d=parseInt(o.dataset.id),m=$e().find(f=>f.id===d);(p=m==null?void 0:m.imageIds)!=null&&p.length&&((h=window.ImageStore)==null||h.remove(m.imageIds)),St($e().filter(f=>f.id!==d)),Ye()})});const v=window.ImageStore;v&&e.querySelectorAll(".jrn-entry-photos-row[data-entry-id]").forEach(async o=>{var m;const d=t.find(p=>String(p.id)===o.dataset.entryId);if((m=d==null?void 0:d.imageIds)!=null&&m.length)for(const p of d.imageIds)try{const h=await v.get(p);if(!h)continue;const f=document.createElement("img");f.className="jrn-entry-photo",f.src=h,f.alt="",f.addEventListener("click",()=>{var y;return(y=window.openLightbox)==null?void 0:y.call(window,h)}),o.appendChild(f)}catch{}})}function di(e){const t={note:"Ajouter une note",traitement:"Ajouter un traitement",culture:"Culture — événement",stade:"Stade phénologique",irrigation:"Irrigation",cycle:"Cycle cultural"},i=C.crop||"",a={note:`
    ...
    <div class="add-modal-content" style="max-width:480px">
    ...
    </div>`,s.querySelector(".add-modal-close").addEventListener("click",()=>s.remove()),s.addEventListener("click",l=>{l.target===s&&s.remove()});const c=[];n&&window.ImageStore&&window.setupImgUpload(s.querySelector("#jrn-f-img-input"),s.querySelector("#jrn-f-img-btn"),s.querySelector("#jrn-f-previews"),s.querySelector("#jrn-f-img-err"),c),s.querySelector("#jrn-f-save").addEventListener("click",async()=>{var d,m;const l=s.querySelector("#jrn-f-date").value||se,u=((d=s.querySelector("#jrn-f-texte"))==null?void 0:d.value.trim())||"",r=C.orgId===1?"Jean-Michel Dutilleul":"Thomas Bertrand",v={id:Date.now(),type:e,date:l,texte:u,auteur:r};if(e==="note")v.category=((m=s.querySelector("#jrn-f-category"))==null?void 0:m.value)||"";else if(e==="traitement")v.produit=s.querySelector("#jrn-f-produit").value.trim(),v.dose=s.querySelector("#jrn-f-dose").value.trim(),v.cible=s.querySelector("#jrn-f-cible").value.trim();else if(e==="culture")v.action=s.querySelector("#jrn-f-action").value,v.culture=s.querySelector("#jrn-f-culture").value.trim(),v.variete=s.querySelector("#jrn-f-variete").value.trim();else if(e==="stade")v.stade=s.querySelector("#jrn-f-stade").value.trim(),v.culture=s.querySelector("#jrn-f-culture").value.trim();else if(e==="irrigation"){const p=parseFloat(s.querySelector("#jrn-f-volume").value);v.volume=isNaN(p)?0:p,v.unite=s.querySelector("#jrn-f-unite").value,v.methode=s.querySelector("#jrn-f-methode").value}else e==="cycle"&&(v.action=s.querySelector("#jrn-f-action").value,v.annee=s.querySelector("#jrn-f-annee").value.trim());if(u||v.produit||v.culture||v.stade||v.volume||v.annee||c.length){if(window.ImageStore&&c.length){v.imageIds=[];for(const p of c){const h=`img_${v.id}_${v.imageIds.length}`;await window.ImageStore.store(h,p),v.imageIds.push(h)}}St([v,...$e()]),s.remove(),Ye()}}),document.body.appendChild(s)}function ui(){const e=document.getElementById("breadcrumb-title");if(!e)return;const t=e.querySelector("span:last-child");if(!t)return;const i=oe.filter(s=>s.orgId===C.orgId).sort((s,c)=>s.name.localeCompare(c.name,"fr")),a=document.createElement("span");a.className="breadcrumb-nav-wrap";const n=document.createElement("select");n.className="breadcrumb-nav-select",n.innerHTML=i.map(s=>`<option value="${s.id}"${s.id===k?" selected":""}>${s.name}</option>`).join(""),n.addEventListener("change",()=>{window.location.href=`parcelle-detail.html?id=${n.value}`}),a.appendChild(n),t.replaceWith(a)}document.addEventListener("DOMContentLoaded",()=>{var i,a,n;if(!C){document.body.innerHTML='<div style="padding:40px"><h1>Parcelle non trouvée</h1></div>';return}Kt(),wt(x.name||C.name,{label:"Parcelles",href:"parcelles.html"}),ui(),U(),Oi(),Ui(),Xi(),Ti(),Di(),Ki();const e=Ct.get("tab");e&&((i=document.querySelector(`.detail-tab-btn[data-pane="tab-${e}"]`))==null||i.click()),Hi(),qi(),ue(),(a=document.getElementById("parcel-add-widget-btn"))==null||a.addEventListener("click",ai),(n=document.getElementById("btn-export-csv"))==null||n.addEventListener("click",Ji),document.addEventListener("click",s=>{const c=s.target.closest(".chart-cumul-add-btn");if(!c)return;s.stopPropagation();const l=c.dataset.cumulLabel,u=c.dataset.cumulVal;if(!confirm(`Ajouter "${l} : ${u}" au tableau de bord ?`))return;const r=document.createElement("div");r.textContent="Cumul ajouté au tableau de bord",Object.assign(r.style,{position:"fixed",bottom:"80px",left:"50%",transform:"translateX(-50%)",background:"rgba(28,28,30,.9)",color:"#fff",padding:"8px 16px",borderRadius:"8px",fontSize:"13px",zIndex:"9999",pointerEvents:"none"}),document.body.appendChild(r),setTimeout(()=>r.remove(),2500)});const t=document.getElementById("sidebar");t&&new MutationObserver(()=>ce()).observe(t,{attributes:!0,attributeFilter:["data-role"]})});let ke="capteur",G=null;const Mt=`charts-order-parcel-${k}`;function mi(){try{return JSON.parse(localStorage.getItem(Mt)||"null")}catch{return null}}function pi(e){localStorage.setItem(Mt,JSON.stringify(e))}function vi(e){let t=null;e.addEventListener("dragstart",i=>{const a=i.target.closest(".chart-card[data-card-key]");a&&(t=a,a.classList.add("chart-dragging"),i.dataTransfer.effectAllowed="move")}),e.addEventListener("dragend",()=>{t==null||t.classList.remove("chart-dragging"),e.querySelectorAll(".chart-card").forEach(a=>a.classList.remove("chart-drag-over")),t=null;const i=[...e.querySelectorAll(".chart-card[data-card-key]")].map(a=>a.dataset.cardKey);pi(i)}),e.addEventListener("dragover",i=>{if(i.preventDefault(),!t)return;const a=i.target.closest(".chart-card[data-card-key]");if(!a||a===t)return;e.querySelectorAll(".chart-card").forEach(s=>s.classList.remove("chart-drag-over")),a.classList.add("chart-drag-over");const n=a.getBoundingClientRect().top+a.getBoundingClientRect().height/2;e.insertBefore(t,i.clientY<n?a:a.nextSibling)}),e.addEventListener("drop",i=>{i.preventDefault(),e.querySelectorAll(".chart-card").forEach(a=>a.classList.remove("chart-drag-over"))})}function hi(e,t){const i=P.filter(o=>t.includes(o.id)),a=i.filter(o=>_.includes(o.model)),n=i.filter(o=>Ue.includes(o.model)),s=i.filter(o=>!_.includes(o.model)&&!Ue.includes(o.model)),c=be(),l=new Set;i.forEach(o=>(R[o.model]||[]).forEach(d=>l.add(d.id)));const u=[];if(s.forEach(o=>{const d=R[o.model];if(!d)return;const m=`${o.model} · ${o.serial}`,p=Math.floor(5+Math.random()*55);d.forEach(h=>{if(h.isWindComposite){u.push({key:`wind-${o.id}`,type:"wind",sensor:o,source:m,emissionMins:p});return}u.push({key:`s${o.id}-${h.id}`,type:"metric",metric:h,source:m,emissionMins:p,sensorId:o.id})})}),a.length>0){const o=`Tensiomètres · ${a.length} capteur${a.length>1?"s":""}`,d=Math.floor(5+Math.random()*55);["pothydr","tsol"].forEach(m=>{u.push({key:`tensio-${m}`,type:"tensio",metricId:m,source:o,emissionMins:d,tensioSensors:a})})}n.forEach(o=>{const d=Jt[o.model]||[],m=`${ee[o.model]||o.model} · ${o.serial}`,p=Math.floor(5+Math.random()*55);d.length>0&&(u.push({key:`capa-vwc-${o.id}`,type:"capa-vwc",sensor:o,horizons:d,source:m,emissionMins:p}),u.push({key:`capa-tsol-${o.id}`,type:"capa-tsol",sensor:o,horizons:d,source:m,emissionMins:p}))}),Ge.filter(o=>!l.has(o.id)).forEach(o=>u.push({key:`always-${o.id}`,type:"metric",metric:o,source:"parcelle",emissionMins:null,unavailable:c<60})),(!!C.irrigation&&C.irrigation!=="Non irrigué"||O.some(o=>o.plotId===k))&&u.push({key:"always-irrigation",type:"metric",metric:Yt,source:"parcelle",emissionMins:null});const v=mi();if(v!=null&&v.length){const o=new Map(v.map((d,m)=>[d,m]));u.sort((d,m)=>(o.has(d.key)?o.get(d.key):1/0)-(o.has(m.key)?o.get(m.key):1/0))}u.forEach(o=>{o.type==="metric"?ze(e,o.metric,o.source,o.emissionMins,o.key,o.unavailable,o.sensorId):o.type==="wind"?Ut(e,o.source,o.emissionMins,o.key):o.type==="tensio"?gi(e,o.metricId,o.tensioSensors,o.source,o.emissionMins,o.key):o.type==="capa-vwc"?yi(e,o.horizons,o.source,o.emissionMins,o.key):o.type==="capa-tsol"&&wi(e,o.horizons,o.source,o.emissionMins,o.key)}),vi(e)}function Ie(e){const t=P.filter(n=>e.includes(n.id)),i=new Set,a=[];return t.forEach(n=>{(R[n.model]||[]).forEach(s=>{i.has(s.id)||(i.add(s.id),a.push(s))})}),Ge.forEach(n=>{i.has(n.id)||(i.add(n.id),a.push(n))}),a}function U(){var t;const e=document.getElementById("charts-container");if(e.innerHTML="",G){e.className="compare-rows";const i=oe.find(p=>p.id===G),a=document.createElement("div");a.className="compare-header-row",a.innerHTML=`
      ...
      </div>`,e.appendChild(a),(t=a.querySelector(".compare-close-btn"))==null||t.addEventListener("click",()=>{G=null,Le(),U()});const n=Ie(x.linkedSensorIds),s=xe(G),c=(s==null?void 0:s.linkedSensorIds)??P.filter(p=>p.parcelIds.includes(G)).map(p=>p.id),l=Ie(c),u=n.map(p=>p.id),r=l.map(p=>p.id),v=u.filter(p=>r.includes(p)),o=u.filter(p=>!r.includes(p)),d=r.filter(p=>!u.includes(p));[...v,...o,...d].forEach(p=>{const h=n.find(g=>g.id===p),f=l.find(g=>g.id===p),y=document.createElement("div");y.className="compare-row";const b=document.createElement("div");h?ze(b,h):b.innerHTML='<div class="compare-chart-empty">—</div>';const w=document.createElement("div");f?ze(w,f):w.innerHTML='<div class="compare-chart-empty">—</div>',y.appendChild(b),y.appendChild(w),e.appendChild(y)})}else e.className="charts-stack",hi(e,x.linkedSensorIds);Ei()}const we=["#5b8dd9","#e07050","#4ecdc4","#f5c842","#c090e0","#78d8a0"];function fi(e){const t=e.depth||30;return[{depth:t,label:`${t} cm`,sensor:e}]}function bi(e){if(ke==="capteur")return e.map((i,a)=>({label:i.serial,color:we[a%we.length],depth:i.depth||30,sensor:i}));const t=new Map;return e.forEach(i=>fi(i).forEach(a=>{t.has(a.depth)||t.set(a.depth,a)})),[...t.values()].sort((i,a)=>i.depth-a.depth).map((i,a)=>({label:i.label,color:we[a%we.length],depth:i.depth,sensor:i.sensor}))}function gi(e,t,i,a=null,n=null,s=null){var p;const l={pothydr:{name:"Potentiel hydrique",unit:"kPa"},tsol:{name:"Température du sol",unit:"°C"}}[t],u=bi(i),r=document.createElement("div");r.className="chart-card tensio-multi-card",r.dataset.tensioMetric=t,r.dataset.tensioCurves=JSON.stringify(u.map(h=>({depth:h.depth,color:h.color}))),s&&(r.dataset.cardKey=s,r.draggable=!0);const v=u.map(h=>`<span style="display:inline-flex;align-items:center;gap:4px;font-size:11px;color:var(--txt2)">
      <span style="display:inline-block;width:20px;height:2px;background:${h.color};vertical-align:middle;border-radius:1px"></span>
      ${h.label}
    </span>`).join(""),o=a?`<span class="chart-card-source">${a}</span>`:"",d=n!=null?`<span class="chart-card-emission">il y a ${n} min</span>`:"",m=`
  ...
  `,r.querySelectorAll(".tensio-toggle-btn").forEach(h=>{h.addEventListener("click",()=>{ke=h.dataset.mode,U()})}),e.appendChild(r)}function Et(e,t,i,a,n,s,c,l){var v;const u=document.createElement("div");u.className=`chart-card ${c}-multi-card`,u.dataset[c+"Curves"]=JSON.stringify(t.map(o=>({depth:o.depth,color:o[i]}))),l&&(u.dataset.cardKey=l,u.draggable=!0);const r=t.map(o=>`<span style="display:inline-flex;align-items:center;gap:4px;font-size:11px;color:var(--txt2)">
  ...
  `,e.appendChild(u),u}function yi(e,t,i=null,a=null,n=null){Et(e,t,"vwcColor","Teneur en eau du sol","%vol","capa-svg","capa",n)}function wi(e,t,i=null,a=null,n=null){Et(e,t,"tsolColor","Température du sol par horizon","°C","capa-tsol-svg","capaT",n)}function ze(e,t,i=null,a=null,n=null,s=!1,c=null){var p;const l=t.base(),u=document.createElement("div");u.className="chart-card",u.dataset.base=l,u.dataset.color=t.color,u.dataset.cumul=t.isCumul?"1":"",u.dataset.chartType=t.chartType||"line",u.dataset.metricId=t.id,u.dataset.metricName=t.name,u.dataset.metricUnit=t.unit,t.isIrrigation&&(u.dataset.isIrrigation="1"),n&&(u.dataset.cardKey=n,u.draggable=!0);const r=t.cumul?`<div class="chart-cumul"><span class="chart-cumul-label">${t.cumul.label} : <strong>${st(t)} ${t.cumul.unit}</strong></span><button class="chart-cumul-add-btn" data-cumul-label="${t.cumul.label}" data-cumul-val="${st(t)} ${t.cumul.unit}" title="Ajouter au tableau de bord"><i class="bi bi-house-add"></i></button></div>`:"",v=i?`<span class="chart-card-source">${i}</span>`:"",o=a!=null?`<span class="chart-card-emission">il y a ${a} min</span>`:"";let d="";if(c){const h=((p=document.getElementById("time-step"))==null?void 0:p.value)||"1h";d=`<a class="chart-card-expand" href="capteur-graphique.html?sensorId=${c}&metricId=${t.id}&parcelId=${k}&period=${J}&step=${h}" title="Graphique plein écran"><i class="bi bi-fullscreen"></i></a>`}const m=s?'<div class="chart-unavailable">Données indisponibles pour ce pas de temps</div>':'<svg class="chart-svg" width="100%" height="180" viewBox="0 0 600 180" preserveAspectRatio="none"></svg>';u.innerHTML=`
    <div class="chart-card-header">
    ...
    ${m}
    ${r}
  `,e.appendChild(u)}let ye=null;function $i(){return ye||(ye=document.createElement("div"),ye.className="chart-tooltip",document.body.appendChild(ye)),ye}function xi(e,t){return t==="temp"||t==="temperature"?["#6eb4d4","#e07050"]:t==="tseche"||t==="thumide"?["#6eb4d4","#e07050"]:t==="temp_rosee"?["#a0d0f0","#4090c0"]:[Ci(e,.55),e]}function Ci(e,t){const i=parseInt(e.slice(1,3),16),a=parseInt(e.slice(3,5),16),n=parseInt(e.slice(5,7),16),s=Math.round(i+(255-i)*t),c=Math.round(a+(255-a)*t),l=Math.round(n+(255-n)*t);return`#${s.toString(16).padStart(2,"0")}${c.toString(16).padStart(2,"0")}${l.toString(16).padStart(2,"0")}`}function Te(e){if(e.length<2)return"";if(e.length===2)return`M${e[0].x},${e[0].y} L${e[1].x},${e[1].y}`;let t=`M${e[0].x.toFixed(1)},${e[0].y.toFixed(1)}`;for(let i=0;i<e.length-1;i++){const a=e[Math.max(i-1,0)],n=e[i],s=e[i+1],c=e[Math.min(i+2,e.length-1)],l=n.x+(s.x-a.x)/6,u=n.y+(s.y-a.y)/6,r=s.x-(c.x-n.x)/6,v=s.y-(c.y-n.y)/6;t+=` C${l.toFixed(1)},${u.toFixed(1)} ${r.toFixed(1)},${v.toFixed(1)} ${s.x.toFixed(1)},${s.y.toFixed(1)}`}return t}function Me(e){const t=new Date(Date.now()-e*6e4);return e<1440?`${String(t.getHours()).padStart(2,"0")}h`:e>=43200?["jan","fév","mar","avr","mai","juin","juil","aoû","sep","oct","nov","déc"][t.getMonth()]:`${String(t.getDate()).padStart(2,"0")}/${String(t.getMonth()+1).padStart(2,"0")}`}function it(e){const t=Date.now()-e*6e4;return new Date(t).getHours()+new Date(t).getMinutes()/60}function Si(e){return Math.max(0,Math.sin(Math.PI*(e-6)/12))}function nt(e){return .5+.5*Math.sin(2*Math.PI*(e-4)/24-Math.PI/2)}function Mi(e){const t=Math.floor((Date.now()-e*6e4)/864e5),i=Math.sin(t*12.9898+78.233)*43758.5453;return i-Math.floor(i)}function de(e,t,i,a=.15){const n=it(i),s=nt(n),c=Si(n),l=Mi(i),u=()=>1+(Math.random()-.5)*2*a;switch(e){case"temp":{const r=.6+l*.8;return(t-6+s*12*r)*u()}case"tseche":case"thumide":{const r=.6+l*.8;return(t-4+s*8*r)*u()}case"temp_rosee":{const r=.6+l*.8,v=t-6+s*12*r;return Math.min(v-1,t-8+s*6*r)*u()}case"tsol":{const r=it(i+120),v=.7+l*.6;return(t-3+nt(r)*6*v)*u()}case"humidite":{const r=1.4-l*.8;return Math.min(100,Math.max(20,(t+(1-s)*25*r-s*15)*u()))}case"rayonnement":{const r=.4+l*.9;return Math.max(0,c*t*1.3*r*u())}case"etp":{const r=.4+l*.9;return Math.max(0,c*t*1.5*r*u())}case"humec":{const r=1.4-l*.8;return Math.max(0,t*Math.max(0,.8-c*1.2)*r*u())}case"pluie":{const r=.06+(1-l)*.22;return Math.random()<r?t*Math.random()*2.5*(1.3-l):0}case"vent":case"rafales":{const r=.5+l;return Math.max(0,t*(.6+c*.8)*r*u())}default:return Math.max(0,t*u())}}function Ei(){const e=ti(),t=be(),i=ii();P.filter(n=>x.linkedSensorIds.includes(n.id)).filter(n=>_.includes(n.model)),document.querySelectorAll(".chart-card").forEach(n=>{if(n.classList.contains("tensio-multi-card")){const m=n.querySelector(".tensio-svg"),p=JSON.parse(n.dataset.tensioCurves||"[]");m&&p.length>0&&Bi(m,p,e,t);return}if(n.classList.contains("capa-multi-card")){const m=n.querySelector(".capa-svg"),p=JSON.parse(n.dataset.capaCurves||"[]");m&&p.length>0&&at(m,p,e,t,"vwc");return}if(n.classList.contains("capaT-multi-card")){const m=n.querySelector(".capa-tsol-svg"),p=JSON.parse(n.dataset.capaTCurves||"[]");m&&p.length>0&&at(m,p,e,t,"tsol");return}const s=n.querySelector(".chart-svg");if(!s)return;const c=parseFloat(n.dataset.base),l=n.dataset.color,u=n.dataset.cumul==="1",r=n.dataset.chartType||"line",v=n.dataset.metricId||"",o=n.dataset.metricName||"",d=n.dataset.metricUnit||"";if(n.dataset.isIrrigation)Ii(s,l,e,t,i);else{const m=i>0&&Zt.has(v);ji(s,c,l,e,t,u,r,v,o,d,i,m)}}),Bt(),jt()}function Bi(e,t,i,a){const c={t:14,r:10,b:28,l:46},l=600-c.l-c.r,u=180-c.t-c.b,r=t.map(w=>{const g=20+w.depth*.8+Math.random()*20;return Array.from({length:i},(S,M)=>{const j=(i-1-M)*a;return Math.max(0,de("pothydr",g,j))})}),v=r.flat(),o=Math.min(...v),d=Math.max(...v),m=d-o||1,p=w=>c.l+w/Math.max(i-1,1)*l,h=w=>c.t+u-(w-o)/m*u,f=`tc-${Math.random().toString(36).slice(2)}`;let y=`<defs><clipPath id="${f}"><rect x="${c.l}" y="${c.t}" width="${l}" height="${u}"/></clipPath></defs>`;for(let w=0;w<=4;w++){const g=c.t+w/4*u,S=d-w/4*m;y+=`<line x1="${c.l}" y1="${g.toFixed(1)}" x2="${600-c.r}" y2="${g.toFixed(1)}" stroke="var(--bdr2)" stroke-width="1"/>`,y+=`<text x="${c.l-5}" y="${(g+4).toFixed(1)}" text-anchor="end" font-size="10" font-family="var(--font)" fill="var(--txt3)">${S.toFixed(0)}</text>`}r.forEach((w,g)=>{const S=w.map((j,I)=>({x:p(I),y:h(j)})),M=Te(S);y+=`<path d="${M}" fill="none" stroke="${t[g].color}" stroke-width="2" stroke-linecap="round" clip-path="url(#${f})"/>`}),y+=`<line x1="${c.l}" y1="${c.t+u}" x2="${600-c.r}" y2="${c.t+u}" stroke="var(--bdr2)" stroke-width="1"/>`;const b=Math.max(1,Math.floor(i/6));for(let w=0;w<i;w+=b){const g=(i-1-w)*a;y+=`<text x="${p(w).toFixed(1)}" y="${(c.t+u+14).toFixed(1)}" text-anchor="middle" font-size="10" font-family="var(--font)" fill="var(--txt3)">${Me(g)}</text>`}e.innerHTML=y}function at(e,t,i,a,n="vwc"){const l={t:14,r:10,b:28,l:46},u=600-l.l-l.r,r=180-l.t-l.b,v=t.map((g,S)=>{if(n==="tsol"){const j=16-g.depth*.06+S*.5+Math.random()*3;return Array.from({length:i},(I,B)=>{const H=(i-1-B)*a;return de("tsol",j,H)})}const M=35-g.depth*.15+S*2+Math.random()*8;return Array.from({length:i},(j,I)=>{const B=(i-1-I)*a;return Math.max(10,Math.min(55,de("teneur-eau",M,B)))})}),o=v.flat(),d=Math.floor(Math.min(...o)-2),m=Math.ceil(Math.max(...o)+2),p=m-d||1,h=g=>l.l+g/Math.max(i-1,1)*u,f=g=>l.t+r-(g-d)/p*r,y=`cc-${Math.random().toString(36).slice(2)}`;let b=`<defs><clipPath id="${y}"><rect x="${l.l}" y="${l.t}" width="${u}" height="${r}"/></clipPath></defs>`;for(let g=0;g<=4;g++){const S=l.t+g/4*r,M=m-g/4*p;b+=`<line x1="${l.l}" y1="${S.toFixed(1)}" x2="${600-l.r}" y2="${S.toFixed(1)}" stroke="var(--bdr2)" stroke-width="1"/>`,b+=`<text x="${l.l-5}" y="${(S+4).toFixed(1)}" text-anchor="end" font-size="10" font-family="var(--font)" fill="var(--txt3)">${M.toFixed(0)}</text>`}v.forEach((g,S)=>{const M=g.map((I,B)=>({x:h(B),y:f(I)})),j=Te(M);b+=`<path d="${j}" fill="none" stroke="${t[S].color}" stroke-width="2" stroke-linecap="round" clip-path="url(#${y})"/>`}),b+=`<line x1="${l.l}" y1="${l.t+r}" x2="${600-l.r}" y2="${l.t+r}" stroke="var(--bdr2)" stroke-width="1"/>`;const w=Math.max(1,Math.floor(i/6));for(let g=0;g<i;g+=w){const S=(i-1-g)*a;b+=`<text x="${h(g).toFixed(1)}" y="${(l.t+r+14).toFixed(1)}" text-anchor="middle" font-size="10" font-family="var(--font)" fill="var(--txt3)">${Me(S)}</text>`}e.innerHTML=b}function ji(e,t,i,a,n,s,c="line",l="",u="",r="",v=0,o=!1){const p={t:14,r:10,b:28,l:46},h=600-p.l-p.r,f=180-p.t-p.b,y=a+v,b=o?v:0,w=a+b,g=Math.max(1,Math.round(n/15)),S=Array.from({length:w},(T,E)=>{const A=(a-1-E)*n;if(s){let N=0;for(let V=0;V<g;V++)N+=de(l,t/g,A+V*(n/g));return N}else if(g>1){let N=0;for(let V=0;V<g;V++)N+=de(l,t,A+V*(n/g));return N/g}else return de(l,t,A)}),M=c==="bar"?0:Math.min(...S),j=Math.max(...S),I=j-M||1,B=T=>p.l+T/Math.max(y-1,1)*h,H=T=>p.t+f-(T-M)/I*f,F=`grad_${Math.random().toString(36).slice(2)}`,[W,Z]=xi(i,l);let q=`<defs>
    ...
    <clipPath id="clip_${F}">
      ...
      <text x="${(600-p.r-4).toFixed(1)}" y="${(p.t+12).toFixed(1)}" text-anchor="end" font-size="10" font-family="var(--font)" fill="var(--txt3)" font-style="italic">Prévisions</text>`}for(let T=0;T<=4;T++){const E=p.t+T/4*f,A=j-T/4*I,N=Math.abs(A)>=100?A.toFixed(0):Math.abs(A)>=10?A.toFixed(1):A.toFixed(2);q+=`<line x1="${p.l}" y1="${E.toFixed(1)}" x2="${600-p.r}" y2="${E.toFixed(1)}" stroke="var(--bdr2)" stroke-width="1"/>`,q+=`<text x="${p.l-5}" y="${(E+4).toFixed(1)}" text-anchor="end" font-size="10" font-family="var(--font)" fill="var(--txt3)">${N}</text>`}q+=`<line x1="${p.l}" y1="${p.t+f}" x2="${600-p.r}" y2="${p.t+f}" stroke="var(--bdr2)" stroke-width="1"/>`;const ge=Math.max(1,Math.floor(y/6));for(let T=0;T<y;T+=ge){const E=B(T).toFixed(1),A=(a-T)*n;q+=`<line x1="${E}" y1="${p.t}" x2="${E}" y2="${p.t+f}" stroke="var(--bdr2)" stroke-width="1" stroke-dasharray="3,3"/>`,q+=`<text x="${E}" y="${p.t+f+14}" text-anchor="middle" font-size="10" font-family="var(--font)" fill="var(--txt3)">${Me(A)}</text>`}if(c==="bar"){const T=Math.max(2,h/y*.65);S.forEach((E,A)=>{if(E<=0)return;const N=A>=a,V=B(A),Ee=H(E),Pe=p.t+f-Ee;q+=`<rect x="${(V-T/2).toFixed(1)}" y="${Ee.toFixed(1)}" width="${T.toFixed(1)}" height="${Pe.toFixed(1)}" fill="${N?"#C7C7CC":`url(#${F})`}" opacity="${N?"0.5":"0.9"}" rx="1"/>`})}else{const T=S.slice(0,a).map((N,V)=>({x:B(V),y:H(N)})),E=Te(T),A=E+` L${B(a-1).toFixed(1)},${p.t+f} L${p.l.toFixed(1)},${p.t+f} Z`;if(q+=`<path d="${A}" fill="${Z}" opacity="0.07" clip-path="url(#clip_${F})"/>`,q+=`<path d="${E}" fill="none" stroke="url(#${F})" stroke-width="2" stroke-linejoin="round" stroke-linecap="round" clip-path="url(#clip_${F})"/>`,b>0){const N=S.slice(a-1).map((Ee,Pe)=>({x:B(a-1+Pe),y:H(Ee)})),V=Te(N);q+=`<path d="${V}" fill="none" stroke="url(#${F})" stroke-width="2" stroke-dasharray="5,4" stroke-linejoin="round" stroke-linecap="round" opacity="0.5" clip-path="url(#clip_${F})"/>`}}q+=`<rect class="chart-hover-rect" x="${p.l}" y="${p.t}" width="${h}" height="${f}" fill="transparent" style="cursor:crosshair"/>`,e.innerHTML=q,ki(e,S,B,H,M,j,y,a,n,u,r,i,p,600)}function ki(e,t,i,a,n,s,c,l,u,r,v,o,d,m,p){const h=$i(),f=e.querySelector(".chart-hover-rect");if(!f)return;const b=document.createElementNS("http://www.w3.org/2000/svg","circle");b.setAttribute("r","4"),b.setAttribute("fill",o),b.setAttribute("stroke","#fff"),b.setAttribute("stroke-width","1.5"),b.style.display="none",b.style.pointerEvents="none",e.appendChild(b),f.addEventListener("mousemove",w=>{const g=e.getBoundingClientRect(),S=m/g.width,M=(w.clientX-g.left)*S,j=m-d.l-d.r,I=Math.max(0,Math.min(1,(M-d.l)/j)),B=Math.round(I*(c-1));if(B<0||B>=t.length)return;const H=t[B],F=i(B),W=a(H);b.setAttribute("cx",F),b.setAttribute("cy",W),b.style.display="";const Z=(l-B)*u,q=Me(Z),ge=Math.abs(H)>=100?H.toFixed(1):H.toFixed(2);h.innerHTML=`
    ...
    `,h.style.display="block";const T=w.clientX+12,E=w.clientY-10;h.style.left=`${Math.min(T,window.innerWidth-160)}px`,h.style.top=`${E}px`}),f.addEventListener("mouseleave",()=>{h.style.display="none",b.style.display="none"})}function Ai(e,t,i,a=0){const n=Date.now(),s=i*6e4,c=n-t*s,l=t+a,u=new Array(l).fill(0);return O.filter(r=>r.plotId===e).forEach(r=>{const v=new Date(r.iso).getTime();if(v<c)return;const o=Math.min(l-1,Math.floor((v-c)/s));o>=0&&(u[o]+=r.mm||0)}),u}function Ii(e,t,i,a,n=0){const l={t:12,r:8,b:28,l:44},u=600-l.l-l.r,r=180-l.t-l.b,v=i+n,o=Ai(k,i,a,n),d=Math.max(...o,1),m=y=>l.l+y/Math.max(v-1,1)*u,p=y=>l.t+r-y/d*r;let h="";for(let y=0;y<=4;y++){const b=l.t+y/4*r,w=(d-y/4*d).toFixed(1);h+=`<line x1="${l.l}" y1="${b}" x2="${600-l.r}" y2="${b}" stroke="var(--bdr2)" stroke-width="1"/>`,h+=`<text x="${l.l-4}" y="${b+4}" text-anchor="end" font-size="10" fill="var(--txt3)">${w}</text>`}if(n>0){const y=m(i-.5),b=`irrig_stripe_${Math.random().toString(36).slice(2,8)}`;h+=`<defs><pattern id="${b}" width="8" height="8" patternUnits="userSpaceOnUse" patternTransform="rotate(45)">
        <rect width="8" height="8" fill="rgba(142,142,147,.05)"/>
        <line x1="0" y1="0" x2="0" y2="8" stroke="rgba(142,142,147,.16)" stroke-width="4"/>
      </pattern></defs>
  ...
  `,i.querySelector(".pheno-pop-close").addEventListener("click",()=>{i.remove(),re=null});const n=t.clientX,s=t.clientY;i.style.position="fixed",i.style.top=s-8+"px",i.style.left=n+12+"px",document.body.appendChild(i),re=i,setTimeout(()=>{const c=i.offsetWidth,l=i.offsetHeight;let u=s-8,r=n+12;r+c>window.innerWidth-8&&(r=n-c-12),u+l>window.innerHeight-8&&(u=s-l),i.style.top=Math.max(8,u)+"px",i.style.left=Math.max(8,r)+"px"},0),document.addEventListener("click",function c(l){i.contains(l.target)||(i.remove(),re=null,document.removeEventListener("click",c))},{capture:!0})}function qi(){const e=document.getElementById("toggle-notes");e&&e.addEventListener("change",jt)}function jt(){document.querySelectorAll(".notes-overlay").forEach(d=>d.remove()),lt();const e=document.getElementById("toggle-notes");if(!(e!=null&&e.checked))return;const t=$e().filter(d=>d.type==="note"||d.type==="traitement");if(!t.length)return;const i=Date.now(),a=ve()*6e4,n=i-a,s=600,c=46,l=10,u=28,r=s-c-l,v=180-u,o=t.filter(d=>{const m=new Date(d.date+"T12:00:00").getTime();return m>=n&&m<=i});o.length&&document.querySelectorAll(".chart-card").forEach(d=>{const m=d.querySelector(".chart-svg, .tensio-svg");if(!m)return;const p=document.createElementNS("http://www.w3.org/2000/svg","g");p.setAttribute("class","notes-overlay"),o.forEach(h=>{const y=(new Date(h.date+"T12:00:00").getTime()-n)/a,b=c+y*r,g=h.type==="traitement"?"#78c860":"#60a8e0",S=v+9,M=document.createElementNS("http://www.w3.org/2000/svg","polygon"),j=5;M.setAttribute("points",`${b.toFixed(1)},${(S-j).toFixed(1)} ${(b+j).toFixed(1)},${S.toFixed(1)} ${b.toFixed(1)},${(S+j).toFixed(1)} ${(b-j).toFixed(1)},${S.toFixed(1)}`),M.setAttribute("fill",g),M.setAttribute("stroke","#fff"),M.setAttribute("stroke-width","1.5"),p.appendChild(M);const I=document.createElementNS("http://www.w3.org/2000/svg","rect");I.setAttribute("x",(b-9).toFixed(1)),I.setAttribute("y",v.toFixed(1)),I.setAttribute("width","18"),I.setAttribute("height","18"),I.setAttribute("fill","transparent"),I.style.cursor="default",I.addEventListener("mouseenter",B=>Ri(h,B)),I.addEventListener("mouseleave",lt),p.appendChild(I)}),m.appendChild(p)})}let Y=null;function Ri(e,t){Y||(Y=document.createElement("div"),Y.className="note-tip",document.body.appendChild(Y));const i=e.type==="traitement";let n=`<div class="note-tip-header">
  ...
  `,t.appendChild(a);const n=a.querySelector(".compare-search-input");n.focus(),n.addEventListener("input",s=>{const c=s.target.value.toLowerCase();a.querySelectorAll(".compare-dropdown-item").forEach(l=>{l.style.display=l.textContent.toLowerCase().includes(c)?"":"none"})}),a.querySelectorAll(".compare-dropdown-item").forEach(s=>{s.addEventListener("click",()=>{G=parseInt(s.dataset.id),a.remove(),Le(),U()})}),setTimeout(()=>{document.addEventListener("click",function s(c){!a.contains(c.target)&&!t.contains(c.target)&&(a.remove(),document.removeEventListener("click",s))})},0)}function Oi(){const e=Ve.find(t=>t.id===C.orgId);kt(e),zi(e),Ae(),_e(),ce(),Je()}const dt=["Abricotier","Ail","Amandier","Artichaut","Asperge","Aubergine","Avoine","Basilic","Betterave fourragère","Betterave sucrière","Blé dur","Blé tendre","Brocoli","Carotte","Cerisier","Chou-fleur","Chou pommé","Ciboulette","Citrouille","Clémentinier","Courgette","Echalote","Endive","Epinard","Fève","Figuier","Fraisier","Framboisier","Gesse","Giroflier","Haricot vert","Houblon","Kiwi","Lavande","Lentille","Luzerne","Maïs doux","Maïs grain","Maïs semence","Maïs silage","Melon","Menthe","Moutarde","Navet","Nectarinier","Noisetier","Noyer","Oignon","Olivier","Orge de brasserie","Orge de printemps","Orge d'hiver","Pêcher","Persil","Pissenlit","Poireau","Pois chiche","Pois de conserve","Pois fourrager","Pois protéagineux","Poivron","Pomme de terre","Pommier","Poirier","Prunier","Pruneau d'Agen","Radis","Raisin de cuve","Raisin de table","Riz","Romarin","Sarrasin","Seigle","Soja","Sorgho","Tabac","Thym","Tomate","Tournesol","Triticale","Vigne","Cardon","Céleri","Cerise","Châtaignier","Colza","Courge","Fénugrec","Groseillier","Lin fibre","Lin oléagineux","Mâche","Millet","Myrtille","Noix de cajou","Paprika","Patate douce","Pistachier","Poisson-Chat","Quinoa","Safran","Sainfoin","Scorsonère","Shallot","Topinambour","Trèfle","Vesce","Fétuque","Ray-grass","Prairie temporaire","Prairie permanente","Jachère","Autre"];function kt(e){const t=document.getElementById("panel-ident"),i=x,a=i.texture||null,n=i.irrigation||null,s=i.crop||dt[0],c=i.env||null,l=a===He,u=i.soilAnalysis||{},r=i.latlngs,v=Array.isArray(r)&&r.length>=3,o=i.area?`${i.area} ha <span class="field-computed">(calculé)</span>`:v?'— <span class="field-computed">(calculé)</span>':'<span class="field-computed">Tracez le contour pour calculer la surface de la parcelle.</span>';t.innerHTML=`
    ${Be("Nom",i.name||"—","name","text")}
    ${Ni("Culture",s,"crop",dt)}
    ${ut("Surface",o)}
    ${Fe("Environnement",c,"env",Gt,"Plein champ")}
    ${Fe("Texture sol",a,"texture",[...Vt,He],"Indéfini")}
    ${l?`
    ...
    `:""}
    ${Fe("Irrigation",n,"irrigation",xt,"Non renseigné")}
    ${ut("Exploitation",e?e.name:"—")}
  `,ie(t,"name",i.name||"",d=>{z({name:d}),wt(d,{label:"Parcelles",href:"parcelles.html"})}),ie(t,"crop",s,d=>z({crop:d})),ie(t,"env",c||"",d=>z({env:d||null})),ie(t,"texture",a||"",d=>{const m=d||null,p={texture:m};m!==He&&(p.soilAnalysis=null),z(p),kt(e)}),l&&(ie(t,"soilArgile",String(u.argile??""),d=>z({soilAnalysis:{...x.soilAnalysis,argile:+d}})),ie(t,"soilLimon",String(u.limon??""),d=>z({soilAnalysis:{...x.soilAnalysis,limon:+d}})),ie(t,"soilSable",String(u.sable??""),d=>z({soilAnalysis:{...x.soilAnalysis,sable:+d}}))),ie(t,"irrigation",n||"",d=>z({irrigation:d||null}))}function Be(e,t,i,a="text"){const n=(t||"").replace(/"/g,"&quot;");return`
    ...
    </div>`}function Fe(e,t,i,a,n="—"){const c=a.includes(n)?"":`<option value=""${t?"":" selected"}>${n}</option>`;return`
    <div class="panel-row" data-field="${i}">
      <span class="panel-row-key">${e}</span>
      <select class="panel-field-input" data-val>
        ${c}
  ...
  `}function _i(){const e=new Set;return P.filter(i=>x.linkedSensorIds.includes(i.id)).forEach(i=>{const a=R[i.model]||[];_.includes(i.model)||a.forEach(n=>e.add(n.id))}),e}function mt(e){const t=R[e]||[];return t.length?`<div class="sensor-metric-badges">${t.map(i=>`<span class="sensor-metric-badge" style="--mc:${i.color}">${i.name}</span>`).join("")}</div>`:""}function Ae(){const e=document.getElementById("panel-sensors"),t=P.filter(m=>x.linkedSensorIds.includes(m.id)),i=P.filter(m=>m.orgId===C.orgId&&!x.linkedSensorIds.includes(m.id)),a=t.filter(m=>!_.includes(m.model)),n={};a.forEach(m=>(R[m.model]||[]).forEach(p=>{n[p.id]=(n[p.id]||0)+1}));const s=Object.entries(n).filter(([,m])=>m>1).map(([m])=>{var p;return((p=Object.values(R).flat().find(h=>h.id===m))==null?void 0:p.name)||m});let c="";if(s.length>0&&(c+=`<div class="sensor-conflict-banner">
      ...
      </div>`);const v=document.getElementById("sensor-add-row"),o=document.getElementById("add-sensor-select");v&&o&&(i.length>0?(o.innerHTML='<option value="">Ajouter un capteur…</option>'+i.map(m=>`<option value="${m.id}">${ee[m.model]||m.model} — ${m.serial}</option>`).join(""),v.style.display=""):v.style.display="none"),e.querySelectorAll(".remove-sensor-btn").forEach(m=>{m.addEventListener("click",()=>{const p=parseInt(m.dataset.id),h=P.find(y=>y.id===p),f=h?`${ee[h.model]||h.model} — ${h.serial}`:`capteur #${p}`;Ce({title:"Retirer le capteur",message:`Retirer <strong>${f}</strong> de cette parcelle ?<br><br>Les données historiques sont conservées.`,confirmLabel:"Retirer",onConfirm:()=>{const y=x.linkedSensorIds.filter(b=>b!==p);z({linkedSensorIds:y}),vt(y),Ae(),U(),ue()}})})});const d=document.getElementById("add-sensor-btn");d&&d.addEventListener("click",()=>{const m=document.getElementById("add-sensor-select"),p=parseInt(m.value);if(!p)return;const h=P.find(y=>y.id===p);if(!h)return;const f=Oe(h.model);if(f){const b=P.filter(w=>x.linkedSensorIds.includes(w.id)).filter(w=>{const g=Oe(w.model);return g&&g!==f});if(b.length>0){const w=b.map(g=>`${ee[g.model]||g.model} — ${g.serial}`).join(", ");Ce({title:"Capteur incompatible",message:`Cette parcelle utilise déjà : <strong>${w}</strong>.<br><br>Les capteurs de sol (CHP, CAPA, EC, T_MINI) sont exclusifs — une seule technologie par parcelle.<br><br>Retirer ${b.length>1?"ces capteurs":"ce capteur"} et ajouter le nouveau ?`,confirmLabel:"Remplacer",onConfirm:()=>{const g=new Set(b.map(M=>M.id)),S=x.linkedSensorIds.filter(M=>!g.has(M));z({linkedSensorIds:[...S,p]}),vt(S),ht(h),Ae(),U(),ue()}});return}}if(!_.includes(h.model)){const y=_i(),w=(R[h.model]||[]).map(g=>g.id).filter(g=>y.has(g));if(w.length>0){const g=w.map(M=>{const j=Object.values(R).flat().find(I=>I.id===M);return(j==null?void 0:j.name)||M});if(!confirm(`Attention : ce capteur (${h.model}) mesure des métriques déjà fournies par un autre capteur :
• ${g.join(`
• `)}

Voulez-vous l'ajouter quand même ?`))return}}z({linkedSensorIds:[...x.linkedSensorIds,p]}),ht(h),Ae(),U(),ue()})}function _e(){var c;const e=document.getElementById("panel-integrations"),t=x.integrations||[],i=Xt.filter(l=>!t.includes(l));let a="";t.length===0?a+='<div class="panel-empty" style="margin-bottom:8px">Aucune intégration active</div>':a+=t.map(l=>`
  ...
  </div>`}function ce(){var o;Wi();const e=((o=document.getElementById("sidebar"))==null?void 0:o.getAttribute("data-role"))==="adherent-reseau",t=document.getElementById("panel-membres"),i=document.getElementById("panel-membres-section"),a=ne.filter(d=>{var m;return d.source==="adherent"&&((m=d.orgIds)==null?void 0:m.includes(C.orgId))}),n=a.filter(d=>K.includes(d.id));i&&(i.style.display=!e&&a.length===0?"none":""),t&&(t.innerHTML=n.length?n.map(d=>pt(d,!0,!1)).join(""):'<p class="panel-empty">Aucun membre associé.</p>',t.querySelectorAll(".remove-membre-btn").forEach(d=>{d.addEventListener("click",()=>{const m=parseInt(d.dataset.id),p=ne.find(h=>h.id===m);Ce({title:"Retirer le membre",message:`Retirer <strong>${p?`${p.prenom} ${p.nom}`:`membre #${m}`}</strong> de cette parcelle ?`,confirmLabel:"Retirer",onConfirm:()=>{K=K.filter(h=>h!==m),ae(k,{linkedOrgMemberIds:K}),ce()}})})}));const s=document.getElementById("add-membre-org-row");s&&(s.style.display="");const c=document.getElementById("add-membre-org-select");c&&(c.innerHTML='<option value="">Associer un membre…</option>',a.filter(d=>!K.includes(d.id)).forEach(d=>{const m=document.createElement("option");m.value=d.id,m.textContent=`${d.prenom} ${d.nom}`,c.appendChild(m)})),document.getElementById("add-membre-org-btn").onclick=()=>{const d=parseInt(c==null?void 0:c.value);!d||K.includes(d)||(K.push(d),ae(k,{linkedOrgMemberIds:K}),ce())};const l=document.getElementById("panel-conseillers"),u=document.getElementById("panel-conseillers-section"),r=ne.filter(d=>d.source==="réseau"&&Q.includes(d.id));u&&(u.style.display=e&&r.length===0?"none":""),l&&(l.innerHTML=r.length?r.map(d=>pt(d,!e,!0)).join(""):'<p class="panel-empty">Aucun conseiller associé.</p>',e||l.querySelectorAll(".remove-membre-btn").forEach(d=>{d.addEventListener("click",()=>{const m=parseInt(d.dataset.id),p=ne.find(h=>h.id===m);Ce({title:"Retirer le conseiller",message:`Retirer <strong>${p?`${p.prenom} ${p.nom}`:`conseiller #${m}`}</strong> de cette parcelle ?`,confirmLabel:"Retirer",onConfirm:()=>{Q=Q.filter(h=>h!==m),ae(k,{linkedConseillerIds:Q}),ce()}})})}));const v=document.getElementById("add-conseiller-row");if(v&&(v.style.display=e?"none":""),!e){const d=document.getElementById("add-membre-select");d&&(d.innerHTML='<option value="">Ajouter un conseiller…</option>',ne.filter(m=>m.source==="réseau"&&!Q.includes(m.id)).forEach(m=>{const p=document.createElement("option");p.value=m.id,p.textContent=`${m.prenom} ${m.nom} (${m.role})`,d.appendChild(p)})),document.getElementById("add-membre-btn").onclick=()=>{const m=parseInt(d==null?void 0:d.value);!m||Q.includes(m)||(Q.push(m),ae(k,{linkedConseillerIds:Q}),ce())}}}function Je(){const e=document.getElementById("panel-alertes"),t=x.alertes||[],i={seuil:"bi-graph-up-arrow",cumul:"bi-droplet",absence:"bi-wifi-off"};let a="";t.length===0?a+='<div class="panel-empty" style="margin-bottom:8px">Aucune alerte configurée</div>':a+=t.map((n,s)=>`
    ...
    `).join(""),a+='<button id="create-alert-btn" class="action-btn action-btn--primary" style="margin-top:6px"><i class="bi bi-plus"></i> Créer une alerte</button>',e.innerHTML=a,e.querySelectorAll(".remove-alert-btn").forEach(n=>{n.addEventListener("click",()=>{const s=parseInt(n.dataset.idx),c=[...x.alertes];c.splice(s,1),z({alertes:c}),Je()})}),document.getElementById("create-alert-btn").addEventListener("click",()=>{Gi(e)})}function Vi(){const e=[];return P.filter(i=>x.linkedSensorIds.includes(i.id)).forEach(i=>{(R[i.model]||[]).forEach(n=>{e.find(s=>s.id===n.id)||e.push({id:n.id,name:n.name,unit:n.unit})})}),Ge.forEach(i=>{e.find(a=>a.id===i.id)||e.push({id:i.id,name:i.name,unit:i.unit})}),e}function Gi(e){if(e.querySelector(".alert-create-form"))return;const i=Vi(),a=document.createElement("div");a.className="alert-create-form",a.innerHTML=`
  ...
  `,e.appendChild(a),a.querySelector("#alert-metric").addEventListener("change",n=>{const s=n.target.selectedOptions[0];a.querySelector("#alert-unit-label").textContent=(s==null?void 0:s.dataset.unit)||"—"}),a.querySelector("#alert-save-btn").addEventListener("click",()=>{const s=a.querySelector("#alert-metric").value,c=i.find(v=>v.id===s),l=a.querySelector("#alert-condition").value,u=a.querySelector("#alert-threshold").value;if(!s||!u)return;const r={type:"seuil",label:`Alerte ${(c==null?void 0:c.name)||s}`,metric:(c==null?void 0:c.name)||s,condition:l,threshold:u,unit:(c==null?void 0:c.unit)||""};z({alertes:[...x.alertes||[],r]}),Je()}),a.querySelector("#alert-cancel-btn").addEventListener("click",()=>a.remove())}function Yi(e,t){const i=new Blob(["\uFEFF"+e],{type:"text/csv;charset=utf-8;"}),a=Object.assign(document.createElement("a"),{href:URL.createObjectURL(i),download:t});document.body.appendChild(a),a.click(),document.body.removeChild(a),setTimeout(()=>URL.revokeObjectURL(a.href),100)}function Ji(){const e=x.name||C.name||"Parcelle",t=Ie(x.linkedSensorIds);let i;if(G){const d=oe.find(f=>f.id===G),m=P.filter(f=>f.parcelIds.includes(G)).map(f=>f.id),p=Ie(m),h=(d==null?void 0:d.name)||"Comparaison";i=[...t.map(f=>({h:`[${e}] ${f.name} (${f.unit})`,gen:f.base})),...p.map(f=>({h:`[${h}] ${f.name} (${f.unit})`,gen:f.base}))]}else i=t.map(d=>({h:`${d.name} (${d.unit})`,gen:d.base}));const a=ve()*6e4,n=be()*6e4,s=J==="custom"&&pe?pe:new Date,c=J==="custom"&&me?me:new Date(s-a),l=Math.min(Math.ceil((s-c)/n)+1,500),u=(s-c)/Math.max(l-1,1),r=["Horodatage",...i.map(d=>d.h)].join(";"),v=Array.from({length:l},(d,m)=>[new Date(c.getTime()+m*u).toISOString().replace("T"," ").slice(0,19),...i.map(h=>h.gen())].join(";")),o=e.replace(/[^\w]/g,"_");Yi([r,...v].join(`\r
`),`${o}_${J}_${new Date().toISOString().slice(0,10)}.csv`)}function Ce({title:e,message:t,confirmLabel:i="Confirmer",onConfirm:a}){const n=document.createElement("div");n.className="modal add-modal",n.style.zIndex="9999",n.innerHTML=`
    <div class="add-modal-content" style="max-width:400px">
      ...
      ${s}`,e.appendChild(n),a.render(n.querySelector(`#dblock-${i}`))}),e.querySelectorAll(".dash-menu-btn").forEach(i=>{i.addEventListener("click",a=>{var r,v,o;a.stopPropagation(),(r=document.querySelector(".dash-dropdown"))==null||r.remove();const n=i.dataset.wid,s=document.createElement("div");s.className="dash-dropdown";const c=n==="irrigations"?`
        <button class="dash-dd-item" data-action="set-vol">Définir le volume limité et le débit</button>`:"";s.innerHTML=`${c}<button class="dash-dd-item dash-dd-remove" data-action="remove" data-wid="${n}">Retirer le widget</button>`;const l=i.getBoundingClientRect(),u=e.getBoundingClientRect();s.style.top=`${l.bottom-u.top+4}px`,s.style.right=`${u.right-l.right}px`,e.style.position="relative",e.appendChild(s),(v=s.querySelector('[data-action="remove"]'))==null||v.addEventListener("click",()=>{s.remove();const d=he().filter(m=>m!==n);fe(d),ue()}),(o=s.querySelector('[data-action="set-vol"]'))==null||o.addEventListener("click",()=>{s.remove(),Nt("vol")}),setTimeout(()=>document.addEventListener("click",()=>s.remove(),{once:!0}),0)})}),e.querySelectorAll(".dash-block-ft-link[data-tab]").forEach(i=>{i.addEventListener("click",a=>{var n;a.preventDefault(),(n=document.querySelector(`.detail-tab-btn[data-pane="tab-${i.dataset.tab}"]`))==null||n.click()})}),pn(e)}function It(e,t=380,i=90){const l=t-28-8,u=i-6-20,r=e.flatMap(b=>b.values);let v=Math.min(...r),o=Math.max(...r);v===o&&(v-=1,o+=1);const d=e[0].values.length,m=b=>(28+b/(d-1)*l).toFixed(1),p=b=>(6+u-(b-v)/(o-v)*u).toFixed(1),h=[.25,.5,.75].map(b=>{const w=(6+b*u).toFixed(1);return`<line x1="28" y1="${w}" x2="${t-8}" y2="${w}" stroke="rgba(0,0,0,.06)" stroke-width="1"/>`}).join(""),f=[v,(v+o)/2,o].map(b=>`<text x="25" y="${(+p(b)+3.5).toFixed(0)}" text-anchor="end" font-size="9" fill="var(--txt3)">${b.toFixed(0)}</text>`).join(""),y=e.map(b=>`<path d="${b.values.map((g,S)=>`${S?"L":"M"}${m(S)},${p(g)}`).join("")}" fill="none" stroke="${b.color}" stroke-width="1.8" stroke-linejoin="round"/>`).join("");return`<svg width="100%" height="${i}" viewBox="0 0 ${t} ${i}" preserveAspectRatio="none">${f}${h}${y}</svg>`}function en(e,t,i,a){const v=(f,y)=>{const b=Math.PI+f*Math.PI,w=Math.PI+y*Math.PI,g=(80+60*Math.cos(b)).toFixed(1),S=(90+60*Math.sin(b)).toFixed(1),M=(80+60*Math.cos(w)).toFixed(1),j=(90+60*Math.sin(w)).toFixed(1);return`M${g},${S} A60,60,0,${y-f>.5?1:0},1,${M},${j}`},o=v(0,1),d=t.filter(f=>f.from<e).map(f=>`<path d="${v(f.from,Math.min(f.to,e))}" fill="none" stroke="${f.color}" stroke-width="12" stroke-linecap="butt"/>`).join(""),m=Math.PI+e*Math.PI,p=(80+60*Math.cos(m)).toFixed(1),h=(90+60*Math.sin(m)).toFixed(1);return`<svg width="160" height="100" viewBox="0 0 160 100">
  ...
  </svg>`}function tn(e){const t=["Dim","Lun","Mar","Mer","Jeu","Ven","Sam"],i=["jan","fév","mar","avr","mai","jun","jul","aoû","sep","oct","nov","déc"],a=["bi-sun","bi-cloud-sun","bi-cloud","bi-cloud-rain","bi-cloud-lightning-rain"],n=["Ensoleillé","Part. nuageux","Couvert","Pluvieux","Orageux"],s=new Date,c=oe.find(d=>d.id===k),l=Ve.find(d=>d.id===(c==null?void 0:c.orgId)),u=(c==null?void 0:c.ville)||(l==null?void 0:l.ville)||"—",r=(d,m)=>{const p=new Date(s);p.setDate(p.getDate()+d);const h=Math.floor((k*7+d*3)%11/2.2);return{lbl:d===0?"Auj.":t[p.getDay()],date:`${p.getDate()} ${i[p.getMonth()]}`,tmax:$(17+m,34+m),tmin:$(4+m,15+m),pluie:h>=3?$(2,18):0,vent:$(10,35),rafales:$(25,70),wi:h}},v=[0,1,2].map(d=>r(d,0)).concat([3,4].map(d=>r(d,-1))),o=d=>`
    <div class="w-prev5-day">
      <div class="w-prev5-daylbl">${d.lbl}</div>
      <div class="w-prev5-date">${d.date}</div>
      <i class="bi ${a[d.wi]} w-prev5-icon" title="${n[d.wi]}"></i>
    ...
    <div class="w-prev5-grid">${v.map(o).join("")}</div>`}function nn(e){const t=new Date,i=x.crop||C.crop||"",a=[{label:"Herbicides de contact",seed:7},{label:"Fongicides",seed:3},{label:"Herbicides racinaires",seed:11},{label:"Herbicides systémiques",seed:5}],n=Array.from({length:12},(l,u)=>{const r=new Date(t);return r.setHours(r.getHours()+u),r}),s=l=>`${String(l.getHours()).padStart(2,"0")}h`,c=l=>{const u=n.map((r,v)=>(l.seed*17+v*5)%11<6);return n.map((r,v)=>`
      <div class="w-weephyt-dot-wrap" title="${s(r)} — ${u[v]?"Fenêtre OK":"Fenêtre non OK"}">
        <div class="w-weephyt-tl-dot" style="background:${u[v]?"#2d9e5f":"#e07050"}"></div>
        <div class="w-weephyt-tl-lbl">${v%3===0?s(r):""}</div>
    ...
    <div class="w-weephyt-src">Via <strong>Weephyt</strong> · ${i||"—"}</div>
      ...
      </div>`}).join("")}</div>`,e.querySelectorAll(".w-cumul-del").forEach(r=>{r.addEventListener("click",v=>{v.stopPropagation(),s.add(r.dataset.cid),Re({hidden:[...s]}),We(e)})}),e.querySelectorAll(".w-cumul-date-input").forEach(r=>{r.addEventListener("change",()=>{c[r.dataset.cid]=r.value,Re({dates:c})})}),e.querySelectorAll(".w-cumul-cfg").forEach(r=>{r.addEventListener("click",v=>{var p;v.stopPropagation();const o=r.dataset.cid,d=u.find(h=>h.id===o);if(!(d!=null&&d.cfgFields))return;(p=e.querySelector(".w-cumul-cfg-panel"))==null||p.remove();const m=document.createElement("div");m.className="w-cumul-cfg-panel",m.style.gridColumn="1 / -1",m.innerHTML=`<div class="w-cumul-cfg-title">Paramétrer ${d.label}</div>`+d.cfgFields.map(h=>`
          <label class="w-cumul-cfg-row">
            <span>${h.label} (°C)</span>
            <input type="number" class="w-cumul-cfg-inp" data-key="${h.key}" value="${l[h.key]??h.def}" step="0.1">
          </label>`).join("")+'<button class="w-cumul-cfg-ok">OK</button>',r.closest(".w-cumul-item").after(m),m.querySelector(".w-cumul-cfg-ok").addEventListener("click",()=>{m.querySelectorAll(".w-cumul-cfg-inp").forEach(h=>{l[h.dataset.key]=parseFloat(h.value)||0}),Re({cfg:l}),m.remove(),We(e)})})})}function an(e){if(!P.filter(o=>x.linkedSensorIds.includes(o.id)).some(o=>o.model==="T_GEL")){e.innerHTML='<div class="dash-empty">Capteur T_GEL non lié</div>';return}const i=25,a=D(0,5),n=Array.from({length:i},(o,d)=>+(a+d*.18+D(-.8,.8)).toFixed(1)),s=n.map(o=>+(o-D(1,2.5)).toFixed(1)),c=It([{values:n,color:"#23B19B"},{values:s,color:"#5E88EC"}],380,100),l=n[i-1],u=s[i-1],r=$(5,8),v=String(Math.floor(Math.random()*60)).padStart(2,"0");e.innerHTML=`<div class="w-gel-wrap">
  ...
  </div>`}function sn(e){const t=P.filter(d=>x.linkedSensorIds.includes(d.id));if(!t.some(d=>{const m=R[d.model]||[];return m.some(p=>p.id==="temp")&&m.some(p=>p.id==="humidite")})){e.innerHTML='<div class="dash-empty">Capteur T+HR requis</div>';return}const a=D(18,30),n=$(40,85),c=+(.611*Math.exp(17.27*a/(a+237.3))*(1-n/100)).toFixed(2),l=Math.min(c/2,1),u=c<.4?"#5b8dd9":c<.8?"#2d9e5f":c<1.2?"#f5a030":"#e07050",r=c<.4?"Transpiration faible":c<.8?"Transpiration optimale":c<1.2?"Forte transpiration":"Stress hydrique",v=[{from:0,to:.2,color:"#5b8dd9"},{from:.2,to:.4,color:"#45b7d1"},{from:.4,to:.6,color:"#2d9e5f"},{from:.6,to:.8,color:"#a0c840"},{from:.8,to:.9,color:"#f5a030"},{from:.9,to:1,color:"#e07050"}],o=t.find(d=>{const m=R[d.model]||[];return m.some(p=>p.id==="temp")&&m.some(p=>p.id==="humidite")});e.innerHTML=`<div class="w-dpv-wrap">
    <div class="w-dpv-gauge" style="color:${u}">${en(l,v,r,c+" kPa")}</div>
  ...
  </div>`}function on(e){if(!P.filter(d=>x.linkedSensorIds.includes(d.id)).some(d=>{const m=R[d.model]||[];return m.some(p=>p.id==="temp")&&m.some(p=>p.id==="humidite")})){e.innerHTML='<div class="dash-empty">Capteur T+HR requis</div>';return}const a=D(20,35),n=$(45,90),s=+(a-.55*(1-n/100)*(a-14.5)).toFixed(0),c=s<68?"#2d9e5f":s<72?"#f5c842":s<79?"#f5a030":"#e07050",l=s<68?"Confort":s<72?"Stress léger":s<79?"Stress modéré":"Stress sévère",u=["Dim","Lun","Mar","Mer","Jeu","Ven","Sam"],r=new Date,v=Array.from({length:3},(d,m)=>{const p=new Date(r);return p.setDate(p.getDate()+m+1),{day:u[p.getDay()],m:$(64,72),j:$(68,80),s:$(62,70)}}),o=d=>d<68?"#2d9e5f":d<72?"#f5c842":"#f5a030";e.innerHTML=`<div class="w-thi-wrap">
    ...
    <div class="w-thi-forecast">
      ...
      ${v.map(d=>`<div class="w-thi-fc-row">
        ...
        <span class="w-thi-fc-val" style="color:${o(d.m)}">${d.m}</span>
        <span class="w-thi-fc-val" style="color:${o(d.j)}">${d.j}</span>
        <span class="w-thi-fc-val" style="color:${o(d.s)}">${d.s}</span>
      </div>`).join("")}
      ...
      <div class="w-thi-legend-row" style="color:#e07050"><span class="w-thi-legend-range">≥ 79</span><span>Stress sévère</span></div>`,e.querySelector(".w-thi-wrap").insertBefore(p,e.querySelector(".w-thi-details"))})}function rn(e){if(!P.filter(u=>x.linkedSensorIds.includes(u.id)).some(u=>{const r=R[u.model]||[];return r.some(v=>v.id==="temp")&&r.some(v=>v.id==="humidite")})){e.innerHTML='<div class="dash-empty">Capteur T+HR requis</div>';return}const a=72,n=D(14,22),s=Array.from({length:a},(u,r)=>+(n+6*Math.sin(r/24*2*Math.PI-Math.PI/2)+D(-.5,.5)).toFixed(1)),c=Array.from({length:a},(u,r)=>Math.max(30,Math.min(100,70-15*Math.sin(r/24*2*Math.PI-Math.PI/2)+D(-3,3)))),l=s.map((u,r)=>{const v=c[r]/100,o=17.27,d=237.3,m=Math.log(v)+o*u/(d+u);return+(d*m/(o-m)).toFixed(1)});e.innerHTML=`<div class="w-temprosee-wrap">
  ...
  </div>`}function ln(e){if(!P.filter(B=>x.linkedSensorIds.includes(B.id)).some(B=>(R[B.model]||[]).some(H=>H.id==="tsol"))){e.innerHTML='<div class="dash-empty">Capteur T. sol requis</div>';return}const a=48,n=D(14,20),s=Array.from({length:a},(B,H)=>+(n+3*Math.sin(H/24*2*Math.PI-Math.PI/2)+D(-.4,.4)).toFixed(1)),c=15,l=22,u=380,r=100,v=28,o=8,d=6,m=20,p=u-v-o,h=r-d-m,f=[...s,c,l],y=Math.min(...f)-1,b=Math.max(...f)+1,w=B=>(v+B/(a-1)*p).toFixed(1),g=B=>(d+h-(B-y)/(b-y)*h).toFixed(1),S=+g(c),M=+g(l),j=[.25,.5,.75].map(B=>{const H=(d+B*h).toFixed(1);return`<line x1="${v}" y1="${H}" x2="${u-o}" y2="${H}" stroke="rgba(0,0,0,.06)" stroke-width="1"/>`}).join(""),I=s.map((B,H)=>`${H?"L":"M"}${w(H)},${g(B)}`).join("");e.innerHTML=`<div class="w-tsol-wrap">
    <svg width="100%" height="${r}" viewBox="0 0 ${u} ${r}" preserveAspectRatio="none">
      ${j}
  ...
  </div>`}function cn(e){const t=(x.crop||C.crop||"").toLowerCase();if(!t.includes("maïs")&&!t.includes("mais")){e.innerHTML='<div class="dash-empty">Culture Maïs requise</div>';return}const i=[{name:"Farmflex 253",target:1320},{name:"DKC 3230",target:1380},{name:"Ronaldinio",target:1290},{name:"Banguy",target:1350}],a=i[k%i.length],n=C.degresJour||$(600,1200),s=Math.min(n/a.target,1),c=Math.max(0,a.target-n),l=new Date,u=Math.round(c/10),r=new Date(l);r.setDate(r.getDate()+Math.max(0,u-5));const v=new Date(l);v.setDate(v.getDate()+u+5);const o=["jan","fév","mar","avr","mai","jun","jul","aoû","sep","oct","nov","déc"],d=m=>`${m.getDate()} ${o[m.getMonth()]}`;e.innerHTML=`<div class="w-maizy-wrap">
  ...
  </div>`}const Pt=[{id:"j7",label:"J-7"},{id:"j1",label:"J-1"},{id:"j0",label:"J0"},{id:"last",label:"Dernières données"}],un=Pt.filter(e=>e.id==="j7"||e.id==="j1"),ft=()=>`w-reservoir-agg-${k}`,bt=()=>`w-profil-reservoir-agg-${k}`;function Ht(e,t="j0"){return localStorage.getItem(e())||t}function Ft(e,t){localStorage.setItem(e(),t)}function qt(e){const t=C.reserveHydrique||80,i=(C.id*17+13)%41,a={j7:-8,j1:-2,j0:0,last:1},n=Math.min(95,Math.max(15,55+i+(a[e]||0))),s=Math.round(t*n/100);return{rhu:t,pct:n,mm:s}}function Rt(e,t=Pt){return`<select class="w-reservoir-agg-sel">
    ${t.map(i=>`<option value="${i.id}"${i.id===e?" selected":""}>${i.label}</option>`).join("")}
  </select>`}function Dt(e){const t=Ht(ft),{rhu:i,pct:a,mm:n}=qt(t),s=a>60?"#2d9e5f":a>35?"#e07820":"#e04040";e.innerHTML=`
    ...
    </div>`,e.querySelector(".w-reservoir-agg-sel").addEventListener("change",c=>{Ft(ft,c.target.value),Dt(e)})}function Ot(e){const t=Ht(bt,"j1"),{pct:i}=qt(t),a=(C.id*17+13)%41,n=[{label:"10 cm",pct:Math.min(100,Math.max(0,i+a%12-5)),color:"#f0cc60"},{label:"30 cm",pct:Math.min(100,Math.max(0,i+a%8)),color:"#c89c30"},{label:"60 cm",pct:Math.min(100,Math.max(0,i-a%10+3)),color:"#a07010"}];e.innerHTML=`
    <div class="w-bilan-layout">
      ${Rt(t,un)}
    ...
    Widget bientôt disponible
      ...
      <div class="w-sensor-src">${ee[n.model]||n.model} · ${n.serial}</div>`;const u=(r=t.closest(".dash-block"))==null?void 0:r.querySelector(".dash-block-ft-link");if(u){const o=((v=document.getElementById("time-step"))==null?void 0:v.value)||"1h";u.href=`capteur-graphique.html?sensorId=${n.id}&parcelId=${k}&period=${J}&step=${o}`,u.removeAttribute("data-tab")}}}function mn(e){const t=P.filter(f=>x.linkedSensorIds.includes(f.id)),i=t.some(f=>f.model.startsWith("CAPA-")),a=t.some(f=>_.includes(f.model)),n=C.reserveHydrique||80,s=(C.id*17+13)%41,c=Math.min(95,Math.max(20,55+s)),l=Math.round(n*c/100),u=4+s%5-2,r=Math.max(2,Math.min(6,u)),v=Math.round(r*7-l*.3),o=Math.max(0,v),d=c>60?"#2d9e5f":c>35?"#e07820":"#e04040",m=c>60?"Réserve suffisante":c>35?"Réserve à surveiller":"Réserve critique",p=c>60?"bi-check-circle-fill":c>35?"bi-exclamation-circle-fill":"bi-x-circle-fill";if(!i&&!a){e.innerHTML=`<div style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:8px;color:var(--txt3)">
    ...
    <div class="w-bilan-layout">
      ...
      <div class="w-bilan-gauge-wrap">
        ...
        <div class="w-bilan-gauge-labels">
          <span>0</span>
          <span style="font-weight:600;color:${d}">${l} mm / ${n} mm RFU (${c} %)</span>
          <span>${n} mm</span>
        </div>
      </div>
      <div class="w-bilan-horizons">
    ...
    </div>`,document.body.appendChild(t),t.addEventListener("click",i=>{i.target===t&&t.remove()}),t.querySelector("#irr-m-s-cancel").onclick=()=>t.remove(),t.querySelector("#irr-m-s-save").onclick=()=>{const i=t.querySelector("#irr-m-s-date").value,a=parseInt(t.querySelector("#irr-m-s-qty").value)||0;if(!i||!a)return;const n=i>se,s=()=>{O.push({iso:i,mm:a,real:!n,plotId:C.id,fromStrategy:!1}),$t(),t.remove(),Se(e),_t("Irrigation enregistrée",[`Date : ${Ne(i)}`,`Quantité : ${a} mm`])},c=O.filter(l=>l.plotId===C.id&&l.iso===i);if(c.length){zt(c.length,()=>{O.splice(0,O.length,...O.filter(l=>!(l.plotId===C.id&&l.iso===i))),s()});return}s()}}function yt(e){const t=document.createElement("div");t.className="journal-form-overlay",t.innerHTML=`
    <div class="journal-form-modal">
    ...
    </div>`,document.body.appendChild(t);const i=()=>{const a=t.querySelector("#irr-m-sa-debut").value,n=t.querySelector("#irr-m-sa-fin").value,s=parseInt(t.querySelector("#irr-m-sa-qty").value)||0,c=parseInt(t.querySelector("#irr-m-sa-freq").value)||0,l=t.querySelector("#irr-m-sa-preview");if(!a||!n||c<=0){l.textContent="—";return}let u=0,r=new Date(a),v=new Date(n);for(;r<=v&&u<200;)u++,r.setDate(r.getDate()+c);if(u>0){const o=C.area>0?Math.round(u*s*C.area*10):0,d=o>0?` · ${o.toLocaleString("fr-FR")} m³`:"";l.innerHTML=`<span style="color:var(--pri);font-weight:600">↗ ${u} irrigations · ${u*s} mm${d}</span>`}else l.innerHTML='<span style="color:var(--txt3)">Ajustez les paramètres</span>'};i(),t.querySelector("#irr-m-sa-debut").addEventListener("change",i),t.querySelector("#irr-m-sa-fin").addEventListener("change",i),t.querySelector("#irr-m-sa-qty").addEventListener("input",i),t.querySelector("#irr-m-sa-freq").addEventListener("input",i),t.addEventListener("click",a=>{a.target===t&&t.remove()}),t.querySelector("#irr-m-sa-cancel").onclick=()=>t.remove(),t.querySelector("#irr-m-sa-save").onclick=()=>{const a=t.querySelector("#irr-m-sa-debut").value,n=t.querySelector("#irr-m-sa-fin").value,s=parseInt(t.querySelector("#irr-m-sa-qty").value)||10,c=parseInt(t.querySelector("#irr-m-sa-freq").value)||7;if(!a||!n)return;const l=[];let u=new Date(a),r=new Date(n);for(;u<=r&&l.length<200;)l.push(new Date(u)),u.setDate(u.getDate()+c);const v=Wt(),o=()=>{l.forEach(m=>{const p=m.toISOString().slice(0,10);O.push({iso:p,mm:s,real:p<=se,plotId:C.id,fromStrategy:!0,seasonId:v})}),$t(),t.remove(),Se(e),_t("Saison enregistrée",[`Début : ${Ne(a)} · Fin : ${Ne(n)}`,`${l.length} irrigations · ${s} mm · tous les ${c} j`])},d=O.filter(m=>m.plotId===C.id&&m.iso>=a&&m.iso<=n);if(d.length){zt(d.length,()=>{O.splice(0,O.length,...O.filter(m=>!(m.plotId===C.id&&m.iso>=a&&m.iso<=n))),o()});return}o()}}function Se(e){var p,h,f,y,b;const t=O.filter(w=>w.plotId===C.id),i=t.filter(w=>w.real),a=t.filter(w=>!w.real),n=i.reduce((w,g)=>w+g.mm,0),s=a.reduce((w,g)=>w+g.mm,0),c=n+s,l=x.irrigation||C.irrigation;let u="";if(t.some(w=>w.fromStrategy)){const w=[...t].sort((j,I)=>j.iso.localeCompare(I.iso)),g=w[w.length-1],S=w[w.length-2],M=S?Math.round((new Date(g.iso)-new Date(S.iso))/864e5):null;u=`
    ...
    <div class="w-irrig-actions">
      ...
      <div class="w-irrig-layout">
        ...
        ${v}
      </div>`,(h=e.querySelector("#w-irrig-act-saisie"))==null||h.addEventListener("click",()=>gt(e)),(f=e.querySelector("#w-irrig-act-saison"))==null||f.addEventListener("click",()=>yt(e)),m();return}e.innerHTML=`
    <div class="w-irrig-layout">

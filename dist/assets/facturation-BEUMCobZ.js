import"./main-DdpHcqUd.js";import{u as v}from"./breadcrumb-DEBQjfiD.js";import{n}from"./network-YzWdS0n_.js";document.addEventListener("DOMContentLoaded",()=>{v(),f()});const s={plan:"Plus",anniversaire:"2022-03-15",numero:"CTR-2022-00418",licencesMembres:5,licencesAdherents:3,licencesIntegrations:27,licencesTotal:8,prixUnitaire:29},a={societe:n.nom,siret:n.siret,adresse:n.siege.adresse,cp:n.siege.codePostal,ville:n.siege.ville,pays:n.siege.pays};function f(){const e=document.getElementById("billing-page");if(!e)return;const l=y();e.innerHTML=`

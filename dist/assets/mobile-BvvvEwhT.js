...
import"./modulepreload-polyfill-B5Qt9EMX.js";import{p as re}from"./plots-DhtWL7s_.js";import{d as Ne,b as qs,c as Re,l as Cn}from"./store-c0FlIf2T.js";import{s as de}from"./sensors-CRadjF8G.js";import{o as we}from"./orgs-DnFmvGlp.js";import{n as Ue}from"./network-YzWdS0n_.js";import{I as me,s as nt,g as Mn}from"./irrigations-C22Dtsoo.js";import{I as Zt,S as Pi,M as Ps,A as hi,a as $t,E as Tn,b as si}from"./constants-CJpDUNiw.js";import{m as ni}from"./members-Cr98hVG_.js";const In="modulepreload",jn=function(e){return"/weenat-proto/"+e},Oi={},ye=function(i,t,n){let a=Promise.resolve();if(t&&t.length>0){document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),l=(s==null?void 0:s.nonce)||(s==null?void 0:s.getAttribute("nonce"));a=Promise.allSettled(t.map(m=>{if(m=jn(m),m in Oi)return;Oi[m]=!0;const d=m.endsWith(".css"),p=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${m}"]${p}`))return;const v=document.createElement("link");if(v.rel=d?"stylesheet":In,d||(v.as="script"),v.crossOrigin="",v.href=m,l&&v.setAttribute("nonce",l),document.head.appendChild(v),d)return new Promise((u,c)=>{v.addEventListener("load",u),v.addEventListener("error",()=>c(new Error(`Unable to preload CSS for ${m}`)))})}))}function o(s){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=s,window.dispatchEvent(l),!l.defaultPrevented)throw s}return a.then(s=>{for(const l of s||[])l.status==="rejected"&&o(l.reason);return i().catch(o)})},ct=[];function $e(e){const i=document.getElementById("phone-screen"),t=document.createElement("div");return t.className="m-detail-layer",t.innerHTML=e,i.appendChild(t),requestAnimationFrame(()=>t.classList.add("m-detail-layer--in")),ct.push(t),t}function he(){const e=ct.pop();e&&(e.classList.remove("m-detail-layer--in"),setTimeout(()=>e.remove(),300))}function Ni(){return ct.length}function qn(){return ct.some(e=>e.dataset.dirty==="true")}function Ds(){ct.forEach(e=>delete e.dataset.dirty)}window.addEventListener("m-tab-change",()=>{ct.forEach(e=>e.remove()),ct.length=0});const Pn=[{key:"orgs",label:"Organisations",icon:"bi-building",desc:"Ajouts de membres, changements d'organisation, nouvelles exploitations"},{key:"capteurs",label:"Capteurs",icon:"bi-broadcast",desc:"Anomalies, changements d'état, mise à jour firmware"},{key:"alertes",label:"Alertes",icon:"bi-bell",desc:"Déclenchements de seuils et alertes météo configurées"}],Vi=[{key:"email",label:"Email",icon:"bi-envelope"},{key:"sms",label:"SMS",icon:"bi-phone"},{key:"push",label:"Push",icon:"bi-bell"}],Dn=["Mon réseau","Mon organisation","Mon secteur"],ai={orgs:"Mon organisation",capteurs:"Mon réseau",alertes:"Mon secteur"},Ji={orgs:{email:!0,sms:!1,push:!0},capteurs:{email:!0,sms:!1,push:!0},alertes:{email:!0,sms:!0,push:!0}};function zn(e){let i=(()=>{try{return JSON.parse(localStorage.getItem("weenat-mobile-notif"))||JSON.parse(JSON.stringify(Ji))}catch{return JSON.parse(JSON.stringify(Ji))}})(),t=(()=>{try{return JSON.parse(localStorage.getItem("weenat-mobile-notif-peri"))||JSON.parse(JSON.stringify(ai))}catch{return JSON.parse(JSON.stringify(ai))}})();function n(){localStorage.setItem("weenat-mobile-notif",JSON.stringify(i)),localStorage.setItem("weenat-mobile-notif-peri",JSON.stringify(t)),e("Préférences enregistrées")}function a(s){const l=i[s.key]||{},m=t[s.key]||ai[s.key];return`
  ...
  `);o.querySelector("#notif-back").addEventListener("click",he),o.querySelectorAll(".notif-toggle").forEach(s=>{s.addEventListener("change",()=>{const l=s.dataset.cat,m=s.dataset.ch;i[l][m]=s.checked,n()})}),o.querySelectorAll(".notif-peri-sel").forEach(s=>{s.addEventListener("change",()=>{t[s.dataset.cat]=s.value,n()})})}const Wi={admin:{initials:"JD",prenom:"Jean",nom:"Dupont",email:"jean.dupont@ferme-du-bocage.fr",phones:[{label:"Principal",numero:"+33 6 12 34 56 78"},{label:"Sophie Dupont",numero:"+33 6 98 76 54 32"}],apiKeys:[{id:1,name:"Application mobile",created:"10/01/2026",value:"sk-wnt-mbl4X9pQr2Lz7vNcKwJ1eYtU6sSoD8aF"},{id:2,name:"Intégration Agreo",created:"28/02/2026",value:"sk-wnt-agr8B3mTxP5nVcLqR1uZoK7wJ9dE2sY"},{id:3,name:"Script export nuit",created:"01/04/2026",value:"sk-wnt-xpt2H7kNpQ4rVmLcJ9sT1oY6uB3wF8dE"}]},adherent:{initials:"MM",prenom:"Marie",nom:"Martin",email:"marie.martin@ferme-du-bocage.fr",phones:[{label:"Principal",numero:"+33 7 52 18 93 46"}],apiKeys:[{id:1,name:"Application mobile",created:"14/02/2026",value:"sk-wnt-mbl9Z2xQr5Lp7vNcKwA1eYtU3sRoD4bG"}]}},Fn=["Français","English","Español","Deutsch","Italiano","Português","Polski","Nederlands"],Ui=["Métrique (mm, °C, km/h…)","Impérial (in, °F, mph…)"];let Qe={};function Ve(e){var n;const i=document.getElementById("phone-screen");(n=document.querySelector(".m-toast"))==null||n.remove();const t=document.createElement("div");t.className="m-toast",t.textContent=e,i.appendChild(t),requestAnimationFrame(()=>t.classList.add("m-toast--show")),setTimeout(()=>{t.classList.remove("m-toast--show"),setTimeout(()=>t.remove(),300)},2200)}function dt({title:e,body:i,onDone:t,doneLabel:n="OK"}){var l;const a=document.getElementById("phone-screen");(l=document.querySelector(".m-sheet-overlay"))==null||l.remove();const o=document.createElement("div");o.className="m-sheet-overlay",o.innerHTML=`
    <div class="m-sheet">
  ...
  `).join("");const o=dt({title:e,body:a,doneLabel:"Fermer",onDone:()=>{}});a.querySelectorAll(".m-sheet-option").forEach(s=>{s.addEventListener("click",()=>{n(i[+s.dataset.i]),o.classList.remove("m-sheet-overlay--show"),setTimeout(()=>o.remove(),280),Ve("Enregistré")})})}function _n(e,i){const t=document.createElement("div"),n=()=>{var a;t.innerHTML=e.map((o,s)=>`
  ...
  `,n.querySelector(".m-sheet-key-copy").addEventListener("click",()=>{var o;(o=navigator.clipboard)==null||o.writeText(e.value).catch(()=>{}),Ve("Clé copiée !")});const a=dt({title:"Clé API",body:n,doneLabel:"Fermer",onDone:()=>{}});n.querySelector(".m-sheet-key-delete").addEventListener("click",()=>{const o=i.findIndex(s=>s.id===e.id);o!==-1&&i.splice(o,1),a.classList.remove("m-sheet-overlay--show"),setTimeout(()=>{a.remove(),t()},280),Ve("Clé supprimée")})}function Hn(){const e="ABCDEFGHJKLMNPQRSTUVWXYZabcdefghjkmnpqrstuvwxyz23456789";return"sk-wnt-"+Array.from({length:32},()=>e[Math.floor(Math.random()*e.length)]).join("")}function Rn(e){const i=document.createElement("div");i.innerHTML='<input class="m-sheet-input" type="text" placeholder="Nom de la clé (ex: Application mobile)">';const t=i.querySelector("input");dt({title:"Nouvelle clé API",body:i,doneLabel:"Générer",onDone:()=>{const n=t.value.trim();if(!n){Ve("Entrez un nom");return}const a={id:Date.now(),name:n,created:new Date().toLocaleDateString("fr-FR"),value:Hn()};e(a),Ve("Clé générée")}}),setTimeout(()=>t.focus(),300)}function On(e,i){Qe={profile:JSON.parse(JSON.stringify(Wi[i]||Wi.admin)),langue:"Français",unites:Ui[0]};const n=localStorage.getItem("mobile_avatarUrl")||null;function a(){const s=Qe.profile,l=n?`<img src="${n}" alt="avatar" style="width:100%;height:100%;object-fit:cover">`:`<span>${s.initials}</span>`,m=s.apiKeys.map(p=>`
    ...
    </div>`,s.querySelector(".irr-sheet-body").appendChild(typeof i=="string"?Object.assign(document.createElement("div"),{innerHTML:i}):i),o.appendChild(s),requestAnimationFrame(()=>s.classList.add("irr-sheet-overlay--open"));const l=()=>{s.classList.remove("irr-sheet-overlay--open"),setTimeout(()=>s.remove(),280)};return s.addEventListener("click",p=>{p.target===s&&l()}),(d=s.querySelector("#iss-del"))==null||d.addEventListener("click",()=>{n==null||n(),l()}),s.querySelector("#iss-save").addEventListener("click",()=>{t==null||t(),l()}),s}function _s(e,i,t){const n=i.filter(l=>e.has(l.id)&&(!l.irrigation||l.irrigation==="Non irrigué"));if(!n.length){t();return}const a=document.createElement("div");a.innerHTML=`
  ...
  `));c.dataset.dirty="true",v(c),p(c),c.querySelector("#irr-back").addEventListener("click",he),c.querySelector("#irr-date").addEventListener("change",r=>{s=r.target.value,d(c),p(c)}),c.querySelector("#irr-qty").addEventListener("input",r=>{l=parseInt(r.target.value)||1,p(c)}),c.querySelector(".irr-save-btn").addEventListener("click",()=>{const r=o;_s(r,e,()=>{const f=s>Ie;r.forEach(k=>{me.push({iso:s,mm:l,real:!f,plotId:k,fromStrategy:!1})}),nt();const w=[{title:null,names:[...r].map(k=>{var A;return(A=e.find(j=>j.id===k))==null?void 0:A.name}).filter(Boolean)}],h=r.size===1?String([...r][0]):"all";Ds(),Hs({title:r.size>1?"Irrigations enregistrées":"Irrigation enregistrée",params:[{label:"Date",value:wt(s)},{label:"Quantité",value:`${l} mm`}],parcelSections:w,isFut:f,plots:e,calFilter:h,addedCount:r.size,stackDepth:1,backToParcel:n,onBack:a})})})}function $i(e,i,t=null,n=null,a=!1,o=null){let s=new Set((t==null?void 0:t.ids)??[]),l=Ie,m=new Date(new Date().setMonth(new Date().getMonth()+4)).toISOString().split("T")[0],d=10,p=7,v=null,u=null;if(n){const h=me.filter(k=>k.fromStrategy&&n.has(k.seasonId));if(h.length){const k=h.map(j=>j.iso).sort();l=k[0],m=k[k.length-1],d=h[0].mm;const A=[...new Set(k)];p=A.length>=2?Math.round((new Date(A[1])-new Date(A[0]))/864e5):7,v=l,u=m}}function c(){if(!l||!m||p<=0)return[];const h=[],k=new Date(m);let A=new Date(l);for(;A<=k&&h.length<100;)h.push(new Date(A)),A.setDate(A.getDate()+p);return h}function r(){const h=c();s.size;const k=h.length>0?`<span class="irr-preview-ok">↗ ${h.length} irrigations · ${h.length*d} mm au total</span>`:'<span style="color:#8e8e93">Ajustez les dates et la fréquence</span>';return`
    ...
    <div class="irr-scroll-body">
      <div class="irr-apercu-summary">
        <div>
          ...
          <div class="irr-apercu-sub">${Ft(n)} → ${Ft(a)} · tous les ${s}j</div>
        </div>
  ...
  `));u.querySelector("#cal-back").addEventListener("click",he),u.querySelector("#cal-filter-sel").addEventListener("change",c=>{t=c.target.value,p(u)}),p(u)}const et=Object.freeze(Object.defineProperty({__proto__:null,buildSelectionHTML:Xt,checkIcon:yi,flexLayer:ut,goToPlot:Fs,openCalendar:Rs,openIrrigationSaisie:Bs,openIrrigationStrategie:$i},Symbol.toStringTag,{value:"Module"})),Zn=[{name:"Allier AgriTech",distance:8,adherents:31,capteurs:198,parcelles:1140,sharedSensorTypes:["Capteurs météo","Capteurs d'irrigation"]},{name:"Auvergne Agri Conseil",distance:15,adherents:54,capteurs:361,parcelles:2080,sharedSensorTypes:["Capteurs météo","Stations météo virtuelles"]},{name:"Réseau Bourbonnais",distance:22,adherents:18,capteurs:112,parcelles:630,sharedSensorTypes:["Capteurs météo","Capteurs d'irrigation"]},{name:"Creuse Agri Net",distance:38,adherents:12,capteurs:74,parcelles:410,sharedSensorTypes:["Capteurs d'irrigation"]},{name:"Puy-de-Dôme Connect",distance:45,adherents:39,capteurs:255,parcelles:1490,sharedSensorTypes:["Capteurs météo","Stations météo virtuelles"]}],es={name:"Breiz'Agri Conseil",city:"Rennes (35)",phone:"02 99 XX XX XX",email:"contact@breizagri.fr",capteurs:312,parcelles:1830,sharedSensorTypes:["Capteurs météo"]},Xn=["Capteurs météo","Capteurs d'irrigation","Stations météo virtuelles"];function ts(e){return e.split(" ").filter(i=>i.length>2).slice(0,2).map(i=>i[0].toUpperCase()).join("")}const He={prenom:"Pierre",nom:"Jourdain",email:"pierre@gaec-jourdain.fr",phone:"06 71 23 45 67",orgName:"GAEC Jourdain",adresse:"Lieu-dit La Croix Blanche, 03500 Saint-Pourçain-sur-Sioule",selectedPlan:"expert",joinNetwork:!0},Os={"P+":"Station météo",PT:"Station météo",P:"Pluviomètre",TH:"Thermomètre-hygromètre",SMV:"Station météo virtuelle",W:"Anémomètre",PYRANO:"Pyranomètre",PAR:"Capteur PAR",LWS:"Capteur d'humectation foliaire",T_GEL:"Sonde gel",T_MINI:"Thermo. sol","CHP-15/30":"Tensiomètre 15/30 cm","CHP-30/60":"Tensiomètre 30/60 cm","CHP-60/90":"Tensiomètre 60/90 cm","CAPA-30-3":"Sonde capacitive","CAPA-60-6":"Sonde capacitive",EC:"Fertirrigation"},Qn={"P+":["pluie","temperature","humidite"],PT:["pluie","temperature"],P:["pluie"],TH:["temperature","humidite"],SMV:["pluie","temperature","humidite"],"CHP-15/30":["pothydr","temp_sol"],"CHP-30/60":["pothydr","temp_sol"],"CHP-60/90":["pothydr","temp_sol"],"CAPA-30-3":["teneur","temp_sol"],"CAPA-60-6":["teneur","temp_sol"],EC:["teneur","temp_sol"]},ea=new Set(["CHP-15/30","CHP-30/60","CHP-60/90"]),ta={"CHP-15/30":[15,30],"CHP-30/60":[30,60],"CHP-60/90":[45,90]},li=[{id:"essential",name:"Weenat Essential",priceNum:0,price:"Gratuit",color:"#636366",features:["Aucun capteur physique","Historique illimité","Alertes","Accès API","2 stations météo virtuelles","Parcelles illimitées"]},{id:"plus",name:"Weenat Plus",priceNum:16.5,price:"16,5 €/mois",color:"#00B093",features:["Historique illimité","Alertes","Intégrations","Exports","Accès API","2 stations météo virtuelles","Parcelles illimitées"]},{id:"expert",name:"Weenat Expert",priceNum:30,price:"30 €/mois",color:"#006798",features:["Historique illimité","Alertes","Intégrations","Exports","Accès API","2 stations météo virtuelles","Parcelles illimitées","Capteurs irrigation","Fonctionnalités irrigation"]}],ri={Administrateur:[{section:"Parcelles",items:[{label:"Consulter et exporter les données",ok:!0},{label:"Créer, modifier, archiver et supprimer",ok:!0}]},{section:"Capteurs",items:[{label:"Consulter et exporter les données",ok:!0},{label:"Ajouter, retirer et lier à une parcelle",ok:!0}]},{section:"Membres",items:[{label:"Consulter les informations",ok:!0},{label:"Inviter, modifier et retirer",ok:!0}]},{section:"Exploitations adhérentes",items:[{label:"Consulter les informations",ok:!0},{label:"Inviter, modifier et retirer",ok:!0}]},{section:"Facturation",items:[{label:"Consulter et modifier les informations",ok:!0}]}],Agent:[{section:"Parcelles",items:[{label:"Consulter et exporter les données",ok:!0},{label:"Créer, modifier, archiver et supprimer",ok:!0}]},{section:"Capteurs",items:[{label:"Consulter et exporter les données",ok:!0},{label:"Ajouter, retirer et lier à une parcelle",ok:!0}]},{section:"Membres",items:[{label:"Consulter les informations",ok:!0},{label:"Inviter, modifier et retirer",ok:!1}]},{section:"Exploitations adhérentes",items:[{label:"Consulter les informations",ok:!0},{label:"Inviter, modifier et retirer",ok:!1}]},{section:"Facturation",items:[{label:"Consulter et modifier les informations",ok:!1}]}],Lecteur:[{section:"Parcelles",items:[{label:"Consulter et exporter les données",ok:!0},{label:"Créer, modifier, archiver et supprimer",ok:!1}]},{section:"Capteurs",items:[{label:"Consulter et exporter les données",ok:!0},{label:"Ajouter, retirer et lier à une parcelle",ok:!1}]},{section:"Membres",items:[{label:"Consulter les informations",ok:!0},{label:"Inviter, modifier et retirer",ok:!1}]},{section:"Exploitations adhérentes",items:[{label:"Consulter les informations",ok:!1},{label:"Inviter, modifier et retirer",ok:!1}]},{section:"Facturation",items:[{label:"Consulter et modifier les informations",ok:!1}]}]};function ia(e,i,t,n){const a=i==="essential",o=i==="expert";return e==="new-member-admin"||e==="new-member-agent"||e==="new-member-reader"?["signup","verify","emailVerified","creating","done"]:e==="new-adherent"?["signup","verify","emailVerified","orgName","geoloc","orgInfo","networkInfo","invite","plan",...o?["volumeChoice"]:[],"creating","done"]:["signup","verify","emailVerified","orgName","geoloc","orgInfo","networkChoice",...t?["networkPick"]:[],"invite","plan",...a?[]:["payment","paymentConfirmed"],...o?["volumeChoice"]:[],"creating","done"]}function sa(e,i,t,n){return ia(e,i,t)}const na={signup:"Inscription",verify:"Vérification",orgName:"Exploitation",geoloc:"Localisation",orgInfo:"Informations",networkChoice:"Réseau",networkPick:"Choisir un réseau",networkInfo:"Mon réseau",invite:"Invitations",plan:"Abonnement",payment:"Paiement",paymentConfirmed:"Paiement",volumeChoice:"Volume autorisé",parcelMap:"Parcelle",parcelSource:"Source de données",parcelConfig:"Paramétrage",parcelDone:"Confirmation"};function aa(e,i){const t=document.getElementById("phone-screen");let n=0,a=e==="new-adherent"?"expert":He.selectedPlan,o=He.joinNetwork,s=!1,l=0,m=!0,d=46.3021,p=3.2938,v=null,u=null,c="smv",r=[],f="Parcelle 1";const b=document.createElement("div");b.id="onboarding-overlay",b.className="m-ob-overlay",t.appendChild(b);function w(){return sa(e,a,o)}function h(){return w()[n]}function k(){return w().filter(W=>!["creating","done","parcelDone","emailVerified","paymentConfirmed"].includes(W)).length}function A(){return li.find(W=>W.id===a)}function j(){const W=w().slice(0,n).filter(N=>N!=="creating"&&N!=="done"&&N!=="parcelDone").length;return`<div class="m-ob-progress-bar"><div class="m-ob-progress-fill" style="width:${Math.round(W/k()*100)}%"></div></div>`}function S(W,G=!0){const N=h(),H=new Set(["creating","done","parcelDone","emailVerified","paymentConfirmed"]),z=G&&n>0&&!H.has(N),R=na[N]||"";return`
    ...
    `)}function P(W){const G=ri[W];return G?`<div class="m-ob-role-perms">${G.map(N=>`
      ...
      </div>`).join("")}</div>`:""}function F(W){const G=ri[W];return G?`<div class="m-rp-summary">${G.map(H=>{const z=H.items.filter(ae=>ae.ok).length,R=z===0?"none":z===H.items.length?"full":"partial",Y={full:"check-circle-fill",partial:"dash-circle-fill",none:"x-circle"}[R],K={full:"#30d158",partial:"#ff9500",none:"#c7c7cc"}[R],le=H.section.replace("Exploitations adhérentes","Adhérents");return`<div class="m-rp-badge"><i class="bi bi-${Y}" style="color:${K}"></i><span>${le}</span></div>`}).join("")}</div>`:""}function _(){const W=Object.keys(ri);return`
    ...
    `)}function L(){if(p==="smv")return A(`
      ...
      `);if(p==="link"){const y=de.slice(0,6);return A(`
        ...
        <button class="m-ob-cta" id="ob-next">Continuer</button>
        <button class="m-ob-link" id="ob-skip-source" type="button">Passer cette étape</button>
      `)}return Ns({showBack:!0,btnLabel:"Continuer",showSkip:!0})}function B(){const y=new Set(["CHP-15/30","CHP-30/60","CHP-60/90","CAPA-30-3","CAPA-60-6","EC"]),T=new Set(["EC"]),P=de.filter(M=>v.includes(M.id)),F=P.some(M=>y.has(M.model)),_=P.some(M=>T.has(M.model)),E=Zt.filter(M=>M!=="Non renseigné");return u||la(t,n).then(M=>{if(!M)return;u=M;const O=b.querySelector("#ob-parcel-name");O&&!O._edited&&(O.value=M)}),A(`
      <div class="m-ob-hero m-ob-hero--compact">
        <div class="m-ob-logo-wrap" style="background:#e8fff0;color:#30d158"><i class="bi bi-sliders"></i></div>
        <h2 class="m-ob-h2">Paramétrage</h2>
        <p class="m-ob-sub">Quelques informations sur cette parcelle.</p>
...
<circle cx="${z}" cy="${C}" r="4.5" fill="#4CAF50" stroke="#fff" stroke-width="1.5" style="pointer-events:none"/>`}).join("");let Q="",J="";for(let N=n;N<n+a;N++){const H=new Date(d.getTime()+N*864e5);if(H.getDate()===1){const z=D(N).toFixed(1);Q+=`<line x1="${z}" y1="${u.t}" x2="${z}" y2="${C}" stroke="rgba(0,0,0,.18)" stroke-width="1" stroke-dasharray="3,4"/>`;const R=new Date(H.getFullYear(),H.getMonth()+1,1),Y=Math.round((R-d)/864e5),K=Math.min(Y,n+a-1),le=D((N+K)/2).toFixed(1),ae=String(H.getFullYear()).slice(-2),ge=`${Gs[H.getMonth()]} ${ae}`;J+=`<text x="${le}" y="${i-6}" text-anchor="middle" font-size="12" font-family="-apple-system,sans-serif" fill="#8e8e93">${ge}</text>`}}const X=`
  ...
  `);n.classList.add("m-fs-layer");const a=n.querySelector("#il-chart-area");let o=Lt(e,14),s=null;function l(){a.clientWidth&&a.clientHeight&&xa(a,o,t)}s=new ResizeObserver(()=>requestAnimationFrame(l)),s.observe(a),requestAnimationFrame(l),n.querySelector("#il-back").addEventListener("click",()=>{s==null||s.disconnect(),he()}),n.querySelector("#il-plot-picker").addEventListener("click",()=>{Sa(e,d=>{s==null||s.disconnect(),he(),requestAnimationFrame(()=>Zs(d))})}),n.querySelector("#il-period").addEventListener("change",d=>{t=d.target.value,l()}),n.querySelector("#il-parcel-btn").addEventListener("click",()=>{ye(()=>Promise.resolve().then(()=>lt),void 0).then(d=>d.initParcelDetail(e,[],"widgets","Irré-LIS"))}),n.querySelector("#il-btn-cumuls").addEventListener("click",()=>{const d=document.createElement("div");d.innerHTML=ga(o,t),ue({title:"Cumuls sur la période",body:d,doneLabel:"Fermer",onDone:()=>{}})}),n.querySelector("#il-btn-legend").addEventListener("click",()=>{const d=document.createElement("div");d.innerHTML=ha(),ue({title:"Légende",body:d,doneLabel:"Fermer",onDone:()=>{}})});const m=()=>{o=Lt(e,14),l()};n.querySelector("#il-btn-config").addEventListener("click",()=>$a(e,m)),n.querySelector("#il-btn-pluv").addEventListener("click",()=>wa(e,m))}const Xs=Object.freeze(Object.defineProperty({__proto__:null,getIrrelisConfig:bt,getIrrelisDailyData:Lt,getIrrelisVal:zi,hasIrrelis:It,irrelisColor:Qt,irrelisMobileWidget:Ks,openIrrelisDetail:Zs},Symbol.toStringTag,{value:"Module"})),Qs={admin:100,adherent:1,new:41},en="weenat-m-dash";function vt(){try{return JSON.parse(localStorage.getItem(en))||{}}catch{return{}}}function St(e){try{localStorage.setItem(en,JSON.stringify({...vt(),...e}))}catch{}}const Ae=[{id:"bilan_hydrique",title:"Irrigation",icon:"bi-droplet",color:"#0172A4",active:!0,available:!0,fixed:!1},{id:"previsions",title:"Prévisions",icon:"bi-cloud-sun",color:"#f5a623",active:!0,available:!0,fixed:!1},{id:"cumuls",title:"Cumuls préférés",info:"Mes cumuls préférés.<br><br>Ajoutez ici les valeurs des cumuls qui sont importants pour vous en ce moment afin de gagner du temps. Vous ouvrez l'app, vous voyez ce qui intéresse. Vous fermez l'app.",gif:"",icon:"bi-bar-chart",color:"#bf5af2",active:!0,available:!0,fixed:!1},{id:"temps_reel",title:"Mesures préférées",info:"Mes mesures préférées.<br><br>Ajoutez ici les indicateurs de vos parcelles ou capteurs qui vous intéressent en ce moment afin de gagner du temps. Vous ouvrez l'app, vous voyez ce qui intéresse. Vous fermez l'app.",gif:"",icon:"bi-activity",color:"#ff9f0a",active:!0,available:!0,fixed:!1},{id:"traitements",title:"Traitements",icon:"bi-shield",color:"#4ecdc4",active:!0,available:!0,fixed:!1},{id:"cultures",title:"Cultures",icon:"bi-flower1",color:"#a2c4c9",active:!0,available:!0,fixed:!1},{id:"evenements",title:"Anomalies capteurs",icon:"bi-exclamation-triangle",color:"#ff3b30",active:!0,available:!0,fixed:!1},{id:"notes",title:"Notes",icon:"bi-pencil-square",color:"#636366",active:!1,available:!0,fixed:!1},{id:"radar_pluie",title:"Radar de pluie",icon:"bi-cloud-rain-heavy",color:"#0172A4",active:!0,available:!0,fixed:!1},{id:"irrelis",title:"Bilan Irré-LIS",icon:"bi-moisture",color:"#0172A4",active:!0,available:!0,fixed:!1},{id:"mon_reseau",title:"Infos Réseau",icon:"bi-diagram-3",color:"#5b8dd9",active:!0,available:!0,fixed:!0},{id:"support",title:"Besoin d'aide ?",icon:"bi-question-circle",color:"#30d158",active:!0,available:!0,fixed:!0}];function ka(e,i,t){var o;const n=document.getElementById("phone-screen");(o=document.querySelector(".m-winfo-overlay"))==null||o.remove();const a=document.createElement("div");a.className="m-winfo-overlay",a.innerHTML=`
    ...
    <div id="cumuls-saved-list" style="display:flex;flex-direction:column;gap:8px">${je.length?Fa():'<div class="m-wf-empty">Ajoutez ici les cumuls que vous souhaitez consulter très régulièrement</div>'}</div>
    ...
    </div>`}`}function _a(e){const i=e.id,t=new Date;let n,a;i%5===3?(n=0,a=(t.getHours()+2+i%3*3)%24):(n=(i*2+1)%6+1,a=6+i%5*2);const o=2+i%3,s=new Date(t);s.setDate(s.getDate()+n);const l=n===0?"Aujourd'hui":s.toLocaleDateString("fr-FR",{day:"2-digit",month:"2-digit"}),m=n*1440+a*60-(t.getHours()*60+t.getMinutes());return{winDateStr:l,winHour:a,winDur:o,minutesFromNow:m}}const Ba="#1a9e40";function Ha(e){const t=e.filter(a=>a.crop).map(a=>({p:a,d:_a(a)})).filter(({d:a})=>a.minutesFromNow>=0&&a.minutesFromNow<=1440).sort((a,o)=>a.d.minutesFromNow-o.d.minutesFromNow);return t.length?`
    ...
    </div>`:'<div class="m-widget-empty">Aucune fenêtre favorable dans les prochaines 24h</div>'}const on="weenat-m-traitements";function Et(){try{return JSON.parse(localStorage.getItem(on))||[]}catch{return[]}}function Fi(e){localStorage.setItem(on,JSON.stringify(e))}function Ra(e,i){let t=new Set;const n=[],a=new Date().toISOString().split("T")[0];function o(){return Xt(n,e,t)}function s(d){const p=t.size,v=d.querySelector(".irr-summary"),u=d.querySelector(".irr-save-btn");!v||!u||(v.textContent=p===0?"":`${p} parcelle${p>1?"s":""}`,u.disabled=p===0)}function l(d){var p;(p=d.querySelector("#irr-sel-all"))==null||p.addEventListener("click",()=>{const v=e.every(u=>t.has(u.id));e.forEach(u=>v?t.delete(u.id):t.add(u.id)),d.querySelector("#trait-sel-list").innerHTML=o(),l(d),s(d)}),d.querySelectorAll(".irr-group-card").forEach(v=>{v.addEventListener("click",()=>{const u=v.dataset.gids.split(",").map(Number),c=u.every(r=>t.has(r));u.forEach(r=>c?t.delete(r):t.add(r)),d.querySelector("#trait-sel-list").innerHTML=o(),l(d),s(d)})}),d.querySelectorAll(".irr-plot-row").forEach(v=>{v.addEventListener("click",()=>{const u=+v.dataset.pid;t.has(u)?t.delete(u):t.add(u),d.querySelector("#trait-sel-list").innerHTML=o(),l(d),s(d)})})}const m=ut($e(`
  ...
  `));l(m),s(m),m.querySelector("#trait-back").addEventListener("click",he),m.querySelector(".irr-save-btn").addEventListener("click",()=>{const d=m.querySelector("#trait-date").value||a,p=m.querySelector("#trait-produit").value.trim()||"—",v=m.querySelector("#trait-dose").value.trim()||"—",u=Et();u.unshift({id:Date.now(),date:d,produit:p,dose:v,plotIds:[...t]}),Fi(u),he(),i("Traitement enregistré")})}function Oa(e,i,t){const n=i==="adherent"?Qs.adherent:null,a=n!==null?re.filter(d=>d.orgId===n):re;let o=null;const s=$e(`
    ...
    <div class="m-sheet m-chat-sheet">
      ...
      <div id="detail-content" class="m-detail-content" style="top:84px">
        ...
        </div>`).join(""),$.querySelectorAll(".m-reorder-btn:not([disabled])").forEach(T=>{T.addEventListener("click",()=>{const P=g(),F=+T.dataset.i,_=F+ +T.dataset.dir,E=Ae.indexOf(P[F]),M=Ae.indexOf(P[_]);[Ae[E],Ae[M]]=[Ae[M],Ae[E]],f(),x(),A()})})};x(),Ye({title:"Réorganiser les widgets",body:$,doneLabel:"Fermer",onDone:()=>{}})}function I(){const $=i==="admin",g=$e(`
      <div class="m-detail-header">
        <div class="m-detail-topbar">
    ...
    <div class="m-detail-content" style="top:52px;overflow-y:auto">
      ...
      <text x="${(b-k-3).toFixed(1)}" y="${(A+9).toFixed(1)}" text-anchor="end" font-size="8" fill="#8e8e93" font-family="-apple-system" font-style="italic">Prévisions</text>`}if(t){const J=S/f.length*.7,X=f.map((ie,ve)=>{const be=(ie-B)/C*L,Ee=A+L-be,ze=ve>=p;return`<rect x="${(I(ve)-J/2).toFixed(1)}" y="${Ee.toFixed(1)}" width="${J.toFixed(1)}" height="${be.toFixed(1)}" fill="${ze?"#C7C7CC":i}" opacity="${ze?".55":".8"}" rx="1"/>`}).join("");return`<svg viewBox="0 0 ${b} ${w}" width="100%" height="${w}" preserveAspectRatio="none">${P}${g}${x}${y}${T}${X}</svg>`}const F=f.map((J,X)=>[I(X),q(J)]),_=F.slice(0,p),E=F.slice(p-1),M=_.map(([J,X],ie)=>`${ie?"L":"M"}${J.toFixed(1)},${X.toFixed(1)}`).join(" "),O=r>0?E.map(([J,X],ie)=>`${ie?"L":"M"}${J.toFixed(1)},${X.toFixed(1)}`).join(" "):"",V=`${M} L${I(p-1).toFixed(1)},${(A+L).toFixed(1)} L${h},${(A+L).toFixed(1)} Z`;return`<div class="m-chart-svg-wrap" data-chart="${encodeURIComponent(JSON.stringify({vals:f.map(J=>+J.toFixed(2)),minV:+B.toFixed(2),maxV:+D.toFixed(2)}))}" data-color="${i}" data-unit="${a}" style="position:relative">
...
`),`${f}_${t}_${new Date().toISOString().slice(0,10)}.csv`)}function Lo(e,i="7d",t="1h",n=null){const a=new Set,o={};e.forEach(c=>{const r=de.find(f=>f.id===c);r&&(Ct[r.model]||[]).forEach(f=>{a.add(f),o[f]||(o[f]=c)})});const s=me.some(c=>c.plotId===n),l=new Set(["CHP-15/30","CHP-30/60","CHP-60/90","CAPA-30-3","CAPA-60-6","EC"]),m=e.some(c=>{const r=de.find(f=>f.id===c);return r&&l.has(r.model)}),d=["pluie","irrigation","temperature","humidite","pothydr","teneur","temp_sol","vent","rayonnement","humectation","par","temp_rosee","etp"],p=[...new Set([...a,"etp","rayonnement","temp_rosee",...m?["rfu"]:["nrs"],...s?["irrigation"]:[]])].filter(c=>Je[c]).sort((c,r)=>{const f=d.indexOf(c),b=d.indexOf(r);return(f===-1?999:f)-(b===-1?999:b)}),v=new Date().toISOString().slice(0,10),u=new Date(Date.now()-7*864e5).toISOString().slice(0,10);return`
    ...
    <div id="detail-content" class="m-detail-content"></div>`);function v(){const C=we.filter(g=>g.id!==100&&g.statut!=="inactif"),I=document.createElement("div"),q=()=>{I.innerHTML=C.map(g=>`
        ...
        ${C.map(x=>`
          ...
          </div>`).join("")}`,q.querySelectorAll("[data-pick-irrig]").forEach(x=>{x.addEventListener("click",()=>{const y=x.dataset.pickIrrig;y&&y!==I&&(Ne(e.id,{irrigation:y}),e.irrigation=y,_e(e.id,{type:"modification",date:new Date().toISOString().slice(0,10),texte:`Type d'irrigation modifié : ${I||"—"} → ${y}.`}),L(),Z("Type d'irrigation mis à jour")),g.classList.remove("m-sheet-overlay--show"),setTimeout(()=>g.remove(),280)})})},g=ue({title:"Type d'irrigation",body:q,doneLabel:"Fermer",onDone:()=>{}});$()}function c(){const C=Tn,I=Re(e.id).env??e.env??"Plein champ",q=document.createElement("div"),$=()=>{q.innerHTML=C.map(x=>`
        <div class="m-sheet-option${x===I?" m-sheet-option--active":""}" data-pick-env="${x}">
          <span>${x}</span>
          ${x===I?'<i class="bi bi-check" style="color:#007aff;font-size:18px"></i>':""}
        </div>`).join(""),q.querySelectorAll("[data-pick-env]").forEach(x=>{x.addEventListener("click",()=>{const y=x.dataset.pickEnv;y&&y!==I&&(Ne(e.id,{env:y}),e.env=y,_e(e.id,{type:"modification",date:new Date().toISOString().slice(0,10),texte:`Environnement modifié : ${I||"—"} → ${y}.`}),L(),Z("Environnement mis à jour")),g.classList.remove("m-sheet-overlay--show"),setTimeout(()=>g.remove(),280)})})},g=ue({title:"Environnement",body:q,doneLabel:"Fermer",onDone:()=>{}});$()}function r(){const C=[...Pi,$t],I=Re(e.id).texture??e.texture,q=document.createElement("div"),$=()=>{q.innerHTML=`
        ...
        ${C.map(x=>`
          <div class="m-sheet-option${x===I?" m-sheet-option--active":""}" data-pick-texture="${x}">
            <span>${x}</span>
            ${x===I?'<i class="bi bi-check" style="color:#007aff;font-size:18px"></i>':""}
          </div>`).join("")}`,q.querySelectorAll("[data-pick-texture]").forEach(x=>{x.addEventListener("click",()=>{const y=x.dataset.pickTexture;if(g.classList.remove("m-sheet-overlay--show"),setTimeout(()=>g.remove(),280),y===$t){k(I);return}y!==I&&(Ne(e.id,{texture:y||null,soilAnalysis:null}),e.texture=y||null,e.soilAnalysis=null,_e(e.id,{type:"modification",date:new Date().toISOString().slice(0,10),texte:`Texture de sol modifiée : ${I||"—"} → ${y||"—"}.`}),L(),Z("Texture de sol mise à jour"))})})},g=ue({title:"Texture de sol",body:q,doneLabel:"Fermer",onDone:()=>{}});$()}function f(){const C=e.name||"",I=document.createElement("div");I.innerHTML=`<input class="m-sheet-input" type="text" value="${C.replace(/"/g,"&quot;")}" placeholder="Nom de la parcelle">`;const q=I.querySelector("input");ue({title:"Nom",body:I,doneLabel:"Enregistrer",onDone:()=>{const $=q.value.trim();$&&$!==C&&(Ne(e.id,{name:$}),e.name=$,_e(e.id,{type:"modification",date:new Date().toISOString().slice(0,10),texte:`Nom de la parcelle modifié : ${C} → ${$}.`}),L(),Z("Nom mis à jour"))}}),setTimeout(()=>q.focus(),300)}function b(){const C=e.variety||"",I=document.createElement("div");I.innerHTML=`<input class="m-sheet-input" type="text" value="${C.replace(/"/g,"&quot;")}" placeholder="Variété">`;const q=I.querySelector("input");ue({title:"Variété",body:I,doneLabel:"Enregistrer",onDone:()=>{const $=q.value.trim();$!==C&&(Ne(e.id,{variety:$||null}),e.variety=$||null,_e(e.id,{type:"modification",date:new Date().toISOString().slice(0,10),texte:`Variété modifiée : ${C||"—"} → ${$||"—"}.`}),L(),Z("Variété mise à jour"))}}),setTimeout(()=>q.focus(),300)}function w(){const C=cropOptions,I=e.crop,q=document.createElement("div");q.innerHTML=C.map(g=>`
    ...
    </div>`,ue({title:"Analyse de sol",body:q,doneLabel:"Enregistrer",onDone:()=>{var T,P,F;const $=+(((T=q.querySelector("#soil-argile"))==null?void 0:T.value)||0),g=+(((P=q.querySelector("#soil-limon"))==null?void 0:P.value)||0),x=+(((F=q.querySelector("#soil-sable"))==null?void 0:F.value)||0),y={argile:$,limon:g,sable:x};Ne(e.id,{texture:$t,soilAnalysis:y}),e.texture=$t,e.soilAnalysis=y,_e(e.id,{type:"modification",date:new Date().toISOString().slice(0,10),texte:`Texture de sol modifiée : ${C||"—"} → analyse de sol (argile ${$}% / limon ${g}% / sable ${x}%).`}),L(),Z("Analyse de sol enregistrée")}})}function A(){const C=Re(e.id).volumeMaxM3??e.volumeMaxM3??null,I=document.createElement("div");I.innerHTML=`<div style="padding:16px;display:flex;flex-direction:column;gap:8px">
          ...
          <div class="m-jrn-entry" data-id="${r.id}">
            ...
            <div class="m-jrn-body">
              <div class="m-jrn-hd">
                ...
                ${k?'<span style="font-size:10px;background:#f2f2f7;color:#8e8e93;border-radius:4px;padding:1px 5px">Dashboard</span>':A?"":`<button class="m-jrn-del" data-id="${r.id}"><i class="bi bi-trash3"></i></button>`}
              </div>
  ...
  `);p.querySelector("#anom-back").addEventListener("click",he);function v(){p.querySelectorAll(".m-anom-tab").forEach(u=>{u.addEventListener("click",()=>{n=u.dataset.tab,p.querySelector("#anom-tabs-bar").innerHTML=m(),p.querySelector("#anom-content").innerHTML=d(),v()})})}v()}const Ii={"P+":"Station météo",PT:"Station météo",P:"Pluviomètre",SMV:"Station météo virtuelle",TH:"Thermomètre-hygromètre",T_MINI:"Thermomètre de sol",W:"Anémomètre",PYRANO:"Pyranomètre",PAR:"Capteur PAR",LWS:"Capteur d'humectation foliaire",T_GEL:"Capteur de gel","CHP-15/30":"Tensiomètre","CHP-30/60":"Tensiomètre","CHP-60/90":"Tensiomètre","CAPA-30-3":"Sonde capacitive","CAPA-60-6":"Sonde capacitive",EC:"Sonde de fertirrigation"},Wo={"P+":"Weenat",PT:"Weenat",P:"Weenat",TH:"Weenat",W:"Weenat",PYRANO:"Weenat",T_MINI:"Weenat",T_GEL:"Weenat",LWS:"Weenat","CHP-15/30":"CoRHIZE","CHP-30/60":"CoRHIZE","CHP-60/90":"CoRHIZE","CAPA-30-3":"CoRHIZE","CAPA-60-6":"CoRHIZE",EC:"CoRHIZE",SMV:"Weenat (virtuel)"};function Bi(e){return e==="CHP-15/30"?[15,30]:e==="CHP-30/60"?[30,60]:e==="CHP-60/90"?[45,90]:null}function Ss(e,i){const t=Ii[e.model]?`${Ii[e.model]} · ${e.model}`:e.model,n=Bi(e.model)&&e.depth!=null?`${e.depth} cm`:null;return[t,n,i].filter(Boolean).join(" · ")}const Mt={"P+":[{id:"pluie",label:"Pluie",unit:"mm",color:"#2E75B6",cumul:!0,cumulsType:"pluie"},{id:"temp",label:"Température",unit:"°C",color:"#FBAF05",cumul:!1,cumulsType:"temp"},{id:"humidite",label:"Humidité",unit:"%",color:"#5B12A4",cumul:!1}],PT:[{id:"pluie",label:"Pluie",unit:"mm",color:"#2E75B6",cumul:!0,cumulsType:"pluie"},{id:"temp",label:"Température",unit:"°C",color:"#FBAF05",cumul:!1,cumulsType:"temp"}],P:[{id:"pluie",label:"Pluie",unit:"mm",color:"#2E75B6",cumul:!0,cumulsType:"pluie"}],SMV:[{id:"pluie",label:"Pluie",unit:"mm",color:"#2E75B6",cumul:!0,cumulsType:"pluie"},{id:"temp",label:"Température",unit:"°C",color:"#FBAF05",cumul:!1,cumulsType:"temp"},{id:"humidite",label:"Humidité",unit:"%",color:"#5B12A4",cumul:!1}],TH:[{id:"temp",label:"Température",unit:"°C",color:"#FBAF05",cumul:!1,cumulsType:"temp"},{id:"humidite",label:"Humidité",unit:"%",color:"#5B12A4",cumul:!1}],T_MINI:[{id:"temp_sol",label:"Température sol",unit:"°C",color:"#795548",cumul:!1}],T_GEL:[{id:"tseche",label:"Température sèche",unit:"°C",color:"#23B19B",cumul:!1},{id:"thumide",label:"Température humide",unit:"°C",color:"#5E88EC",cumul:!1}],W:[{id:"vent",label:"Vent",unit:"km/h",color:"#616161",cumul:!1}],PYRANO:[{id:"rayonnement",label:"Rayonnement solaire",unit:"W/m²",color:"#CBCB0B",cumul:!1,cumulsType:"rayo"}],PAR:[{id:"par",label:"Rayonnement PAR",unit:"µmol/m²/s",color:"#4CBB17",cumul:!1}],LWS:[{id:"humectation",label:"Humectation foliaire",unit:"%",color:"#00887E",cumul:!1,cumulsType:"hws"}],"CHP-15/30":[{id:"pothydr",label:"Potentiel hydrique",unit:"kPa",color:"#A6C157",cumul:!1},{id:"temp_sol",label:"Température sol",unit:"°C",color:"#795548",cumul:!1}],"CHP-30/60":[{id:"pothydr",label:"Potentiel hydrique",unit:"kPa",color:"#A6C157",cumul:!1},{id:"temp_sol",label:"Température sol",unit:"°C",color:"#795548",cumul:!1}],"CHP-60/90":[{id:"pothydr",label:"Potentiel hydrique",unit:"kPa",color:"#A6C157",cumul:!1},{id:"temp_sol",label:"Température sol",unit:"°C",color:"#795548",cumul:!1}],"CAPA-30-3":[{id:"teneur",label:"Teneur en eau",unit:"%vol",color:"#ED9A2C",cumul:!1},{id:"temp_sol",label:"Température sol",unit:"°C",color:"#795548",cumul:!1}],"CAPA-60-6":[{id:"teneur",label:"Teneur en eau",unit:"%vol",color:"#ED9A2C",cumul:!1},{id:"temp_sol",label:"Température sol",unit:"°C",color:"#795548",cumul:!1}],EC:[{id:"teneur",label:"Teneur en eau",unit:"%vol",color:"#ED9A2C",cumul:!1},{id:"temp_sol",label:"Température sol",unit:"°C",color:"#795548",cumul:!1}]};function gn(e,i){const t={pluie:{base:2,amp:6,min:0,sparse:!0},temp:{base:15,amp:8,min:-5},humidite:{base:65,amp:20,min:20,max:100},pothydr:{base:80,amp:60,min:0,max:200},teneur:{base:30,amp:12,min:5,max:50},temp_sol:{base:14,amp:5,min:0,max:35},tseche:{base:14,amp:6,min:-5},thumide:{base:10,amp:5,min:-8},rayonnement:{base:350,amp:300,min:0,max:900},humectation:{base:20,amp:80,min:0,max:100,sparse:!0},vent:{base:15,amp:15,min:0,max:80},par:{base:900,amp:800,min:0,max:2e3}}[e]||{base:50,amp:20,min:0};return Array.from({length:i},(n,a)=>{const o=a/i*Math.PI*4;if(t.sparse&&Math.random()>.25)return 0;const s=t.base+t.amp*Math.sin(o-1)+(Math.random()-.5)*t.amp*.5;return Math.max(t.min??0,Math.min(t.max??9999,s))})}const yn={"365d":525600,"30d":43200,"7d":10080,hier:1440,"1d":1440,custom:10080};function Uo(e,i,t,n,a,o=20){const s=yn[e]||10080,l=new Date,m=u=>e==="1d"||e==="hier"?`${String(u.getHours()).padStart(2,"0")}h`:e==="365d"?u.toLocaleDateString("fr-FR",{month:"short"}):`${String(u.getDate()).padStart(2,"0")}/${String(u.getMonth()+1).padStart(2,"0")}`,d=4,p=i-t-n,v=a-o;return Array.from({length:d+1},(u,c)=>{const r=c/d,f=new Date(l.getTime()-(1-r)*s*6e4),b=(t+r*p).toFixed(1),w=c===0?"start":c===d?"end":"middle";return[`<line x1="${b}" y1="${v}" x2="${b}" y2="${v+4}" stroke="rgba(0,0,0,.2)" stroke-width="1"/>`,`<text x="${b}" y="${a-3}" text-anchor="${w}" font-size="9" fill="#8e8e93" font-family="-apple-system">${m(f)}</text>`].join("")}).join("")}function Go(e,i,t,n="7d",a=""){const o=xn[n]||60,s=gn(e,o),l=320,m=100,d=34,p=6,v=10,u=20,c=l-d-p,r=m-v-u,f=t?0:Math.min(...s),b=Math.max(...s,f+.001),w=b-f,h=$=>d+$/(s.length-1)*c,k=$=>v+r-($-f)/w*r,A=`g${Math.random().toString(36).slice(2,8)}`,j=[0,.5,1].map($=>{const g=f+$*w,x=v+r-$*r;return`<text x="${d-3}" y="${(x+3).toFixed(1)}" text-anchor="end" font-size="9" fill="#8e8e93" font-family="-apple-system">${g<10?g.toFixed(1):Math.round(g)}</text>`}).join(""),S=[.25,.5,.75].map($=>`<line x1="${d}" y1="${(v+r-$*r).toFixed(1)}" x2="${l-p}" y2="${(v+r-$*r).toFixed(1)}" stroke="rgba(0,0,0,.07)" stroke-width="1" stroke-dasharray="3,3"/>`).join(""),L=`<line x1="${d}" y1="${v+r}" x2="${l-p}" y2="${v+r}" stroke="rgba(0,0,0,.12)" stroke-width="1"/>`,B=Uo(n,l,d,p,m);if(t){const $=c/s.length*.7;return`<svg viewBox="0 0 ${l} ${m}" width="100%" height="${m}" preserveAspectRatio="none">
    ...
    <div class="m-sheet-input-group" style="display:flex;flex-direction:column;gap:10px">
      ...
      <div id="mbr-list-content" style="padding-bottom:32px"></div>`),F=P.querySelector("#mbr-list-content");function _(){var V;const E=T(),M=E.slice(0,y),O=E.length-M.length;F.innerHTML=`
        ...
        </div>`,F.querySelectorAll("[data-mbr-idx]").forEach(Q=>{Q.addEventListener("click",()=>B(+Q.dataset.mbrIdx,_))}),(V=F.querySelector("#mbr-load-more"))==null||V.addEventListener("click",()=>{y+=20,_()})}P.querySelector(".m-detail-back").addEventListener("click",he),P.querySelector("#mbr-invite-btn").addEventListener("click",I),P.querySelector("#mbr-search").addEventListener("input",E=>{g=E.target.value,y=20,_()}),_()}function C(){const g=Is();let x="";function y(){if(!x)return g;const _=x.toLowerCase();return g.filter(E=>E.numero.toLowerCase().includes(_)||E.statut.toLowerCase().includes(_)||String(E.montant).includes(_))}const T=$e(`
      <div class="m-detail-header">
        <div class="m-detail-topbar">
          <button class="m-detail-back"><i class="bi bi-chevron-left"></i><span>Mon exploitation</span></button>

import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css             */import{u as $}from"./breadcrumb-DEBQjfiD.js";import{m as v}from"./members-C_ssoUx1.js";import{o as f}from"./orgs-Cx4wNzLL.js";import{n as o}from"./network-YzWdS0n_.js";document.addEventListener("DOMContentLoaded",()=>{$(),L()});const c={plan:"Plus",anniversaire:"2022-03-15",numero:"CTR-2022-00418",licencesMembres:v.length,licencesAdherents:f.filter(e=>e.id!==100&&e.statut!=="inactif").length,licencesIntegrations:27,licencesTotal:v.length+f.filter(e=>e.id!==100&&e.statut!=="inactif").length},n={societe:o.nom,siret:o.siret,adresse:o.siege.adresse,cp:o.siege.codePostal,ville:o.siege.ville,pays:o.siege.pays};function L(){const e=document.getElementById("billing-page");if(!e)return;const l=S();e.innerHTML=`

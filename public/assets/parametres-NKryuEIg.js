      ...
      <div class="param-col">
        ...
        <div class="param-section">
          ...
          <div id="p-reseau-panel-independante" style="display:none">
            ...
            <div style="font-size:13px;color:var(--txt2);margin-bottom:14px">${v} réseaux proches de votre exploitation</div>

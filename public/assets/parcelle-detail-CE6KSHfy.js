import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css             */import{p as oe}from"./plots-DhtWL7s_.js";import{s as P}from"./sensors-CRadjF8G.js";import{o as Ve}from"./orgs-DnFmvGlp.js";import{m as ne}from"./members-Cr98hVG_.js";import{u as wt}from"./breadcrumb-CzFWtd6d.js";import{d as ae,c as xe}from"./store-c0FlIf2T.js";import{I as O,g as Wt,s as $t}from"./irrigations-C22Dtsoo.js";import{S as Vt,a as He,E as Gt,I as xt}from"./constants-CJpDUNiw.js";const Ct=new URLSearchParams(window.location.search),k=parseInt(Ct.get("id")),x=oe.find(e=>e.id===k);function $(e,t){return Math.floor(Math.random()*(t-e+1))+e}function D(e,t){return parseFloat((Math.random()*(t-e)+e).toFixed(2))}const Ge=[{id:"etp",name:"Évapotranspiration (ETP)",unit:"mm/j",color:"#7DBDD7",base:()=>D(.5,5),cumul:{label:"Cumul d'ETP",unit:"mm"},isCumul:!1,chartType:"bar"},{id:"rayonnement",name:"Rayonnement",unit:"W/m²",color:"#CBCB0B",base:()=>$(0,900),cumul:{label:"Énergie",unit:"Wh/m²"},isCumul:!1},{id:"temp_rosee",name:"Température de rosée",unit:"°C",color:"#72B0D8",base:()=>$(2,16),isCumul:!1}],Yt={id:"irrigation",name:"Irrigation",unit:"mm",color:"#FF8C00",base:()=>0,isCumul:!0,chartType:"bar",isIrrigation:!0},R={"P+":[{id:"pluie",name:"Pluie",unit:"mm",color:"#2E75B6",base:()=>$(0,8),cumul:{label:"Cumul de pluie",unit:"mm"},isCumul:!0,chartType:"bar"},{id:"temp",name:"Température",unit:"°C",color:"#FBAF05",base:()=>$(10,28),cumul:{label:"Cumul de degrés jour",unit:"°j"}},{id:"humidite",name:"Humidité",unit:"%",color:"#5B12A4",base:()=>$(40,90)}],PT:[{id:"pluie",name:"Pluie",unit:"mm",color:"#2E75B6",base:()=>$(0,8),cumul:{label:"Cumul de pluie",unit:"mm"},isCumul:!0,chartType:"bar"},{id:"temp",name:"Température",unit:"°C",color:"#FBAF05",base:()=>$(10,28),cumul:{label:"Cumul de degrés jour",unit:"°j"}},{id:"etp",name:"Évapotranspiration (ETP)",unit:"mm/j",color:"#7DBDD7",base:()=>D(.5,5),cumul:{label:"Cumul ETP",unit:"mm"},isCumul:!1,chartType:"bar"}],P:[{id:"pluie",name:"Pluie",unit:"mm",color:"#2E75B6",base:()=>$(0,8),cumul:{label:"Cumul de pluie",unit:"mm"},isCumul:!0,chartType:"bar"}],SMV:[{id:"pluie",name:"Pluie",unit:"mm",color:"#2E75B6",base:()=>$(0,8),cumul:{label:"Cumul de pluie",unit:"mm"},isCumul:!0,chartType:"bar"},{id:"temp",name:"Température",unit:"°C",color:"#FBAF05",base:()=>$(10,28),cumul:{label:"Cumul de degrés jour",unit:"°j"}},{id:"humidite",name:"Humidité",unit:"%",color:"#5B12A4",base:()=>$(40,90)},{id:"etp",name:"Évapotranspiration (ETP)",unit:"mm/j",color:"#7DBDD7",base:()=>D(.5,5),cumul:{label:"Cumul ETP",unit:"mm"},isCumul:!1,chartType:"bar"}],TH:[{id:"temp",name:"Température",unit:"°C",color:"#FBAF05",base:()=>$(10,28),cumul:{label:"Cumul de degrés jour",unit:"°j"}},{id:"humidite",name:"Humidité",unit:"%",color:"#5B12A4",base:()=>$(40,90)}],"CHP-15/30":[{id:"pothydr",name:"Potentiel hydrique",unit:"kPa",color:"#A6C157",base:()=>$(10,150)},{id:"tsol",name:"Température du sol",unit:"°C",color:"#795548",base:()=>$(8,22)}],"CHP-30/60":[{id:"pothydr",name:"Potentiel hydrique",unit:"kPa",color:"#A6C157",base:()=>$(10,150)},{id:"tsol",name:"Température du sol",unit:"°C",color:"#795548",base:()=>$(8,22)}],"CHP-60/90":[{id:"pothydr",name:"Potentiel hydrique",unit:"kPa",color:"#A6C157",base:()=>$(10,150)},{id:"tsol",name:"Température du sol",unit:"°C",color:"#795548",base:()=>$(8,22)}],"CAPA-30-3":[{id:"vwc10",name:"Teneur en eau du sol 10 cm",unit:"%vol",color:"#105200",base:()=>$(15,45)},{id:"vwc20",name:"Teneur en eau du sol 20 cm",unit:"%vol",color:"#8C5E82",base:()=>$(15,45)},{id:"vwc30",name:"Teneur en eau du sol 30 cm",unit:"%vol",color:"#46DA82",base:()=>$(15,45)},{id:"tsol",name:"Température du sol",unit:"°C",color:"#795548",base:()=>$(8,22)}],"CAPA-60-6":[{id:"vwc10",name:"Teneur en eau du sol 10 cm",unit:"%vol",color:"#105200",base:()=>$(15,45)},{id:"vwc20",name:"Teneur en eau du sol 20 cm",unit:"%vol",color:"#8C5E82",base:()=>$(15,45)},{id:"vwc30",name:"Teneur en eau du sol 30 cm",unit:"%vol",color:"#46DA82",base:()=>$(15,45)},{id:"vwc40",name:"Teneur en eau du sol 40 cm",unit:"%vol",color:"#949494",base:()=>$(17,43)},{id:"vwc50",name:"Teneur en eau du sol 50 cm",unit:"%vol",color:"#870021",base:()=>$(18,42)},{id:"vwc60",name:"Teneur en eau du sol 60 cm",unit:"%vol",color:"#F608C2",base:()=>$(18,42)},{id:"tsol",name:"Température du sol",unit:"°C",color:"#795548",base:()=>$(8,22)}],T_MINI:[{id:"tsol",name:"Température du sol",unit:"°C",color:"#795548",base:()=>$(8,22)}],LWS:[{id:"humec",name:"Humectation foliaire",unit:"h",color:"#00887E",base:()=>$(0,12)}],T_GEL:[{id:"tseche",name:"Temp. sèche",unit:"°C",color:"#23B19B",base:()=>$(-2,12)},{id:"thumide",name:"Temp. humide",unit:"°C",color:"#5E88EC",base:()=>$(-4,10)}],W:[{id:"_vent",name:"Vent",unit:"km/h · direction",color:"#7bc4b0",isWindComposite:!0,base:()=>$(0,40)}],EC:[{id:"ec",name:"Conductivité",unit:"mS/cm",color:"#f0a030",base:()=>D(.1,3)},{id:"tsol",name:"Température du sol",unit:"°C",color:"#bb8fce",base:()=>$(8,22)}],PYRANO:[{id:"rayonnement",name:"Rayonnement",unit:"W/m²",color:"#f5c842",base:()=>$(0,900),cumul:{label:"Énergie",unit:"Wh/m²"}}],PAR:[{id:"par",name:"Densité de flux de photons photosynthétiques",unit:"µmol/m²/s",color:"#c47a00",base:()=>$(0,2e3)}]},_=["CHP-15/30","CHP-30/60","CHP-60/90"],De=[{name:"Tensiomètre (CHP)",models:new Set(["CHP-15/30","CHP-30/60","CHP-60/90"])},{name:"Sonde capacitive (CAPA)",models:new Set(["CAPA-30-3","CAPA-60-6"])},{name:"Sonde fertirrigation (EC)",models:new Set(["EC"])},{name:"Thermomètre de sol (T_MINI)",models:new Set(["T_MINI"])}];function Oe(e){return De.find(t=>t.models.has(e))||null}const Jt={"CAPA-30-3":[{depth:10,label:"10 cm",vwcColor:"#105200",tsolColor:"#FFA040"},{depth:20,label:"20 cm",vwcColor:"#8C5E82",tsolColor:"#E07050"},{depth:30,label:"30 cm",vwcColor:"#46DA82",tsolColor:"#A04030"}],"CAPA-60-6":[{depth:10,label:"10 cm",vwcColor:"#105200",tsolColor:"#FFA040"},{depth:20,label:"20 cm",vwcColor:"#8C5E82",tsolColor:"#E07050"},{depth:30,label:"30 cm",vwcColor:"#46DA82",tsolColor:"#A04030"},{depth:40,label:"40 cm",vwcColor:"#949494",tsolColor:"#804828"},{depth:50,label:"50 cm",vwcColor:"#870021",tsolColor:"#603818"},{depth:60,label:"60 cm",vwcColor:"#F608C2",tsolColor:"#402810"}]},Ue=["CAPA-30-3","CAPA-60-6"],ee={"P+":"Station météo",PT:"Station météo",P:"Pluviomètre",SMV:"Station météo virtuelle",TH:"Thermomètre-hygromètre",T_MINI:"Thermomètre de sol",W:"Anémomètre",PYRANO:"Pyranomètre",PAR:"Capteur PAR",LWS:"Capteur d'humectation foliaire",T_GEL:"Capteur de gel","CHP-15/30":"Tensiomètre","CHP-30/60":"Tensiomètre","CHP-60/90":"Tensiomètre","CAPA-30-3":"Sonde capacitive","CAPA-60-6":"Sonde capacitive",EC:"Sonde de fertirrigation"};function Ut(e,t=null,i=null,n=null){const a=Math.max(2,Math.min(200,Math.floor(ve()/be()))),o=Array.from({length:a},()=>$(5,35)),c=o.map(E=>Math.min(E+$(3,18),80)),l=Array.from({length:a},()=>$(0,359)),u=600,r=200,v=46,s=16,d=16,m=28,p=u-v-s,h=r-d-m,f=Math.ceil(Math.max(...c)/10)*10||50,y=E=>v+E/Math.max(a-1,1)*p,b=E=>d+h-E/f*h,w=c.map((E,A)=>`${y(A).toFixed(1)},${b(E).toFixed(1)}`).join("L"),g=[...o].reverse().map((E,A)=>`${y(a-1-A).toFixed(1)},${b(E).toFixed(1)}`).join("L"),S=`M${w}L${g}Z`,M=o.map((E,A)=>`${A?"L":"M"}${y(A).toFixed(1)},${b(E).toFixed(1)}`).join(""),j=[.25,.5,.75].map(E=>{const A=(d+h-E*h).toFixed(1);return`<line x1="${v}" y1="${A}" x2="${u-s}" y2="${A}" stroke="rgba(0,0,0,.06)" stroke-width="1" stroke-dasharray="3,3"/>`}).join(""),I=[0,.5,1].map(E=>{const A=d+h-E*h;return`<text x="${v-4}" y="${(A+4).toFixed(1)}" text-anchor="end" font-size="10" fill="var(--txt3)">${Math.round(E*f)}</text>`}).join(""),B=`<line x1="${v}" y1="${d+h}" x2="${u-s}" y2="${d+h}" stroke="var(--bdr2)" stroke-width="1"/>`,H=Math.max(1,Math.floor(a/6));let F="";for(let E=0;E<a;E+=H){const A=(a-1-E)/Math.max(a-1,1)*ve();F+=`<text x="${y(E).toFixed(1)}" y="${(d+h+14).toFixed(1)}" text-anchor="middle" font-size="10" font-family="var(--font)" fill="var(--txt3)">${Me(A)}</text>`}const W=Math.max(1,Math.round(a/25)),Z=[];for(let E=0;E<a;E+=W){const A=y(E).toFixed(1),N=(d+h*.35).toFixed(1);Z.push(`<g transform="translate(${A},${N}) rotate(${l[E]})">
    ...
    <div class="add-modal-content" style="max-width:520px">
      ...
      ${ni.map(r=>{const v=r.items.filter(l);return v.length?`
        <div class="add-modal-section">
          ...
          <div class="wcat-list">
            ${v.map(s=>{const d=Xe[s],m=d&&n.includes(d);return`
              <div class="wcat-item">
                <span>${s}</span>
    ...
    </div>`,u.addEventListener("click",r=>{r.target===u&&u.remove()}),u.querySelector(".add-modal-close").addEventListener("click",()=>u.remove()),u.querySelectorAll(".wcat-add-btn").forEach(r=>{r.addEventListener("click",()=>{const v=r.dataset.wid;if(!v)return;const s=he();s.includes(v)||(s.push(v),fe(s)),u.remove(),ue()})}),document.body.appendChild(u)}const je=`weenat-journal-${k}`,se=new Date().toISOString().slice(0,10);function si(e,t){const i=new Date(e);return i.setDate(i.getDate()+t),i.toISOString().slice(0,10)}function Ne(e){const t=["jan.","fév.","mar.","avr.","mai","jun.","jul.","aoû.","sep.","oct.","nov.","déc."],[,i,n]=e.split("-");return`${parseInt(n)} ${t[parseInt(i)-1]} ${e.split("-")[0]}`}const oi=["Observation générale","Préparation du sol (labour)","Préparation du sol (strip-till)","Préparation du sol (sous-solage)","Fertilisation","Semis","Récolte","Stade phénologique","Passage de sangliers","Gestion de haie bocagère","Irrigation manuelle","Autre"];function ri(){const e=x,t=[],i=(l,u,r="Système")=>t.push({id:"auto-"+l+u.slice(0,8),type:"modification",date:l,texte:u,auteur:r}),n=e.orgId===1,a=n?"Jean-Michel Dutilleul":"Thomas Bertrand",o=n?"Alexandre Bernard":"Sophie Dubois";return i("2024-01-01","Création de la parcelle",a),e.crop&&i("2024-03-15",`Culture définie : ${e.crop}`,a),e.texture&&i("2024-03-15",`Texture de sol définie : ${e.texture}`,a),e.irrigation&&i("2024-04-01",`Type d'irrigation : ${e.irrigation}`,a),P.filter(l=>C.linkedSensorIds.includes(l.id)).forEach(l=>i("2024-06-10",`Liaison capteur : ${ee[l.model]||l.model} · ${l.serial}`,o)),i("2026-03-01","Début de cycle cultural 2026",a),t}const li=new Set(["culture","stade","irrigation","cycle"]),Ke=[["BBCH 21 — Tallage actif","BBCH 30 — Début montaison","BBCH 45 — Gonflement épis"],["BBCH 13 — 3 feuilles étalées","BBCH 31 — Début élongation","BBCH 59 — Fin de floraison"],["BBCH 09 — Levée","BBCH 40 — Développement des organes de récolte","BBCH 49 — Taille de récolte atteinte"],["BBCH 15 — 5 feuilles étalées","BBCH 51 — Apparition inflorescence","BBCH 69 — Fin de floraison"]],Ze=["Apache","RGT Bilboa","Soissons","Fixion","Forum","Allez-y"],Qe=["Mise en place de la saison 2026","Démarrage de la nouvelle campagne","Lancement de la saison sur cette parcelle"],et=["Développement homogène sur la parcelle","Légère hétérogénéité en bordure, sous surveillance","Bon développement, conforme aux attentes"];function tt(e,t){const i=x.crop||"Blé tendre",n=x.id%100,a=Ke[x.id%Ke.length],o=Ze[x.id%Ze.length],c=x.id%6;return[{id:17434656e5,type:"cycle",date:te("2026-03-01",c),auteur:e,action:"début",annee:"2026",texte:Qe[n%Qe.length]},{id:17438976e5,type:"culture",date:te("2026-03-06",c),auteur:e,action:"modification",culture:i,variete:o,texte:"Culture confirmée pour la saison 2026"},{id:17443296e5,type:"stade",date:te("2026-04-11",c),auteur:e,stade:a[0],culture:i,texte:""},{id:17453664e5,type:"stade",date:te("2026-04-23",c),auteur:t,stade:a[1],culture:i,texte:""},{id:17460576e5,type:"stade",date:te("2026-05-01",c),auteur:t,stade:a[2],culture:i,texte:et[n%et.length]}]}function te(e,t){const i=new Date(e+"T00:00:00");return i.setDate(i.getDate()+t),i.toISOString().slice(0,10)}function ci(e){return O.filter(t=>t.plotId===e&&t.real).map(t=>({id:`auto-irrig-${e}-${t.iso}-${t.mm}`,type:"irrigation",date:t.iso,volume:t.mm,unite:"mm",methode:x.irrigation||"",texte:"Irrigation effectuée.",auteur:"Système",_auto:!0}))}function $e(){const e=x.orgId===1,t=e?"Jean-Michel Dutilleul":"Thomas Bertrand",i=e?"Marie Martin":"Sophie Dubois";try{const u=localStorage.getItem(je);if(u){const r=JSON.parse(u);if(Array.isArray(r)){if(!r.some(s=>li.has(s.type))){const s=[...tt(t,i),...r];return localStorage.setItem(je,JSON.stringify(s)),s}return r}}}catch{}const n=[{cible:"Pucerons",produit:"Karate Zeon 10 CS",dose:"0,1 L/ha",obs1:"Observation de quelques pucerons sur les feuilles basses. À surveiller.",obs2:"peu de pucerons visibles, situation sous contrôle."},{cible:"Mildiou",produit:"Bordeaux mixture",dose:"2 kg/ha",obs1:"Taches suspectes observées sur les feuilles basses, conditions humides.",obs2:"progression stoppée, feuillage sain."},{cible:"Limaces",produit:"Métaldéhyde",dose:"5 kg/ha",obs1:"Dégâts de limaces constatés en bordure de parcelle après les pluies.",obs2:"dégâts limités, population réduite."},{cible:"Altises",produit:"Karaté K",dose:"75 mL/ha",obs1:"Présence d'altises sur jeunes plants, seuil de nuisibilité approché.",obs2:"population sous contrôle, reprise normale."}],a=x.id%n.length,o=n[a],c=x.id%6,l=[{id:17469216e5,type:"note",category:"Observation générale",date:te("2026-05-11",c),auteur:t,texte:o.obs1},{id:17473536e5,type:"traitement",date:te("2026-05-16",c),auteur:i,texte:"Application conforme aux conditions météo. Vent < 2 m/s.",produit:o.produit,dose:o.dose,cible:o.cible},{id:17477856e5,type:"note",category:"Observation générale",date:te("2026-05-21",c),auteur:t,texte:`Suite traitement du ${te("2026-05-16",c).split("-").reverse().slice(0,2).join("/")} : ${o.obs2}`},...tt(t,i)];return localStorage.setItem(je,JSON.stringify(l)),l}function St(e){localStorage.setItem(je,JSON.stringify(e))}function Ye(){const e=document.getElementById("journal-container");if(!e)return;const t=$e(),i=[...ri(),...ci(k)],n=[...t,...i].sort((s,d)=>d.date.localeCompare(s.date)),a=s=>{const[d,m,p]=s.split("-");return`${p}/${m}/${d}`},o={note:{label:"Note",icon:"bi-pencil",dotCls:"note",badgeCls:"note"},traitement:{label:"Traitement",icon:"bi-eyedropper",dotCls:"traitement",badgeCls:"traitement"},modification:{label:"Modification",icon:"bi-pencil-square",dotCls:"modification",badgeCls:"modification"},culture:{label:"Culture",icon:"bi-flower1",dotCls:"culture",badgeCls:"culture"},cycle:{label:"Cycle cultural",icon:"bi-arrow-repeat",dotCls:"cycle",badgeCls:"cycle"},stade:{label:"Stade phéno.",icon:"bi-calendar2-check",dotCls:"stade",badgeCls:"stade"},irrigation:{label:"Irrigation",icon:"bi-droplet-half",dotCls:"irrigation",badgeCls:"irrigation"}};let l=`
  ...
  `;n.length===0?l+='<div class="journal-empty">Aucune entrée dans le journal.</div>':n.forEach(s=>{var h;const d=o[s.type]||o.note,m=s.type==="modification"||s._auto===!0,p=s.type==="traitement";l+=`
    ...
    <div class="add-modal-content" style="max-width:480px">
    ...
    </div>`,o.querySelector(".add-modal-close").addEventListener("click",()=>o.remove()),o.addEventListener("click",l=>{l.target===o&&o.remove()});const c=[];a&&window.ImageStore&&window.setupImgUpload(o.querySelector("#jrn-f-img-input"),o.querySelector("#jrn-f-img-btn"),o.querySelector("#jrn-f-previews"),o.querySelector("#jrn-f-img-err"),c),o.querySelector("#jrn-f-save").addEventListener("click",async()=>{var d,m;const l=o.querySelector("#jrn-f-date").value||se,u=((d=o.querySelector("#jrn-f-texte"))==null?void 0:d.value.trim())||"",r=x.orgId===1?"Jean-Michel Dutilleul":"Thomas Bertrand",v={id:Date.now(),type:e,date:l,texte:u,auteur:r};if(e==="note")v.category=((m=o.querySelector("#jrn-f-category"))==null?void 0:m.value)||"";else if(e==="traitement")v.produit=o.querySelector("#jrn-f-produit").value.trim(),v.dose=o.querySelector("#jrn-f-dose").value.trim(),v.cible=o.querySelector("#jrn-f-cible").value.trim();else if(e==="culture")v.action=o.querySelector("#jrn-f-action").value,v.culture=o.querySelector("#jrn-f-culture").value.trim(),v.variete=o.querySelector("#jrn-f-variete").value.trim();else if(e==="stade")v.stade=o.querySelector("#jrn-f-stade").value.trim(),v.culture=o.querySelector("#jrn-f-culture").value.trim();else if(e==="irrigation"){const p=parseFloat(o.querySelector("#jrn-f-volume").value);v.volume=isNaN(p)?0:p,v.unite=o.querySelector("#jrn-f-unite").value,v.methode=o.querySelector("#jrn-f-methode").value}else e==="cycle"&&(v.action=o.querySelector("#jrn-f-action").value,v.annee=o.querySelector("#jrn-f-annee").value.trim());if(u||v.produit||v.culture||v.stade||v.volume||v.annee||c.length){if(window.ImageStore&&c.length){v.imageIds=[];for(const p of c){const h=`img_${v.id}_${v.imageIds.length}`;await window.ImageStore.store(h,p),v.imageIds.push(h)}}St([v,...$e()]),o.remove(),Ye()}}),document.body.appendChild(o)}function ui(){const e=document.getElementById("breadcrumb-title");if(!e)return;const t=e.querySelector("span:last-child");if(!t)return;const i=oe.filter(o=>o.orgId===x.orgId).sort((o,c)=>o.name.localeCompare(c.name,"fr")),n=document.createElement("span");n.className="breadcrumb-nav-wrap";const a=document.createElement("select");a.className="breadcrumb-nav-select",a.innerHTML=i.map(o=>`<option value="${o.id}"${o.id===k?" selected":""}>${o.name}</option>`).join(""),a.addEventListener("change",()=>{window.location.href=`parcelle-detail.html?id=${a.value}`}),n.appendChild(a),t.replaceWith(n)}document.addEventListener("DOMContentLoaded",()=>{var i,n,a;if(!x){document.body.innerHTML='<div style="padding:40px"><h1>Parcelle non trouvée</h1></div>';return}Kt(),wt(C.name||x.name,{label:"Parcelles",href:"parcelles.html"}),ui(),U(),Oi(),Ui(),Xi(),Ti(),Di(),Ki();const e=Ct.get("tab");e&&((i=document.querySelector(`.detail-tab-btn[data-pane="tab-${e}"]`))==null||i.click()),Hi(),qi(),ue(),(n=document.getElementById("parcel-add-widget-btn"))==null||n.addEventListener("click",ai),(a=document.getElementById("btn-export-csv"))==null||a.addEventListener("click",Ji),document.addEventListener("click",o=>{const c=o.target.closest(".chart-cumul-add-btn");if(!c)return;o.stopPropagation();const l=c.dataset.cumulLabel,u=c.dataset.cumulVal;if(!confirm(`Ajouter "${l} : ${u}" au tableau de bord ?`))return;const r=document.createElement("div");r.textContent="Cumul ajouté au tableau de bord",Object.assign(r.style,{position:"fixed",bottom:"80px",left:"50%",transform:"translateX(-50%)",background:"rgba(28,28,30,.9)",color:"#fff",padding:"8px 16px",borderRadius:"8px",fontSize:"13px",zIndex:"9999",pointerEvents:"none"}),document.body.appendChild(r),setTimeout(()=>r.remove(),2500)});const t=document.getElementById("sidebar");t&&new MutationObserver(()=>ce()).observe(t,{attributes:!0,attributeFilter:["data-role"]})});let ke="capteur",G=null;const Mt=`charts-order-parcel-${k}`;function mi(){try{return JSON.parse(localStorage.getItem(Mt)||"null")}catch{return null}}function pi(e){localStorage.setItem(Mt,JSON.stringify(e))}function vi(e){let t=null;e.addEventListener("dragstart",i=>{const n=i.target.closest(".chart-card[data-card-key]");n&&(t=n,n.classList.add("chart-dragging"),i.dataTransfer.effectAllowed="move")}),e.addEventListener("dragend",()=>{t==null||t.classList.remove("chart-dragging"),e.querySelectorAll(".chart-card").forEach(n=>n.classList.remove("chart-drag-over")),t=null;const i=[...e.querySelectorAll(".chart-card[data-card-key]")].map(n=>n.dataset.cardKey);pi(i)}),e.addEventListener("dragover",i=>{if(i.preventDefault(),!t)return;const n=i.target.closest(".chart-card[data-card-key]");if(!n||n===t)return;e.querySelectorAll(".chart-card").forEach(o=>o.classList.remove("chart-drag-over")),n.classList.add("chart-drag-over");const a=n.getBoundingClientRect().top+n.getBoundingClientRect().height/2;e.insertBefore(t,i.clientY<a?n:n.nextSibling)}),e.addEventListener("drop",i=>{i.preventDefault(),e.querySelectorAll(".chart-card").forEach(n=>n.classList.remove("chart-drag-over"))})}function hi(e,t){const i=P.filter(s=>t.includes(s.id)),n=i.filter(s=>_.includes(s.model)),a=i.filter(s=>Ue.includes(s.model)),o=i.filter(s=>!_.includes(s.model)&&!Ue.includes(s.model)),c=be(),l=new Set;i.forEach(s=>(R[s.model]||[]).forEach(d=>l.add(d.id)));const u=[];if(o.forEach(s=>{const d=R[s.model];if(!d)return;const m=`${s.model} · ${s.serial}`,p=Math.floor(5+Math.random()*55);d.forEach(h=>{if(h.isWindComposite){u.push({key:`wind-${s.id}`,type:"wind",sensor:s,source:m,emissionMins:p});return}u.push({key:`s${s.id}-${h.id}`,type:"metric",metric:h,source:m,emissionMins:p,sensorId:s.id})})}),n.length>0){const s=`Tensiomètres · ${n.length} capteur${n.length>1?"s":""}`,d=Math.floor(5+Math.random()*55);["pothydr","tsol"].forEach(m=>{u.push({key:`tensio-${m}`,type:"tensio",metricId:m,source:s,emissionMins:d,tensioSensors:n})})}a.forEach(s=>{const d=Jt[s.model]||[],m=`${ee[s.model]||s.model} · ${s.serial}`,p=Math.floor(5+Math.random()*55);d.length>0&&(u.push({key:`capa-vwc-${s.id}`,type:"capa-vwc",sensor:s,horizons:d,source:m,emissionMins:p}),u.push({key:`capa-tsol-${s.id}`,type:"capa-tsol",sensor:s,horizons:d,source:m,emissionMins:p}))}),Ge.filter(s=>!l.has(s.id)).forEach(s=>u.push({key:`always-${s.id}`,type:"metric",metric:s,source:"parcelle",emissionMins:null,unavailable:c<60})),(!!x.irrigation&&x.irrigation!=="Non irrigué"||O.some(s=>s.plotId===k))&&u.push({key:"always-irrigation",type:"metric",metric:Yt,source:"parcelle",emissionMins:null});const v=mi();if(v!=null&&v.length){const s=new Map(v.map((d,m)=>[d,m]));u.sort((d,m)=>(s.has(d.key)?s.get(d.key):1/0)-(s.has(m.key)?s.get(m.key):1/0))}u.forEach(s=>{s.type==="metric"?ze(e,s.metric,s.source,s.emissionMins,s.key,s.unavailable,s.sensorId):s.type==="wind"?Ut(e,s.source,s.emissionMins,s.key):s.type==="tensio"?gi(e,s.metricId,s.tensioSensors,s.source,s.emissionMins,s.key):s.type==="capa-vwc"?yi(e,s.horizons,s.source,s.emissionMins,s.key):s.type==="capa-tsol"&&wi(e,s.horizons,s.source,s.emissionMins,s.key)}),vi(e)}function Ie(e){const t=P.filter(a=>e.includes(a.id)),i=new Set,n=[];return t.forEach(a=>{(R[a.model]||[]).forEach(o=>{i.has(o.id)||(i.add(o.id),n.push(o))})}),Ge.forEach(a=>{i.has(a.id)||(i.add(a.id),n.push(a))}),n}function U(){var t;const e=document.getElementById("charts-container");if(e.innerHTML="",G){e.className="compare-rows";const i=oe.find(p=>p.id===G),n=document.createElement("div");n.className="compare-header-row",n.innerHTML=`
      <div class="compare-col-header"><span>${C.name||x.name}</span></div>
      ...
      </div>`,e.appendChild(n),(t=n.querySelector(".compare-close-btn"))==null||t.addEventListener("click",()=>{G=null,Le(),U()});const a=Ie(C.linkedSensorIds),o=xe(G),c=(o==null?void 0:o.linkedSensorIds)??P.filter(p=>p.parcelIds.includes(G)).map(p=>p.id),l=Ie(c),u=a.map(p=>p.id),r=l.map(p=>p.id),v=u.filter(p=>r.includes(p)),s=u.filter(p=>!r.includes(p)),d=r.filter(p=>!u.includes(p));[...v,...s,...d].forEach(p=>{const h=a.find(g=>g.id===p),f=l.find(g=>g.id===p),y=document.createElement("div");y.className="compare-row";const b=document.createElement("div");h?ze(b,h):b.innerHTML='<div class="compare-chart-empty">—</div>';const w=document.createElement("div");f?ze(w,f):w.innerHTML='<div class="compare-chart-empty">—</div>',y.appendChild(b),y.appendChild(w),e.appendChild(y)})}else e.className="charts-stack",hi(e,C.linkedSensorIds);Ei()}const we=["#5b8dd9","#e07050","#4ecdc4","#f5c842","#c090e0","#78d8a0"];function fi(e){const t=e.depth||30;return[{depth:t,label:`${t} cm`,sensor:e}]}function bi(e){if(ke==="capteur")return e.map((i,n)=>({label:i.serial,color:we[n%we.length],depth:i.depth||30,sensor:i}));const t=new Map;return e.forEach(i=>fi(i).forEach(n=>{t.has(n.depth)||t.set(n.depth,n)})),[...t.values()].sort((i,n)=>i.depth-n.depth).map((i,n)=>({label:i.label,color:we[n%we.length],depth:i.depth,sensor:i.sensor}))}function gi(e,t,i,n=null,a=null,o=null){var p;const l={pothydr:{name:"Potentiel hydrique",unit:"kPa"},tsol:{name:"Température du sol",unit:"°C"}}[t],u=bi(i),r=document.createElement("div");r.className="chart-card tensio-multi-card",r.dataset.tensioMetric=t,r.dataset.tensioCurves=JSON.stringify(u.map(h=>({depth:h.depth,color:h.color}))),o&&(r.dataset.cardKey=o,r.draggable=!0);const v=u.map(h=>`<span style="display:inline-flex;align-items:center;gap:4px;font-size:11px;color:var(--txt2)">
  ...
  `,e.appendChild(u),u}function yi(e,t,i=null,n=null,a=null){Et(e,t,"vwcColor","Teneur en eau du sol","%vol","capa-svg","capa",a)}function wi(e,t,i=null,n=null,a=null){Et(e,t,"tsolColor","Température du sol par horizon","°C","capa-tsol-svg","capaT",a)}function ze(e,t,i=null,n=null,a=null,o=!1,c=null){var p;const l=t.base(),u=document.createElement("div");u.className="chart-card",u.dataset.base=l,u.dataset.color=t.color,u.dataset.cumul=t.isCumul?"1":"",u.dataset.chartType=t.chartType||"line",u.dataset.metricId=t.id,u.dataset.metricName=t.name,u.dataset.metricUnit=t.unit,t.isIrrigation&&(u.dataset.isIrrigation="1"),a&&(u.dataset.cardKey=a,u.draggable=!0);const r=t.cumul?`<div class="chart-cumul"><span class="chart-cumul-label">${t.cumul.label} : <strong>${st(t)} ${t.cumul.unit}</strong></span><button class="chart-cumul-add-btn" data-cumul-label="${t.cumul.label}" data-cumul-val="${st(t)} ${t.cumul.unit}" title="Ajouter au tableau de bord"><i class="bi bi-house"></i></button></div>`:"",v=i?`<span class="chart-card-source">${i}</span>`:"",s=n!=null?`<span class="chart-card-emission">il y a ${n} min</span>`:"";let d="";if(c){const h=((p=document.getElementById("time-step"))==null?void 0:p.value)||"1h";d=`<a class="chart-card-expand" href="capteur-graphique.html?sensorId=${c}&metricId=${t.id}&parcelId=${k}&period=${J}&step=${h}" title="Graphique plein écran"><i class="bi bi-fullscreen"></i></a>`}const m=o?'<div class="chart-unavailable">Données indisponibles pour ce pas de temps</div>':'<svg class="chart-svg" width="100%" height="180" viewBox="0 0 600 180" preserveAspectRatio="none"></svg>';u.innerHTML=`
    <div class="chart-card-header">
    ...
    ${m}
    ${r}
  `,e.appendChild(u)}let ye=null;function $i(){return ye||(ye=document.createElement("div"),ye.className="chart-tooltip",document.body.appendChild(ye)),ye}function xi(e,t){return t==="temp"||t==="temperature"?["#6eb4d4","#e07050"]:t==="tseche"||t==="thumide"?["#6eb4d4","#e07050"]:t==="temp_rosee"?["#a0d0f0","#4090c0"]:[Ci(e,.55),e]}function Ci(e,t){const i=parseInt(e.slice(1,3),16),n=parseInt(e.slice(3,5),16),a=parseInt(e.slice(5,7),16),o=Math.round(i+(255-i)*t),c=Math.round(n+(255-n)*t),l=Math.round(a+(255-a)*t);return`#${o.toString(16).padStart(2,"0")}${c.toString(16).padStart(2,"0")}${l.toString(16).padStart(2,"0")}`}function Te(e){if(e.length<2)return"";if(e.length===2)return`M${e[0].x},${e[0].y} L${e[1].x},${e[1].y}`;let t=`M${e[0].x.toFixed(1)},${e[0].y.toFixed(1)}`;for(let i=0;i<e.length-1;i++){const n=e[Math.max(i-1,0)],a=e[i],o=e[i+1],c=e[Math.min(i+2,e.length-1)],l=a.x+(o.x-n.x)/6,u=a.y+(o.y-n.y)/6,r=o.x-(c.x-a.x)/6,v=o.y-(c.y-a.y)/6;t+=` C${l.toFixed(1)},${u.toFixed(1)} ${r.toFixed(1)},${v.toFixed(1)} ${o.x.toFixed(1)},${o.y.toFixed(1)}`}return t}function Me(e){const t=new Date(Date.now()-e*6e4);return e<1440?`${String(t.getHours()).padStart(2,"0")}h`:e>=43200?["jan","fév","mar","avr","mai","juin","juil","aoû","sep","oct","nov","déc"][t.getMonth()]:`${String(t.getDate()).padStart(2,"0")}/${String(t.getMonth()+1).padStart(2,"0")}`}function it(e){const t=Date.now()-e*6e4;return new Date(t).getHours()+new Date(t).getMinutes()/60}function Si(e){return Math.max(0,Math.sin(Math.PI*(e-6)/12))}function nt(e){return .5+.5*Math.sin(2*Math.PI*(e-4)/24-Math.PI/2)}function Mi(e){const t=Math.floor((Date.now()-e*6e4)/864e5),i=Math.sin(t*12.9898+78.233)*43758.5453;return i-Math.floor(i)}function de(e,t,i,n=.15){const a=it(i),o=nt(a),c=Si(a),l=Mi(i),u=()=>1+(Math.random()-.5)*2*n;switch(e){case"temp":{const r=.6+l*.8;return(t-6+o*12*r)*u()}case"tseche":case"thumide":{const r=.6+l*.8;return(t-4+o*8*r)*u()}case"temp_rosee":{const r=.6+l*.8,v=t-6+o*12*r;return Math.min(v-1,t-8+o*6*r)*u()}case"tsol":{const r=it(i+120),v=.7+l*.6;return(t-3+nt(r)*6*v)*u()}case"humidite":{const r=1.4-l*.8;return Math.min(100,Math.max(20,(t+(1-o)*25*r-o*15)*u()))}case"rayonnement":{const r=.4+l*.9;return Math.max(0,c*t*1.3*r*u())}case"etp":{const r=.4+l*.9;return Math.max(0,c*t*1.5*r*u())}case"humec":{const r=1.4-l*.8;return Math.max(0,t*Math.max(0,.8-c*1.2)*r*u())}case"pluie":{const r=.06+(1-l)*.22;return Math.random()<r?t*Math.random()*2.5*(1.3-l):0}case"vent":case"rafales":{const r=.5+l;return Math.max(0,t*(.6+c*.8)*r*u())}default:return Math.max(0,t*u())}}function Ei(){const e=ti(),t=be(),i=ii();P.filter(a=>C.linkedSensorIds.includes(a.id)).filter(a=>_.includes(a.model)),document.querySelectorAll(".chart-card").forEach(a=>{if(a.classList.contains("tensio-multi-card")){const m=a.querySelector(".tensio-svg"),p=JSON.parse(a.dataset.tensioCurves||"[]");m&&p.length>0&&Bi(m,p,e,t);return}if(a.classList.contains("capa-multi-card")){const m=a.querySelector(".capa-svg"),p=JSON.parse(a.dataset.capaCurves||"[]");m&&p.length>0&&at(m,p,e,t,"vwc");return}if(a.classList.contains("capaT-multi-card")){const m=a.querySelector(".capa-tsol-svg"),p=JSON.parse(a.dataset.capaTCurves||"[]");m&&p.length>0&&at(m,p,e,t,"tsol");return}const o=a.querySelector(".chart-svg");if(!o)return;const c=parseFloat(a.dataset.base),l=a.dataset.color,u=a.dataset.cumul==="1",r=a.dataset.chartType||"line",v=a.dataset.metricId||"",s=a.dataset.metricName||"",d=a.dataset.metricUnit||"";if(a.dataset.isIrrigation)Ii(o,l,e,t,i);else{const m=i>0&&Zt.has(v);ji(o,c,l,e,t,u,r,v,s,d,i,m)}}),Bt(),jt()}function Bi(e,t,i,n){const c={t:14,r:10,b:28,l:46},l=600-c.l-c.r,u=180-c.t-c.b,r=t.map(w=>{const g=20+w.depth*.8+Math.random()*20;return Array.from({length:i},(S,M)=>{const j=(i-1-M)*n;return Math.max(0,de("pothydr",g,j))})}),v=r.flat(),s=Math.min(...v),d=Math.max(...v),m=d-s||1,p=w=>c.l+w/Math.max(i-1,1)*l,h=w=>c.t+u-(w-s)/m*u,f=`tc-${Math.random().toString(36).slice(2)}`;let y=`<defs><clipPath id="${f}"><rect x="${c.l}" y="${c.t}" width="${l}" height="${u}"/></clipPath></defs>`;for(let w=0;w<=4;w++){const g=c.t+w/4*u,S=d-w/4*m;y+=`<line x1="${c.l}" y1="${g.toFixed(1)}" x2="${600-c.r}" y2="${g.toFixed(1)}" stroke="var(--bdr2)" stroke-width="1"/>`,y+=`<text x="${c.l-5}" y="${(g+4).toFixed(1)}" text-anchor="end" font-size="10" font-family="var(--font)" fill="var(--txt3)">${S.toFixed(0)}</text>`}r.forEach((w,g)=>{const S=w.map((j,I)=>({x:p(I),y:h(j)})),M=Te(S);y+=`<path d="${M}" fill="none" stroke="${t[g].color}" stroke-width="2" stroke-linecap="round" clip-path="url(#${f})"/>`}),y+=`<line x1="${c.l}" y1="${c.t+u}" x2="${600-c.r}" y2="${c.t+u}" stroke="var(--bdr2)" stroke-width="1"/>`;const b=Math.max(1,Math.floor(i/6));for(let w=0;w<i;w+=b){const g=(i-1-w)*n;y+=`<text x="${p(w).toFixed(1)}" y="${(c.t+u+14).toFixed(1)}" text-anchor="middle" font-size="10" font-family="var(--font)" fill="var(--txt3)">${Me(g)}</text>`}e.innerHTML=y}function at(e,t,i,n,a="vwc"){const l={t:14,r:10,b:28,l:46},u=600-l.l-l.r,r=180-l.t-l.b,v=t.map((g,S)=>{if(a==="tsol"){const j=16-g.depth*.06+S*.5+Math.random()*3;return Array.from({length:i},(I,B)=>{const H=(i-1-B)*n;return de("tsol",j,H)})}const M=35-g.depth*.15+S*2+Math.random()*8;return Array.from({length:i},(j,I)=>{const B=(i-1-I)*n;return Math.max(10,Math.min(55,de("teneur-eau",M,B)))})}),s=v.flat(),d=Math.floor(Math.min(...s)-2),m=Math.ceil(Math.max(...s)+2),p=m-d||1,h=g=>l.l+g/Math.max(i-1,1)*u,f=g=>l.t+r-(g-d)/p*r,y=`cc-${Math.random().toString(36).slice(2)}`;let b=`<defs><clipPath id="${y}"><rect x="${l.l}" y="${l.t}" width="${u}" height="${r}"/></clipPath></defs>`;for(let g=0;g<=4;g++){const S=l.t+g/4*r,M=m-g/4*p;b+=`<line x1="${l.l}" y1="${S.toFixed(1)}" x2="${600-l.r}" y2="${S.toFixed(1)}" stroke="var(--bdr2)" stroke-width="1"/>`,b+=`<text x="${l.l-5}" y="${(S+4).toFixed(1)}" text-anchor="end" font-size="10" font-family="var(--font)" fill="var(--txt3)">${M.toFixed(0)}</text>`}v.forEach((g,S)=>{const M=g.map((I,B)=>({x:h(B),y:f(I)})),j=Te(M);b+=`<path d="${j}" fill="none" stroke="${t[S].color}" stroke-width="2" stroke-linecap="round" clip-path="url(#${y})"/>`}),b+=`<line x1="${l.l}" y1="${l.t+r}" x2="${600-l.r}" y2="${l.t+r}" stroke="var(--bdr2)" stroke-width="1"/>`;const w=Math.max(1,Math.floor(i/6));for(let g=0;g<i;g+=w){const S=(i-1-g)*n;b+=`<text x="${h(g).toFixed(1)}" y="${(l.t+r+14).toFixed(1)}" text-anchor="middle" font-size="10" font-family="var(--font)" fill="var(--txt3)">${Me(S)}</text>`}e.innerHTML=b}function ji(e,t,i,n,a,o,c="line",l="",u="",r="",v=0,s=!1){const p={t:14,r:10,b:28,l:46},h=600-p.l-p.r,f=180-p.t-p.b,y=n+v,b=s?v:0,w=n+b,g=Math.max(1,Math.round(a/15)),S=Array.from({length:w},(T,E)=>{const A=(n-1-E)*a;if(o){let N=0;for(let V=0;V<g;V++)N+=de(l,t/g,A+V*(a/g));return N}else if(g>1){let N=0;for(let V=0;V<g;V++)N+=de(l,t,A+V*(a/g));return N/g}else return de(l,t,A)}),M=c==="bar"?0:Math.min(...S),j=Math.max(...S),I=j-M||1,B=T=>p.l+T/Math.max(y-1,1)*h,H=T=>p.t+f-(T-M)/I*f,F=`grad_${Math.random().toString(36).slice(2)}`,[W,Z]=xi(i,l);let q=`<defs>
    ...
    <clipPath id="clip_${F}">
  ...
  </defs>`;if(v>0){const T=B(n-.5),E=`stripe_${F}`;q+=`<defs><pattern id="${E}" width="8" height="8" patternUnits="userSpaceOnUse" patternTransform="rotate(45)">
      ...
      <text x="${(600-p.r-4).toFixed(1)}" y="${(p.t+12).toFixed(1)}" text-anchor="end" font-size="10" font-family="var(--font)" fill="var(--txt3)" font-style="italic">Prévisions</text>`}for(let T=0;T<=4;T++){const E=p.t+T/4*f,A=j-T/4*I,N=Math.abs(A)>=100?A.toFixed(0):Math.abs(A)>=10?A.toFixed(1):A.toFixed(2);q+=`<line x1="${p.l}" y1="${E.toFixed(1)}" x2="${600-p.r}" y2="${E.toFixed(1)}" stroke="var(--bdr2)" stroke-width="1"/>`,q+=`<text x="${p.l-5}" y="${(E+4).toFixed(1)}" text-anchor="end" font-size="10" font-family="var(--font)" fill="var(--txt3)">${N}</text>`}q+=`<line x1="${p.l}" y1="${p.t+f}" x2="${600-p.r}" y2="${p.t+f}" stroke="var(--bdr2)" stroke-width="1"/>`;const ge=Math.max(1,Math.floor(y/6));for(let T=0;T<y;T+=ge){const E=B(T).toFixed(1),A=(n-T)*a;q+=`<line x1="${E}" y1="${p.t}" x2="${E}" y2="${p.t+f}" stroke="var(--bdr2)" stroke-width="1" stroke-dasharray="3,3"/>`,q+=`<text x="${E}" y="${p.t+f+14}" text-anchor="middle" font-size="10" font-family="var(--font)" fill="var(--txt3)">${Me(A)}</text>`}if(c==="bar"){const T=Math.max(2,h/y*.65);S.forEach((E,A)=>{if(E<=0)return;const N=A>=n,V=B(A),Ee=H(E),Pe=p.t+f-Ee;q+=`<rect x="${(V-T/2).toFixed(1)}" y="${Ee.toFixed(1)}" width="${T.toFixed(1)}" height="${Pe.toFixed(1)}" fill="${N?"#C7C7CC":`url(#${F})`}" opacity="${N?"0.5":"0.9"}" rx="1"/>`})}else{const T=S.slice(0,n).map((N,V)=>({x:B(V),y:H(N)})),E=Te(T),A=E+` L${B(n-1).toFixed(1)},${p.t+f} L${p.l.toFixed(1)},${p.t+f} Z`;if(q+=`<path d="${A}" fill="${Z}" opacity="0.07" clip-path="url(#clip_${F})"/>`,q+=`<path d="${E}" fill="none" stroke="url(#${F})" stroke-width="2" stroke-linejoin="round" stroke-linecap="round" clip-path="url(#clip_${F})"/>`,b>0){const N=S.slice(n-1).map((Ee,Pe)=>({x:B(n-1+Pe),y:H(Ee)})),V=Te(N);q+=`<path d="${V}" fill="none" stroke="url(#${F})" stroke-width="2" stroke-dasharray="5,4" stroke-linejoin="round" stroke-linecap="round" opacity="0.5" clip-path="url(#clip_${F})"/>`}}q+=`<rect class="chart-hover-rect" x="${p.l}" y="${p.t}" width="${h}" height="${f}" fill="transparent" style="cursor:crosshair"/>`,e.innerHTML=q,ki(e,S,B,H,M,j,y,n,a,u,r,i,p,600)}function ki(e,t,i,n,a,o,c,l,u,r,v,s,d,m,p){const h=$i(),f=e.querySelector(".chart-hover-rect");if(!f)return;const b=document.createElementNS("http://www.w3.org/2000/svg","circle");b.setAttribute("r","4"),b.setAttribute("fill",s),b.setAttribute("stroke","#fff"),b.setAttribute("stroke-width","1.5"),b.style.display="none",b.style.pointerEvents="none",e.appendChild(b),f.addEventListener("mousemove",w=>{const g=e.getBoundingClientRect(),S=m/g.width,M=(w.clientX-g.left)*S,j=m-d.l-d.r,I=Math.max(0,Math.min(1,(M-d.l)/j)),B=Math.round(I*(c-1));if(B<0||B>=t.length)return;const H=t[B],F=i(B),W=n(H);b.setAttribute("cx",F),b.setAttribute("cy",W),b.style.display="";const Z=(l-B)*u,q=Me(Z),ge=Math.abs(H)>=100?H.toFixed(1):H.toFixed(2);h.innerHTML=`
      <div style="font-size:11px;color:var(--txt3);margin-bottom:2px">${r}</div>
      <div class="chart-tooltip-val" style="color:${s}">${ge} <span style="font-size:12px;font-weight:400;color:var(--txt2)">${v}</span></div>
      <div class="chart-tooltip-ts">${q}</div>
    `,h.style.display="block";const T=w.clientX+12,E=w.clientY-10;h.style.left=`${Math.min(T,window.innerWidth-160)}px`,h.style.top=`${E}px`}),f.addEventListener("mouseleave",()=>{h.style.display="none",b.style.display="none"})}function Ai(e,t,i,n=0){const a=Date.now(),o=i*6e4,c=a-t*o,l=t+n,u=new Array(l).fill(0);return O.filter(r=>r.plotId===e).forEach(r=>{const v=new Date(r.iso).getTime();if(v<c)return;const s=Math.min(l-1,Math.floor((v-c)/o));s>=0&&(u[s]+=r.mm||0)}),u}function Ii(e,t,i,n,a=0){const l={t:12,r:8,b:28,l:44},u=600-l.l-l.r,r=180-l.t-l.b,v=i+a,s=Ai(k,i,n,a),d=Math.max(...s,1),m=y=>l.l+y/Math.max(v-1,1)*u,p=y=>l.t+r-y/d*r;let h="";for(let y=0;y<=4;y++){const b=l.t+y/4*r,w=(d-y/4*d).toFixed(1);h+=`<line x1="${l.l}" y1="${b}" x2="${600-l.r}" y2="${b}" stroke="var(--bdr2)" stroke-width="1"/>`,h+=`<text x="${l.l-4}" y="${b+4}" text-anchor="end" font-size="10" fill="var(--txt3)">${w}</text>`}if(a>0){const y=m(i-.5),b=`irrig_stripe_${Math.random().toString(36).slice(2,8)}`;h+=`<defs><pattern id="${b}" width="8" height="8" patternUnits="userSpaceOnUse" patternTransform="rotate(45)">
        <rect width="8" height="8" fill="rgba(142,142,147,.05)"/>
        <line x1="0" y1="0" x2="0" y2="8" stroke="rgba(142,142,147,.16)" stroke-width="4"/>
      </pattern></defs>
  ...
  `,t.appendChild(n);const a=n.querySelector(".compare-search-input");a.focus(),a.addEventListener("input",o=>{const c=o.target.value.toLowerCase();n.querySelectorAll(".compare-dropdown-item").forEach(l=>{l.style.display=l.textContent.toLowerCase().includes(c)?"":"none"})}),n.querySelectorAll(".compare-dropdown-item").forEach(o=>{o.addEventListener("click",()=>{G=parseInt(o.dataset.id),n.remove(),Le(),U()})}),setTimeout(()=>{document.addEventListener("click",function o(c){!n.contains(c.target)&&!t.contains(c.target)&&(n.remove(),document.removeEventListener("click",o))})},0)}function Oi(){const e=Ve.find(t=>t.id===x.orgId);kt(e),zi(e),Ae(),_e(),ce(),Je()}const dt=["Abricotier","Ail","Amandier","Artichaut","Asperge","Aubergine","Avoine","Basilic","Betterave fourragère","Betterave sucrière","Blé dur","Blé tendre","Brocoli","Carotte","Cerisier","Chou-fleur","Chou pommé","Ciboulette","Citrouille","Clémentinier","Courgette","Echalote","Endive","Epinard","Fève","Figuier","Fraisier","Framboisier","Gesse","Giroflier","Haricot vert","Houblon","Kiwi","Lavande","Lentille","Luzerne","Maïs doux","Maïs grain","Maïs semence","Maïs silage","Melon","Menthe","Moutarde","Navet","Nectarinier","Noisetier","Noyer","Oignon","Olivier","Orge de brasserie","Orge de printemps","Orge d'hiver","Pêcher","Persil","Pissenlit","Poireau","Pois chiche","Pois de conserve","Pois fourrager","Pois protéagineux","Poivron","Pomme de terre","Pommier","Poirier","Prunier","Pruneau d'Agen","Radis","Raisin de cuve","Raisin de table","Riz","Romarin","Sarrasin","Seigle","Soja","Sorgho","Tabac","Thym","Tomate","Tournesol","Triticale","Vigne","Cardon","Céleri","Cerise","Châtaignier","Colza","Courge","Fénugrec","Groseillier","Lin fibre","Lin oléagineux","Mâche","Millet","Myrtille","Noix de cajou","Paprika","Patate douce","Pistachier","Poisson-Chat","Quinoa","Safran","Sainfoin","Scorsonère","Shallot","Topinambour","Trèfle","Vesce","Fétuque","Ray-grass","Prairie temporaire","Prairie permanente","Jachère","Autre"];function kt(e){const t=document.getElementById("panel-ident"),i=C,n=i.texture||null,a=i.irrigation||null,o=i.crop||dt[0],c=i.env||null,l=n===He,u=i.soilAnalysis||{};t.innerHTML=`
    ${Be("Nom",i.name||"—","name","text")}
    ${Ni("Culture",o,"crop",dt)}
    ${ut("Surface",(i.area?`${i.area} ha`:"—")+' <span class="field-computed">(calculé)</span>')}
    ${Fe("Environnement",c,"env",Gt,"Plein champ")}
    ${Fe("Texture sol",n,"texture",[...Vt,He],"Indéfini")}
    ${l?`
    ...
    `:""}
    ${Fe("Irrigation",a,"irrigation",xt,"Non renseigné")}
    ${ut("Exploitation",e?e.name:"—")}
  `,ie(t,"name",i.name||"",r=>{z({name:r}),wt(r,{label:"Parcelles",href:"parcelles.html"})}),ie(t,"crop",o,r=>z({crop:r})),ie(t,"env",c||"",r=>z({env:r||null})),ie(t,"texture",n||"",r=>{const v=r||null,s={texture:v};v!==He&&(s.soilAnalysis=null),z(s),kt(e)}),l&&(ie(t,"soilArgile",String(u.argile??""),r=>z({soilAnalysis:{...C.soilAnalysis,argile:+r}})),ie(t,"soilLimon",String(u.limon??""),r=>z({soilAnalysis:{...C.soilAnalysis,limon:+r}})),ie(t,"soilSable",String(u.sable??""),r=>z({soilAnalysis:{...C.soilAnalysis,sable:+r}}))),ie(t,"irrigation",a||"",r=>z({irrigation:r||null}))}function Be(e,t,i,n="text"){const a=(t||"").replace(/"/g,"&quot;");return`
    ...
    </div>`}function Fe(e,t,i,n,a="—"){const c=n.includes(a)?"":`<option value=""${t?"":" selected"}>${a}</option>`;return`
    <div class="panel-row" data-field="${i}">
      <span class="panel-row-key">${e}</span>
      <select class="panel-field-input" data-val>
        ${c}
    ...
    </div>`}function ie(e,t,i,n){const a=e.querySelector(`[data-field="${t}"] [data-val]`);if(!a)return;const o=()=>{var l;const c=(l=a.value)==null?void 0:l.trim();c&&c!==i&&(i=c,n(c))};a.addEventListener("change",o),a.tagName==="INPUT"&&a.addEventListener("keydown",c=>{c.key==="Enter"&&(c.preventDefault(),a.blur())})}function zi(e){const t=document.getElementById("panel-geoloc"),i=C.latlngs||x.latlngs,n=Array.isArray(i)&&i.length>=3,a=C.ville||x.ville||(e==null?void 0:e.ville)||"—",o=x.departement||(e==null?void 0:e.departement),c=C.lat??x.lat??(e==null?void 0:e.lat),l=C.lng??x.lng??(e==null?void 0:e.lng);t.innerHTML=`
    <div class="panel-row">
  ...
  `}function _i(){const e=new Set;return P.filter(i=>C.linkedSensorIds.includes(i.id)).forEach(i=>{const n=R[i.model]||[];_.includes(i.model)||n.forEach(a=>e.add(a.id))}),e}function mt(e){const t=R[e]||[];return t.length?`<div class="sensor-metric-badges">${t.map(i=>`<span class="sensor-metric-badge" style="--mc:${i.color}">${i.name}</span>`).join("")}</div>`:""}function Ae(){const e=document.getElementById("panel-sensors"),t=P.filter(m=>C.linkedSensorIds.includes(m.id)),i=P.filter(m=>m.orgId===x.orgId&&!C.linkedSensorIds.includes(m.id)),n=t.filter(m=>!_.includes(m.model)),a={};n.forEach(m=>(R[m.model]||[]).forEach(p=>{a[p.id]=(a[p.id]||0)+1}));const o=Object.entries(a).filter(([,m])=>m>1).map(([m])=>{var p;return((p=Object.values(R).flat().find(h=>h.id===m))==null?void 0:p.name)||m});let c="";if(o.length>0&&(c+=`<div class="sensor-conflict-banner">
      ...
      </div>`);const v=document.getElementById("sensor-add-row"),s=document.getElementById("add-sensor-select");v&&s&&(i.length>0?(s.innerHTML='<option value="">Ajouter un capteur…</option>'+i.map(m=>`<option value="${m.id}">${ee[m.model]||m.model} — ${m.serial}</option>`).join(""),v.style.display=""):v.style.display="none"),e.querySelectorAll(".remove-sensor-btn").forEach(m=>{m.addEventListener("click",()=>{const p=parseInt(m.dataset.id),h=P.find(y=>y.id===p),f=h?`${ee[h.model]||h.model} — ${h.serial}`:`capteur #${p}`;Ce({title:"Retirer le capteur",message:`Retirer <strong>${f}</strong> de cette parcelle ?<br><br>Les données historiques sont conservées.`,confirmLabel:"Retirer",onConfirm:()=>{const y=C.linkedSensorIds.filter(b=>b!==p);z({linkedSensorIds:y}),vt(y),Ae(),U(),ue()}})})});const d=document.getElementById("add-sensor-btn");d&&d.addEventListener("click",()=>{const m=document.getElementById("add-sensor-select"),p=parseInt(m.value);if(!p)return;const h=P.find(y=>y.id===p);if(!h)return;const f=Oe(h.model);if(f){const b=P.filter(w=>C.linkedSensorIds.includes(w.id)).filter(w=>{const g=Oe(w.model);return g&&g!==f});if(b.length>0){const w=b.map(g=>`${ee[g.model]||g.model} — ${g.serial}`).join(", ");Ce({title:"Capteur incompatible",message:`Cette parcelle utilise déjà : <strong>${w}</strong>.<br><br>Les capteurs de sol (CHP, CAPA, EC, T_MINI) sont exclusifs — une seule technologie par parcelle.<br><br>Retirer ${b.length>1?"ces capteurs":"ce capteur"} et ajouter le nouveau ?`,confirmLabel:"Remplacer",onConfirm:()=>{const g=new Set(b.map(M=>M.id)),S=C.linkedSensorIds.filter(M=>!g.has(M));z({linkedSensorIds:[...S,p]}),vt(S),ht(h),Ae(),U(),ue()}});return}}if(!_.includes(h.model)){const y=_i(),w=(R[h.model]||[]).map(g=>g.id).filter(g=>y.has(g));if(w.length>0){const g=w.map(M=>{const j=Object.values(R).flat().find(I=>I.id===M);return(j==null?void 0:j.name)||M});if(!confirm(`Attention : ce capteur (${h.model}) mesure des métriques déjà fournies par un autre capteur :
• ${g.join(`
• `)}

Voulez-vous l'ajouter quand même ?`))return}}z({linkedSensorIds:[...C.linkedSensorIds,p]}),ht(h),Ae(),U(),ue()})}function _e(){var c;const e=document.getElementById("panel-integrations"),t=C.integrations||[],i=Xt.filter(l=>!t.includes(l));let n="";t.length===0?n+='<div class="panel-empty" style="margin-bottom:8px">Aucune intégration active</div>':n+=t.map(l=>`
    ...
    `).join(""),n+='<button id="create-alert-btn" class="action-btn" style="margin-top:6px"><i class="bi bi-plus"></i> Créer une alerte</button>',e.innerHTML=n,e.querySelectorAll(".remove-alert-btn").forEach(a=>{a.addEventListener("click",()=>{const o=parseInt(a.dataset.idx),c=[...C.alertes];c.splice(o,1),z({alertes:c}),Je()})}),document.getElementById("create-alert-btn").addEventListener("click",()=>{Gi(e)})}function Vi(){const e=[];return P.filter(i=>C.linkedSensorIds.includes(i.id)).forEach(i=>{(R[i.model]||[]).forEach(a=>{e.find(o=>o.id===a.id)||e.push({id:a.id,name:a.name,unit:a.unit})})}),Ge.forEach(i=>{e.find(n=>n.id===i.id)||e.push({id:i.id,name:i.name,unit:i.unit})}),e}function Gi(e){if(e.querySelector(".alert-create-form"))return;const i=Vi(),n=document.createElement("div");n.className="alert-create-form",n.innerHTML=`
...
`),`${s}_${J}_${new Date().toISOString().slice(0,10)}.csv`)}function Ce({title:e,message:t,confirmLabel:i="Confirmer",onConfirm:n}){const a=document.createElement("div");a.className="modal add-modal",a.style.zIndex="9999",a.innerHTML=`
    <div class="add-modal-content" style="max-width:400px">
      ...
      ${o}`,e.appendChild(a),n.render(a.querySelector(`#dblock-${i}`))}),e.querySelectorAll(".dash-menu-btn").forEach(i=>{i.addEventListener("click",n=>{var r,v,s;n.stopPropagation(),(r=document.querySelector(".dash-dropdown"))==null||r.remove();const a=i.dataset.wid,o=document.createElement("div");o.className="dash-dropdown";const c=a==="irrigations"?`
        <button class="dash-dd-item" data-action="set-vol">Définir le volume limité et le débit</button>`:"";o.innerHTML=`${c}<button class="dash-dd-item dash-dd-remove" data-action="remove" data-wid="${a}">Retirer le widget</button>`;const l=i.getBoundingClientRect(),u=e.getBoundingClientRect();o.style.top=`${l.bottom-u.top+4}px`,o.style.right=`${u.right-l.right}px`,e.style.position="relative",e.appendChild(o),(v=o.querySelector('[data-action="remove"]'))==null||v.addEventListener("click",()=>{o.remove();const d=he().filter(m=>m!==a);fe(d),ue()}),(s=o.querySelector('[data-action="set-vol"]'))==null||s.addEventListener("click",()=>{o.remove(),Nt("vol")}),setTimeout(()=>document.addEventListener("click",()=>o.remove(),{once:!0}),0)})}),e.querySelectorAll(".dash-block-ft-link[data-tab]").forEach(i=>{i.addEventListener("click",n=>{var a;n.preventDefault(),(a=document.querySelector(`.detail-tab-btn[data-pane="tab-${i.dataset.tab}"]`))==null||a.click()})}),pn(e)}function It(e,t=380,i=90){const l=t-28-8,u=i-6-20,r=e.flatMap(b=>b.values);let v=Math.min(...r),s=Math.max(...r);v===s&&(v-=1,s+=1);const d=e[0].values.length,m=b=>(28+b/(d-1)*l).toFixed(1),p=b=>(6+u-(b-v)/(s-v)*u).toFixed(1),h=[.25,.5,.75].map(b=>{const w=(6+b*u).toFixed(1);return`<line x1="28" y1="${w}" x2="${t-8}" y2="${w}" stroke="rgba(0,0,0,.06)" stroke-width="1"/>`}).join(""),f=[v,(v+s)/2,s].map(b=>`<text x="25" y="${(+p(b)+3.5).toFixed(0)}" text-anchor="end" font-size="9" fill="var(--txt3)">${b.toFixed(0)}</text>`).join(""),y=e.map(b=>`<path d="${b.values.map((g,S)=>`${S?"L":"M"}${m(S)},${p(g)}`).join("")}" fill="none" stroke="${b.color}" stroke-width="1.8" stroke-linejoin="round"/>`).join("");return`<svg width="100%" height="${i}" viewBox="0 0 ${t} ${i}" preserveAspectRatio="none">${f}${h}${y}</svg>`}function en(e,t,i,n){const v=(f,y)=>{const b=Math.PI+f*Math.PI,w=Math.PI+y*Math.PI,g=(80+60*Math.cos(b)).toFixed(1),S=(90+60*Math.sin(b)).toFixed(1),M=(80+60*Math.cos(w)).toFixed(1),j=(90+60*Math.sin(w)).toFixed(1);return`M${g},${S} A60,60,0,${y-f>.5?1:0},1,${M},${j}`},s=v(0,1),d=t.filter(f=>f.from<e).map(f=>`<path d="${v(f.from,Math.min(f.to,e))}" fill="none" stroke="${f.color}" stroke-width="12" stroke-linecap="butt"/>`).join(""),m=Math.PI+e*Math.PI,p=(80+60*Math.cos(m)).toFixed(1),h=(90+60*Math.sin(m)).toFixed(1);return`<svg width="160" height="100" viewBox="0 0 160 100">
  ...
  </svg>`}function tn(e){const t=["Dim","Lun","Mar","Mer","Jeu","Ven","Sam"],i=["jan","fév","mar","avr","mai","jun","jul","aoû","sep","oct","nov","déc"],n=["bi-sun","bi-cloud-sun","bi-cloud","bi-cloud-rain","bi-cloud-lightning-rain"],a=["Ensoleillé","Part. nuageux","Couvert","Pluvieux","Orageux"],o=new Date,c=oe.find(d=>d.id===k),l=Ve.find(d=>d.id===(c==null?void 0:c.orgId)),u=(c==null?void 0:c.ville)||(l==null?void 0:l.ville)||"—",r=(d,m)=>{const p=new Date(o);p.setDate(p.getDate()+d);const h=Math.floor((k*7+d*3)%11/2.2);return{lbl:d===0?"Auj.":t[p.getDay()],date:`${p.getDate()} ${i[p.getMonth()]}`,tmax:$(17+m,34+m),tmin:$(4+m,15+m),pluie:h>=3?$(2,18):0,vent:$(10,35),rafales:$(25,70),wi:h}},v=[0,1,2].map(d=>r(d,0)).concat([3,4].map(d=>r(d,-1))),s=d=>`
  ...
  </div>`}function on(e){if(!P.filter(d=>C.linkedSensorIds.includes(d.id)).some(d=>{const m=R[d.model]||[];return m.some(p=>p.id==="temp")&&m.some(p=>p.id==="humidite")})){e.innerHTML='<div class="dash-empty">Capteur T+HR requis</div>';return}const n=D(20,35),a=$(45,90),o=+(n-.55*(1-a/100)*(n-14.5)).toFixed(0),c=o<68?"#2d9e5f":o<72?"#f5c842":o<79?"#f5a030":"#e07050",l=o<68?"Confort":o<72?"Stress léger":o<79?"Stress modéré":"Stress sévère",u=["Dim","Lun","Mar","Mer","Jeu","Ven","Sam"],r=new Date,v=Array.from({length:3},(d,m)=>{const p=new Date(r);return p.setDate(p.getDate()+m+1),{day:u[p.getDay()],m:$(64,72),j:$(68,80),s:$(62,70)}}),s=d=>d<68?"#2d9e5f":d<72?"#f5c842":"#f5a030";e.innerHTML=`<div class="w-thi-wrap">
  ...
  </div>`}function ln(e){if(!P.filter(B=>C.linkedSensorIds.includes(B.id)).some(B=>(R[B.model]||[]).some(H=>H.id==="tsol"))){e.innerHTML='<div class="dash-empty">Capteur T. sol requis</div>';return}const n=48,a=D(14,20),o=Array.from({length:n},(B,H)=>+(a+3*Math.sin(H/24*2*Math.PI-Math.PI/2)+D(-.4,.4)).toFixed(1)),c=15,l=22,u=380,r=100,v=28,s=8,d=6,m=20,p=u-v-s,h=r-d-m,f=[...o,c,l],y=Math.min(...f)-1,b=Math.max(...f)+1,w=B=>(v+B/(n-1)*p).toFixed(1),g=B=>(d+h-(B-y)/(b-y)*h).toFixed(1),S=+g(c),M=+g(l),j=[.25,.5,.75].map(B=>{const H=(d+B*h).toFixed(1);return`<line x1="${v}" y1="${H}" x2="${u-s}" y2="${H}" stroke="rgba(0,0,0,.06)" stroke-width="1"/>`}).join(""),I=o.map((B,H)=>`${H?"L":"M"}${w(H)},${g(B)}`).join("");e.innerHTML=`<div class="w-tsol-wrap">
    <svg width="100%" height="${r}" viewBox="0 0 ${u} ${r}" preserveAspectRatio="none">
      ${j}
      <rect x="${v}" y="${M.toFixed(1)}" width="${p}" height="${(S-M).toFixed(1)}" fill="rgba(45,158,95,.1)"/>
      <line x1="${v}" y1="${S.toFixed(1)}" x2="${u-s}" y2="${S.toFixed(1)}" stroke="#2d9e5f" stroke-width="1" stroke-dasharray="4,3" opacity=".5"/>
  ...
  </div>`}function cn(e){const t=(C.crop||x.crop||"").toLowerCase();if(!t.includes("maïs")&&!t.includes("mais")){e.innerHTML='<div class="dash-empty">Culture Maïs requise</div>';return}const i=[{name:"Farmflex 253",target:1320},{name:"DKC 3230",target:1380},{name:"Ronaldinio",target:1290},{name:"Banguy",target:1350}],n=i[k%i.length],a=x.degresJour||$(600,1200),o=Math.min(a/n.target,1),c=Math.max(0,n.target-a),l=new Date,u=Math.round(c/10),r=new Date(l);r.setDate(r.getDate()+Math.max(0,u-5));const v=new Date(l);v.setDate(v.getDate()+u+5);const s=["jan","fév","mar","avr","mai","jun","jul","aoû","sep","oct","nov","déc"],d=m=>`${m.getDate()} ${s[m.getMonth()]}`;e.innerHTML=`<div class="w-maizy-wrap">
  ...
  </div>`}function dn(e){const t=(C.crop||x.crop||"").toLowerCase();if(!t.includes("pommier")&&!t.includes("pomme")){e.innerHTML='<div class="dash-empty">Culture Pommier requise</div>';return}const i=new Date,n=new Date(i);n.setDate(n.getDate()-$(2,8));const a=["jan","fév","mar","avr","mai","jun","jul","aoû","sep","oct","nov","déc"],o=v=>`${v.getDate()} ${a[v.getMonth()]}`,c=$(8,24),l=$(80,280),u=l>200?"Élevé":l>120?"Modéré":"Léger",r=l>200?"#e07050":l>120?"#f5a030":"#2d9e5f";e.innerHTML=`<div class="w-tav-wrap">
  ...
  </div>`}const Pt=[{id:"j7",label:"J-7"},{id:"j1",label:"J-1"},{id:"j0",label:"J0"},{id:"last",label:"Dernières données"}],un=Pt.filter(e=>e.id==="j7"||e.id==="j1"),ft=()=>`w-reservoir-agg-${k}`,bt=()=>`w-profil-reservoir-agg-${k}`;function Ht(e,t="j0"){return localStorage.getItem(e())||t}function Ft(e,t){localStorage.setItem(e(),t)}function qt(e){const t=x.reserveHydrique||80,i=(x.id*17+13)%41,n={j7:-8,j1:-2,j0:0,last:1},a=Math.min(95,Math.max(15,55+i+(n[e]||0))),o=Math.round(t*a/100);return{rhu:t,pct:a,mm:o}}function Rt(e,t=Pt){return`<select class="w-reservoir-agg-sel">
    ${t.map(i=>`<option value="${i.id}"${i.id===e?" selected":""}>${i.label}</option>`).join("")}
  </select>`}function Dt(e){const t=Ht(ft),{rhu:i,pct:n,mm:a}=qt(t),o=n>60?"#2d9e5f":n>35?"#e07820":"#e04040";e.innerHTML=`
    ...
    </div>`,e.querySelector(".w-reservoir-agg-sel").addEventListener("change",c=>{Ft(ft,c.target.value),Dt(e)})}function Ot(e){const t=Ht(bt,"j1"),{pct:i}=qt(t),n=(x.id*17+13)%41,a=[{label:"10 cm",pct:Math.min(100,Math.max(0,i+n%12-5)),color:"#f0cc60"},{label:"30 cm",pct:Math.min(100,Math.max(0,i+n%8)),color:"#c89c30"},{label:"60 cm",pct:Math.min(100,Math.max(0,i-n%10+3)),color:"#a07010"}];e.innerHTML=`
    <div class="w-bilan-layout">
      ${Rt(t,un)}
    ...
    <div class="w-bilan-layout">
    ...
    </div>`}function Nt(e){const t=document.createElement("div");if(t.className="journal-form-overlay",e==="vol"){const i=xe(k).volumeMaxM3??"",n=xe(k).debitM3h??"";t.innerHTML=`
      ...
      </div>`,document.body.appendChild(t),t.querySelector("#iwa-cancel").onclick=()=>t.remove(),t.querySelector("#iwa-save").onclick=()=>{const a=t.querySelector("#iwa-vol-inp").value,o=t.querySelector("#iwa-debit-inp").value;ae(k,{volumeMaxM3:a!==""?parseInt(a):null,debitM3h:o!==""?parseFloat(o):null}),t.remove(),document.querySelector("#dblock-irrigations")&&Se(document.querySelector("#dblock-irrigations"))}}else{const i=C.irrigation||"";t.innerHTML=`
      <div class="journal-form-modal">
    ...
    </div>`,document.body.appendChild(t),t.addEventListener("click",i=>{i.target===t&&t.remove()}),t.querySelector("#irr-m-s-cancel").onclick=()=>t.remove(),t.querySelector("#irr-m-s-save").onclick=()=>{const i=t.querySelector("#irr-m-s-date").value,n=parseInt(t.querySelector("#irr-m-s-qty").value)||0;if(!i||!n)return;const a=i>se,o=()=>{O.push({iso:i,mm:n,real:!a,plotId:x.id,fromStrategy:!1}),$t(),t.remove(),Se(e),_t("Irrigation enregistrée",[`Date : ${Ne(i)}`,`Quantité : ${n} mm`])},c=O.filter(l=>l.plotId===x.id&&l.iso===i);if(c.length){zt(c.length,()=>{O.splice(0,O.length,...O.filter(l=>!(l.plotId===x.id&&l.iso===i))),o()});return}o()}}function yt(e){const t=document.createElement("div");t.className="journal-form-overlay",t.innerHTML=`
    <div class="journal-form-modal">
    ...
    </div>`,document.body.appendChild(t);const i=()=>{const n=t.querySelector("#irr-m-sa-debut").value,a=t.querySelector("#irr-m-sa-fin").value,o=parseInt(t.querySelector("#irr-m-sa-qty").value)||0,c=parseInt(t.querySelector("#irr-m-sa-freq").value)||0,l=t.querySelector("#irr-m-sa-preview");if(!n||!a||c<=0){l.textContent="—";return}let u=0,r=new Date(n),v=new Date(a);for(;r<=v&&u<200;)u++,r.setDate(r.getDate()+c);if(u>0){const s=x.area>0?Math.round(u*o*x.area*10):0,d=s>0?` · ${s.toLocaleString("fr-FR")} m³`:"";l.innerHTML=`<span style="color:var(--pri);font-weight:600">↗ ${u} irrigations · ${u*o} mm${d}</span>`}else l.innerHTML='<span style="color:var(--txt3)">Ajustez les paramètres</span>'};i(),t.querySelector("#irr-m-sa-debut").addEventListener("change",i),t.querySelector("#irr-m-sa-fin").addEventListener("change",i),t.querySelector("#irr-m-sa-qty").addEventListener("input",i),t.querySelector("#irr-m-sa-freq").addEventListener("input",i),t.addEventListener("click",n=>{n.target===t&&t.remove()}),t.querySelector("#irr-m-sa-cancel").onclick=()=>t.remove(),t.querySelector("#irr-m-sa-save").onclick=()=>{const n=t.querySelector("#irr-m-sa-debut").value,a=t.querySelector("#irr-m-sa-fin").value,o=parseInt(t.querySelector("#irr-m-sa-qty").value)||10,c=parseInt(t.querySelector("#irr-m-sa-freq").value)||7;if(!n||!a)return;const l=[];let u=new Date(n),r=new Date(a);for(;u<=r&&l.length<200;)l.push(new Date(u)),u.setDate(u.getDate()+c);const v=Wt(),s=()=>{l.forEach(m=>{const p=m.toISOString().slice(0,10);O.push({iso:p,mm:o,real:p<=se,plotId:x.id,fromStrategy:!0,seasonId:v})}),$t(),t.remove(),Se(e),_t("Saison enregistrée",[`Début : ${Ne(n)} · Fin : ${Ne(a)}`,`${l.length} irrigations · ${o} mm · tous les ${c} j`])},d=O.filter(m=>m.plotId===x.id&&m.iso>=n&&m.iso<=a);if(d.length){zt(d.length,()=>{O.splice(0,O.length,...O.filter(m=>!(m.plotId===x.id&&m.iso>=n&&m.iso<=a))),s()});return}s()}}function Se(e){var p,h,f,y,b;const t=O.filter(w=>w.plotId===x.id),i=t.filter(w=>w.real),n=t.filter(w=>!w.real),a=i.reduce((w,g)=>w+g.mm,0),o=n.reduce((w,g)=>w+g.mm,0),c=a+o,l=C.irrigation||x.irrigation;let u="";if(t.some(w=>w.fromStrategy)){const w=[...t].sort((j,I)=>j.iso.localeCompare(I.iso)),g=w[w.length-1],S=w[w.length-2],M=S?Math.round((new Date(g.iso)-new Date(S.iso))/864e5):null;u=`

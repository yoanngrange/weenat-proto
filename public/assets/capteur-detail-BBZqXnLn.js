import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css             */import{s as X}from"./sensors-CRadjF8G.js";import{p as N}from"./plots-DhtWL7s_.js";import{o as ne}from"./orgs-DnFmvGlp.js";import{m as T}from"./members-Cr98hVG_.js";import{u as xe}from"./breadcrumb-CzFWtd6d.js";import{a as ue,p as R}from"./store-c0FlIf2T.js";const He=new URLSearchParams(window.location.search),$=parseInt(He.get("id")),c=X.find(t=>t.id===$),we={pluie:{name:"Pluie",unit:"mm",color:"#2E75B6",baseVal:()=>v(0,8),cumul:{label:"Cumul de pluie",unit:"mm"},isCumul:!0},temperature:{name:"Température",unit:"°C",color:"#FBAF05",baseVal:()=>v(10,28),cumul:{label:"Cumul de degrés jour",unit:"°j"}},humidite_air:{name:"Humidité",unit:"%",color:"#5B12A4",baseVal:()=>v(40,90)},dpv:{name:"DPV",unit:"kPa",color:"#5E88EC",baseVal:()=>te(.1,2.5)},vent_vitesse:{name:"Vent – vitesse",unit:"km/h",color:"#616161",baseVal:()=>v(0,40)},vent_rafales:{name:"Vent – rafales",unit:"km/h",color:"#525252",baseVal:()=>v(5,60)},vent_direction:{name:"Vent – direction",unit:"°",color:"#424242",baseVal:()=>v(0,360)},vent_direction_rafales:{name:"Vent – direction rafales",unit:"°",color:"#343232",baseVal:()=>v(0,360)},rayonnement:{name:"Rayonnement",unit:"W/m²",color:"#CBCB0B",baseVal:()=>v(0,900),cumul:{label:"Énergie",unit:"Wh/m²"}},etp:{name:"ETP",unit:"mm/j",color:"#7DBDD7",baseVal:()=>te(.5,5),cumul:{label:"Cumul ETP",unit:"mm"}},temperature_min:{name:"Température min",unit:"°C",color:"#FEE7B4",baseVal:()=>v(-2,15),cumul:{label:"Cumul d'heures de froid",unit:"h"}},humidite_sol_10:{name:"Teneur en eau du sol 10 cm",unit:"%vol",color:"#105200",baseVal:()=>v(15,45)},humidite_sol_20:{name:"Teneur en eau du sol 20 cm",unit:"%vol",color:"#8C5E82",baseVal:()=>v(15,45)},humidite_sol_30:{name:"Teneur en eau du sol 30 cm",unit:"%vol",color:"#46DA82",baseVal:()=>v(15,45)},humidite_sol_ec:{name:"Teneur en eau du sol",unit:"%vol",color:"#46DA82",baseVal:()=>v(15,45)},humidite_sol_40:{name:"Teneur en eau du sol 40 cm",unit:"%vol",color:"#949494",baseVal:()=>v(17,43)},humidite_sol_50:{name:"Teneur en eau du sol 50 cm",unit:"%vol",color:"#870021",baseVal:()=>v(18,42)},humidite_sol_60:{name:"Teneur en eau du sol 60 cm",unit:"%vol",color:"#F608C2",baseVal:()=>v(18,42)},humidite_sol_90:{name:"Teneur en eau du sol 90 cm",unit:"%vol",color:"#B14C19",baseVal:()=>v(20,40)},temp_sol:{name:"Température du sol",unit:"°C",color:"#795548",baseVal:()=>v(8,22)},potentiel_hydrique:{name:"Potentiel hydrique",unit:"kPa",color:"#A6C157",baseVal:()=>{const t=new Date().getMonth();return Math.round(10+(.5-.5*Math.cos(2*Math.PI*t/12))*140)}},tensio_30:{name:"Tension sol 30 cm",unit:"cbar",color:"#46DA82",baseVal:()=>v(10,80)},tensio_60:{name:"Tension sol 60 cm",unit:"cbar",color:"#F608C2",baseVal:()=>v(10,80)},tensio_90:{name:"Tension sol 90 cm",unit:"cbar",color:"#B14C19",baseVal:()=>v(10,80)},tensio_120:{name:"Tension sol 120 cm",unit:"cbar",color:"#7D9537",baseVal:()=>v(10,80)},tensio_150:{name:"Tension sol 150 cm",unit:"cbar",color:"#5C7020",baseVal:()=>v(10,80)},tensio_180:{name:"Tension sol 180 cm",unit:"cbar",color:"#3C4E10",baseVal:()=>v(10,80)},conductivite:{name:"Conductivité",unit:"mS/cm",color:"#2BCDDE",baseVal:()=>te(.1,3)},humectation:{name:"Humectation foliaire",unit:"h",color:"#00887E",baseVal:()=>v(0,12)},par:{name:"Densité de flux de photons photosynthétiques",unit:"µmol/m²/s",color:"#4CBB17",baseVal:()=>v(0,2e3)},temperature_gel:{name:"Temp. feuille/gel",unit:"°C",color:"#FEE7B4",baseVal:()=>v(-3,12),cumul:{label:"Cumul d'heures de gel",unit:"h"}},temp_rosee:{name:"Température de rosée",unit:"°C",color:"#72B0D8",baseVal:()=>v(4,16)},temp_seche:{name:"Température sèche",unit:"°C",color:"#23B19B",baseVal:()=>v(-5,10)},temp_humide:{name:"Température humide",unit:"°C",color:"#5E88EC",baseVal:()=>v(-7,8)}},Ve={"P+":["pluie","temperature","humidite_air"],PT:["pluie","temperature"],P:["pluie"],TH:["temperature","humidite_air"],T_MINI:["temp_sol"],W:["_vent"],"CHP-15/30":["potentiel_hydrique","temp_sol"],"CHP-30/60":["potentiel_hydrique","temp_sol"],"CHP-60/90":["humidite_sol_60","humidite_sol_90","temp_sol"],"CAPA-30-3":["_capa_vwc","_capa_temp"],"CAPA-60-6":["_capa_vwc","_capa_temp"],EC:["humidite_sol_ec","temp_sol","conductivite"],LWS:["_lws_intensite","_lws_duree"],PYRANO:["rayonnement"],PAR:["par"],T_GEL:["temp_seche","temp_humide"]},he={_capa_vwc:{name:"Humidité sol par horizon",unit:"%vol",color:"#ED9A2C",isVirtual:!0},_capa_temp:{name:"Température du sol par horizon",unit:"°C",color:"#795548",isVirtual:!0},_lws_intensite:{name:"Intensité d'humectation",unit:"mV",color:"#00887E",isVirtual:!0},_lws_duree:{name:"Durée d'humectation",unit:"h",color:"#003D39",isVirtual:!0},_vent:{name:"Vent",unit:"km/h",color:"#616161",isVirtual:!0}},Ee={"CAPA-30-3":[{id:"humidite_sol_10",label:"10 cm",color:"#105200"},{id:"humidite_sol_20",label:"20 cm",color:"#8C5E82"},{id:"humidite_sol_30",label:"30 cm",color:"#46DA82"}],"CAPA-60-6":[{id:"humidite_sol_10",label:"10 cm",color:"#105200"},{id:"humidite_sol_20",label:"20 cm",color:"#8C5E82"},{id:"humidite_sol_30",label:"30 cm",color:"#46DA82"},{id:"humidite_sol_40",label:"40 cm",color:"#949494"},{id:"humidite_sol_50",label:"50 cm",color:"#870021"},{id:"humidite_sol_60",label:"60 cm",color:"#F608C2"}]};function v(t,e){return Math.floor(Math.random()*(e-t+1))+t}function te(t,e){return parseFloat((Math.random()*(e-t)+t).toFixed(2))}function O(t){return(Ve[t.model]||["temperature","humidite_air"]).map(o=>{if(he[o])return{id:o,...he[o],current:null};const n=we[o];return n?{id:o,...n,current:n.baseVal()}:null}).filter(Boolean)}let P=null,D="7d",G=null,Y=null;function _e(){const t={"1d":1440,hier:1440,"3d":4320,"7d":10080,"30d":43200,"365d":525600};return D==="custom"&&G&&Y?Math.max(60,Math.round((Y-G)/6e4)):t[D]??10080}function ae(){var e;const t=((e=document.getElementById("time-step"))==null?void 0:e.value)||"1h";return{max:15,"1h":60,"1d":1440,"1w":10080,"1mo":43200}[t]??60}function Pe(t){return t==="365d"?"1mo":t==="30d"?"1w":t==="7d"?"1d":"1h"}function me(){const t=_e(),e=ae();return Math.max(2,Math.min(200,Math.floor(t/e)))}const Fe={"P+":"Station météo",PT:"Station météo",P:"Pluviomètre",SMV:"Station météo virtuelle",TH:"Thermomètre-hygromètre",T_MINI:"Thermomètre de sol",W:"Anémomètre",PYRANO:"Pyranomètre",PAR:"Capteur PAR",LWS:"Capteur d'humectation foliaire",T_GEL:"Capteur de gel","CHP-15/30":"Tensiomètre","CHP-30/60":"Tensiomètre","CHP-60/90":"Tensiomètre","CAPA-30-3":"Sonde capacitive","CAPA-60-6":"Sonde capacitive",EC:"Sonde de fertirrigation"};function qe(){const t=document.getElementById("breadcrumb-title");if(!t)return;const e=t.querySelector("span:last-child");if(!e)return;const o=X.filter(i=>i.orgId===c.orgId).sort((i,s)=>i.serial.localeCompare(s.serial)),n=document.createElement("span");n.className="breadcrumb-nav-wrap";const a=document.createElement("select");a.className="breadcrumb-nav-select",a.innerHTML=o.map(i=>`<option value="${i.id}"${i.id===$?" selected":""}>${Fe[i.model]||i.model} · ${i.serial}</option>`).join(""),a.addEventListener("change",()=>{window.location.href=`capteur-detail.html?id=${a.value}`}),n.appendChild(a),e.replaceWith(n)}document.addEventListener("DOMContentLoaded",()=>{var e;if(!c){document.body.innerHTML='<div style="padding:40px"><h1>Capteur non trouvé</h1></div>';return}xe(`Capteur ${c.serial}`,{label:"Capteurs",href:"capteurs.html"}),qe(),De(),W(),et(),pt(),Qe(),Ke(),mt(),ht(),pe(),(e=document.getElementById("btn-export-csv"))==null||e.addEventListener("click",rt);const t=document.getElementById("sidebar");t&&new MutationObserver(()=>{const o=N.find(n=>{var a;return(a=c.parcelIds)==null?void 0:a.includes(n.id)})||null;J(o),Le()}).observe(t,{attributes:!0,attributeFilter:["data-role"]})});function De(){var o,n;const t=document.getElementById("latest-strip");if(!t)return;const e=O(c);if(e.forEach(a=>{if(a.isVirtual)return;const i=document.createElement("div");i.className="latest-card",i.style.borderTop=`3px solid ${a.color}`,i.innerHTML=`
    ...
    ${o}
    ${a}
  `,e}function Re(t,e){O(e).forEach(n=>{if(n.isVirtual){Ie(t,n,e);return}t.appendChild(Me(n))})}function ve(t,e,o){e.isVirtual?Ie(t,e,o):t.appendChild(Me(e))}function W(){var e;const t=document.getElementById("charts-container");if(t.innerHTML="",P){t.className="compare-rows";const o=X.find(l=>l.id===P),n=document.createElement("div");n.className="compare-header-row",n.innerHTML=`
      ...
      </div>`,t.appendChild(n),(e=n.querySelector(".compare-close-btn"))==null||e.addEventListener("click",()=>{P=null,oe(),W()});const a=O(c),i=o?O(o):[],s=a.map(l=>l.id);[...s,...i.map(l=>l.id).filter(l=>!s.includes(l))].forEach(l=>{const d=a.find(E=>E.id===l),u=i.find(E=>E.id===l),p=document.createElement("div");p.className="compare-row";const h=document.createElement("div");d?ve(h,d,c):h.innerHTML='<div class="compare-chart-empty">—</div>';const g=document.createElement("div");u?ve(g,u,o):g.innerHTML='<div class="compare-chart-empty">—</div>',p.appendChild(h),p.appendChild(g),t.appendChild(p)})}else t.className="charts-stack",Re(t,c);Ge(),Oe()}function Ne(t){const e=t==="temperature_min",o=Math.round(Math.random()*200+50),n=Math.round(Math.random()*400+100);return`
  ...
  `}function Oe(){document.querySelectorAll(".temp-thresh-input").forEach(t=>{t.addEventListener("change",()=>{var a,i;const e=t.closest(".temp-threshold-row"),o=t.dataset.type;parseFloat(t.value);const n=(i=(a=e.querySelector(`.temp-threshold-stat [data-type="${o}"]`))==null?void 0:a.closest(".temp-threshold-stat"))==null?void 0:i.querySelector(".temp-threshold-val");n&&(o==="cold"?n.textContent=`${Math.round(Math.random()*150+30)} h`:n.textContent=`${Math.round(Math.random()*350+80)} °j`)})})}function We(t){const e=me(),o=Array.from({length:e},()=>v(5,35)),n=o.map(b=>Math.min(b+v(3,18),80)),a=Array.from({length:e},()=>v(0,359)),i=600,s=200,r=46,l=16,d=16,u=28,p=i-r-l,h=s-d-u,g=Math.ceil(Math.max(...n)/10)*10||50,E=b=>r+b/Math.max(e-1,1)*p,m=b=>d+h-b/g*h,x=n.map((b,M)=>`${E(M).toFixed(1)},${m(b).toFixed(1)}`).join("L"),y=[...o].reverse().map((b,M)=>`${E(e-1-M).toFixed(1)},${m(b).toFixed(1)}`).join("L"),A=`M${x}L${y}Z`,f=o.map((b,M)=>`${M?"L":"M"}${E(M).toFixed(1)},${m(b).toFixed(1)}`).join(""),_=[.25,.5,.75].map(b=>{const M=(d+h-b*h).toFixed(1);return`<line x1="${r}" y1="${M}" x2="${i-l}" y2="${M}" stroke="rgba(0,0,0,.06)" stroke-width="1" stroke-dasharray="3,3"/>`}).join(""),I=[0,.5,1].map(b=>{const M=d+h-b*h;return`<text x="${r-4}" y="${(M+4).toFixed(1)}" text-anchor="end" font-size="10" fill="var(--txt3)">${Math.round(b*g)}</text>`}).join(""),j=Math.max(1,Math.round(e/25)),z=[];for(let b=0;b<e;b+=j){const M=E(b).toFixed(1),K=(d+h*.35).toFixed(1);z.push(`<g transform="translate(${M},${K}) rotate(${a[b]})">
    ...
    `,t.appendChild(n),requestAnimationFrame(()=>Ce(n.querySelector(".chart-svg--multi"),a,i));return}if(e.id==="_lws_intensite"||e.id==="_lws_duree"){const a=e.id==="_lws_intensite",i=a?"Intensité d'humectation":"Durée d'humectation",s=a?"mV":"h",r=a?"#78d8a0":"#45c090",l=a?v(0,800):v(0,12),d=a?"humectation":"lws_duree";n.dataset.base=l,n.dataset.color=r,n.dataset.cumul="",n.dataset.metricId=d,n.dataset.metricName=i,n.dataset.metricUnit=s,n.classList.remove("chart-card--multi"),n.innerHTML=`
      <div class="chart-card-header">
        <span class="chart-card-name" style="color:${r}">${i}</span>
        <span class="chart-card-unit">${s}</span>
      </div>
      <svg class="chart-svg" width="100%" height="180" viewBox="0 0 600 180" preserveAspectRatio="none"></svg>
    `,t.appendChild(n)}}function Ce(t,e,o){const n=me(),a=ae(),i=600,s=200,r={t:14,r:10,b:28,l:46},l=i-r.l-r.r,d=s-r.t-r.b,u=e.map(f=>{var j;const _=o?f.id:"temp_sol",I=((j=we[_])==null?void 0:j.baseVal())||25;return{color:f.color,label:f.label,vals:Array.from({length:n},(z,C)=>{const b=(n-1-C)*a,M=e.indexOf(f)*1.5;return Math.max(0,re(_,I+M,b))})}}),p=u.flatMap(f=>f.vals),h=Math.min(...p),g=Math.max(...p),E=g-h||1,m=f=>r.l+f/Math.max(n-1,1)*l,x=f=>r.t+d-(f-h)/E*d;let y="<defs></defs>";for(let f=0;f<=4;f++){const _=r.t+f/4*d,I=g-f/4*E,j=Math.abs(I)>=100?I.toFixed(0):I.toFixed(1);y+=`<line x1="${r.l}" y1="${_.toFixed(1)}" x2="${i-r.r}" y2="${_.toFixed(1)}" stroke="var(--bdr2)" stroke-width="1"/>`,y+=`<text x="${r.l-5}" y="${(_+4).toFixed(1)}" text-anchor="end" font-size="10" font-family="var(--font)" fill="var(--txt3)">${j}</text>`}const A=Math.max(1,Math.floor(n/6));for(let f=0;f<n;f+=A){const _=m(f).toFixed(1);y+=`<line x1="${_}" y1="${r.t}" x2="${_}" y2="${r.t+d}" stroke="var(--bdr2)" stroke-width="1" stroke-dasharray="3,3"/>`,y+=`<text x="${_}" y="${s-6}" text-anchor="middle" font-size="10" font-family="var(--font)" fill="var(--txt3)">${se((n-f)*a)}</text>`}u.forEach(f=>{const _=f.vals.map((I,j)=>({x:m(j),y:x(I)}));y+=`<path d="${Se(_)}" fill="none" stroke="${f.color}" stroke-width="2" stroke-linejoin="round" stroke-linecap="round" opacity="0.9"/>`}),t.innerHTML=y}let Q=null;function ze(){return Q||(Q=document.createElement("div"),Q.className="chart-tooltip",document.body.appendChild(Q)),Q}function Ue(t,e){return e==="temperature"||e==="temperature_min"?["#6eb4d4","#e07050"]:e==="temperature_gel"?["#a0d8f0","#6090d0"]:[Je(t,.55),t]}function Je(t,e){const o=parseInt(t.slice(1,3),16),n=parseInt(t.slice(3,5),16),a=parseInt(t.slice(5,7),16);return`#${Math.round(o+(255-o)*e).toString(16).padStart(2,"0")}${Math.round(n+(255-n)*e).toString(16).padStart(2,"0")}${Math.round(a+(255-a)*e).toString(16).padStart(2,"0")}`}function Se(t){if(t.length<2)return"";let e=`M${t[0].x.toFixed(1)},${t[0].y.toFixed(1)}`;for(let o=0;o<t.length-1;o++){const n=t[Math.max(o-1,0)],a=t[o],i=t[o+1],s=t[Math.min(o+2,t.length-1)],r=a.x+(i.x-n.x)/6,l=a.y+(i.y-n.y)/6,d=i.x-(s.x-a.x)/6,u=i.y-(s.y-a.y)/6;e+=` C${r.toFixed(1)},${l.toFixed(1)} ${d.toFixed(1)},${u.toFixed(1)} ${i.x.toFixed(1)},${i.y.toFixed(1)}`}return e}function se(t){const e=new Date(Date.now()-t*6e4);return t<1440?`${String(e.getHours()).padStart(2,"0")}h`:t>=43200?["jan","fév","mar","avr","mai","juin","juil","aoû","sep","oct","nov","déc"][e.getMonth()]:`${String(e.getDate()).padStart(2,"0")}/${String(e.getMonth()+1).padStart(2,"0")}`}function Ge(){const t=me(),e=ae();document.querySelectorAll(".chart-card").forEach(o=>{const n=o.querySelector(".chart-svg:not(.chart-svg--multi)");if(!n)return;const a=parseFloat(o.dataset.base),i=o.dataset.color,s=o.dataset.cumul==="1",r=o.dataset.metricId||"",l=o.dataset.metricName||"",d=o.dataset.metricUnit||"";Xe(n,a,i,t,e,s,r,l,d)}),document.querySelectorAll(".chart-svg--multi").forEach(o=>{const n=o.dataset.model,a=o.dataset.virtual,i=Ee[n]||[],s=a==="_capa_vwc";i.length&&Ce(o,i,s)})}function fe(t){const e=Date.now()-t*6e4;return new Date(e).getHours()+new Date(e).getMinutes()/60}function Ye(t){return Math.max(0,Math.sin(Math.PI*(t-6)/12))}function be(t){return .5+.5*Math.sin(2*Math.PI*(t-4)/24-Math.PI/2)}function re(t,e,o,n=.15){const a=fe(o),i=be(a),s=Ye(a),r=()=>1+(Math.random()-.5)*2*n;switch(t){case"temperature":case"temperature_min":return(e-6+i*12)*r();case"temperature_gel":return(e-4+i*8)*r();case"temp_sol":{const l=fe(o+120);return(e-3+be(l)*6)*r()}case"humidite_air":{const l=e+(1-i)*25-i*15;return Math.min(100,Math.max(20,l*r()))}case"rayonnement":case"par":{const l=s*e*1.3;return Math.max(0,l*r())}case"etp":{const l=s*e*1.5;return Math.max(0,l*r())}case"dpv":{const l=s*e*1.4+.05;return Math.max(0,l*r())}case"temp_rosee":{const d=e-6+i*12-2,u=e-8+i*6;return Math.min(d,u)*r()}case"lws_duree":{const l=Math.max(0,.9-s*1.1);return Math.max(0,e*l*r())}case"humectation":{const l=Math.max(0,.8-s*1.2),d=e*l;return Math.max(0,d*r())}case"potentiel_hydrique":return Math.max(5,Math.min(195,e*r()));case"humidite_sol_10":case"humidite_sol_20":case"humidite_sol_30":case"humidite_sol_40":case"humidite_sol_50":case"humidite_sol_60":case"humidite_sol_90":return Math.max(5,e*r());case"tensio_30":case"tensio_60":case"tensio_90":case"tensio_120":case"tensio_150":case"tensio_180":return Math.max(5,e*r());case"conductivite":{const l=20+i*10+(Math.random()-.5)*8;return l<15?0:Math.max(0,(l-15)*.08*r())}case"pluie":return Math.random()<.15?e*Math.random()*2:0;case"vent_vitesse":case"vent_rafales":{const l=e*(.6+s*.8)*r();return Math.max(0,l)}case"vent_direction":case"vent_direction_rafales":return(e+(Math.random()-.5)*60+360)%360;default:return Math.max(0,e*r())}}function Xe(t,e,o,n,a,i,s="",r="",l=""){const p={t:14,r:10,b:28,l:46},h=600-p.l-p.r,g=180-p.t-p.b,E=Math.max(1,Math.round(a/15)),m=Array.from({length:n},(w,S)=>{const B=(n-1-S)*a;if(i){let U=0;for(let F=0;F<E;F++)U+=re(s,e/E,B+F*(a/E));return U}else return re(s,e,B)}),x=Math.min(...m),y=Math.max(...m),A=y-x||1,f=w=>p.l+w/Math.max(n-1,1)*h,_=w=>p.t+g-(w-x)/A*g,I=`sg_${Math.random().toString(36).slice(2)}`,[j,z]=Ue(o,s);let C=`<defs>
  ...
  </defs>`;for(let w=0;w<=4;w++){const S=p.t+w/4*g,B=y-w/4*A,U=Math.abs(B)>=100?B.toFixed(0):Math.abs(B)>=10?B.toFixed(1):B.toFixed(2);C+=`<line x1="${p.l}" y1="${S.toFixed(1)}" x2="${600-p.r}" y2="${S.toFixed(1)}" stroke="var(--bdr2)" stroke-width="1"/>`,C+=`<text x="${p.l-5}" y="${(S+4).toFixed(1)}" text-anchor="end" font-size="10" font-family="var(--font)" fill="var(--txt3)">${U}</text>`}const b=Math.max(1,Math.floor(n/6));for(let w=0;w<n;w+=b){const S=f(w).toFixed(1);C+=`<line x1="${S}" y1="${p.t}" x2="${S}" y2="${p.t+g}" stroke="var(--bdr2)" stroke-width="1" stroke-dasharray="3,3"/>`,C+=`<text x="${S}" y="174" text-anchor="middle" font-size="10" font-family="var(--font)" fill="var(--txt3)">${se((n-w)*a)}</text>`}const M=m.map((w,S)=>({x:f(S),y:_(w)})),K=Se(M),je=K+` L${f(n-1).toFixed(1)},${p.t+g} L${p.l.toFixed(1)},${p.t+g} Z`;C+=`<path d="${je}" fill="${z}" opacity="0.07" clip-path="url(#clip_${I})"/>`,C+=`<path d="${K}" fill="none" stroke="url(#${I})" stroke-width="2" stroke-linejoin="round" stroke-linecap="round" clip-path="url(#clip_${I})"/>`,C+=`<rect class="chart-hover-rect" x="${p.l}" y="${p.t}" width="${h}" height="${g}" fill="transparent" style="cursor:crosshair"/>`,t.innerHTML=C;const Z=ze(),ie=t.querySelector(".chart-hover-rect");if(!ie)return;const k=document.createElementNS("http://www.w3.org/2000/svg","circle");k.setAttribute("r","4"),k.setAttribute("fill",o),k.setAttribute("stroke","#fff"),k.setAttribute("stroke-width","1.5"),k.style.display="none",k.style.pointerEvents="none",t.appendChild(k),ie.addEventListener("mousemove",w=>{const S=t.getBoundingClientRect(),B=(w.clientX-S.left)*(600/S.width),U=Math.max(0,Math.min(1,(B-p.l)/h)),F=Math.round(U*(n-1));if(F<0||F>=m.length)return;const ee=m[F];k.setAttribute("cx",f(F)),k.setAttribute("cy",_(ee)),k.style.display="";const Be=Math.abs(ee)>=100?ee.toFixed(1):ee.toFixed(2);Z.innerHTML=`
  ...
  `}function Te(){const t=document.getElementById("panel-events");if(c.event){const e=Array.isArray(c.event)?c.event:[c.event];t.innerHTML=e.map((o,n)=>{const a=o.toLowerCase().includes("déplacé");return`
      ...
      </div>`}).join(""),t.querySelectorAll(".ev-stop-btn").forEach(o=>{o.addEventListener("click",()=>{const n=+o.dataset.evIdx;Array.isArray(c.event)?(c.event=c.event.filter((a,i)=>i!==n),c.event.length||(c.event=null)):c.event=null,Te()})})}else t.innerHTML='<div class="panel-empty"><i class="bi bi-check-circle" style="color:var(--ok)"></i> Aucun événement</div>'}function ot(){const t=O(c);document.getElementById("panel-metrics").innerHTML=t.map(e=>`
  ...
  `).join("")}function it(){const t=document.getElementById("panel-config");if(!t)return;const e=c.model||"",o=e.startsWith("CHP"),n=e.startsWith("CAPA"),a=e==="EC",i=c.isVirtual;let s="";if(i&&(s+=`
    ...
    `),s?t.innerHTML=s:t.innerHTML='<div class="panel-empty">Pas de configuration spécifique pour ce modèle.</div>'}let H=N.filter(t=>{var e;return t.orgId===c.orgId&&((e=c.parcelIds)==null?void 0:e.includes(t.id))}).map(t=>t.id);(function(){const e=ue($);e.linkedPlotIds?H=e.linkedPlotIds:R($,{linkedPlotIds:H})})();function le(){var l;const t=document.getElementById("panel-plots");if(!t)return;const e=c.orgId||((l=N.find(d=>{var u;return(u=c.parcelIds)==null?void 0:u.includes(d.id)}))==null?void 0:l.orgId),o=N.filter(d=>d.orgId===e),n=o.filter(d=>H.includes(d.id)),a=o.filter(d=>!H.includes(d.id));t.innerHTML=n.length?n.map(d=>`
    ...
    `).join(""):'<div class="panel-empty" style="margin-bottom:6px">Aucune parcelle liée</div>',t.querySelectorAll(".remove-plot-btn").forEach(d=>{d.addEventListener("click",()=>{H=H.filter(u=>u!==parseInt(d.dataset.id)),R($,{linkedPlotIds:H}),le()})});const i=document.getElementById("plot-add-row"),s=document.getElementById("add-plot-select");i&&s&&(a.length>0?(s.innerHTML='<option value="">Ajouter une parcelle…</option>'+a.map(d=>`<option value="${d.id}">${d.name}${d.area?" — "+d.area+" ha":""}</option>`).join(""),i.style.display=""):i.style.display="none");const r=document.getElementById("add-plot-btn");r&&(r.onclick=()=>{const d=parseInt(document.getElementById("add-plot-select").value);!d||H.includes(d)||(H.push(d),R($,{linkedPlotIds:H}),le())})}function st(t,e){const o=new Blob(["\uFEFF"+t],{type:"text/csv;charset=utf-8;"}),n=Object.assign(document.createElement("a"),{href:URL.createObjectURL(o),download:e});document.body.appendChild(n),n.click(),document.body.removeChild(n),setTimeout(()=>URL.revokeObjectURL(n.href),100)}function rt(){const t=O(c).filter(u=>u.baseVal);let e;if(P){const u=X.find(h=>h.id===P),p=u?O(u).filter(h=>h.baseVal):[];e=[...t.map(h=>({h:`[${c.serial}] ${h.name} (${h.unit})`,gen:h.baseVal})),...p.map(h=>({h:`[${u.serial}] ${h.name} (${h.unit})`,gen:h.baseVal}))]}else e=t.map(u=>({h:`${u.name} (${u.unit})`,gen:u.baseVal}));const o=_e()*6e4,n=ae()*6e4,a=D==="custom"&&Y?Y:new Date,i=D==="custom"&&G?G:new Date(a-o),s=Math.min(Math.ceil((a-i)/n)+1,500),r=(a-i)/Math.max(s-1,1),l=["Horodatage",...e.map(u=>u.h)].join(";"),d=Array.from({length:s},(u,p)=>[new Date(i.getTime()+p*r).toISOString().replace("T"," ").slice(0,19),...e.map(g=>g.gen())].join(";"));st([l,...d].join(`\r
`),`${c.serial}_${D}_${new Date().toISOString().slice(0,10)}.csv`)}function lt({title:t,message:e,confirmLabel:o="Confirmer",onConfirm:n}){const a=document.createElement("div");a.className="modal add-modal",a.innerHTML=`
  ...
  `,t.querySelector("#unlink-sensor-btn").addEventListener("click",()=>{const e=N.filter(n=>c.parcelIds.includes(n.id)),o=e.length?e.map(n=>`<strong>${n.name}</strong>`).join(", "):"aucune parcelle";lt({title:"Retirer le capteur de l'exploitation",message:`Retirer <strong>${c.model} ${c.serial}</strong> de l'exploitation ?<br><br>Parcelles liées : ${o}.<br><br>Le capteur restera visible dans le catalogue réseau.`,confirmLabel:"Retirer",onConfirm:()=>showToast("Capteur retiré de l'exploitation (fonctionnalité à venir)")})})}function dt(){const t=(c==null?void 0:c.orgId)===1,e=(()=>{const a=T.find(s=>s.source==="réseau"&&s.role==="agent"&&s.orgIds.includes(c==null?void 0:c.orgId));if(a)return`${a.prenom} ${a.nom}`;const i=T.find(s=>s.source==="réseau"&&(s.role==="admin"||s.role==="propriétaire"));return i?`${i.prenom} ${i.nom}`:"Technicien réseau"})(),o=t?(()=>{const a=T.find(i=>i.source==="adherent"&&i.orgIds.includes(1));return a?`${a.prenom} ${a.nom}`:e})():e,n=[{type:"installation",label:"Installation initiale",date:"15/01/2023",user:e,icon:"bi-box-arrow-in-down"},{type:"nettoyage",label:"Nettoyage pluviomètre",date:"20/03/2023",user:o,icon:"bi-droplet"},{type:"batterie",label:"Changement de batterie",date:"10/06/2023",user:e,icon:"bi-battery-charging"},{type:"note",label:"Redressage capteur déplacé",date:"02/11/2023",user:o,icon:"bi-chat-text"}];document.getElementById("panel-maint").innerHTML=`
  ...
  </div>`}function J(t){var E;ut(t);const e=((E=document.getElementById("sidebar"))==null?void 0:E.getAttribute("data-role"))==="adherent-reseau",o=(t==null?void 0:t.orgId)??c.orgId,n=document.getElementById("panel-membres"),a=document.getElementById("panel-membres-section"),i=T.filter(m=>{var x;return m.source==="adherent"&&((x=m.orgIds)==null?void 0:x.includes(o))}),s=i.filter(m=>V.includes(m.id));a&&(a.style.display=!e&&i.length===0?"none":""),n&&(n.innerHTML=s.length?s.map(m=>$e(m,!0,!1)).join(""):'<p class="panel-empty">Aucun membre associé.</p>',n.querySelectorAll(".remove-membre-btn").forEach(m=>{m.addEventListener("click",()=>{V=V.filter(x=>x!==parseInt(m.dataset.id)),R($,{linkedOrgMemberIds:V}),J(t)})}));const r=document.getElementById("add-membre-org-row");r&&(r.style.display="");const l=document.getElementById("add-membre-org-select");l&&(l.innerHTML='<option value="">Associer un membre…</option>',i.filter(m=>!V.includes(m.id)).forEach(m=>{const x=document.createElement("option");x.value=m.id,x.textContent=`${m.prenom} ${m.nom}`,l.appendChild(x)}));const d=document.getElementById("add-membre-org-btn");d&&(d.onclick=()=>{const m=parseInt(l==null?void 0:l.value);!m||V.includes(m)||(V.push(m),R($,{linkedOrgMemberIds:V}),J(t))});const u=document.getElementById("panel-conseillers"),p=document.getElementById("panel-conseillers-section"),h=T.filter(m=>m.source==="réseau"&&q.includes(m.id));p&&(p.style.display=e&&h.length===0?"none":""),u&&(u.innerHTML=h.length?h.map(m=>$e(m,!e,!0)).join(""):'<p class="panel-empty">Aucun conseiller associé.</p>',e||u.querySelectorAll(".remove-membre-btn").forEach(m=>{m.addEventListener("click",()=>{q=q.filter(x=>x!==parseInt(m.dataset.id)),R($,{linkedConseillerIds:q}),J(t)})}));const g=document.getElementById("add-conseiller-row");if(g&&(g.style.display=e?"none":""),!e){const m=document.getElementById("add-membre-select");m&&(m.innerHTML='<option value="">Ajouter un conseiller…</option>',T.filter(y=>y.source==="réseau"&&!q.includes(y.id)).forEach(y=>{const A=document.createElement("option");A.value=y.id,A.textContent=`${y.prenom} ${y.nom} (${y.role})`,m.appendChild(A)}));const x=document.getElementById("add-membre-btn");x&&(x.onclick=()=>{const y=parseInt(m==null?void 0:m.value);!y||q.includes(y)||(q.push(y),R($,{linkedConseillerIds:q}),J(t))})}}function mt(){const t=N.find(a=>{var i;return(i=c.parcelIds)==null?void 0:i.includes(a.id)}),e=t?ne.find(a=>a.id===t.orgId):c.orgId?ne.find(a=>a.id===c.orgId):null;if(!(e!=null&&e.lat))return;const o=L.map("sensor-mini-map",{zoomControl:!1,attributionControl:!1});L.tileLayer("https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}",{attribution:"Esri"}).addTo(o);const n=t==null?void 0:t.latlngs;if(Array.isArray(n)&&n.length>=3){const a=L.polygon(n,{color:"#0172A4",weight:1.5,fillColor:"#0172A4",fillOpacity:.3}).addTo(o),i=n.reduce((r,l)=>r+l[0],0)/n.length,s=n.reduce((r,l)=>r+l[1],0)/n.length;L.circleMarker([i,s],{radius:6,color:"white",fillColor:"#0172A4",fillOpacity:1,weight:2}).addTo(o),o.fitBounds(a.getBounds(),{padding:[10,10]})}else o.setView([e.lat,e.lng],13),L.circleMarker([e.lat,e.lng],{radius:6,color:"white",fillColor:"#0172A4",fillOpacity:1,weight:2}).addTo(o)}function Le(){var i,s,r,l,d;const e=(((i=document.getElementById("sidebar"))==null?void 0:i.getAttribute("data-role"))||"")==="adherent-reseau"&&(c==null?void 0:c.orgId)!==1;[(s=document.querySelector("#panel-plots"))==null?void 0:s.closest(".panel-section"),(r=document.querySelector("#panel-config"))==null?void 0:r.closest(".panel-section"),document.getElementById("panel-membres-section"),document.getElementById("panel-conseillers-section"),(l=document.querySelector("#panel-actions"))==null?void 0:l.closest(".panel-section"),(d=document.querySelector("#panel-maint"))==null?void 0:d.closest(".panel-section")].forEach(u=>{u&&(u.style.display=e?"none":"")});const o=document.querySelector('.detail-tab-btn[data-pane="tab-journal"]');o&&(o.style.display=e?"none":"");const n=document.getElementById("panel-loc-parcel");n&&(n.style.display=e?"none":"");const a=document.querySelector('#panel-ident [data-field="label"] input');a&&(a.readOnly=e,a.style.cssText=e?"cursor:default;background:transparent;border:none;padding:0;pointer-events:none;color:var(--txt)":"")}function pt(){const t=document.getElementById("detail-layout"),e=document.getElementById("panel-toggle"),o=e.querySelector("i");e.addEventListener("click",()=>{const n=t.classList.toggle("panel-collapsed");e.title=n?"Afficher le panneau":"Masquer le panneau",o.className=n?"bi bi-chevron-left":"bi bi-chevron-right"})}function ht(){document.querySelectorAll(".detail-tab-btn").forEach(t=>{t.addEventListener("click",()=>{var e;document.querySelectorAll(".detail-tab-btn").forEach(o=>o.classList.remove("active")),document.querySelectorAll(".detail-tab-pane").forEach(o=>o.classList.remove("active")),t.classList.add("active"),(e=document.getElementById(t.dataset.pane))==null||e.classList.add("active")})})}const ce=`sensor-journal-${$}`,ke=[{id:"installation",label:"Installation",icon:"bi-box-arrow-in-down",color:"#0172A4"},{id:"batterie",label:"Remplacement batterie",icon:"bi-battery-charging",color:"#e07820"},{id:"antenne",label:"Remplacement antenne",icon:"bi-reception-4",color:"#5b8dd9"},{id:"bocal",label:"Remplacement bocal",icon:"bi-cup",color:"#3a9e6a"},{id:"lacet",label:"Remplacement lacet",icon:"bi-link-45deg",color:"#8060c0"},{id:"cuillere",label:"Remplacement cuillère",icon:"bi-moisture",color:"#45b7d1"},{id:"nettoyage",label:"Nettoyage",icon:"bi-droplet",color:"#4ecdc4"},{id:"verification",label:"Vérification terrain",icon:"bi-check2-circle",color:"#3a7a38"},{id:"note",label:"Note technique",icon:"bi-chat-text",color:"#8e8e93"}];function vt(){if((c==null?void 0:c.orgId)===1){const n=T.find(a=>a.source==="adherent"&&a.orgIds.includes(1));if(n)return`${n.prenom} ${n.nom}`}const e=T.find(n=>n.source==="réseau"&&n.role==="agent"&&n.orgIds.includes(c==null?void 0:c.orgId));if(e)return`${e.prenom} ${e.nom}`;const o=T.find(n=>n.source==="réseau"&&(n.role==="admin"||n.role==="propriétaire"));return o?`${o.prenom} ${o.nom}`:""}function de(){try{const u=localStorage.getItem(ce);if(u)return JSON.parse(u)}catch{}const t=(c==null?void 0:c.orgId)===1,e=(()=>{const u=T.find(h=>h.source==="réseau"&&h.role==="agent"&&h.orgIds.includes(c==null?void 0:c.orgId));if(u)return`${u.prenom} ${u.nom}`;const p=T.find(h=>h.source==="réseau"&&(h.role==="admin"||h.role==="propriétaire"));return p?`${p.prenom} ${p.nom}`:"Technicien réseau"})(),o=t?(()=>{const u=T.find(p=>p.source==="adherent"&&p.orgIds.includes(1));return u?`${u.prenom} ${u.nom}`:e})():e,n=["Nettoyage pluviomètre après hiver","Nettoyage du capteur, dépôt de poussière sur la cellule","Toile d'araignée retirée dans l'entonnoir","Nettoyage de routine, aucune anomalie constatée"],a=["Capteur légèrement déplacé après passage tracteur — redressé","Antenne réorientée pour améliorer la réception","Végétation haute autour du capteur — dégagée","Capteur incliné après un coup de vent — vérifié et stabilisé","Câble légèrement endommagé — surveillance renforcée"],i=[{id:"batterie",label:""},{id:"antenne",label:""},{id:"bocal",label:""},{id:"lacet",label:""}],s=$%100,r=i[$%i.length].id,d=[{id:1,type:"installation",date:`${2022+$%3}-${String(1+$%12).padStart(2,"0")}-${String(1+$*3%27).padStart(2,"0")}`,user:e,texte:""},{id:2,type:"nettoyage",date:"2023-03-20",user:o,texte:n[s%n.length]},{id:3,type:r,date:"2023-06-10",user:e,texte:""},{id:4,type:"note",date:"2023-11-02",user:o,texte:a[s%a.length]}];return $%3===0&&d.push({id:5,type:"verification",date:"2024-09-12",user:e,texte:"Vérification annuelle conforme."}),localStorage.setItem(ce,JSON.stringify(d)),d}function Ae(t){localStorage.setItem(ce,JSON.stringify(t))}function pe(){var i;const t=document.getElementById("sensor-journal-container");if(!t)return;const e=de().slice().sort((s,r)=>r.date.localeCompare(s.date)),o=s=>{const[r,l,d]=s.split("-");return`${d}/${l}/${r}`},n=Object.fromEntries(ke.map(s=>[s.id,s]));let a=`
      ...
      <div class="journal-form">
        <div class="journal-form-row">
          ...
          <select id="sjrn-f-type" class="journal-form-input">
            ${ke.map(n=>`<option value="${n.id}">${n.label}</option>`).join("")}
          </select>
        </div>
        <div class="journal-form-row">
